...
|---|---|---|---|---|---|
| point | NEAR | `0x8054cc6` | `0x98` | `0x8057726` | `0x98` |
...
{
    // ORIG 失败分支返回 .rodata:0x8151740 的 CharacterNameStruct::char_name
    // （内容 "iiiEC2Ej"，已验证）；重建不得硬编码 ORIG 地址，改为等价静态缓冲。
    static char s_failedCharacterName[] = "iiiEC2Ej";
