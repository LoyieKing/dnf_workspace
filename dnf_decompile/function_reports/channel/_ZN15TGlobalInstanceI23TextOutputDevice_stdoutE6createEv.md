...
|---|---|---|---|---|---|
| channel | DIFF | `0x8052782` | `0x93` | `0x805f44a` | `0xae` |
...
+jne    <T> <_ZN15TGlobalInstanceI23TextOutputDevice_stdoutE6createEv+0xa7>
 movl   $0x1902c,(%esp)
 call   <T> <_Znwj>
-mov    %eax,%esi
-mov    %esi,%ebx
...
+jmp    <T> <_ZN15TGlobalInstanceI23TextOutputDevice_stdoutE6createEv+0xa7>
 mov    %eax,(%esp)
...

{
  ...
  if ((this->m_p == (TextOutputDevice_stdout *)0x0) && (this->m_p == (TextOutputDevice_stdout *)0x0)
                    ...
                    /* try { // try from 080527a3 to 080527a7 has its CatchHandler @ 080527d8 */
...
定义于 [source/ChannelOld/DNFChannelServer/ChannelService.cpp](source/ChannelOld/DNFChannelServer/ChannelService.cpp)（约第 363 行）：
