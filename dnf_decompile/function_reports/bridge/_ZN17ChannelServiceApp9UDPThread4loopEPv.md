...
|---|---|---|---|---|---|
| bridge | DIFF | `0x8060eba` | `0x17f` | `0x8056896` | `0x17c` |
...
@@ -1,105 +1,103 @@
 ...
 call   <T> <puts>
-jmp    <T> <_ZN17ChannelServiceApp9UDPThread4loopEPv+0x16a>
+jmp    <T> <_ZN17ChannelServiceApp9UDPThread4loopEPv+0x167>
 mov    0x8(%ebp),%eax
 mov    0x1c(%eax),%eax
 movzwl %ax,%eax
 movl   $0x1,0x8(%esp)
...
+jmp    <T> <_ZN17ChannelServiceApp9UDPThread4loopEPv+0x167>
 ...
 call   <T> <printf>
-jmp    <T> <_ZN17ChannelServiceApp9UDPThread4loopEPv+0x12c>
+jmp    <T> <_ZN17ChannelServiceApp9UDPThread4loopEPv+0x129>
 movl   $0xa,(%esp)
...
+jmp    <T> <_ZN17ChannelServiceApp9UDPThread4loopEPv+0x129>
 cmpl   $0x0,-0xc(%ebp)
-je     <T> <_ZN17ChannelServiceApp9UDPThread4loopEPv+0x12b>
+je     <T> <_ZN17ChannelServiceApp9UDPThread4loopEPv+0x129>
 mov    0x8(%ebp),%eax
 mov    0x18(%eax),%eax
 mov    (%eax),%eax
 mov    (%eax),%ecx
...

{
  ...
  UDPSocket::UDPSocket(&local_38);
                    /* try { // try from 08060ee2 to 08061006 has its CatchHandler @ 08061009 */
