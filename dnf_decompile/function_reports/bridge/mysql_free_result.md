...
|---|---|---|---|---|---|
| bridge | DIFF | `0x8096020` | `0xd4` | `0x8056e71` | `0x5` |
...
定义于 [source/ChannelOld/DNFChannelBridge/MysqlClient.cpp](source/ChannelOld/DNFChannelBridge/MysqlClient.cpp)（约第 52 行）：
