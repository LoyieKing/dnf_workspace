...
|---|---|---|---|---|---|
| bridge | DIFF | `0x8098360` | `0x14e` | `0x8056e76` | `0x13` |
...
定义于 [source/ChannelOld/DNFChannelBridge/MysqlClient.cpp](source/ChannelOld/DNFChannelBridge/MysqlClient.cpp)（约第 56 行）：
