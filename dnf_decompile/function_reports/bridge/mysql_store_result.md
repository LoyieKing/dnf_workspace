...
|---|---|---|---|---|---|
| bridge | DIFF | `0x80948c0` | `0x1b2` | `0x8056e5d` | `0xa` |
...

{
  ...
  if (*(int *)(param_1 + 0x294) != 0) {
    if (*(int *)(param_1 + 0x380) != 1) {
      set_mysql_error(param_1,0x7de,*(undefined4 *)PTR_unknown_sqlstate_082271fc);
...
定义于 [source/ChannelOld/DNFChannelBridge/MysqlClient.cpp](source/ChannelOld/DNFChannelBridge/MysqlClient.cpp)（约第 42 行）：
