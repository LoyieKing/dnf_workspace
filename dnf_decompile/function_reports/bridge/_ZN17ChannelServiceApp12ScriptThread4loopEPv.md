...
|---|---|---|---|---|---|
| bridge | DIFF | `0x8063936` | `0xb40` | `0x804ef74` | `0xae5` |
...
+mov    -0x40(%ebp),%eax
+test   %eax,%eax
+jne    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x171>
+nop
+jmp    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0xaa7>
+mov    -0x40(%ebp),%eax
+mov    -0x34(%ebp),%edx
 add    $0x3804cd0,%edx
 mov    %eax,0x4(%esp)
...
-call   <T> <exit>
+addl   $0x1,-0x28(%ebp)
+jmp    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x146>
 movl   $0x400,0x8(%esp)
 movl   $0x0,0x4(%esp)
-lea    -0x482(%ebp),%eax
+lea    -0x5b0(%ebp),%eax
...
+mov    %eax,-0x30(%ebp)
+cmpl   $0x0,-0x30(%ebp)
+jne    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x249>
+lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    -0x40(%ebp),%eax
+test   %eax,%eax
+je     <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x476>
+mov    -0x40(%ebp),%eax
 mov    (%eax),%eax
 movl   $0x14,0x8(%esp)
 mov    %eax,0x4(%esp)
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jne    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x3a2>
+lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5DBMgr13Mysql_relogonEv>
-lea    -0x882(%ebp),%eax
...
+mov    -0x84(%ebp),%eax
+test   %eax,%eax
+je     <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x437>
+mov    -0x84(%ebp),%eax
 add    $0x4,%eax
 mov    (%eax),%eax
 mov    %eax,(%esp)
...
-lea    -0x34(%ebp),%eax
+addl   $0x1,-0x24(%ebp)
+jmp    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x3a9>
+nop
+mov    -0x1c(%ebp),%eax
+mov    %eax,0x4(%esp)
+lea    -0x38(%ebp),%eax
...
-lea    -0x34(%ebp),%eax
+addl   $0x1,-0x28(%ebp)
+jmp    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x250>
+nop
+mov    -0x30(%ebp),%eax
+mov    %eax,0x4(%esp)
+lea    -0x38(%ebp),%eax
...
+mov    %eax,-0x30(%ebp)
+cmpl   $0x0,-0x30(%ebp)
+jne    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x503>
+lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5DBMgr13Mysql_relogonEv>
-lea    -0x482(%ebp),%eax
...
+mov    -0x40(%ebp),%eax
+test   %eax,%eax
+je     <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x8b9>
+mov    -0x40(%ebp),%eax
 add    $0x4,%eax
 mov    (%eax),%eax
 mov    %eax,(%esp)
...
+call   <T> <snprintf>
+cmpl   $0x0,-0x28(%ebp)
+jne    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x5dd>
+mov    -0x2c(%ebp),%eax
 mov    %eax,0xc(%esp)
 movl   $0x9,0x8(%esp)
 movl   $0x1,0x4(%esp)
...
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x86e>
+mov    -0x2c(%ebp),%eax
 mov    %eax,0xc(%esp)
 movl   $0xc,0x8(%esp)
 movl   $0x1,0x4(%esp)
...
-mov    -0x28(%ebp),%eax
+addl   $0x1,-0x28(%ebp)
+jmp    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x50a>
+nop
+mov    -0x2c(%ebp),%eax
 mov    %eax,0xc(%esp)
 movl   $0x9,0x8(%esp)
...
+mov    %eax,-0x30(%ebp)
+cmpl   $0x0,-0x30(%ebp)
+jne    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x98f>
+lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5DBMgr13Mysql_relogonEv>
-lea    -0x482(%ebp),%eax
...
+jne    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x9f5>
+mov    -0x30(%ebp),%eax
+mov    %eax,0x4(%esp)
+lea    -0x38(%ebp),%eax
+mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+jne    <T> <_ZN17ChannelServiceApp12ScriptThread4loopEPv+0x1cf>
+movl   $"[ERROR] cann't open channel_into.etc",(%esp)
+call   <T> <puts>
+movl   $0x1,(%esp)
+call   <T> <exit>
