...
|---|---|---|---|---|---|
| manager | DIFF | `0x805277a` | `0x80` | `0x8062c88` | `0x74` |
...
定义于 [source/DNFServer/GameServer/Manager/DNFTickHandler.cpp](source/DNFServer/GameServer/Manager/DNFTickHandler.cpp)（约第 17 行）：
