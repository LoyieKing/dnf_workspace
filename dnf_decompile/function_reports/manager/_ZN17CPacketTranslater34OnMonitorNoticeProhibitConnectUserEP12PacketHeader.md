...
|---|---|---|---|---|---|
| manager | DIFF | `0x8065440` | `0x718` | `0x805c064` | `0x6fb` |
...
+jne    <T> <_ZN17CPacketTranslater34OnMonitorNoticeProhibitConnectUserEP12PacketHeader+0x18e>
 movl   $0x138,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater34OnMonitorNoticeProhibitConnectUserEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x68(%ebp),%eax
-mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Manager/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Manager/DNFPacketTranslater.cpp)（约第 562 行）：
