...
|---|---|---|---|---|---|
| manager | DIFF | `0x805d36c` | `0x457` | `0x80616f4` | `0x44f` |
...
+jne    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x34c>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x2dc>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x2d6>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x2fa>
+jne    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x2fb>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%ecx
 mov    %ebx,%eax
-jmp    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x2fa>
+jmp    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x2fb>
 lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
+jmp    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x3df>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x3d9>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x3fd>
+jne    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x3fe>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%ecx
 mov    %ebx,%eax
-jmp    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x3fd>
+jmp    <T> <_ZN17CTcpNetworkThread8dispatchEPv+0x3fe>
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...

{
  ...
  *(undefined1 *)((int)param_1 + 0x2c) = 1;
                    /* try { // try from 0805d399 to 0805d588 has its CatchHandler @ 0805d58e */
