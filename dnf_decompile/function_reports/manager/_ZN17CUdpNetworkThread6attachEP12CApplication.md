...
|---|---|---|---|---|---|
| manager | DIFF | `0x806ba6c` | `0x52` | `0x805569c` | `0x55` |
...
+je     <T> <_ZN17CUdpNetworkThread6attachEP12CApplication+0x52>
 mov    0xc(%ebp),%eax
 mov    %eax,(%esp)
 ...
 mov    0x8(%ebp),%edx
 mov    %eax,0x18(%edx)
+jmp    <T> <_ZN17CUdpNetworkThread6attachEP12CApplication+0x53>
+nop
 leave
 ret
```
