...
|---|---|---|---|---|---|
| manager | DIFF | `0x8057212` | `0x24d` | `0x806443a` | `0x24f` |
...
+jmp    <T> <_ZN5CPeer11send_packetEv+0x248>
 mov    0x8(%ebp),%eax
 mov    0x1834(%eax),%ebx
 mov    0x8(%ebp),%eax
 lea    0x183c(%eax),%esi
...
+jle    <T> <_ZN5CPeer11send_packetEv+0x245>
 mov    0x8(%ebp),%eax
 mov    0x1834(%eax),%eax
 cmp    -0xc(%ebp),%eax
-jle    <T> <_ZN5CPeer11send_packetEv+0x1ef>
+jle    <T> <_ZN5CPeer11send_packetEv+0x1f1>
 mov    0x8(%ebp),%eax
-lea    0x183c(%eax),%edx
-mov    -0xc(%ebp),%eax
-add    %eax,%edx
...
-mov    0x8(%ebp),%eax
-mov    0x1834(%eax),%ebx
+jbe    <T> <_ZN5CPeer11send_packetEv+0x1a6>
 movl   $0x17e,0x8(%esp)
...
+jge    <T> <_ZN5CPeer11send_packetEv+0x226>
 mov    0x8(%ebp),%eax
 mov    0x1834(%eax),%eax
 mov    -0xc(%ebp),%edx
 mov    %edx,0x8(%esp)
