...
|---|---|---|---|---|---|
| manager | DIFF | `0x80649c6` | `0x251` | `0x805a696` | `0x24b` |
...
+lea    -0x1d(%ebp),%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
-jmp    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x141>
-lea    -0x39(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x13d>
+lea    -0x1d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+jmp    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x243>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x1e3>
+jne    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x1dd>
 mov    %eax,(%esp)
...
+lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x1dc>
+jmp    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x1d6>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x244>
+jmp    <T> <_ZN17CPacketTranslater10OnEventEndEP12PacketHeader+0x23e>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...

{
  ...
  if (m_pclApp == 0) {
    std::allocator<char>::allocator();
                    /* try { // try from 080649fc to 08064a00 has its CatchHandler @ 08064a6a */
    std::string::string(local_44,"CPacketTranslater::OnEventEnd : 0 == m_pclApp",&local_3d);
    this = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 08064a1b to 08064a1f has its CatchHandler @ 08064a22 */
    CDNFException::CDNFException(this,local_44);
                    /* try { // try from 08064a59 to 08064a5d has its CatchHandler @ 08064a60 */
    std::string::~string(local_44);
    std::allocator<char>::~allocator((allocator<char> *)&local_3d);
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 08064aa0 to 08064b01 has its CatchHandler @ 08064b07 */
  ...
  CMyFileLog::CMyFileLog(local_3c,"OnEventEnd",0x92);
...
定义于 [source/DNFServer/GameServer/Manager/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Manager/DNFPacketTranslater.cpp)（约第 97 行）：
