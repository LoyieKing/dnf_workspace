# _ZN13CTcpNetSystemD1Ev

`CTcpNetSystem::~CTcpNetSystem()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| manager | DIFF | `0x80584d0` | `0x28a` | `0x8066156` | `0x272` |
...
+je     <T> <_ZN13CTcpNetSystemD1Ev+0x83>
 mov    0x8(%ebp),%eax
 mov    0x118(%eax),%eax
-mov    (%eax),%eax
-mov    (%eax),%edx
...
+je     <T> <_ZN13CTcpNetSystemD1Ev+0xd5>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
-mov    (%eax),%eax
-mov    (%eax),%edx
...
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0xd5>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x144,%eax
...
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0xe7>
 mov    0x8(%ebp),%eax
 add    $0x144,%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt3mapIjP5CPeerSt4lessIjESaISt4pairIKjS1_EEED1Ev>
-jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x131>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x101>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x11c,%eax
...
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x113>
 mov    0x8(%ebp),%eax
 add    $0x11c,%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt5queueIP5CPeerSt5dequeIS1_SaIS1_EEED1Ev>
-jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x18d>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x12d>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x100,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x13f>
+mov    0x8(%ebp),%eax
+add    $0x100,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x159>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xe8,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x16b>
+mov    0x8(%ebp),%eax
+add    $0xe8,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x185>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
...
-mov    %eax,(%esp)
-call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x197>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt5queueIP14CTcpSendBufferSt5dequeIS1_SaIS1_EEED1Ev>
-jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x239>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x1b1>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xa8,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x1c3>
+mov    0x8(%ebp),%eax
+add    $0xa8,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x1dd>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x90,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x1ef>
+mov    0x8(%ebp),%eax
+add    $0x90,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x207>
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x217>
+mov    0x8(%ebp),%eax
+add    $0x78,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x22f>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x60,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x23f>
+mov    0x8(%ebp),%eax
+add    $0x60,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x25d>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x8,%eax
...
void __thiscall CTcpNetSystem::_ZN13CTcpNetSystemD1Ev(CTcpNetSystem *this)

{
  CTcpHandler *this_00;
  
                    /* try { // try from 080584de to 080585ae has its CatchHandler @ 080585bb */
  ...
  if (*(int *)(this + 4) != 0) {
    ...
    *(undefined4 *)(this + 4) = 0;
                    ...
                    /* try { // try from 080585e0 to 080585e4 has its CatchHandler @ 080585e7 */
  std::
  ...
  ::~map((map<unsigned_int,CPeer*,std::less<unsigned_int>,std::allocator<std::pair<unsigned_int_const,CPeer*>>>
          *)(this + 0x144));
                    /* try { // try from 0805860c to 08058610 has its CatchHandler @ 08058613 */
  ...
  CMutex::~CMutex((CMutex *)(this + 0xe8));
                    /* try { // try from 08058688 to 0805868c has its CatchHandler @ 0805868f */
