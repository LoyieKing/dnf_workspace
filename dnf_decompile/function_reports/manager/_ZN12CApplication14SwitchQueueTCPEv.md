...
|---|---|---|---|---|---|
| manager | DIFF | `0x805f0da` | `0x8a` | `0x804ee8c` | `0x8c` |
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN12CApplication14SwitchQueueTCPEv+0x7a>
 call   <T> <_ZN6IQueueISt5queueIP14CTcpRecvBufferSt5dequeIS2_SaIS2_EEEE3GetEv>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CApplication14SwitchQueueTCPEv+0x7a>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0xc(%ebp),%eax
 mov    %eax,(%esp)
...

{
  ...
  *pIVar3;
  ...
  pCVar2 = (CMutex *)CTcpNetSystem::Get_TcpRecvQLock((CTcpNetSystem *)(this + 0xcc));
  CGuard<CMutex>::CGuard(local_10,pCVar2);
                    /* try { // try from 0805f101 to 0805f134 has its CatchHandler @ 0805f137 */
