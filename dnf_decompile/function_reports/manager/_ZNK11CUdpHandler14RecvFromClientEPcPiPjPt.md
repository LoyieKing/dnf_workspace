...
|---|---|---|---|---|---|
| manager | DIFF | `0x8055bae` | `0x273` | `0x8063ae0` | `0x266` |
...
+jne    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1c>
 mov    $0x0,%eax
...
+jg     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x18b>
 mov    0x10(%ebp),%eax
 mov    (%eax),%eax
 mov    %eax,0x4(%esp)
...
+movzwl (%eax),%eax
+cmp    $0x4c8,%ax
+je     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1e0>
+mov    0xc(%ebp),%eax
+movzwl (%eax),%eax
+cmp    $0x4c9,%ax
+je     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1e0>
...
+movzwl (%eax),%eax
+cmp    $0x450,%ax
+jne    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x25a>
+movl   $0xd1,0x8(%esp)
+movl   $"RecvFromClient",0x4(%esp)
+lea    -0x40(%ebp),%eax
+mov    %eax,(%esp)
