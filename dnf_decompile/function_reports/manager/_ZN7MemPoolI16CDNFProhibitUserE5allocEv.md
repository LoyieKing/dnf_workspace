# _ZN7MemPoolI16CDNFProhibitUserE5allocEv

`MemPool<CDNFProhibitUser>::alloc()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| manager | DIFF | `0x806c2a4` | `0x151` | `0x805786a` | `0x17f` |
...
-movl   $0x14,(%esp)
-call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x14a>
+jne    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x167>
...
-mov    0x8(%ebp),%eax
-mov    0x4(%eax),%edx
+jne    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x14a>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    0x4(%eax),%eax
 ...
 mov    %eax,-0x10(%ebp)
 movl   $0x0,-0xc(%ebp)
-jmp    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x8f>
-mov    -0xc(%ebp),%edx
-mov    %edx,%eax
-shl    $0x2,%eax
-add    %edx,%eax
-shl    $0x2,%eax
+jmp    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x80>
+mov    -0x10(%ebp),%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
 mov    %eax,%ecx
...
+jne    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x4b>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
-lea    -0x1(%eax),%edx
...
+jmp    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x15f>
+mov    -0x14(%ebp),%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
+sub    $0x4,%eax
...
-add    $0x40,%esp
+mov    %eax,-0x18(%ebp)
+jmp    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x176>
+movl   $0x14,(%esp)
+call   <T> <_Znwj>
+mov    %eax,-0x18(%ebp)
+mov    -0x18(%ebp),%eax
...
void * __thiscall
MemPool<CDNFProhibitUser>::_ZN7MemPoolI16CDNFProhibitUserE5allocEv(MemPool<CDNFProhibitUser> *this)
