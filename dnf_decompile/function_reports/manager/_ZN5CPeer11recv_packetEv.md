...
|---|---|---|---|---|---|
| manager | DIFF | `0x80569ca` | `0x1a1` | `0x80641aa` | `0x195` |
...
+jmp    <T> <_ZN5CPeer11recv_packetEv+0x18e>
...
+jne    <T> <_ZN5CPeer11recv_packetEv+0x74>
 mov    0x8(%ebp),%eax
 lea    0x1c(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0x181c(%eax)
...
+cmpl   $0x0,-0xc(%ebp)
+jns    <T> <_ZN5CPeer11recv_packetEv+0x11a>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0xb,%eax
-je     <T> <_ZN5CPeer11recv_packetEv+0xda>
+je     <T> <_ZN5CPeer11recv_packetEv+0xbc>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0x4,%eax
-je     <T> <_ZN5CPeer11recv_packetEv+0xda>
...
-cmp    $0xb,%eax
-je     <T> <_ZN5CPeer11recv_packetEv+0xda>
+jne    <T> <_ZN5CPeer11recv_packetEv+0xc6>
+mov    $0x0,%eax
+jmp    <T> <_ZN5CPeer11recv_packetEv+0x18e>
 call   <T> <__errno_location>
 mov    (%eax),%eax
...
-mov    $0x0,%eax
-jmp    <T> <_ZN5CPeer11recv_packetEv+0x19a>
+je     <T> <_ZN5CPeer11recv_packetEv+0x113>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 mov    %eax,(%esp)
 call   <T> <strerror>
...
定义于 [source/DNFServer/GameServer/Manager/Peer.cpp](source/DNFServer/GameServer/Manager/Peer.cpp)（约第 40 行）：
