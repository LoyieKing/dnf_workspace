...
|---|---|---|---|---|---|
| manager | DIFF | `0x8064758` | `0x26d` | `0x805a42a` | `0x26b` |
...
+lea    -0x1d(%ebp),%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
 jmp    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x15d>
-lea    -0x39(%ebp),%eax
+lea    -0x1d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
-jmp    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x265>
+jmp    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x263>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x1ff>
+jne    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x1fd>
 mov    %eax,(%esp)
...
+lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x1f8>
+jmp    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x1f6>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x260>
+jmp    <T> <_ZN17CPacketTranslater12OnEventStartEP12PacketHeader+0x25e>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...

{
  ...
  if (m_pclApp == 0) {
    std::allocator<char>::allocator();
                    /* try { // try from 0806478e to 08064792 has its CatchHandler @ 080647fc */
    std::string::string(local_44,"CPacketTranslater::OnEventStart : 0 == m_pclApp",&local_3d);
    this = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 080647ad to 080647b1 has its CatchHandler @ 080647b4 */
    CDNFException::CDNFException(this,local_44);
                    /* try { // try from 080647eb to 080647ef has its CatchHandler @ 080647f2 */
    std::string::~string(local_44);
    std::allocator<char>::~allocator((allocator<char> *)&local_3d);
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 08064832 to 080648af has its CatchHandler @ 080648b5 */
  ...
  CMyFileLog::CMyFileLog(local_3c,"OnEventStart",0x70);
...
定义于 [source/DNFServer/GameServer/Manager/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Manager/DNFPacketTranslater.cpp)（约第 66 行）：
