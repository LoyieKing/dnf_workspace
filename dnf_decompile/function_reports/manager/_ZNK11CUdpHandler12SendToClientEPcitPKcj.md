...
|---|---|---|---|---|---|
| manager | DIFF | `0x8055e22` | `0x309` | `0x80637ec` | `0x2f3` |
...
+jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x2f1>
 cmpl   $0x0,0x18(%ebp)
...
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x80>
 cmpl   $0x0,0x1c(%ebp)
...
+jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0xf4>
 movl   $0x10,0x8(%esp)
 movl   $0x0,0x4(%esp)
-lea    -0x48(%ebp),%eax
+lea    -0x20(%ebp),%eax
...
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x230>
 call   <T> <_Z8getErrnov>
 mov    %eax,-0xc(%ebp)
+cmpl   $0x61,-0xc(%ebp)
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x15a>
...
+jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x226>
+cmpl   $0x6e,-0xc(%ebp)
+jle    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x1b8>
+cmpl   $0x71,-0xc(%ebp)
+jg     <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x1b8>
 mov    -0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
...
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x27f>
...
+jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x2f1>
 mov    -0x10(%ebp),%eax
+cmp    0x10(%ebp),%eax
+je     <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x2ec>
+mov    -0x10(%ebp),%eax
+mov    0x10(%ebp),%edx
+mov    %edx,0x8(%esp)
 mov    %eax,0x4(%esp)
...
*未能在以下候选源文件中定位定义：source/DNFServer/GameServer/COServer/DNFUdpHandler.cpp, source/DNFServer/GameServer/DBMW/DNFUdpHandler.cpp, source/DNFServer/GameServer/Guild/DNFUdpHandler.cpp, source/DNFServer/GameServer/Manager/DNFUdpHandler.cpp, source/DNFServer/GameServer/Monitor/DNFUdpHandler.cpp, source/DNFServer/GameServer/Statics/DNFUdpHandler.cpp, source/ChannelOld/DNFChannelBridge/Authenticator.h, source/ChannelOld/DNFChannelBridge/ChannelService.h 等 642 个文件*
