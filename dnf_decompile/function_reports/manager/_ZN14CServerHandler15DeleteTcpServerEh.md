...
|---|---|---|---|---|---|
| manager | NEAR | `0x80685e4` | `0xe8` | `0x805e0aa` | `0xe8` |
...
定义于 [source/DNFServer/GameServer/Manager/DNFServerHandler.cpp](source/DNFServer/GameServer/Manager/DNFServerHandler.cpp)（约第 116 行）：
