...
|---|---|---|---|---|---|
| manager | DIFF | `0x8059008` | `0xe7` | `0x80668d0` | `0xed` |
...
+je     <T> <_ZN13CTcpNetSystem10DeletePeerEP5CPeer+0xd8>
 mov    %ebx,(%esp)
 call   <T> <_ZN5CPeerD1Ev>
 mov    %ebx,(%esp)
 call   <T> <_ZN5CPeerdlEPv>
-jmp    <T> <_ZN13CTcpNetSystem10DeletePeerEP5CPeer+0xd2>
+jmp    <T> <_ZN13CTcpNetSystem10DeletePeerEP5CPeer+0xd8>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x18(%ebp),%eax
+lea    -0x1c(%ebp),%eax
...

{
  ...
  if (param_1 != (CPeer *)0x0) {
                    /* try { // try from 080590b0 to 080590bc has its CatchHandler @ 080590bf */
    CPeer::~CPeer(param_1);
...
定义于 [source/DNFServer/GameServer/Manager/TcpNetSystem.cpp](source/DNFServer/GameServer/Manager/TcpNetSystem.cpp)（约第 135 行）：
