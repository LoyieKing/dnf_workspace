...
|---|---|---|---|---|---|
| manager | DIFF | `0x80522c2` | `0x13c` | `0x8062d78` | `0x140` |
...
-pop    %ebp
-ret
+jne    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0xf6>
 lea    -0x19(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
 lea    -0x19(%ebp),%eax
...
+jmp    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0x99>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0x93>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0xfe>
+jne    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0xb8>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%ecx
 mov    %ebx,%eax
-jmp    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0xfe>
+jmp    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0xb8>
 lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0x119>
+jmp    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0xd3>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN18CFrameCountHandler18InitFrameCountInfoEP12CApplicationjt+0xfe>
...

{
  ...
  std::allocator<char>::allocator();
                    /* try { // try from 08052342 to 08052346 has its CatchHandler @ 080523bc */
  std::string::string(local_24,"CFrameCountHandler::InitFrameCountInfo() Exception Break!",local_1d)
  ;
  this = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 08052361 to 08052365 has its CatchHandler @ 08052368 */
  CDNFException::CDNFException(this,local_24);
                    /* try { // try from 080523a7 to 080523ab has its CatchHandler @ 080523ae */
...
定义于 [source/DNFServer/GameServer/Manager/DNFTickHandler.cpp](source/DNFServer/GameServer/Manager/DNFTickHandler.cpp)（约第 39 行）：
