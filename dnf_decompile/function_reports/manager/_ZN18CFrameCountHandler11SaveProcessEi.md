...
|---|---|---|---|---|---|
| manager | DIFF | `0x80527fa` | `0x87` | `0x8062cfc` | `0x7b` |
...
定义于 [source/DNFServer/GameServer/Manager/DNFTickHandler.cpp](source/DNFServer/GameServer/Manager/DNFTickHandler.cpp)（约第 28 行）：
