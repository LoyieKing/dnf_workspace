...
|---|---|---|---|---|---|
| manager | DIFF | `0x806b180` | `0x8eb` | `0x8055614` | `0x8eb` |
...
+je     <T> <_ZN17CUdpNetworkThread8dispatchEPv+0x363>
+jmp    <T> <_ZN17CUdpNetworkThread8dispatchEPv+0x30e>
+mov    %eax,%ecx
+mov    %edx,%eax
+mov    %eax,%ebx
+mov    %ecx,%esi
...
+je     <T> <_ZN17CUdpNetworkThread8dispatchEPv+0x42d>
 mov    -0x28(%ebp),%eax
 movzwl (%eax),%eax
 movzwl %ax,%edi
 mov    -0x78(%ebp),%esi
...
+jmp    <T> <_ZN17CUdpNetworkThread8dispatchEPv+0x41a>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jbe    <T> <_ZN17CUdpNetworkThread8dispatchEPv+0x4ed>
 mov    -0x28(%ebp),%eax
 movzwl (%eax),%eax
 movzwl %ax,%edi
 mov    -0x78(%ebp),%esi
...
+jmp    <T> <_ZN17CUdpNetworkThread8dispatchEPv+0x4da>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jbe    <T> <_ZN17CUdpNetworkThread8dispatchEPv+0x5aa>
 mov    -0x28(%ebp),%eax
 movzwl (%eax),%eax
 movzwl %ax,%edi
 mov    -0x78(%ebp),%esi
...
+jmp    <T> <_ZN17CUdpNetworkThread8dispatchEPv+0x597>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
