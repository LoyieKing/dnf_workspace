...
|---|---|---|---|---|---|
| manager | DIFF | `0x806af84` | `0xda` | `0x806089c` | `0xdc` |
...
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xda>
+movl   $0x0,-0xc(%ebp)
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x88>
 movzbl -0x410(%ebp),%eax
 cmp    $0x23,%al
-je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x85>
-mov    -0x10(%ebp),%eax
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x87>
+mov    -0xc(%ebp),%eax
 cmp    0x10(%ebp),%eax
...
-mov    -0xc(%ebp),%eax
+jne    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xbf>
+mov    -0x10(%ebp),%eax
 mov    %eax,0x8(%esp)
 movl   $0x400,0x4(%esp)
 lea    -0x410(%ebp),%eax
...
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xbf>
 mov    $0x1,%eax
-jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xc2>
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xc4>
 mov    $0x0,%eax
 test   %al,%al
