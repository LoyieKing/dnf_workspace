...
|---|---|---|---|---|---|
| manager | DIFF | `0x8052e70` | `0x45` | `0x8056bfa` | `0x41` |
...
+je     <T> <_ZN7MemPoolI14CUdpRecvBufferE4freeEPvj+0x3f>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 cmp    0x10(%ebp),%eax
-je     <T> <_ZN7MemPoolI14CUdpRecvBufferE4freeEPvj+0x23>
+jne    <T> <_ZN7MemPoolI14CUdpRecvBufferE4freeEPvj+0x34>
+mov    0xc(%ebp),%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
+sub    $0x4,%eax
...
+jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE4freeEPvj+0x3f>
 mov    0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZdlPv>
