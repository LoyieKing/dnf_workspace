...
|---|---|---|---|---|---|
| dbmw | NEAR | `0x806d25c` | `0x7ec` | `0x806d5b2` | `0x7ec` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFApplication.cpp](source/DNFServer/GameServer/DBMW/DNFApplication.cpp)（约第 177 行）：
