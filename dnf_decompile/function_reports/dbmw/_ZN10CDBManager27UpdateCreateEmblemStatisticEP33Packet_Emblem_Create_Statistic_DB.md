...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8083370` | `0xef` | `0x80522aa` | `0xfd` |
...
+je     <T> <_ZN10CDBManager27UpdateCreateEmblemStatisticEP33Packet_Emblem_Create_Statistic_DB+0xc8>
 movl   $0x1f04,0x8(%esp)
...
+jmp    <T> <_ZN10CDBManager27UpdateCreateEmblemStatisticEP33Packet_Emblem_Create_Statistic_DB+0xf5>
+mov    -0x1c(%ebp),%eax
+mov    (%eax),%eax
+add    $0x20,%eax
+mov    (%eax),%edx
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager27UpdateCreateEmblemStatisticEP33Packet_Emblem_Create_Statistic_DB+0xf0>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager27UpdateCreateEmblemStatisticEP33Packet_Emblem_Create_Statistic_DB+0xf5>
 mov    $0x1,%eax
 add    $0x5c,%esp
