...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809932a` | `0x1a` | `0x80dcbdc` | `0x5` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 3053 行）：
