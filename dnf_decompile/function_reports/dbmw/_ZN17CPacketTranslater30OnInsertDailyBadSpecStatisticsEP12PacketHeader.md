...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809932a` | `0x1a` | `0x80893f0` | `0x5` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 2855 行）：
