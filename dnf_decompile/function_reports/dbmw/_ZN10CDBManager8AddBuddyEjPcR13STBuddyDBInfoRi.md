...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8076778` | `0x441` | `0x8060532` | `0x3df` |
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0xe7>
 movl   $0xb8a,0x8(%esp)
 movl   $"AddBuddy",0x4(%esp)
-lea    -0x28(%ebp),%eax
+lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
 add    $0x20,%eax
-mov    (%eax),%edx
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x112>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
-mov    $0x0,%eax
-jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x43a>
+jne    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x137>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 cmpl   $0x1,-0x10(%ebp)
-jle    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x1bd>
+jle    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x17a>
 movl   $0xb9e,0x8(%esp)
 movl   $"AddBuddy",0x4(%esp)
-lea    -0x20(%ebp),%eax
+lea    -0x28(%ebp),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x19d>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x1d2>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x207>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x23c>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x271>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x2a6>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
+movl   $0x0,-0x18(%ebp)
 mov    -0x14(%ebp),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x2df>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    0x8(%ebp),%eax
 mov    0x44(%eax),%eax
...
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x313>
+mov    $0x1,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x318>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x32f>
 mov    0x18(%ebp),%eax
 movl   $0x5a,(%eax)
 mov    $0x0,%eax
-jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x43a>
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x366>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3a7>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3cf>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager8AddBuddyEjPcR13STBuddyDBInfoRi+0x3dd>
 mov    0x18(%ebp),%eax
 movl   $0x0,(%eax)
