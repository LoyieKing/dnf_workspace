...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809e6a0` | `0x252` | `0x80d0cac` | `0x23e` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 418 行）：
