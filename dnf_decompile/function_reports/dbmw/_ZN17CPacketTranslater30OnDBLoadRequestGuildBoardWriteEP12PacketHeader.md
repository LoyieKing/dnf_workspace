...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809e6a0` | `0x252` | `0x807d4d2` | `0x26b` |
...
+je     <T> <_ZN17CPacketTranslater30OnDBLoadRequestGuildBoardWriteEP12PacketHeader+0x260>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x18(%ebp)
+mov    %eax,-0x14(%ebp)
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater30OnDBLoadRequestGuildBoardWriteEP12PacketHeader+0x115>
+movl   $0xfbc,0x8(%esp)
+movl   $"OnDBLoadRequestGuildBoardWrite",0x4(%esp)
+lea    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater30OnDBLoadRequestGuildBoardWriteEP12PacketHeader+0x261>
+lea    -0x243(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN38Packet_DB_Load_Reply_Guild_Board_WriteC1Ev>
+lea    -0x243(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater30OnDBLoadRequestGuildBoardWriteEP12PacketHeader+0x204>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater30OnDBLoadRequestGuildBoardWriteEP12PacketHeader+0x1fd>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater30OnDBLoadRequestGuildBoardWriteEP12PacketHeader+0x259>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 359 行）：
