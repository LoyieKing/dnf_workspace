...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8093a98` | `0x204` | `0x80d4196` | `0x201` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1104 行）：
