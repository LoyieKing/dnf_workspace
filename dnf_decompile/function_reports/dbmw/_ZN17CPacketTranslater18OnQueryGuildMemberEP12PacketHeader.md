...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8093a98` | `0x204` | `0x8080638` | `0x201` |
...
+je     <T> <_ZN17CPacketTranslater18OnQueryGuildMemberEP12PacketHeader+0x1fa>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x24(%ebp)
-mov    -0x24(%ebp),%eax
+mov    %eax,-0x10(%ebp)
...
+je     <T> <_ZN17CPacketTranslater18OnQueryGuildMemberEP12PacketHeader+0x1fa>
 movl   $0x98,0x8(%esp)
 movl   $"OnQueryGuildMember",0x4(%esp)
-lea    -0x3c(%ebp),%eax
+lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnQueryGuildMemberEP12PacketHeader+0x1fa>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater18OnQueryGuildMemberEP12PacketHeader+0x190>
+jne    <T> <_ZN17CPacketTranslater18OnQueryGuildMemberEP12PacketHeader+0x194>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnQueryGuildMemberEP12PacketHeader+0x18d>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnQueryGuildMemberEP12PacketHeader+0x1f5>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
