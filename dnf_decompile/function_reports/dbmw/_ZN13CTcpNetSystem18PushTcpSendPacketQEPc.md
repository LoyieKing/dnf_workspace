...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805bf6a` | `0xe9` | `0x80f5f42` | `0xe7` |
...
定义于 [source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp](source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp)（约第 261 行）：
