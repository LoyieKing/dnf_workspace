...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805bf6a` | `0xe9` | `0x80f5b5a` | `0xef` |
...
定义于 [source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp](source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp)（约第 251 行）：
