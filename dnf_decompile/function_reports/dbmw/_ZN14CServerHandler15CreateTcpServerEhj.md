...
|---|---|---|---|---|---|
| dbmw | NEAR | `0x808fb08` | `0x107` | `0x808c2e6` | `0x109` |
...
@@ -1,83 +1,83 @@
 ...
 mov    %edx,0x4(%esp)
 mov    %eax,(%esp)
 call   <T> <_ZN10CTcpServer13SetServerTypeEh>
 lea    -0x20(%ebp),%eax
 lea    -0x34(%ebp),%edx
 mov    %edx,0x8(%esp)
 lea    -0x3c(%ebp),%edx
 ...
 lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt4pairIKhP10CTcpServerEC1IhS2_EEOS_IT_T0_E>
 mov    0x8(%ebp),%eax
 lea    0x1000(%eax),%ecx
 lea    -0x30(%ebp),%eax
 lea    -0x28(%ebp),%edx
 ...
 mov    %ecx,0x4(%esp)
 mov    %eax,(%esp)
 call   <T> <_ZNSt3mapIhP10CTcpServerSt4lessIhESaISt4pairIKhS1_EEE6insertERKS6_>
 sub    $0x4,%esp
 movzbl -0x2c(%ebp),%eax
 test   %al,%al
...

{
  ...
  pair local_34 [4];
  char local_30;
  pair<unsigned_char_const,CTcpServer*> local_2c [8];
  uchar local_24 [20];
  
  local_40[0] = param_1;
  pCVar1 = operator_new(0x10);
                    /* try { // try from 0808fb2a to 0808fb2e has its CatchHandler @ 0808fb31 */
  CTcpServer::CTcpServer(pCVar1);
  local_38 = pCVar1;
  pCVar2 = (CTcpNetSystem *)CApplication::Get_TcpNetSystem(*(CApplication **)(this + 0x1028));
  CTcpServer::_ZN10CTcpServer4InitEjP13CTcpNetSystem(local_38,param_2,pCVar2);
  CTcpServer::SetServerType(local_38,local_40[0]);
  std::make_pair<unsigned_char&,CTcpServer*&>(local_24,(CTcpServer **)local_40);
  std::pair<unsigned_char_const,CTcpServer*>::pair<unsigned_char,CTcpServer*>(local_2c,local_24);
  std::
