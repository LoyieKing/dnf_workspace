...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8074cb2` | `0x2e1` | `0x806249a` | `0x2df` |
...
+call   *%eax
 ...
 movl   $0x897,0x8(%esp)
 movl   $"SendGuildCoinByMail",0x4(%esp)
-lea    -0x3c(%ebp),%eax
+lea    -0x2c(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN10CDBManager19SendGuildCoinByMailEijjjiPcS0_+0x2dd>
 mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
 add    $0x20,%eax
-mov    (%eax),%edx
...
+jmp    <T> <_ZN10CDBManager19SendGuildCoinByMailEijjjiPcS0_+0x2c7>
 mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
 add    $0x24,%eax
-mov    (%eax),%edx
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN10CDBManager19SendGuildCoinByMailEijjjiPcS0_+0x222>
 movl   $0x8c0,0x8(%esp)
 movl   $"SendGuildCoinByMail",0x4(%esp)
-lea    -0x34(%ebp),%eax
+lea    -0x3c(%ebp),%eax
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN10CDBManager19SendGuildCoinByMailEijjjiPcS0_+0x2c3>
 movl   $0x8c6,0x8(%esp)
 movl   $"SendGuildCoinByMail",0x4(%esp)
-lea    -0x2c(%ebp),%eax
+lea    -0x44(%ebp),%eax
