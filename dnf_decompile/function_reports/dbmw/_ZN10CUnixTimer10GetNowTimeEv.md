...
|---|---|---|---|---|---|
| dbmw | NEAR | `0x808e804` | `0x37` | `0x80a0254` | `0x37` |
...
@@ -1,18 +1,18 @@
 ...
 mov    %eax,-0x1c(%ebp)
 fildl  -0x1c(%ebp)
-fldl   &data#a8536781(.rodata)
+fldl   &data#de50b9c6(.rodata)
 fdivrp %st,%st(1)
 faddp  %st,%st(1)
 leave
 ret
...

{
  ...
  return (longdouble)local_14[0].tv_usec / (longdouble)_DAT_081bab48 +
