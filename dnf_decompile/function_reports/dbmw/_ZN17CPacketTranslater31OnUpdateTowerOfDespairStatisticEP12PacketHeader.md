...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809f9de` | `0x18f` | `0x80d5c4a` | `0x192` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1463 行）：
