...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80966b6` | `0x138` | `0x807c682` | `0x12d` |
...
+je     <T> <_ZN17CPacketTranslater26OnChangeGuildNotifyMessageEP12PacketHeader+0x125>
 mov    0x8(%ebp),%eax
 mov    %eax,-0x10(%ebp)
 mov    -0x10(%ebp),%eax
-lea    0xf(%eax),%ebx
...
+jmp    <T> <_ZN17CPacketTranslater26OnChangeGuildNotifyMessageEP12PacketHeader+0x126>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater26OnChangeGuildNotifyMessageEP12PacketHeader+0xd4>
+jne    <T> <_ZN17CPacketTranslater26OnChangeGuildNotifyMessageEP12PacketHeader+0xc9>
 mov    %eax,(%esp)
 call   <T> <__cxa_begin_catch>
 mov    %eax,-0xc(%ebp)
+movl   $0x4b9,0x8(%esp)
+movl   $"OnChangeGuildNotifyMessage",0x4(%esp)
+lea    -0x18(%ebp),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater26OnChangeGuildNotifyMessageEP12PacketHeader+0xc2>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater26OnChangeGuildNotifyMessageEP12PacketHeader+0x11e>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 141 行）：
