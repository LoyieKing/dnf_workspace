...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80936ea` | `0x3ae` | `0x80d8f5c` | `0x387` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1098 行）：
