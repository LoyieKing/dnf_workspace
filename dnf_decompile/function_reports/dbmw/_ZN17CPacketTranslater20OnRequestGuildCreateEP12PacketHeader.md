...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8097b46` | `0x1e5` | `0x8080a5a` | `0x1e5` |
...
+je     <T> <_ZN17CPacketTranslater20OnRequestGuildCreateEP12PacketHeader+0x1dd>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x24(%ebp)
-lea    -0x69(%ebp),%eax
+mov    %eax,-0x10(%ebp)
...
+jmp    <T> <_ZN17CPacketTranslater20OnRequestGuildCreateEP12PacketHeader+0x1de>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater20OnRequestGuildCreateEP12PacketHeader+0x17d>
+jne    <T> <_ZN17CPacketTranslater20OnRequestGuildCreateEP12PacketHeader+0x181>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater20OnRequestGuildCreateEP12PacketHeader+0x17a>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater20OnRequestGuildCreateEP12PacketHeader+0x1d6>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
