...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8097b46` | `0x1e5` | `0x80d45be` | `0x1d9` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1153 行）：
