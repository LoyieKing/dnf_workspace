...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809602c` | `0x321` | `0x80d0920` | `0x31e` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 385 行）：
