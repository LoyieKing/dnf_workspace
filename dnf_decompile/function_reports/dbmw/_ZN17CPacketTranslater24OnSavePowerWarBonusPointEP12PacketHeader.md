...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809d8e0` | `0x280` | `0x807f8a0` | `0x280` |
...
-mov    %eax,%ebx
 movl   $0xea5,0x8(%esp)
 movl   $"OnSavePowerWarBonusPoint",0x4(%esp)
 lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 812 行）：
