...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805584a` | `0x37c` | `0x80e52ba` | `0x33d` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFTickHandler.cpp](source/DNFServer/GameServer/DBMW/DNFTickHandler.cpp)（约第 65 行）：
