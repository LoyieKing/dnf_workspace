...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805584a` | `0x37c` | `0x80e574e` | `0x379` |
...
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x166>
 mov    0x8(%ebp),%eax
 movb   $0x1,(%eax)
 mov    0x8(%ebp),%eax
 movl   $0x0,0x14(%eax)
...
+mov    %al,-0x21(%ebp)
+cmpb   $0x0,-0x21(%ebp)
+je     <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x15e>
+lea    -0x29(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x35(%ebp),%eax
...
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x101>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0xfb>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x120>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x120>
+lea    -0x30(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x13b>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x120>
...
-lea    -0x4c(%ebp),%eax
+mov    0x8(%ebp),%eax
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x371>
+lea    -0x50(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <times>
-mov    %eax,%edx
...
+mov    %al,-0x21(%ebp)
+cmpb   $0x0,-0x21(%ebp)
+je     <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x26c>
+lea    -0x22(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x2d(%ebp),%eax
...
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x20f>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x209>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x22e>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x22e>
+lea    -0x28(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x249>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x22e>
...
-mov    0x8(%ebp),%eax
-mov    0x10(%eax),%edx
+jbe    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x28a>
+mov    0x8(%ebp),%eax
+mov    0x10(%eax),%eax
+mov    %eax,%edx
 mov    0x8(%ebp),%eax
...
+cmp    -0x1c(%ebp),%eax
+jae    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x2d9>
 mov    0x8(%ebp),%eax
 mov    0x14(%eax),%eax
 lea    0x1(%eax),%edx
 mov    0x8(%ebp),%eax
...
+cmpl   $0x63,-0x20(%ebp)
+jbe    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x36e>
 mov    0x8(%ebp),%eax
 mov    0x14(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0x18(%eax)
