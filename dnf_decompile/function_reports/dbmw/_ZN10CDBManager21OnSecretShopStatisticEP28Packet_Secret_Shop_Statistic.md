...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8083f2a` | `0x2a6` | `0x8063af4` | `0x1fb` |
...
+mov    %eax,-0x24(%ebp)
+movl   $0x0,-0x20(%ebp)
+jmp    <T> <_ZN10CDBManager21OnSecretShopStatisticEP28Packet_Secret_Shop_Statistic+0x1dd>
 mov    0xc(%ebp),%ecx
+mov    -0x20(%ebp),%edx
 mov    %edx,%eax
 shl    $0x2,%eax
...
+je     <T> <_ZN10CDBManager21OnSecretShopStatisticEP28Packet_Secret_Shop_Statistic+0x10c>
 movl   $0x21bd,0x8(%esp)
...
+call   *%eax
 ...
 test   %al,%al
-je     <T> <_ZN10CDBManager21OnSecretShopStatisticEP28Packet_Secret_Shop_Statistic+0x281>
+je     <T> <_ZN10CDBManager21OnSecretShopStatisticEP28Packet_Secret_Shop_Statistic+0x1d9>
 movl   $0x21cb,0x8(%esp)
 movl   $"OnSecretShopStatistic",0x4(%esp)
-lea    -0x28(%ebp),%eax
+lea    -0x38(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DBManager.cpp](source/DNFServer/GameServer/DBMW/DBManager.cpp)（约第 6159 行）：
...
char CDBManager::OnSecretShopStatistic(Packet_Secret_Shop_Statistic* packet)
{
    ...
    for (int i = 0; i < count; i++)
    {
        ...
        if (!h->exec(0x4efb))
        {
            CMyFileLog log("OnSecretShopStatistic", 0x21cb);
            log("./log/DBQueryErr",
