...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8064210` | `0x6d6` | `0x80c9aea` | `0x6d6` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFNetworkThread.cpp](source/DNFServer/GameServer/DBMW/DNFNetworkThread.cpp)（约第 50 行）：
