...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x806c35c` | `0x1df` | `0x806cc00` | `0x1de` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFApplication.cpp](source/DNFServer/GameServer/DBMW/DNFApplication.cpp)（约第 79 行）：
