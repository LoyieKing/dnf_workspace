...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809634e` | `0x368` | `0x8064c26` | `0x366` |
...
+je     <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x35a>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x24(%ebp)
-lea    -0x76(%ebp),%eax
+mov    %eax,-0x28(%ebp)
...
-movzbl -0x45(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x11b>
+movb   $0xff,-0x4a(%ebp)
+movzwl -0x78(%ebp),%eax
+movzwl %ax,%edx
+lea    -0x7a(%ebp),%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN12CGuildServer12SendToServerEPci>
+jmp    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x35b>
+cmpl   $0x1,-0x20(%ebp)
+jne    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x143>
+movzwl -0x78(%ebp),%eax
+movzwl %ax,%edx
+lea    -0x7a(%ebp),%eax
+mov    %edx,0x8(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x35b>
+cmpl   $0x2,-0x20(%ebp)
+je     <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x151>
+mov    -0x48(%ebp),%eax
+cmp    $0x2,%eax
+jne    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x184>
+mov    -0x28(%ebp),%eax
+add    $0x13,%eax
+movzbl (%eax),%eax
 cmp    $0x1,%al
...
-jmp    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x35d>
-mov    -0x24(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x184>
+movb   $0xfe,-0x4a(%ebp)
+movzwl -0x78(%ebp),%eax
+movzwl %ax,%edx
+lea    -0x7a(%ebp),%eax
...
+mov    -0x48(%ebp),%eax
+cmp    -0x20(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x1ae>
+movzwl -0x78(%ebp),%eax
+movzwl %ax,%edx
+lea    -0x7a(%ebp),%eax
+mov    %edx,0x8(%esp)
...
-mov    -0x24(%ebp),%eax
-mov    0xb(%eax),%ebx
+je     <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x35b>
+movzwl -0x78(%ebp),%eax
+movzwl %ax,%edx
+lea    -0x7a(%ebp),%eax
+mov    %edx,0x8(%esp)
...
+jne    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x2fe>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x2f7>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater35OnChangeUnconnectedGuildMemberGradeEP12PacketHeader+0x353>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DBManager.cpp](source/DNFServer/GameServer/DBMW/DBManager.cpp)（约第 7144 行）：
