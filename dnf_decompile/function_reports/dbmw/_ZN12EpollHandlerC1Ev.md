...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8057864` | `0x6f` | `0x80942a6` | `0x71` |
...

{
  ...
  *(undefined ***)this = &PTR__EpollHandler_081a30c8;
  CMutex::CMutex((CMutex *)(this + 0x18));
                    /* try { // try from 08057894 to 08057898 has its CatchHandler @ 0805789b */
...
定义于 [source/DNFServer/GameServer/DBMW/EpollHandler.cpp](source/DNFServer/GameServer/DBMW/EpollHandler.cpp)（约第 26 行）：
