...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805876e` | `0x113` | `0x80e475c` | `0x137` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp](source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp)（约第 199 行）：
