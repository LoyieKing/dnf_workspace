...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805876e` | `0x113` | `0x80e44f2` | `0x137` |
...
+cmpl   $0x0,-0x24(%ebp)
+jns    <T> <_ZNK9TCPSocket14pollErrorEventEv+0xe6>
...
+jmp    <T> <_ZNK9TCPSocket14pollErrorEventEv+0x12c>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
-shr    $0x5,%eax
...
+mov    %edi,%eax
 and    $0x1,%eax
+test   %al,%al
+je     <T> <_ZNK9TCPSocket14pollErrorEventEv+0x127>
+mov    $0x1,%eax
+jmp    <T> <_ZNK9TCPSocket14pollErrorEventEv+0x12c>
+mov    $0x0,%eax
 add    $0xcc,%esp
...
定义于 [source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp](source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp)（约第 192 行）：
