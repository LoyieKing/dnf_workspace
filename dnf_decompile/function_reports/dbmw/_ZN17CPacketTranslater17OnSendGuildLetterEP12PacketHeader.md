...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80967ee` | `0x335` | `0x80d0152` | `0x33b` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 264 行）：
