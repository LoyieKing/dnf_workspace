...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80953b4` | `0x218` | `0x80d2812` | `0x215` |
...
+jmp    <T> <_ZN17CPacketTranslater25OnRequestBlackListOnLoginEP12PacketHeader+0x20b>
 mov    -0x18(%ebp),%eax
 movzbl 0xe(%eax),%eax
 cmp    $0xc9,%al
...
+jne    <T> <_ZN17CPacketTranslater25OnRequestBlackListOnLoginEP12PacketHeader+0x20b>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    0x18(%eax),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 788 行）：
