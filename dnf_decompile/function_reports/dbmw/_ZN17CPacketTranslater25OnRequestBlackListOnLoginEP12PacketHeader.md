...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80953b4` | `0x218` | `0x80d2512` | `0x209` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 755 行）：
