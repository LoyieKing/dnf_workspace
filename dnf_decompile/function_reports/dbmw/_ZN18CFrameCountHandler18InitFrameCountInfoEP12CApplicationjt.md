...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805570e` | `0x13c` | `0x80e5278` | `0x13e` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFTickHandler.cpp](source/DNFServer/GameServer/DBMW/DNFTickHandler.cpp)（约第 47 行）：
