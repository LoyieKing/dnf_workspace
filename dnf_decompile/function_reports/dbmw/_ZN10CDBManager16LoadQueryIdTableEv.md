...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8076f44` | `0x14c` | `0x8058440` | `0x144` |
...
定义于 [source/DNFServer/GameServer/DBMW/DBManager.cpp](source/DNFServer/GameServer/DBMW/DBManager.cpp)（约第 3084 行）：
