...
|---|---|---|---|---|---|
| dbmw | NEAR | `0x807fab8` | `0x159` | `0x804e036` | `0x159` |
...
@@ -1,89 +1,89 @@
 ...
 movl   $0x2,0x12(%eax)
 movl   $0x1975,0x8(%esp)
 movl   $&_ZZN10CDBManager17OnCreateGuildAgitEP27Packet_DB_Create_Guild_AgitR33Packet_DB_Create_Guild_Agit_ReplyE12__FUNCTION__,0x4(%esp)
-lea    -0x20(%ebp),%eax
+lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
