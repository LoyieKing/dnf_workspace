...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80a320c` | `0xdc` | `0x80e8e64` | `0xd6` |
...
定义于 [source/DNFServer/GameServer/DBMW/GuildManager.cpp](source/DNFServer/GameServer/DBMW/GuildManager.cpp)（约第 138 行）：
