...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809ce38` | `0x1d6` | `0x80d5cde` | `0x1d1` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1527 行）：
