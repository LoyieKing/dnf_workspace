...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809ce38` | `0x1d6` | `0x80822b0` | `0x1e0` |
...
-movl   $0x0,-0x30(%ebp)
-movl   $0x0,-0x34(%ebp)
+je     <T> <_ZN17CPacketTranslater23OnDBMWVillageAttackRankEP12PacketHeader+0x1d8>
+movb   $0x0,-0xd(%ebp)
+movl   $0x0,-0x14(%ebp)
+movl   $0x0,-0x18(%ebp)
 mov    0x8(%ebp),%eax
...
+je     <T> <_ZN17CPacketTranslater23OnDBMWVillageAttackRankEP12PacketHeader+0x98>
 movl   $0xd5a,0x8(%esp)
 movl   $"OnDBMWVillageAttackRank",0x4(%esp)
-lea    -0x28(%ebp),%eax
+lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
-movzbl -0x29(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater23OnDBMWVillageAttackRankEP12PacketHeader+0x1d9>
+movzbl -0xd(%ebp),%eax
 test   %al,%al
-je     <T> <_ZN17CPacketTranslater23OnDBMWVillageAttackRankEP12PacketHeader+0x1cf>
-lea    -0x46(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater23OnDBMWVillageAttackRankEP12PacketHeader+0x1d9>
+lea    -0x2a(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater23OnDBMWVillageAttackRankEP12PacketHeader+0x17c>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater23OnDBMWVillageAttackRankEP12PacketHeader+0x175>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater23OnDBMWVillageAttackRankEP12PacketHeader+0x1d1>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1329 行）：
