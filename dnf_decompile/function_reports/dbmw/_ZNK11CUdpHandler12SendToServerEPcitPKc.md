...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80597ea` | `0x27b` | `0x80e5780` | `0x265` |
...
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x263>
 cmpw   $0x0,-0x4c(%ebp)
-jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x5d>
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x58>
 cmpl   $0x0,0x18(%ebp)
...
-lea    -0x48(%ebp),%eax
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0xcd>
 movl   $0x10,0x8(%esp)
 movl   $0x0,0x4(%esp)
+lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x1c8>
 call   <T> <_Z8getErrnov>
 mov    %eax,-0xc(%ebp)
+cmpl   $0x61,-0xc(%ebp)
...
+cmpl   $0x6e,-0xc(%ebp)
+jle    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x172>
+cmpl   $0x71,-0xc(%ebp)
...
定义于 [source/DNFServer/GameServer/DBMW/DNFUdpHandler.cpp](source/DNFServer/GameServer/DBMW/DNFUdpHandler.cpp)（约第 75 行）：
