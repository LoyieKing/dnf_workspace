...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x807ad84` | `0x418` | `0x805feb0` | `0x408` |
...
-mov    0xc(%ebp),%eax
-mov    0xa(%eax),%ebx
+jne    <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x7d>
+mov    0xc(%ebp),%eax
+mov    0xe(%eax),%eax
+mov    %eax,-0x10(%ebp)
+mov    0xc(%ebp),%eax
...
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x402>
+mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
 add    $0x1c,%eax
 mov    (%eax),%edx
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0xfa>
 movl   $0x1319,0x8(%esp)
 movl   $&_ZZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_SaveE12__FUNCTION__,0x4(%esp)
-lea    -0x50(%ebp),%eax
-mov    %eax,(%esp)
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x125>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x402>
+mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x188>
 movl   $0x1327,0x8(%esp)
 movl   $&_ZZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_SaveE12__FUNCTION__,0x4(%esp)
-lea    -0x48(%ebp),%eax
-mov    %eax,(%esp)
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x1c1>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x402>
+mov    0xc(%ebp),%eax
+mov    0xe(%eax),%edx
...
-mov    -0x1c(%ebp),%eax
+jne    <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x2dc>
+mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
 add    $0x1c,%eax
 mov    (%eax),%edx
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x263>
 movl   $0x1348,0x8(%esp)
 movl   $&_ZZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_SaveE12__FUNCTION__,0x4(%esp)
+lea    -0x38(%ebp),%eax
+mov    %eax,(%esp)
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x3fd>
+movl   $0x134f,0x8(%esp)
+movl   $&_ZZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_SaveE12__FUNCTION__,0x4(%esp)
 lea    -0x40(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    0xc(%ebp),%eax
-lea    0x12(%eax),%edi
+je     <T> <_ZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_Save+0x381>
 movl   $0x135e,0x8(%esp)
 movl   $&_ZZN10CDBManager24SaveUnchangableGuildInfoEP33Packet_UnChangable_GuildInfo_SaveE12__FUNCTION__,0x4(%esp)
-lea    -0x30(%ebp),%eax
-mov    %eax,(%esp)
