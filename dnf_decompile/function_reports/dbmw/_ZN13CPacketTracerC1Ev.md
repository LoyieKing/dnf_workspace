...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8092594` | `0xad` | `0x80ce8e2` | `0xab` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTracer.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTracer.cpp)（约第 27 行）：
