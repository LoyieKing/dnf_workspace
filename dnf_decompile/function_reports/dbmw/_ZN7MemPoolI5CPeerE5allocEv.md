# _ZN7MemPoolI5CPeerE5allocEv

`MemPool<CPeer>::alloc()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805abfa` | `0x150` | `0x80cb2aa` | `0x15f` |
...
+sub    $0x44,%esp
 ...
 mov    (%eax),%eax
 cmp    $0x97840,%eax
-je     <T> <_ZN7MemPoolI5CPeerE5allocEv+0x25>
+je     <T> <_ZN7MemPoolI5CPeerE5allocEv+0x24>
 movl   $0x97840,(%esp)
 call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x149>
+jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x159>
 mov    &_ZN7MemPoolI5CPeerE15headOfFreeList_E,%eax
 mov    %eax,-0x14(%ebp)
 cmpl   $0x0,-0x14(%ebp)
-je     <T> <_ZN7MemPoolI5CPeerE5allocEv+0x46>
-mov    -0x14(%ebp),%eax
-mov    0x9783c(%eax),%eax
-mov    %eax,&_ZN7MemPoolI5CPeerE15headOfFreeList_E
-jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x146>
-mov    0x8(%ebp),%eax
-mov    0x4(%eax),%edx
+je     <T> <_ZN7MemPoolI5CPeerE5allocEv+0x4c>
+mov    -0x14(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+sub    $0x4,%eax
...
+mov    (%eax),%eax
+mov    %eax,&_ZN7MemPoolI5CPeerE15headOfFreeList_E
+jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x156>
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    0x4(%eax),%eax
 ...
 mov    %eax,-0x10(%ebp)
 movl   $0x0,-0xc(%ebp)
-jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x8d>
+jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x9a>
+mov    -0x10(%ebp),%edx
 mov    -0xc(%ebp),%eax
 imul   $0x97840,%eax,%eax
-add    -0x10(%ebp),%eax
-mov    -0xc(%ebp),%edx
-add    $0x1,%edx
-imul   $0x97840,%edx,%edx
-add    -0x10(%ebp),%edx
-mov    %edx,0x9783c(%eax)
+add    %eax,%edx
+mov    -0xc(%ebp),%eax
+add    $0x1,%eax
+imul   $0x97840,%eax,%ecx
+mov    -0x10(%ebp),%eax
+lea    (%ecx,%eax,1),%eax
+mov    %eax,0x9783c(%edx)
 addl   $0x1,-0xc(%ebp)
 ...
 seta   %al
 test   %al,%al
-jne    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x68>
+jne    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x70>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
 sub    $0x1,%eax
...
+movl   $0x7d,0x8(%esp)
+movl   $&_ZZN7MemPoolI5CPeerE5allocEvE12__FUNCTION__,0x4(%esp)
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
...
void * __thiscall MemPool<CPeer>::_ZN7MemPoolI5CPeerE5allocEv(MemPool<CPeer> *this)
  ...
  if (*(int *)this == 0x97840) {
    ...
    if (headOfFreeList_ == (void *)0x0) {
      ...
      for (local_10 = 0; local_10 < *(int *)(this + 4) - 1U; local_10 = local_10 + 1) {
        *(void **)((int)local_24 + local_10 * 0x97840 + 0x9783c) =
             (void *)((local_10 + 1) * 0x97840 + (int)local_24);
      }
      *(undefined4 *)((int)local_24 + (*(int *)(this + 4) + -1) * 0x97840 + 0x9783c) = 0;
      headOfFreeList_ = (void *)((int)local_24 + 0x97840);
      local_18 = local_24;
      local_14 = local_24;
      ...
      headOfFreeList_ = *(void **)((int)headOfFreeList_ + 0x9783c);
    }
  }
  else {
    local_18 = operator_new(0x97840);
  }
  return local_18;
}
```
