...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80a06c0` | `0x4af` | `0x80d80ec` | `0x450` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 2013 行）：
