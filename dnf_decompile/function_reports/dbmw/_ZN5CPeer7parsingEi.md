...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8059fcc` | `0x489` | `0x80ec6d2` | `0x443` |
...
-nop
+mov    $0x1,%eax
+jmp    <T> <_ZN5CPeer7parsingEi+0x43b>
 mov    0x8(%ebp),%eax
 mov    0x1820(%eax),%eax
 test   %eax,%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN5CPeer7parsingEi+0x39b>
 mov    0x8(%ebp),%eax
 mov    0x182c(%eax),%eax
 mov    %eax,0x4(%esp)
 lea    -0x64(%ebp),%eax
...
+cmpl   $0x0,-0x28(%ebp)
+je     <T> <_ZN5CPeer7parsingEi+0x33e>
+jmp    <T> <_ZN5CPeer7parsingEi+0x34f>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x68(%ebp),%eax
 mov    %eax,(%esp)
...
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+cmpl   $0x0,-0x28(%ebp)
+jle    <T> <_ZN5CPeer7parsingEi+0x436>
+mov    -0x28(%ebp),%eax
 cmp    $0x1800,%eax
-jbe    <T> <_ZN5CPeer7parsingEi+0x3fa>
+jbe    <T> <_ZN5CPeer7parsingEi+0x3f3>
 movl   $0x10e,0x8(%esp)
 movl   $&_ZZN5CPeer7parsingEiE12__FUNCTION__,0x4(%esp)
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
