...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8059fcc` | `0x489` | `0x80ec6e4` | `0x41d` |
...
+mov    $0x1,%eax
+jmp    <T> <_ZN5CPeer7parsingEi+0x416>
+nop
+mov    0x8(%ebp),%eax
+mov    0x1820(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN5CPeer7parsingEi+0xe7>
+mov    0x8(%ebp),%eax
+mov    0x181c(%eax),%edx
+mov    0x8(%ebp),%eax
+mov    0x1820(%eax),%eax
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x9,-0xc(%ebp)
+jle    <T> <_ZN5CPeer7parsingEi+0x13f>
+cmpl   $0x1800,-0xc(%ebp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN5CPeer7parsingEi+0x377>
 mov    0x8(%ebp),%eax
 mov    0x182c(%eax),%eax
 mov    %eax,0x4(%esp)
-lea    -0x64(%ebp),%eax
...
+jmp    <T> <_ZN5CPeer7parsingEi+0x2e3>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x64(%ebp),%eax
+lea    -0x3c(%ebp),%eax
...
+movl   $0x0,0x1820(%eax)
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN5CPeer7parsingEi+0x32f>
 mov    0x8(%ebp),%eax
 lea    0x1c(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0x181c(%eax)
...
+cmpl   $0x0,-0x10(%ebp)
+jle    <T> <_ZN5CPeer7parsingEi+0x411>
    ...
    *(int *)(this + 0x181c) = *(int *)(this + 0x181c) + param_1;
    ...
    do {
      ...
      CGuard<CMutex>::CGuard(local_68,pCVar4);
                    /* try { // try from 0805a1cf to 0805a1d3 has its CatchHandler @ 0805a246 */
      ...
      *(undefined4 *)(pCVar2 + 6) = uVar3;
      CGuard<CMutex>::CGuard(local_6c,*(CMutex **)(this + 0x1830));
                    /* try { // try from 0805a23f to 0805a243 has its CatchHandler @ 0805a2b5 */
      std::queue<CTcpRecvBuffer*,std::deque<CTcpRecvBuffer*,std::allocator<CTcpRecvBuffer*>>>::push
                (*(queue<CTcpRecvBuffer*,std::deque<CTcpRecvBuffer*,std::allocator<CTcpRecvBuffer*>>>
                   **)(this + 0x1828),&local_64);
                    /* try { // try from 0805a26d to 0805a271 has its CatchHandler @ 0805a2b5 */
      local_2c = std::
                 queue<CTcpRecvBuffer*,std::deque<CTcpRecvBuffer*,std::allocator<CTcpRecvBuffer*>>>
...
LAB_0805a36b:
    if (0 < (int)local_28) {
      if (0x1800 < local_28) {
                    /* try { // try from 0805a395 to 0805a3bb has its CatchHandler @ 0805a40a */
...
定义于 [source/DNFServer/GameServer/DBMW/Peer.cpp](source/DNFServer/GameServer/DBMW/Peer.cpp)（约第 199 行）：
