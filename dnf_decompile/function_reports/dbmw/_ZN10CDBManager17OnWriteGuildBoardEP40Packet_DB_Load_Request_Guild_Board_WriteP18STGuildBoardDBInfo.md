...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8084a8a` | `0x307` | `0x804d7ae` | `0x313` |
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x171>
 movl   $0x22fc,0x8(%esp)
+movl   $"OnWriteGuildBoard",0x4(%esp)
+lea    -0x28(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x30b>
+mov    -0x20(%ebp),%eax
+mov    (%eax),%eax
+add    $0x1c,%eax
+mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x1f4>
+movl   $0x2306,0x8(%esp)
 movl   $"OnWriteGuildBoard",0x4(%esp)
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x217>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x30b>
+mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x24c>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x30b>
+mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x281>
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x30b>
+mov    -0x1c(%ebp),%eax
+add    $0xf,%eax
...
-mov    %dl,0x84(%eax)
-mov    0xc(%ebp),%eax
+jne    <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x29b>
+mov    0x10(%ebp),%eax
+sub    $0xffffff80,%eax
+movl   $0x0,(%eax)
+jmp    <T> <_ZN10CDBManager17OnWriteGuildBoardEP40Packet_DB_Load_Request_Guild_Board_WriteP18STGuildBoardDBInfo+0x306>
+mov    0x10(%ebp),%eax
+lea    0x80(%eax),%edx
+mov    -0x1c(%ebp),%eax
+add    $0x13,%eax
