...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8057a6a` | `0x93` | `0x80e7c1a` | `0x99` |
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0xc(%ebp)
+jns    <T> <_ZN12EpollHandler10ResetEpollEi+0x7f>
...
-lea    -0xc(%ebp),%eax
+mov    (%eax),%eax
+jmp    <T> <_ZN12EpollHandler10ResetEpollEi+0x84>
+mov    $0x0,%eax
+mov    %eax,%ebx
+lea    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/EpollHandler.cpp](source/DNFServer/GameServer/DBMW/EpollHandler.cpp)（约第 86 行）：
