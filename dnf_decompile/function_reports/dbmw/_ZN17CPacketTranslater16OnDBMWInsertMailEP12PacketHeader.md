...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809ca50` | `0x28f` | `0x80d3850` | `0x28c` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 964 行）：
