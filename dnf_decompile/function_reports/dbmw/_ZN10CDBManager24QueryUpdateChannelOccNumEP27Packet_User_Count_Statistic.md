...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8086072` | `0x1be` | `0x8050a3a` | `0x1c5` |
...
+jmp    <T> <_ZN10CDBManager24QueryUpdateChannelOccNumEP27Packet_User_Count_Statistic+0x1bf>
 mov    0x8(%ebp),%eax
 mov    0x8(%eax),%eax
+mov    %eax,-0x14(%ebp)
+cmpl   $0x0,-0x14(%ebp)
...
+call   *%eax
+movl   $0x27dc,0x8(%esp)
+movl   $"QueryUpdateChannelOccNum",0x4(%esp)
+lea    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
-mov    -0x10(%ebp),%eax
+jmp    <T> <_ZN10CDBManager24QueryUpdateChannelOccNumEP27Packet_User_Count_Statistic+0x1ab>
+mov    -0x14(%ebp),%eax
 mov    (%eax),%eax
 add    $0x1c,%eax
-mov    (%eax),%ecx
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager24QueryUpdateChannelOccNumEP27Packet_User_Count_Statistic+0x1a7>
+movl   $0x27e4,0x8(%esp)
+movl   $"QueryUpdateChannelOccNum",0x4(%esp)
+lea    -0x24(%ebp),%eax
+mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/DBManager.cpp](source/DNFServer/GameServer/DBMW/DBManager.cpp)（约第 1016 行）：
