...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805c054` | `0x2f1` | `0x80f5b50` | `0x2ed` |
...
定义于 [source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp](source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp)（约第 169 行）：
