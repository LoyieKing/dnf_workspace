...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805c054` | `0x2f1` | `0x80f5678` | `0x2f9` |
...
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x3f>
 mov    $0x0,%ebx
 mov    $0x0,%esi
...
-movzwl (%eax),%eax
-movzwl %ax,%ebx
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x164>
 movl   $0xba,0x8(%esp)
...
-jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x2e4>
-lea    -0x4c(%ebp),%eax
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x2ed>
+lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
+movb   $0x1,-0x9(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1a5>
+mov    -0x14(%ebp),%eax
+add    $0x6,%eax
+mov    (%eax),%ebx
+mov    -0x10(%ebp),%eax
...
+jne    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1a5>
 mov    $0x1,%eax
-jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1ad>
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1aa>
 mov    $0x0,%eax
 test   %al,%al
...
-movzwl (%eax),%eax
-movzwl %ax,%ebx
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1b2>
+movb   $0x0,-0x9(%ebp)
+cmpb   $0x0,-0x9(%ebp)
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x23e>
 movl   $0xc3,0x8(%esp)
 movl   $&_ZZN13CTcpNetSystem10SendPacketEvE12__FUNCTION__,0x4(%esp)
-lea    -0x3c(%ebp),%eax
+lea    -0x30(%ebp),%eax
...
+mov    %eax,%ebx
+test   %ebx,%ebx
+jg     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x2db>
 movl   $0xd5,0x8(%esp)
 movl   $&_ZZN13CTcpNetSystem10SendPacketEvE12__FUNCTION__,0x4(%esp)
-lea    -0x34(%ebp),%eax
+lea    -0x38(%ebp),%eax
...

{
  ...
  CGuard<CMutex>::CGuard(local_54,(CMutex *)(this + 0xe8));
                    /* try { // try from 0805c07f to 0805c0a3 has its CatchHandler @ 0805c0b0 */
