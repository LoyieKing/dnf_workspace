...
+jne    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x2b1>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x18(%ebp)
+cmpl   $0x0,-0x18(%ebp)
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x2b1>
+mov    -0x18(%ebp),%eax
+add    $0x6,%eax
+mov    (%eax),%eax
+mov    %eax,-0x14(%ebp)
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x15a>
+mov    -0x10(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    $0x1,%eax
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x166>
+mov    $0x0,%eax
+test   %al,%al
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0xc(%ebp)
+jle    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x224>
+mov    -0x18(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    0x8(%ebp),%eax
+mov    %eax,(%esp)
