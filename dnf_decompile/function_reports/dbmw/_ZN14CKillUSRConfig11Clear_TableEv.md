...
+jne    <T> <_ZN14CKillUSRConfig11Clear_TableEv+0xa1>
 mov    0x8(%ebp),%eax
 lea    0x4(%eax),%edx
 lea    -0x14(%ebp),%eax
 mov    %edx,0x4(%esp)
...
+jmp    <T> <_ZN14CKillUSRConfig11Clear_TableEv+0x63>
 lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN14CKillUSRConfig11Clear_TableEv+0x36>
 mov    0x8(%ebp),%eax
 add    $0x4,%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt6vectorIP16ST_KillUSRConfigSaIS1_EE5clearEv>
+jmp    <T> <_ZN14CKillUSRConfig11Clear_TableEv+0xa2>
+nop
 leave
 ret
```
