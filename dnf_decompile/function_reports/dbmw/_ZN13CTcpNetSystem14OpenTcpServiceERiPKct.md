...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805c550` | `0x1b1` | `0x80f4ebe` | `0x1b1` |
...
定义于 [source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp](source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp)（约第 51 行）：
