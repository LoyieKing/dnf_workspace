...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8062a68` | `0x405` | `0x808f22c` | `0x40f` |
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x407>
 mov    0x8(%ebp),%eax
 movzwl 0x34(%eax),%eax
 movzwl %ax,%eax
 mov    0x8(%ebp),%edx
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x1c7>
 mov    0x8(%ebp),%eax
 add    $0x18,%eax
 mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x1c6>
 mov    0x8(%ebp),%eax
 mov    0xc(%eax),%eax
 mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x134>
 mov    -0x20(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CPeer12GetTcpSocketEv>
 mov    %eax,(%esp)
...
+jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x304>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x294>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x28e>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2a9>
+jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2b3>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%ecx
 mov    %ebx,%eax
-jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2a9>
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2b3>
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2be>
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2c8>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2a9>
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2ef>
 lea    -0x29(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x397>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x391>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3ac>
+jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3b6>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%ecx
 mov    %ebx,%eax
-jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3ac>
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3b6>
 lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3c1>
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3cb>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3ac>
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3f2>
 lea    -0x21(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
 movl   $&_ZN13CDNFExceptionD2Ev,0x8(%esp)
