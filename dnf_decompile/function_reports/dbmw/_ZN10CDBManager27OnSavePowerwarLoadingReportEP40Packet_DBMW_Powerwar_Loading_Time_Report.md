...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8080a06` | `0xe9` | `0x80587ee` | `0xe8` |
...
+mov    %eax,-0xc(%ebp)
 movl   $0x1afc,0x8(%esp)
 movl   $&_ZZN10CDBManager27OnSavePowerwarLoadingReportEP40Packet_DBMW_Powerwar_Loading_Time_ReportE12__FUNCTION__,0x4(%esp)
-lea    -0x1c(%ebp),%eax
+lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
