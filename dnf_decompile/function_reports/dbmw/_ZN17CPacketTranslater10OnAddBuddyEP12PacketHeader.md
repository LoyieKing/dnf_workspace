...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80955cc` | `0x187` | `0x80d7faa` | `0x187` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1982 行）：
