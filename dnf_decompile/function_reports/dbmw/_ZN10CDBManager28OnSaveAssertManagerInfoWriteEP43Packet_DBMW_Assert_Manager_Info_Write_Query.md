...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x807ff9e` | `0x386` | `0x805f9a8` | `0x300` |
...
+mov    $0x0,%eax
+jmp    <T> <_ZN10CDBManager28OnSaveAssertManagerInfoWriteEP43Packet_DBMW_Assert_Manager_Info_Write_Query+0x2fe>
+mov    0xc(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
 mov    %eax,-0x14(%ebp)
...
+movl   $0x0,-0x10(%ebp)
+jmp    <T> <_ZN10CDBManager28OnSaveAssertManagerInfoWriteEP43Packet_DBMW_Assert_Manager_Info_Write_Query+0x2e8>
 movl   $0x400,0x8(%esp)
 movl   $0x0,0x4(%esp)
 lea    -0x628(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN10CDBManager28OnSaveAssertManagerInfoWriteEP43Packet_DBMW_Assert_Manager_Info_Write_Query+0xee>
 movl   $0x1a0e,0x8(%esp)
 movl   $"OnSaveAssertManagerInfoWrite",0x4(%esp)
 lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x14(%ebp),%eax
+jmp    <T> <_ZN10CDBManager28OnSaveAssertManagerInfoWriteEP43Packet_DBMW_Assert_Manager_Info_Write_Query+0x2e4>
+mov    -0x18(%ebp),%eax
 mov    (%eax),%eax
 add    $0x78,%eax
-mov    (%eax),%edx
...
+je     <T> <_ZN10CDBManager28OnSaveAssertManagerInfoWriteEP43Packet_DBMW_Assert_Manager_Info_Write_Query+0x2a4>
 movl   $0x400,0x8(%esp)
 movl   $0x0,0x4(%esp)
 lea    -0x628(%ebp),%eax
 mov    %eax,(%esp)
