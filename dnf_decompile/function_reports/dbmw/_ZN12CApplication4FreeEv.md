...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x806c0ba` | `0x2a2` | `0x806ea2c` | `0x2a0` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFApplication.cpp](source/DNFServer/GameServer/DBMW/DNFApplication.cpp)（约第 357 行）：
