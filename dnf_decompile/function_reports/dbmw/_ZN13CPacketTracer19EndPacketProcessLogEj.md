...
|---|---|---|---|---|---|
| dbmw | NEAR | `0x80928f2` | `0xa6` | `0x80cecc0` | `0xa6` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTracer.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTracer.cpp)（约第 78 行）：
