...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809ff46` | `0x158` | `0x807c52e` | `0x153` |
...
+je     <T> <_ZN17CPacketTranslater27onUpdateLimitNpcBuyItemInfoEP12PacketHeader+0x14c>
 movl   $0x134c,0x8(%esp)
 movl   $"onUpdateLimitNpcBuyItemInfo",0x4(%esp)
-lea    -0x28(%ebp),%eax
+lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 122 行）：
