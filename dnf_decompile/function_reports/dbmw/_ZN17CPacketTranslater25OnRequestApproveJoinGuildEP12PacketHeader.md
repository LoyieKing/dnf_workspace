...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8096b24` | `0x28a` | `0x80d4a3a` | `0x281` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1240 行）：
