...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8096b24` | `0x28a` | `0x8080ff8` | `0x2c2` |
...
+je     <T> <_ZN17CPacketTranslater25OnRequestApproveJoinGuildEP12PacketHeader+0x2b6>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x24(%ebp)
-lea    -0x9a(%ebp),%eax
+mov    %eax,-0x20(%ebp)
...
-mov    -0x8c(%ebp),%ebx
-movl   $0x52a,0x8(%esp)
-movl   $"OnRequestApproveJoinGuild",0x4(%esp)
-lea    -0x44(%ebp),%eax
-mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater25OnRequestApproveJoinGuildEP12PacketHeader+0x2b7>
+lea    -0x96(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
+test   %eax,%eax
+jne    <T> <_ZN17CPacketTranslater25OnRequestApproveJoinGuildEP12PacketHeader+0xf9>
+lea    -0x96(%ebp),%eax
+add    $0xa,%eax
+movl   $0x1,(%eax)
+movl   $0x52a,0x8(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater25OnRequestApproveJoinGuildEP12PacketHeader+0x2b7>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater25OnRequestApproveJoinGuildEP12PacketHeader+0x222>
+jne    <T> <_ZN17CPacketTranslater25OnRequestApproveJoinGuildEP12PacketHeader+0x25a>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater25OnRequestApproveJoinGuildEP12PacketHeader+0x253>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater25OnRequestApproveJoinGuildEP12PacketHeader+0x2af>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
