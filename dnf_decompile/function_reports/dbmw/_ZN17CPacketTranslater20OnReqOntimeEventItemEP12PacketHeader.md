...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809f3b2` | `0x2c8` | `0x808619c` | `0x2c3` |
...
+lea    -0x44(%ebp),%eax
 ...
 movl   $0x1118,0x8(%esp)
 movl   $"OnReqOntimeEventItem",0x4(%esp)
-lea    -0x44(%ebp),%eax
+lea    -0x4c(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater20OnReqOntimeEventItemEP12PacketHeader+0x261>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater20OnReqOntimeEventItemEP12PacketHeader+0x25a>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+lea    -0x5c(%ebp),%eax
 ...
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater20OnReqOntimeEventItemEP12PacketHeader+0x2bb>
+jmp    <T> <_ZN17CPacketTranslater20OnReqOntimeEventItemEP12PacketHeader+0x2b6>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 2235 行）：
