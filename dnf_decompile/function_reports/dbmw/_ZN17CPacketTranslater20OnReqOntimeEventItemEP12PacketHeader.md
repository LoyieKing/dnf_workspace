...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809f3b2` | `0x2c8` | `0x80d9742` | `0x2c5` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 2358 行）：
