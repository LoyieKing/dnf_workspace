...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x807d82a` | `0x7c7` | `0x8057292` | `0x7f0` |
...
+jmp    <T> <_ZN10CDBManager31QueryPartyCharacStatisticCreateEP42Packet_DBMW_Dungeon_Statistic_Party_Charac+0x7e3>
 ...
 mov    %eax,-0x20(%ebp)
 movl   $0x16ce,0x8(%esp)
 movl   $"QueryPartyCharacStatisticCreate",0x4(%esp)
-lea    -0x40(%ebp),%eax
+lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
...
+lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogC1EPKci>
-movl   $&data#42bb5fb1(.rodata),0x8(%esp)
+movl   $&data#5f467fe9(.rodata),0x8(%esp)
 movl   $"./log/statistic",0x4(%esp)
-lea    -0x38(%ebp),%eax
+lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
