# _ZN11DnfItemInfoC1Ev

`DnfItemInfo::DnfItemInfo()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80a1368` | `0x2f` | `0x8052ce2` | `0x5b` |
...
void __thiscall DnfItemInfo::_ZN11DnfItemInfoC1Ev(DnfItemInfo *this)
...
定义于 [source/DNFServer/GameServer/DBMW/DBManager.cpp](source/DNFServer/GameServer/DBMW/DBManager.cpp)（约第 1713 行）：
