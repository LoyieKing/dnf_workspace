# _ZN7MemPoolI14CUdpRecvBufferE5allocEv

`MemPool<CUdpRecvBuffer>::alloc()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8056180` | `0x150` | `0x80ca7c2` | `0x15f` |
...
+sub    $0x44,%esp
 ...
 mov    (%eax),%eax
 cmp    $0x1804,%eax
-je     <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x25>
+je     <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x24>
 movl   $0x1804,(%esp)
 call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x149>
+jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x159>
 mov    &_ZN7MemPoolI14CUdpRecvBufferE15headOfFreeList_E,%eax
 mov    %eax,-0x14(%ebp)
 cmpl   $0x0,-0x14(%ebp)
-je     <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x46>
-mov    -0x14(%ebp),%eax
-mov    0x1800(%eax),%eax
-mov    %eax,&_ZN7MemPoolI14CUdpRecvBufferE15headOfFreeList_E
-jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x146>
-mov    0x8(%ebp),%eax
-mov    0x4(%eax),%edx
+je     <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x4c>
+mov    -0x14(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+sub    $0x4,%eax
...
+mov    (%eax),%eax
+mov    %eax,&_ZN7MemPoolI14CUdpRecvBufferE15headOfFreeList_E
+jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x156>
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
...
+jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x9a>
+mov    -0x10(%ebp),%edx
 mov    -0xc(%ebp),%eax
 imul   $0x1804,%eax,%eax
-add    -0x10(%ebp),%eax
...
+jne    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x70>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
 sub    $0x1,%eax
...
void * __thiscall
MemPool<CUdpRecvBuffer>::_ZN7MemPoolI14CUdpRecvBufferE5allocEv(MemPool<CUdpRecvBuffer> *this)
