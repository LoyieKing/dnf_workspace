...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809eaee` | `0x252` | `0x80d0d32` | `0x254` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 416 行）：
