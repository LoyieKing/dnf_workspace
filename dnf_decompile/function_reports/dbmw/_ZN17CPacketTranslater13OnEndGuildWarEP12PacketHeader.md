...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8094d1c` | `0x17a` | `0x80d4cee` | `0x172` |
...
+je     <T> <_ZN17CPacketTranslater13OnEndGuildWarEP12PacketHeader+0x16a>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x14(%ebp)
-mov    -0x14(%ebp),%eax
-movzbl 0xa(%eax),%eax
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater13OnEndGuildWarEP12PacketHeader+0x16b>
 movl   $0x223,0x8(%esp)
...
+jne    <T> <_ZN17CPacketTranslater13OnEndGuildWarEP12PacketHeader+0x10e>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater13OnEndGuildWarEP12PacketHeader+0x107>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+lea    -0x18(%ebp),%eax
 ...
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater13OnEndGuildWarEP12PacketHeader+0x16b>
+jmp    <T> <_ZN17CPacketTranslater13OnEndGuildWarEP12PacketHeader+0x163>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1199 行）：
