...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8094d1c` | `0x17a` | `0x808162a` | `0x170` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1140 行）：
