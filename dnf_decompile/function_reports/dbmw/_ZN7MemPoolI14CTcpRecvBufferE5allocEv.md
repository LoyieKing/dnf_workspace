...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805636c` | `0x150` | `0x80774e4` | `0x181` |
...
+jne    <T> <_ZN7MemPoolI14CTcpRecvBufferE5allocEv+0x169>
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN7MemPoolI14CTcpRecvBufferE5allocEv+0x14c>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
...
+jmp    <T> <_ZN7MemPoolI14CTcpRecvBufferE5allocEv+0x84>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
...
+jne    <T> <_ZN7MemPoolI14CTcpRecvBufferE5allocEv+0x4d>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
...
+call   <T> <_ZNSt6vectorIPvSaIS0_EE9push_backERKS0_>
+movl   $0x7d,0x8(%esp)
+movl   $"alloc",0x4(%esp)
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN7MemPoolI14CTcpRecvBufferE5allocEv+0x161>
+mov    -0x10(%ebp),%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
+sub    $0x4,%eax
...
+mov    -0x10(%ebp),%eax
+mov    %eax,-0x14(%ebp)
+jmp    <T> <_ZN7MemPoolI14CTcpRecvBufferE5allocEv+0x178>
+movl   $0x1804,(%esp)
+call   <T> <_Znwj>
+mov    %eax,-0x14(%ebp)
 mov    -0x14(%ebp),%eax
