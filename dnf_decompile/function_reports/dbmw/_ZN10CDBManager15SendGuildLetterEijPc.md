...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80746c2` | `0x2f9` | `0x804d4fa` | `0x31c` |
...
-mov    -0x1c(%ebp),%eax
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x30f>
+mov    -0x2c(%ebp),%eax
 mov    (%eax),%eax
 add    $0x20,%eax
 mov    (%eax),%edx
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0xcc>
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x30f>
+mov    -0x2c(%ebp),%eax
 mov    (%eax),%eax
...
+mov    %eax,-0x20(%ebp)
+movl   $0x0,-0x1c(%ebp)
+jmp    <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x2f9>
+mov    -0x2c(%ebp),%eax
 mov    (%eax),%eax
 add    $0x24,%eax
 mov    (%eax),%edx
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x164>
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x30f>
+movl   $0x0,-0x40(%ebp)
+mov    -0x2c(%ebp),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x1a4>
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x30f>
 lea    -0x5e(%ebp),%eax
-mov    $0x1e,%ebx
...
+je     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x1c3>
 mov    %dx,(%eax)
 add    $0x2,%eax
-sub    $0x2,%ebx
-mov    %ebx,%esi
...
+cmp    %edi,%ecx
+jb     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x1cd>
 add    %ecx,%eax
-mov    %ebx,%ecx
+mov    %esi,%ecx
 and    $0x2,%ecx
...
+je     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x1e8>
 mov    %dx,(%eax)
 add    $0x2,%eax
-mov    %ebx,%ecx
+mov    %esi,%ecx
...
+je     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x1f6>
 mov    %dl,(%eax)
 add    $0x1,%eax
-lea    -0x2c(%ebp),%eax
+lea    -0x64(%ebp),%eax
...
+je     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x2c4>
+movl   $0x80d,0x8(%esp)
+movl   $&_ZZN10CDBManager15SendGuildLetterEijPcE12__FUNCTION__,0x4(%esp)
+lea    -0x70(%ebp),%eax
+mov    %eax,(%esp)
...
+call   <T> <_ZNSsD1Ev>
+test   %esi,%esi
+je     <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x30f>
+addl   $0x1,-0x1c(%ebp)
+mov    -0x1c(%ebp),%eax
+cmp    -0x28(%ebp),%eax
 setl   %al
...
-mov    $0x1,%eax
-lea    -0x8(%ebp),%esp
+jne    <T> <_ZN10CDBManager15SendGuildLetterEijPc+0x13a>
+mov    $0x1,%ebx
+mov    %ebx,%eax
+lea    -0xc(%ebp),%esp
 add    $0x0,%esp
