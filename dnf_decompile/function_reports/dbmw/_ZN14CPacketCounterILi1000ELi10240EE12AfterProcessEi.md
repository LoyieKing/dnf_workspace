...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80920c4` | `0x11d` | `0x80ebc98` | `0xfd` |
...
+jg     <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xfb>
 cmpl   $0x3e7,0xc(%ebp)
-jle    <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0x113>
+jle    <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xfb>
 mov    0x8(%ebp),%eax
...
+ja     <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xfb>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
-mov    %eax,-0xc(%ebp)
...
+cmp    $0xffffffff,%eax
+je     <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xfb>
 mov    0x8(%ebp),%eax
 movzbl 0x1d640(%eax),%eax
 test   %al,%al
-je     <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0x8f>
+jne    <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xb7>
 mov    0x8(%ebp),%eax
-mov    0x9068(%eax),%eax
-mov    -0xc(%ebp),%edx
-mov    %edx,%ecx
...
-mov    %ecx,%eax
+movb   $0x0,(%eax,%edx,1)
+jmp    <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xc4>
+mov    0x8(%ebp),%eax
+add    $0x9068,%eax
+mov    (%eax),%eax
 mov    %eax,-0x8(%ebp)
...
定义于 [source/DNFServer/GameServer/DBMW/PacketCounter.cpp](source/DNFServer/GameServer/DBMW/PacketCounter.cpp)（约第 82 行）：
