...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809fd9e` | `0x1a7` | `0x807c392` | `0x19c` |
...
+je     <T> <_ZN17CPacketTranslater25onLoadLimitNpcBuyItemInfoEP12PacketHeader+0x8c>
 movl   $0x132e,0x8(%esp)
 movl   $"onLoadLimitNpcBuyItemInfo",0x4(%esp)
-lea    -0x2c(%ebp),%eax
+lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 100 行）：
