...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80970dc` | `0x465` | `0x80d8ba8` | `0x3e0` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 2204 行）：
