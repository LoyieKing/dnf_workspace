...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8058882` | `0x255` | `0x80e462a` | `0x2aa` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp](source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp)（约第 208 行）：
