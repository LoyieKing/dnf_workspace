...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8093c9c` | `0x2bc` | `0x807f04a` | `0x2af` |
...
+je     <T> <_ZN17CPacketTranslater11OnSaveGuildEP12PacketHeader+0x2a3>
 mov    0x8(%ebp),%eax
 mov    %eax,-0x20(%ebp)
 mov    -0x20(%ebp),%eax
 mov    0xcc(%eax),%eax
...
+jmp    <T> <_ZN17CPacketTranslater11OnSaveGuildEP12PacketHeader+0x2a4>
 mov    -0x20(%ebp),%eax
 mov    0xcc(%eax),%eax
 cmp    $0x1,%eax
-jne    <T> <_ZN17CPacketTranslater11OnSaveGuildEP12PacketHeader+0xa2>
+jne    <T> <_ZN17CPacketTranslater11OnSaveGuildEP12PacketHeader+0x2a4>
 mov    -0x20(%ebp),%eax
 lea    0xf(%eax),%ebx
 mov    -0x20(%ebp),%eax
 mov    0xb(%eax),%edx
...
+jne    <T> <_ZN17CPacketTranslater11OnSaveGuildEP12PacketHeader+0x23b>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater11OnSaveGuildEP12PacketHeader+0x234>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater11OnSaveGuildEP12PacketHeader+0x29c>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 703 行）：
