...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x818c81d` | `0x106` | `0x80f166f` | `0xd5` |
...
定义于 [source/DNFServer/GameServer/DBMW/StackBuffer.cpp](source/DNFServer/GameServer/DBMW/StackBuffer.cpp)（约第 103 行）：
