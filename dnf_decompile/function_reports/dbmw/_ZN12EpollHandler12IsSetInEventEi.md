...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8057b8c` | `0x1f` | `0x80e7b14` | `0x21` |
...
定义于 [source/DNFServer/GameServer/DBMW/EpollHandler.cpp](source/DNFServer/GameServer/DBMW/EpollHandler.cpp)（约第 66 行）：
