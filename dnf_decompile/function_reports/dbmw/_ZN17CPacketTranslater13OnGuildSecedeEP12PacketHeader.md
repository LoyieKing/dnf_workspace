...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8097542` | `0x2cd` | `0x80d2e2c` | `0x2bb` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 847 行）：
