...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8097542` | `0x2cd` | `0x80d2ce4` | `0x2c4` |
...
+je     <T> <_ZN17CPacketTranslater13OnGuildSecedeEP12PacketHeader+0x2b5>
 mov    0x8(%ebp),%eax
 mov    %eax,-0x24(%ebp)
 mov    -0x24(%ebp),%eax
 mov    0xa(%eax),%eax
...
+je     <T> <_ZN17CPacketTranslater13OnGuildSecedeEP12PacketHeader+0x2b8>
 lea    -0x85(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater13OnGuildSecedeEP12PacketHeader+0x2b9>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater13OnGuildSecedeEP12PacketHeader+0x265>
+jne    <T> <_ZN17CPacketTranslater13OnGuildSecedeEP12PacketHeader+0x259>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater13OnGuildSecedeEP12PacketHeader+0x252>
 mov    %edx,%ebx
 mov    %eax,%esi
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 864 行）：
