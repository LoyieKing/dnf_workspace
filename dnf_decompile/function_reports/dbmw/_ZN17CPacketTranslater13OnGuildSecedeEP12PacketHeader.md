...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8097542` | `0x2cd` | `0x80d29a0` | `0x2bb` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 787 行）：
