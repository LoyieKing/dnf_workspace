...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x806d110` | `0x8a` | `0x806ecc6` | `0x90` |
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN12CApplication14SwitchQueueTCPEv+0x7e>
+mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CApplication14SwitchQueueTCPEv+0x7e>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0xc(%ebp),%eax
+lea    -0x10(%ebp),%eax
...

{
  ...
  *pIVar3;
  ...
  pCVar2 = (CMutex *)CTcpNetSystem::Get_TcpRecvQLock((CTcpNetSystem *)(this + 0x128));
  CGuard<CMutex>::CGuard(local_10,pCVar2);
                    /* try { // try from 0806d137 to 0806d16a has its CatchHandler @ 0806d16d */
