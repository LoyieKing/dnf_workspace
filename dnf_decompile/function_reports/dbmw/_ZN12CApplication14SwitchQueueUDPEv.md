...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x806d19a` | `0xc2` | `0x806e96e` | `0xc5` |
...
+xor    $0x1,%eax
 test   %al,%al
-jne    <T> <_ZN12CApplication14SwitchQueueUDPEv+0xb0>
+je     <T> <_ZN12CApplication14SwitchQueueUDPEv+0xb3>
 mov    0x8(%ebp),%eax
 add    $0xa0,%eax
 mov    %eax,(%esp)
 ...
 mov    %eax,0x4(%esp)
 mov    %edx,(%esp)
 call   <T> <_ZN14CNetworkThread11SetUDPQueueEPSt5queueIP14CUdpRecvBufferSt5dequeIS2_SaIS2_EEE>
 mov    0x8(%ebp),%eax
 add    $0xa0,%eax
 mov    %eax,(%esp)
...
-jmp    <T> <_ZN12CApplication14SwitchQueueUDPEv+0xb0>
+jmp    <T> <_ZN12CApplication14SwitchQueueUDPEv+0xb3>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0xc(%ebp),%eax
 mov    %eax,(%esp)
...

{
  ...
  CGuard<CMutex>::CGuard(local_10,(CMutex *)(this + 0xf8));
  this_00 = (queue<CUdpRecvBuffer*,std::deque<CUdpRecvBuffer*,std::allocator<CUdpRecvBuffer*>>> *)
            ...
            ::GetRecvQ((CSwapQueue<std::queue<CUdpRecvBuffer*,std::deque<CUdpRecvBuffer*,std::allocator<CUdpRecvBuffer*>>>,2>
                        *)(this + 0xa0));
                    /* try { // try from 0806d1cc to 0806d22c has its CatchHandler @ 0806d22f */
  ...
  if (cVar1 == '\0') {
    ...
    pqVar2 = (queue *)CSwapQueue<std::queue<CUdpRecvBuffer*,std::deque<CUdpRecvBuffer*,std::allocator<CUdpRecvBuffer*>>>,2>
                      ::GetRecvQ((CSwapQueue<std::queue<CUdpRecvBuffer*,std::deque<CUdpRecvBuffer*,std::allocator<CUdpRecvBuffer*>>>,2>
                                  *)(this + 0xa0));
    CNetworkThread::SetUDPQueue(*(CNetworkThread **)(this + 0x9c),pqVar2);
    pqVar2 = (queue *)CSwapQueue<std::queue<CUdpRecvBuffer*,std::deque<CUdpRecvBuffer*,std::allocator<CUdpRecvBuffer*>>>,2>
...
定义于 [source/DNFServer/GameServer/DBMW/DNFApplication.cpp](source/DNFServer/GameServer/DBMW/DNFApplication.cpp)（约第 350 行）：
