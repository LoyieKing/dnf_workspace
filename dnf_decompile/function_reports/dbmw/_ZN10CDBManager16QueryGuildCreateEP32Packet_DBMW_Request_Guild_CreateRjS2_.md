...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80797d2` | `0x99f` | `0x805a7be` | `0x9bb` |
...
-add    $0x20,%eax
-mov    (%eax),%edx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x9ae>
+mov    -0x20(%ebp),%eax
+mov    (%eax),%eax
+add    $0x20,%eax
+mov    (%eax),%eax
...
-mov    -0x24(%ebp),%eax
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x215>
+mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
 add    $0x24,%eax
-mov    (%eax),%edx
...
-mov    -0x24(%ebp),%eax
+jne    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x215>
+movl   $0x0,-0x40(%ebp)
+mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
 add    $0x38,%eax
...
+movzbl 0x13(%eax),%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x22f>
+mov    0xc(%ebp),%eax
+movzbl 0x38(%eax),%eax
+test   %al,%al
+jne    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x2e9>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    0xc(%ebp),%eax
+movzbl 0x13(%eax),%eax
+test   %al,%al
+jne    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x29b>
 movl   $0x114f,0x8(%esp)
 movl   $"QueryGuildCreate",0x4(%esp)
-lea    -0x44(%ebp),%eax
+lea    -0x48(%ebp),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x38f>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x9ae>
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x3c3>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x9ae>
...
+xor    $0x1,%eax
+test   %al,%al
+jne    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x4a0>
+mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
 add    $0x74,%eax
-mov    (%eax),%edx
...
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x4ac>
 mov    $0x0,%eax
 test   %al,%al
...
-movl   $0x2,(%eax)
-mov    -0x24(%ebp),%eax
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x4b9>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
...
+call   *%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x5cb>
+mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
 add    $0x74,%eax
-mov    (%eax),%edx
...
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x5d0>
 mov    $0x0,%eax
 test   %al,%al
-je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x74f>
-mov    -0x24(%ebp),%eax
+jne    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x6cb>
+mov    -0x20(%ebp),%eax
 mov    (%eax),%eax
 add    $0x1c,%eax
 mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x6cb>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    -0x20(%ebp),%eax
+mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x71e>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x959>
+mov    -0x20(%ebp),%eax
+mov    (%eax),%eax
+add    $0x20,%eax
+mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x748>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    -0x20(%ebp),%eax
+mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x797>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x959>
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x7c1>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    -0x20(%ebp),%eax
+mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x814>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x959>
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x83e>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    -0x20(%ebp),%eax
+mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x883>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x959>
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x8ad>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    -0x1c(%ebp),%eax
+mov    (%eax),%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x913>
+mov    0x14(%ebp),%eax
+movl   $0x2,(%eax)
+mov    $0x0,%ebx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x959>
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x93d>
 mov    0x14(%ebp),%eax
 movl   $0x2,(%eax)
 mov    $0x1,%ebx
-lea    -0x50(%ebp),%eax
...
+lea    -0x30(%ebp),%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x966>
+lea    -0x30(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x97b>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x2c(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x988>
+lea    -0x2c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN16StackBuffer_charD1Ev>
+jmp    <T> <_ZN10CDBManager16QueryGuildCreateEP32Packet_DBMW_Request_Guild_CreateRjS2_+0x9a3>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x21(%ebp),%eax
+mov    %eax,(%esp)
