...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809e8f2` | `0x1fc` | `0x80d0ff0` | `0x205` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 451 行）：
