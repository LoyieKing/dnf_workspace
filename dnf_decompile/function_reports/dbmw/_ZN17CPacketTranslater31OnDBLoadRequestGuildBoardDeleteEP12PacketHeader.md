...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809e8f2` | `0x1fc` | `0x80d10c2` | `0x201` |
...
+je     <T> <_ZN17CPacketTranslater31OnDBLoadRequestGuildBoardDeleteEP12PacketHeader+0x1f9>
 mov    0x8(%ebp),%eax
 mov    %eax,-0x14(%ebp)
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    0x18(%eax),%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater31OnDBLoadRequestGuildBoardDeleteEP12PacketHeader+0x97>
 lea    -0x44(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater31OnDBLoadRequestGuildBoardDeleteEP12PacketHeader+0x1fa>
 mov    -0x14(%ebp),%eax
 mov    0xf(%eax),%ebx
 movl   $0xfe9,0x8(%esp)
...
+jne    <T> <_ZN17CPacketTranslater31OnDBLoadRequestGuildBoardDeleteEP12PacketHeader+0x19d>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater31OnDBLoadRequestGuildBoardDeleteEP12PacketHeader+0x196>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater31OnDBLoadRequestGuildBoardDeleteEP12PacketHeader+0x1f2>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 492 行）：
