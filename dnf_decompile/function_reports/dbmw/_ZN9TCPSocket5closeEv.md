...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80582e2` | `0x52` | `0x80e3e34` | `0x4f` |
...
+je     <T> <_ZN9TCPSocket5closeEv+0x4d>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 mov    %eax,(%esp)
 call   <T> <close>
...
定义于 [source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp](source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp)（约第 48 行）：
