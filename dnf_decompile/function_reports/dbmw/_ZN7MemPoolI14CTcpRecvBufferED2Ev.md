# _ZN7MemPoolI14CTcpRecvBufferED2Ev

`MemPool<CTcpRecvBuffer>::~MemPool()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8057480` | `0xcf` | `0x807743c` | `0xa8` |
...
-xor    $0x1,%eax
-test   %al,%al
-je     <T> <_ZN7MemPoolI14CTcpRecvBufferED1Ev+0xb7>
 mov    0x8(%ebp),%eax
 lea    0x8(%eax),%edx
 lea    -0x10(%ebp),%eax
 mov    %edx,0x4(%esp)
 ...
 sub    $0x4,%esp
-jmp    <T> <_ZN7MemPoolI14CTcpRecvBufferED1Ev+0x5b>
+jmp    <T> <_ZN7MemPoolI14CTcpRecvBufferED1Ev+0x42>
 lea    -0x10(%ebp),%eax
 mov    %eax,(%esp)
 ...
 test   %al,%al
-jne    <T> <_ZN7MemPoolI14CTcpRecvBufferED1Ev+0x3b>
-mov    0x8(%ebp),%eax
-add    $0x8,%eax
-mov    %eax,(%esp)
-call   <T> <_ZNSt6vectorIPvSaIS0_EE5clearEv>
-jmp    <T> <_ZN7MemPoolI14CTcpRecvBufferED1Ev+0xb7>
+jne    <T> <_ZN7MemPoolI14CTcpRecvBufferED1Ev+0x22>
+jmp    <T> <_ZN7MemPoolI14CTcpRecvBufferED1Ev+0x90>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x8,%eax
...
void __thiscall
MemPool<CTcpRecvBuffer>::_ZN7MemPoolI14CTcpRecvBufferED2Ev(MemPool<CTcpRecvBuffer> *this)

{
  ...
  __normal_iterator local_10 [4];
                    ...
                    /* try { // try from 08057491 to 08057516 has its CatchHandler @ 08057519 */
