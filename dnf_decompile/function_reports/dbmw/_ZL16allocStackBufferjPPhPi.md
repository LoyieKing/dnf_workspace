...
|---|---|---|---|---|---|
| dbmw | NEAR | `0x818c4c0` | `0x272` | `0x80f1891` | `0x272` |
...
定义于 [source/DNFServer/GameServer/DBMW/StackBuffer.cpp](source/DNFServer/GameServer/DBMW/StackBuffer.cpp)（约第 36 行）：
