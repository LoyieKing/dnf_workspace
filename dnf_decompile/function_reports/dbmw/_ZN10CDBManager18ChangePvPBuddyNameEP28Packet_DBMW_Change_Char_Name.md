...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x807b276` | `0xe3` | `0x805c6f6` | `0xed` |
...
+movl   $0x13b0,0x8(%esp)
+movl   $"ChangePvPBuddyName",0x4(%esp)
+lea    -0x14(%ebp),%eax
+mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/DBManager.cpp](source/DNFServer/GameServer/DBMW/DBManager.cpp)（约第 4259 行）：
