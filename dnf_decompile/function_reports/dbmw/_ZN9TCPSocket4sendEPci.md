...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80580ec` | `0x117` | `0x80907c2` | `0x147` |
...
+jmp    <T> <_ZN9TCPSocket4sendEPci+0x145>
 mov    0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 mov    %edx,0x8(%esp)
...
+jg     <T> <_ZN9TCPSocket4sendEPci+0x11c>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0xb,%eax
-je     <T> <_ZN9TCPSocket4sendEPci+0x86>
+je     <T> <_ZN9TCPSocket4sendEPci+0x7b>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0x4,%eax
-je     <T> <_ZN9TCPSocket4sendEPci+0x86>
+je     <T> <_ZN9TCPSocket4sendEPci+0x7b>
 ...
 cmp    $0xb,%eax
-je     <T> <_ZN9TCPSocket4sendEPci+0x86>
+jne    <T> <_ZN9TCPSocket4sendEPci+0xab>
+call   <T> <__errno_location>
+mov    (%eax),%eax
+mov    %eax,(%esp)
+call   <T> <strerror>
...
+je     <T> <_ZN9TCPSocket4sendEPci+0xe3>
+call   <T> <__errno_location>
+mov    (%eax),%eax
+mov    %eax,(%esp)
+call   <T> <strerror>
