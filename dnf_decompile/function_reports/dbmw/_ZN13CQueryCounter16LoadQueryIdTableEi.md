...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x808e75e` | `0x3c` | `0x8099f84` | `0x3c` |
...
定义于 [source/DNFServer/GameServer/DBMW/QueryCounter.cpp](source/DNFServer/GameServer/DBMW/QueryCounter.cpp)（约第 114 行）：
