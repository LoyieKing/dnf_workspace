...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8085b3c` | `0x158` | `0x8062f60` | `0x15a` |
...
+call   *%eax
 ...
 movl   $0x24b1,0x8(%esp)
 movl   $"QueryOnTimeEventItem",0x4(%esp)
 lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/DBManager.cpp](source/DNFServer/GameServer/DBMW/DBManager.cpp)（约第 5950 行）：
