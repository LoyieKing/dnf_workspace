...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x80a009e` | `0x158` | `0x8082d52` | `0x153` |
...
+je     <T> <_ZN17CPacketTranslater20onCompatibilityIndexEP12PacketHeader+0x14b>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x10(%ebp)
-mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
-lea    0x50(%eax),%edx
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater20onCompatibilityIndexEP12PacketHeader+0x14c>
 movl   $0x13a5,0x8(%esp)
 movl   $"onCompatibilityIndex",0x4(%esp)
-lea    -0x28(%ebp),%eax
+lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater20onCompatibilityIndexEP12PacketHeader+0x14c>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater20onCompatibilityIndexEP12PacketHeader+0xf4>
+jne    <T> <_ZN17CPacketTranslater20onCompatibilityIndexEP12PacketHeader+0xef>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater20onCompatibilityIndexEP12PacketHeader+0xe8>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater20onCompatibilityIndexEP12PacketHeader+0x144>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1474 行）：
