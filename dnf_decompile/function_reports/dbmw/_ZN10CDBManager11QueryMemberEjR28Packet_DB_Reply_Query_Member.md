...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8073048` | `0xb7a` | `0x8053b94` | `0xaee` |
...
定义于 [source/DNFServer/GameServer/DBMW/DBManager.cpp](source/DNFServer/GameServer/DBMW/DBManager.cpp)（约第 2024 行）：
