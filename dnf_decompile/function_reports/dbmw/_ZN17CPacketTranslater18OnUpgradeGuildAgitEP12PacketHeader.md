...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x809a444` | `0x230` | `0x80d19e6` | `0x233` |
...
+jmp    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x22b>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x1ce>
+jne    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x1d1>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x1ca>
 mov    %edx,%ebx
 mov    %eax,%esi
