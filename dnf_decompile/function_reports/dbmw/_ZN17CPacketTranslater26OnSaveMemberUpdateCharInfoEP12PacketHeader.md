...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x8094738` | `0x1a6` | `0x8081dca` | `0x1a6` |
...
-mov    0xa(%eax),%ebx
 movl   $0x1a4,0x8(%esp)
 movl   $"OnSaveMemberUpdateCharInfo",0x4(%esp)
-lea    -0x28(%ebp),%eax
+lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp](source/DNFServer/GameServer/DBMW/DNFPacketTranslater.cpp)（约第 1260 行）：
