...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805c916` | `0x11c` | `0x80f602a` | `0x123` |
...
定义于 [source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp](source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp)（约第 276 行）：
