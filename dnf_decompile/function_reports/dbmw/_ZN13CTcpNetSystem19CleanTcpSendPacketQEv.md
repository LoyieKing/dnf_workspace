...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805c916` | `0x11c` | `0x80f5c5c` | `0x11b` |
...
@@ -1,83 +1,83 @@
 ...
 push   %ebx
 sub    $0x30,%esp
+jmp    <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0xb>
+nop
 mov    0x8(%ebp),%eax
 add    $0xe8,%eax
 mov    %eax,0x4(%esp)
...
+je     <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0x40>
 mov    $0x0,%ebx
-jmp    <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0x81>
+jmp    <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0xcb>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0x9e>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0xb0>
+lea    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CGuardI6CMutexED1Ev>
 mov    $0x1,%ebx
...
定义于 [source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp](source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp)（约第 264 行）：
