...
|---|---|---|---|---|---|
| dbmw | DIFF | `0x805c916` | `0x11c` | `0x80f5c44` | `0x11b` |
...
定义于 [source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp](source/DNFServer/GameServer/DBMW/TcpNetSystem.cpp)（约第 265 行）：
