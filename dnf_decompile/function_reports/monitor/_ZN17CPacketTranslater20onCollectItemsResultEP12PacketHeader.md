...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80912d8` | `0x21a` | `0x807c8dc` | `0x218` |
...
+jmp    <T> <_ZN17CPacketTranslater20onCollectItemsResultEP12PacketHeader+0x210>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater20onCollectItemsResultEP12PacketHeader+0x1b8>
+jne    <T> <_ZN17CPacketTranslater20onCollectItemsResultEP12PacketHeader+0x1b6>
 mov    %eax,(%esp)
...
-mov    %eax,%ebx
 movl   $0x1fe6,0x8(%esp)
 movl   $"onCollectItemsResult",0x4(%esp)
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater20onCollectItemsResultEP12PacketHeader+0x1af>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater20onCollectItemsResultEP12PacketHeader+0x20b>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5255 行）：
