...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808797e` | `0x2c0` | `0x8072c18` | `0x2c8` |
...
+jne    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x4c>
 movl   $0x1032,0x8(%esp)
 movl   $"OnAddBuddyDBReply",0x4(%esp)
-lea    -0x3c(%ebp),%eax
+lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x2c1>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 add    $0x10,%eax
-mov    %eax,-0x10(%ebp)
-mov    -0x14(%ebp),%eax
...
+mov    %eax,-0x14(%ebp)
+cmpl   $0x0,-0x14(%ebp)
+jne    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0xb2>
+movl   $0x105f,0x8(%esp)
+movl   $"OnAddBuddyDBReply",0x4(%esp)
+lea    -0x28(%ebp),%eax
+mov    %eax,(%esp)
...
-mov    -0x14(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x1ba>
+mov    0x8(%ebp),%eax
 add    $0xe,%eax
 mov    %eax,0x4(%esp)
-mov    -0x1c(%ebp),%eax
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x142>
+movb   $0xff,-0x3a(%ebp)
+jmp    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x172>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x18(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x15c>
+movb   $0xff,-0x3a(%ebp)
+jmp    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x172>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %al,-0x3d(%ebp)
-movzwl -0x75(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x1c6>
+mov    0x8(%ebp),%eax
+add    $0x35,%eax
+movzbl (%eax),%eax
+mov    %al,-0x39(%ebp)
...
+jne    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x267>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x260>
 mov    %edx,%ebx
 mov    %eax,%esi
...
-movl   $"./log/Except",0x4(%esp)
-lea    -0x24(%ebp),%eax
+movl   $"CPacketTranslater::OnAddBuddyDBReply() Exception Break",0x8(%esp)
+movl   $"%s",0x4(%esp)
+lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x2b4>
+jmp    <T> <_ZN17CPacketTranslater17OnAddBuddyDBReplyEP12PacketHeader+0x2bc>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2733 行）：
