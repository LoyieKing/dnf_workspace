...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8078776` | `0x64` | `0x8059522` | `0x60` |
...
+mov    $0x0,%eax
+jmp    <T> <_ZN12CTcpDBServer16makePacketHeaderEtt+0x5e>
 mov    0x8(%ebp),%eax
 mov    0xc(%eax),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFDBServer.cpp](source/DNFServer/GameServer/Guild/DNFDBServer.cpp)（约第 207 行）：
