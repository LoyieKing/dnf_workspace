...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808dfc0` | `0x1a8` | `0x80795da` | `0x193` |
...
+je     <T> <_ZN17CPacketTranslater24OnResultRegisterEventIdxEP12PacketHeader+0xa6>
 mov    -0x10(%ebp),%eax
-mov    0xa(%eax),%edx
-mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
-mov    0x320(%eax),%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 4539 行）：
