...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807cab0` | `0x1f8` | `0x80686ba` | `0x1d0` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Monitor/DNFPacketDecoder.cpp)（约第 288 行）：
