...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804fffe` | `0x5e` | `0x8085fa6` | `0x66` |
...
定义于 [source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp](source/DNFServer/GameServer/DBMW/DNFTcpSocket.cpp)（约第 175 行）：
