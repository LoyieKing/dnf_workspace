...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80796b4` | `0x46f` | `0x807fb1a` | `0x46b` |
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0x57>
+cmpl   $0x3,-0x28(%ebp)
...
-lea    -0x40(%ebp),%eax
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0x110>
+lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x1c(%ebp),%eax
+test   %al,%al
+je     <T> <_ZN14CServerHandler7ProcessEv+0xb6>
+mov    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0xb6>
+mov    $0x1,%eax
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0xbb>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN14CServerHandler7ProcessEv+0xf3>
+mov    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %al,-0x19(%ebp)
+cmpb   $0xbd,-0x19(%ebp)
+ja     <T> <_ZN14CServerHandler7ProcessEv+0xe8>
+mov    -0x20(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x20(%eax),%eax
-mov    -0x1c(%ebp),%edx
...
+jne    <T> <_ZN14CServerHandler7ProcessEv+0x71>
 mov    0x8(%ebp),%eax
 mov    0x18(%eax),%eax
 test   %eax,%eax
-je     <T> <_ZN14CServerHandler7ProcessEv+0x163>
+je     <T> <_ZN14CServerHandler7ProcessEv+0x15e>
 mov    0x8(%ebp),%eax
 mov    0x18(%eax),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN16CServerInterface13IsValidServerEv>
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0x165>
+mov    $0x1,%eax
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0x16a>
+mov    $0x0,%eax
+test   %al,%al
+jne    <T> <_ZN14CServerHandler7ProcessEv+0x466>
 mov    0x8(%ebp),%eax
 mov    0x18(%eax),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN16CServerInterface11IsConnectedEv>
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0x19d>
 mov    0x8(%ebp),%eax
 mov    0x18(%eax),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN16CServerInterface19IsHeartBeatTimeOverEv>
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0x19d>
+mov    $0x1,%eax
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0x1a2>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN14CServerHandler7ProcessEv+0x1ea>
 mov    0x8(%ebp),%eax
 mov    0x18(%eax),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN16CServerInterface12OnDisconnectEv>
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN14CServerHandler7ProcessEv+0x2ee>
+mov    0x8(%ebp),%eax
+add    $0x58,%eax
 mov    %eax,(%esp)
...
-mov    0x8(%ebp),%eax
-add    $0x54,%eax
+je     <T> <_ZN14CServerHandler7ProcessEv+0x233>
+mov    0x8(%ebp),%eax
+add    $0x58,%eax
 mov    %eax,(%esp)
...
-mov    0x8(%ebp),%eax
-add    $0x54,%eax
+jne    <T> <_ZN14CServerHandler7ProcessEv+0x23a>
+mov    $0x1,%eax
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0x23f>
+mov    $0x0,%eax
+test   %al,%al
+jne    <T> <_ZN14CServerHandler7ProcessEv+0x2ee>
+mov    0x8(%ebp),%eax
+mov    0x20(%eax),%eax
+mov    %eax,(%esp)
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0x331>
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN14CServerHandler16GetServerGroupNoEv>
 movzbl %al,%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN14CServerHandler7ProcessEv+0x435>
 mov    0x8(%ebp),%eax
 add    $0x40,%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0x37a>
 mov    0x8(%ebp),%eax
 add    $0x40,%eax
 mov    %eax,(%esp)
...
-test   %al,%al
-je     <T> <_ZN14CServerHandler7ProcessEv+0x430>
+jne    <T> <_ZN14CServerHandler7ProcessEv+0x381>
+mov    $0x1,%eax
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0x386>
+mov    $0x0,%eax
+test   %al,%al
+jne    <T> <_ZN14CServerHandler7ProcessEv+0x435>
+mov    0x8(%ebp),%eax
+mov    0x20(%eax),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN12CApplication16Get_TcpNetSystemEv>
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0x466>
 mov    0x8(%ebp),%eax
 add    $0x40,%eax
 mov    %eax,(%esp)
