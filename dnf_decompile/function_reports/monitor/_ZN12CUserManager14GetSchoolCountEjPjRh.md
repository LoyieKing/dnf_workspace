...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80724c6` | `0x227` | `0x808bd6c` | `0x21f` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 349 行）：
