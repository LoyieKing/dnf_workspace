...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808bc48` | `0x3b0` | `0x807736a` | `0x3ae` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 4093 行）：
