...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808bc48` | `0x3b0` | `0x807729a` | `0x3a1` |
...
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x288>
+lea    -0x31(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+jne    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x125>
+movl   $0xffffffff,-0x28(%ebp)
+jmp    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x133>
 mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x28(%ebp)
+cmpl   $0x0,-0x28(%ebp)
+je     <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x1ae>
+mov    -0x28(%ebp),%eax
+mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
+add    $0x10,%edx
 mov    %eax,0x4(%esp)
...
+je     <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x398>
+lea    -0x48(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN25Packet_Set_CleanPad_PointC1Ev>
 mov    -0x20(%ebp),%eax
...
-lea    -0x3d(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x399>
+lea    -0x29(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x3d(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x22d>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x24c>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x24c>
+lea    -0x30(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x261>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x24c>
...
+jne    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x32c>
 mov    %ecx,(%esp)
...
-mov    %eax,%ebx
 movl   $0x1660,0x8(%esp)
 movl   $"OnSetCleanPadPoint",0x4(%esp)
-lea    -0x3c(%ebp),%eax
+lea    -0x50(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x325>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnSetCleanPadPointEP12PacketHeader+0x391>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3933 行）：
