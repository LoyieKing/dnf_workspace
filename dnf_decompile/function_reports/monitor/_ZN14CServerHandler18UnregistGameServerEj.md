...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807a710` | `0xd0` | `0x8080a14` | `0xdf` |
...
+je     <T> <_ZN14CServerHandler18UnregistGameServerEj+0x58>
 mov    $0x0,%eax
-jmp    <T> <_ZN14CServerHandler18UnregistGameServerEj+0xcb>
-lea    -0x18(%ebp),%eax
+jmp    <T> <_ZN14CServerHandler18UnregistGameServerEj+0xda>
+lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0xc(%ebp)
+je     <T> <_ZN14CServerHandler18UnregistGameServerEj+0x86>
+mov    -0xc(%ebp),%ebx
 test   %ebx,%ebx
...
-mov    0xc(%ebp),%ebx
 movl   $0x412,0x8(%esp)
 movl   $"UnregistGameServer",0x4(%esp)
-lea    -0x10(%ebp),%eax
+lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...

{
  ...
  if (cVar1 == '\0') {
    ...
    ::erase((map<unsigned_int,CGameServer*,std::less<unsigned_int>,std::allocator<std::pair<unsigned_int_const,CGameServer*>>>
             *)this,local_1c);
    CMyFileLog::CMyFileLog(local_14,"UnregistGameServer",0x412);
