...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8099f66` | `0x112` | `0x80628f0` | `0x118` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 427 行）：
