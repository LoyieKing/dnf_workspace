...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809e91a` | `0xb3` | `0x8058086` | `0x138` |
...
+mov    $0x0,%eax
+jmp    <T> <_ZN12CBuddyHandle11addFromCashEP6CBuddy+0x12e>
+lea    -0x9(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSaIcEC1Ev>
 mov    0xc(%ebp),%eax
...
-jmp    <T> <_ZN12CBuddyHandle11addFromCashEP6CBuddy+0xa7>
+jmp    <T> <_ZN12CBuddyHandle11addFromCashEP6CBuddy+0xd4>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN12CBuddyHandle11addFromCashEP6CBuddy+0xbf>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN12CBuddyHandle11addFromCashEP6CBuddy+0xe1>
+lea    -0x18(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSt4pairISsP6CBuddyED1Ev>
+jmp    <T> <_ZN12CBuddyHandle11addFromCashEP6CBuddy+0xf6>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x10(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN12CBuddyHandle11addFromCashEP6CBuddy+0x103>
+lea    -0x10(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN12CBuddyHandle11addFromCashEP6CBuddy+0x11e>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x9(%ebp),%eax
+mov    %eax,(%esp)
