...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809e91a` | `0xb3` | `0x8058102` | `0xb6` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFBuddyHandle.cpp](source/DNFServer/GameServer/Monitor/DNFBuddyHandle.cpp)（约第 195 行）：
