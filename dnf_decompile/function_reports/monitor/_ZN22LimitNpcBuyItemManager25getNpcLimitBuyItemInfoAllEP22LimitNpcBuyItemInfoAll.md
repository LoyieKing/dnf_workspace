...
|---|---|---|---|---|---|
| monitor | DIFF | `0x805b0d4` | `0x126` | `0x8095a08` | `0x123` |
...
定义于 [source/DNFServer/GameServer/Monitor/LimitNpcBuyItem.cpp](source/DNFServer/GameServer/Monitor/LimitNpcBuyItem.cpp)（约第 92 行）：
