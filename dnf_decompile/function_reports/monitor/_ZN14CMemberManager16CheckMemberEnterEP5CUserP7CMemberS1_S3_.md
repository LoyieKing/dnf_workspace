...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809b122` | `0xce` | `0x8062abe` | `0xce` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 467 行）：
