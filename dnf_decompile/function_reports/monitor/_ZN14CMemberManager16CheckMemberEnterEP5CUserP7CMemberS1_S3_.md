...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809b122` | `0xce` | `0x806297a` | `0xce` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 466 行）：
