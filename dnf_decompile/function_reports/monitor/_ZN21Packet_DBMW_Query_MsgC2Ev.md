# _ZN21Packet_DBMW_Query_MsgC2Ev

`Packet_DBMW_Query_Msg::Packet_DBMW_Query_Msg()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| monitor | DIFF | `0x80aa2c4` | `0x64` | `0x807dc6e` | `0x60` |
...
+jmp    <T> <_ZN21Packet_DBMW_Query_MsgC1Ev+0x50>
+mov    0x8(%ebp),%eax
+mov    -0xc(%ebp),%edx
+add    $0x12,%edx
+add    %edx,%eax
...
+jne    <T> <_ZN21Packet_DBMW_Query_MsgC1Ev+0x3e>
 leave
 ret
```
## 2. Ghidra 反编译 C
...
void __thiscall Packet_DBMW_Query_Msg::_ZN21Packet_DBMW_Query_MsgC2Ev(Packet_DBMW_Query_Msg *this)
