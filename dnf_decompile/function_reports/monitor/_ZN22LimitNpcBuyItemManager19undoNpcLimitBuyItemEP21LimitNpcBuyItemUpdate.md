...
|---|---|---|---|---|---|
| monitor | DIFF | `0x805af9a` | `0x13a` | `0x80952cc` | `0x129` |
...
-lea    -0x28(%ebp),%eax
+je     <T> <_ZN22LimitNpcBuyItemManager19undoNpcLimitBuyItemEP21LimitNpcBuyItemUpdate+0x11e>
+lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKj15NpcBuyLimitItemEEptEv>
 mov    0xc(%eax),%ecx
...
+mov    0x14(%edx),%edx
 ...
 mov    %edx,0xc(%eax)
+movl   $0x34,0x8(%esp)
+movl   $"undoNpcLimitBuyItem",0x4(%esp)
 lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Monitor/LimitNpcBuyItem.cpp](source/DNFServer/GameServer/Monitor/LimitNpcBuyItem.cpp)（约第 57 行）：
