...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a0774` | `0x150` | `0x8065cac` | `0x16f` |
...
+jmp    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0xa3>
+mov    -0x10(%ebp),%ecx
 mov    -0xc(%ebp),%eax
-imul   $0xa8,%eax,%eax
-add    -0x10(%ebp),%eax
...
+jne    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x6d>
+mov    -0x10(%ebp),%ecx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+mov    %eax,%edx
