...
|---|---|---|---|---|---|
| monitor | NEAR | `0x8062e20` | `0x12e` | `0x8050b78` | `0x12e` |
...
+call   *%eax
 ...
 call   <T> <puts>
 jmp    <T> <_ZN12CApplication4InitEiPPc+0x127>
 cmp    $0x2,%edx
 jne    <T> <_ZN12CApplication4InitEiPPc+0xf9>
 mov    %eax,(%esp)
...

{
  CSignalTranslator *this_00;
                    ...
                    /* try { // try from 08062e28 to 08062eca has its CatchHandler @ 08062ecd */
  ShowLogo();
