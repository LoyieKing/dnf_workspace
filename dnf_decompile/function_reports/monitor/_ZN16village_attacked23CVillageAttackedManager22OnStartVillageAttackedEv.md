...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a8aa2` | `0x6e` | `0x80a734a` | `0x7d` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 267 行）：
