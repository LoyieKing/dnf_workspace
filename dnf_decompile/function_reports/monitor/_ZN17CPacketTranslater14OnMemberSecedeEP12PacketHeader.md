...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8081be2` | `0x524` | `0x806db08` | `0x507` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1341 行）：
