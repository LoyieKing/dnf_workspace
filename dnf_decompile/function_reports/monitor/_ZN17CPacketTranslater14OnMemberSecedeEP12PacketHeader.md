...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8081be2` | `0x524` | `0x806d806` | `0x508` |
...
-mov    0x8(%ebp),%eax
-mov    %eax,-0x1c(%ebp)
+je     <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x4fe>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 add    $0x10,%eax
-mov    %eax,-0x18(%ebp)
+mov    %eax,-0x30(%ebp)
...
-mov    -0x1c(%ebp),%eax
+cmpl   $0x0,-0x20(%ebp)
+jne    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x97>
+mov    0x8(%ebp),%eax
 add    $0x13,%eax
 mov    %eax,0x8(%esp)
 movl   $0x31,0x4(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x4fe>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
-mov    0xa0(%eax),%eax
-mov    %eax,-0x10(%ebp)
-cmpl   $0x0,-0x10(%ebp)
...
+jmp    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x126>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x4c(%ebp),%eax
+lea    -0x38(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x10e>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x45(%ebp),%eax
+lea    -0x31(%ebp),%eax
...
-lea    -0x45(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x3f2>
+lea    -0x31(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
-test   %bl,%bl
...
+movl   $0x0,-0x3c(%ebp)
+cmpl   $0x0,-0x18(%ebp)
+jne    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x1e7>
+mov    0x8(%ebp),%eax
 lea    0x13(%eax),%edx
-lea    -0x50(%ebp),%eax
+lea    -0x3c(%ebp),%eax
...
+mov    %al,-0x11(%ebp)
+cmpb   $0x3,-0x11(%ebp)
+je     <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x4fa>
+mov    -0x24(%ebp),%eax
+mov    %eax,0x8(%esp)
+mov    -0x20(%ebp),%eax
+mov    %eax,0x4(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x1b2>
 movl   $0x0,0xc(%esp)
-mov    -0x20(%ebp),%eax
-mov    %eax,0x8(%esp)
-mov    -0x10(%ebp),%eax
...
-mov    -0x30(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x3bd>
+mov    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x50(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x271>
+mov    -0x3c(%ebp),%eax
 movl   $0x1,0x8(%esp)
 mov    %eax,0x4(%esp)
-mov    -0x2c(%ebp),%eax
...
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x26b>
 movl   $0x0,0x8(%esp)
-mov    -0x20(%ebp),%eax
-mov    %eax,0x4(%esp)
-mov    -0x28(%ebp),%eax
...
-mov    -0x50(%ebp),%eax
+movb   $0x1,-0x11(%ebp)
+jmp    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x2ab>
+mov    -0x3c(%ebp),%eax
 movl   $0x1,0x8(%esp)
 mov    %eax,0x4(%esp)
-mov    -0x2c(%ebp),%eax
...
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x2ab>
 movl   $0x0,0x8(%esp)
-mov    -0x20(%ebp),%eax
-mov    %eax,0x4(%esp)
-mov    -0x28(%ebp),%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x316>
+movl   $0x0,0xc(%esp)
+mov    -0x28(%ebp),%eax
+mov    %eax,0x8(%esp)
+mov    -0x1c(%ebp),%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x359>
+mov    -0x3c(%ebp),%eax
 movl   $0x0,0xc(%esp)
-mov    -0x20(%ebp),%eax
-mov    %eax,0x8(%esp)
...
+movb   $0x2,-0x6b(%ebp)
+cmpb   $0x1,-0x11(%ebp)
+jne    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x386>
+movb   $0x1,-0x6b(%ebp)
+mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x492>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x48b>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater14OnMemberSecedeEP12PacketHeader+0x4f3>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1313 行）：
