...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a8c48` | `0x9e` | `0x80a7434` | `0x9c` |
...
+add    $0x1a,%eax
 movl   $0xa,0x8(%esp)
-movl   $&data#d6d33e6a(.rodata),0x4(%esp)
-lea    -0x13b(%ebp),%eax
-add    $0x1a,%eax
...
+add    $0x2f,%eax
 movl   $0x8e,0x8(%esp)
-movl   $&data#16d59de3(.rodata),0x4(%esp)
-lea    -0x13b(%ebp),%eax
-add    $0x2f,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 290 行）：
