...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a8c48` | `0x9e` | `0x80a77e2` | `0xb0` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 291 行）：
