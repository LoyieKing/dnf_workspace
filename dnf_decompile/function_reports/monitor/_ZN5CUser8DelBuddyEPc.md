...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806e002` | `0x97` | `0x8088fde` | `0xce` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUser.cpp](source/DNFServer/GameServer/Monitor/DNFUser.cpp)（约第 254 行）：
