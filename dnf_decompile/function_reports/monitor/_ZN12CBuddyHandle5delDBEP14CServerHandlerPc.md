...
|---|---|---|---|---|---|
| monitor | NEAR | `0x809e9f2` | `0x1ce` | `0x8057b4e` | `0x1ce` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFBuddyHandle.cpp](source/DNFServer/GameServer/Monitor/DNFBuddyHandle.cpp)（约第 86 行）：
