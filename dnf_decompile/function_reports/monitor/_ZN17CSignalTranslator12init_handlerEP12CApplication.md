...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804c3be` | `0x1b3` | `0x8083c2c` | `0x23a` |
...
-mov    0x8(%ebp),%eax
-mov    0x3c(%eax),%eax
+jmp    <T> <_ZN17CSignalTranslator12init_handlerEP12CApplication+0x41>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-cmpl   $0x19,-0xc(%ebp)
+movl   $0x0,-0x1c(%ebp)
+jmp    <T> <_ZN17CSignalTranslator12init_handlerEP12CApplication+0x7c>
+mov    -0x1c(%ebp),%eax
+shl    $0x2,%eax
+add    -0x34(%ebp),%eax
+mov    -0x30(%ebp),%edx
...
+jne    <T> <_ZN17CSignalTranslator12init_handlerEP12CApplication+0x6a>
 movl   $0x8,(%esp)
 call   <T> <_Znwj>
 mov    %eax,%ebx
 mov    %ebx,%eax
...
-mov    0x8(%ebp),%eax
-mov    0x18(%eax),%eax
+jmp    <T> <_ZN17CSignalTranslator12init_handlerEP12CApplication+0xb9>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    0x8(%ebp),%eax
-mov    0x28(%eax),%eax
+jmp    <T> <_ZN17CSignalTranslator12init_handlerEP12CApplication+0x12c>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    0x8(%ebp),%eax
-mov    0x30(%eax),%eax
+jmp    <T> <_ZN17CSignalTranslator12init_handlerEP12CApplication+0x17e>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    0x8(%ebp),%eax
-mov    0x10(%eax),%eax
+jmp    <T> <_ZN17CSignalTranslator12init_handlerEP12CApplication+0x1d0>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
