...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a97e8` | `0x70` | `0x80a8116` | `0x6a` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 452 行）：
