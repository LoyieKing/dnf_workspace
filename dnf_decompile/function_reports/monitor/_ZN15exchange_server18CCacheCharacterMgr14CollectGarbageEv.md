...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80938a0` | `0x107` | `0x805d950` | `0x113` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFManagerServer.cpp](source/DNFServer/GameServer/Monitor/DNFManagerServer.cpp)（约第 333 行）：
