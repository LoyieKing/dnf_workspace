...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8070982` | `0x2f9` | `0x808b6c6` | `0x306` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 234 行）：
