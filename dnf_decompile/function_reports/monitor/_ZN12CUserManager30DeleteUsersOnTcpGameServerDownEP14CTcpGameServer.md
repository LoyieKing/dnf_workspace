...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8070982` | `0x2f9` | `0x808b7ea` | `0x306` |
...
+jmp    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x301>
 mov    0x8(%ebp),%eax
 lea    0x30(%eax),%edx
+lea    -0x20(%ebp),%eax
+mov    %edx,0x4(%esp)
...
+sub    $0x4,%esp
+jmp    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0xb9>
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjP5CUserEEptEv>
+mov    0x4(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x71>
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjP5CUserEEptEv>
+mov    0x4(%eax),%eax
...
+cmp    0xc(%ebp),%eax
+jne    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x71>
+mov    $0x1,%eax
+jmp    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x76>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0xae>
+lea    -0x24(%ebp),%eax
+movl   $0x0,0x8(%esp)
+lea    -0x20(%ebp),%edx
+mov    %edx,0x4(%esp)
...
+sub    $0x4,%esp
+jmp    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x181>
+lea    -0x28(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKSsP5CUserEEptEv>
+mov    0x4(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x139>
+lea    -0x28(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKSsP5CUserEEptEv>
+mov    0x4(%eax),%eax
...
+call   <T> <_ZN5CUser16GetTcpGameServerEv>
+cmp    0xc(%ebp),%eax
+jne    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x139>
+mov    $0x1,%eax
+jmp    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x13e>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x176>
 lea    -0x2c(%ebp),%eax
-mov    %edx,0x4(%esp)
-mov    %eax,(%esp)
-call   <T> <_ZNSt3mapIKjP5CUserSt4lessIS0_ESaISt4pairIS0_S2_EEE5beginEv>
...
+test   %al,%al
+jne    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x105>
+mov    0x8(%ebp),%eax
+lea    0x18(%eax),%edx
+lea    -0x30(%ebp),%eax
+mov    %edx,0x4(%esp)
...
+sub    $0x4,%esp
+jmp    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x2ca>
+lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjP5CUserEEptEv>
 mov    0x4(%eax),%eax
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x2ca>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser16GetTcpGameServerEv>
 cmp    0xc(%ebp),%eax
...
+je     <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x2bf>
 mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x234>
 mov    0x8(%ebp),%eax
 mov    0x78(%eax),%eax
 mov    -0x10(%ebp),%edx
 mov    %edx,0x8(%esp)
...
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x28b>
 mov    -0x10(%ebp),%ebx
 test   %ebx,%ebx
...
+jne    <T> <_ZN12CUserManager30DeleteUsersOnTcpGameServerDownEP14CTcpGameServer+0x1d0>
 mov    $0x0,%eax
 mov    -0x4(%ebp),%ebx
 leave
 ret
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 231 行）：
