...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809aa62` | `0x23a` | `0x8061c14` | `0x245` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 126 行）：
