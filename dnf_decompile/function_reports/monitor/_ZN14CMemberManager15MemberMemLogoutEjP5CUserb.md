...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809aa62` | `0x23a` | `0x8061d52` | `0x237` |
...
+jmp    <T> <_ZN14CMemberManager15MemberMemLogoutEjP5CUserb+0x22f>
 mov    0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+jne    <T> <_ZN14CMemberManager15MemberMemLogoutEjP5CUserb+0x1ad>
 movl   $0x241,0x8(%esp)
 movl   $&_ZZN14CMemberManager15MemberMemLogoutEjP5CUserbE12__FUNCTION__,0x4(%esp)
-lea    -0x2c(%ebp),%eax
+lea    -0x30(%ebp),%eax
...
+mov    %al,-0x19(%ebp)
+cmpb   $0x1,-0x19(%ebp)
+je     <T> <_ZN14CMemberManager15MemberMemLogoutEjP5CUserb+0x22f>
 movzbl -0x4c(%ebp),%ebx
 movl   $0x24b,0x8(%esp)
 movl   $&_ZZN14CMemberManager15MemberMemLogoutEjP5CUserbE12__FUNCTION__,0x4(%esp)
-lea    -0x24(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 124 行）：
