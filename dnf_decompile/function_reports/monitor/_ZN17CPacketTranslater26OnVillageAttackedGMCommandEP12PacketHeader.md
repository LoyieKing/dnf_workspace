...
|---|---|---|---|---|---|
| monitor | NEAR | `0x808c90c` | `0x11a` | `0x807800e` | `0x11a` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 4159 行）：
