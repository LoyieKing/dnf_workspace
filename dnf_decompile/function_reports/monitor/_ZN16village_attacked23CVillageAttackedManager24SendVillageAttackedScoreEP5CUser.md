...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a9690` | `0xb8` | `0x80a7868` | `0xcc` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 408 行）：
