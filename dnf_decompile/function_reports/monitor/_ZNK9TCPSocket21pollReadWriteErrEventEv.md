...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804fc8a` | `0x255` | `0x80858dc` | `0x2cd` |
...
+cmpl   $0x0,-0x38(%ebp)
+jns    <T> <_ZNK9TCPSocket21pollReadWriteErrEventEv+0x1d6>
...
-sar    %cl,%ebx
-mov    %ebx,%eax
+jmp    <T> <_ZNK9TCPSocket21pollReadWriteErrEventEv+0x2bf>
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
+lea    0x1f(%eax),%edx
+test   %eax,%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZNK9TCPSocket21pollReadWriteErrEventEv+0x2b2>
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
+lea    0x1f(%eax),%edx
+test   %eax,%eax
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZNK9TCPSocket21pollReadWriteErrEventEv+0x2a3>
+mov    -0x34(%ebp),%eax
+mov    %eax,-0x38(%ebp)
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
...
+je     <T> <_ZNK9TCPSocket21pollReadWriteErrEventEv+0x2bf>
+movl   $0x3,-0x34(%ebp)
+mov    -0x34(%ebp),%eax
+mov    %eax,-0x38(%ebp)
+jmp    <T> <_ZNK9TCPSocket21pollReadWriteErrEventEv+0x2bf>
