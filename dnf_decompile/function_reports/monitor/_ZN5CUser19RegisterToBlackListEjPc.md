...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806d6ce` | `0xf9` | `0x808999c` | `0x11b` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUser.cpp](source/DNFServer/GameServer/Monitor/DNFUser.cpp)（约第 493 行）：
