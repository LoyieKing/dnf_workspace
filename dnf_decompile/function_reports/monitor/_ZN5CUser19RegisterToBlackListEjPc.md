...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806d6ce` | `0xf9` | `0x80897ca` | `0x11b` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUser.cpp](source/DNFServer/GameServer/Monitor/DNFUser.cpp)（约第 491 行）：
