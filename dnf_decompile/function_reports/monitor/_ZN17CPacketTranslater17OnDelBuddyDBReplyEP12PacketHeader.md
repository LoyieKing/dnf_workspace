...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8087e72` | `0x25d` | `0x80732fa` | `0x25a` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2999 行）：
