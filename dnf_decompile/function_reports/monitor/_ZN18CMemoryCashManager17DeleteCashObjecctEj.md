...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a179e` | `0x90` | `0x8098418` | `0xa7` |
...
定义于 [source/DNFServer/GameServer/Monitor/MemoryCashManager.cpp](source/DNFServer/GameServer/Monitor/MemoryCashManager.cpp)（约第 364 行）：
