...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8062f4e` | `0x10df` | `0x8050ca6` | `0x10e1` |
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1067>
 mov    %ebx,%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0x318(%eax)
 mov    0x8(%ebp),%eax
...
-mov    %eax,%esi
-lea    -0xa4(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xd4>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x64(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0xa4(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xe1>
+lea    -0x64(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-mov    %eax,%esi
-lea    -0x9d(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xf9>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x5d(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,%esi
-lea    -0x9c(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x165>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x5c(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x9c(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x172>
+lea    -0x5c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-mov    %eax,%esi
-lea    -0x95(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x18a>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x55(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,%esi
-lea    -0x94(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x236>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x54(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x94(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x243>
+lea    -0x54(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-mov    %eax,%esi
-lea    -0x8d(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x25b>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x4d(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x85(%ebp),%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x3d8>
+lea    -0x45(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x85(%ebp),%eax
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x386>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x380>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN12CApplication4LoadEiPPc+0x3f7>
+jne    <T> <_ZN12CApplication4LoadEiPPc+0x39d>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%eax
 mov    %ebx,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x3f7>
-lea    -0x8c(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x39d>
+lea    -0x4c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x412>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x3b5>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN12CApplication4LoadEiPPc+0x3f7>
+jne    <T> <_ZN12CApplication4LoadEiPPc+0x39d>
 call   <T> <_ZSt9terminatev>
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x407>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x48a>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    %ebx,%eax
-mov    %eax,%edx
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x4d8>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+je     <T> <_ZN12CApplication4LoadEiPPc+0x518>
...
-cmpw   $0x0,-0x32(%ebp)
-je     <T> <_ZN12CApplication4LoadEiPPc+0x800>
+je     <T> <_ZN12CApplication4LoadEiPPc+0x7a7>
+cmpw   $0x0,-0x2e(%ebp)
+je     <T> <_ZN12CApplication4LoadEiPPc+0x7a7>
 mov    0x8(%ebp),%eax
 add    $0x168,%eax
...
-mov    %eax,%esi
-lea    -0x7c(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x63d>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x44(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x7c(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x64a>
+lea    -0x44(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-mov    %eax,%esi
-lea    -0x75(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x662>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x3d(%ebp),%eax
 mov    %eax,(%esp)
...
-movzwl -0x32(%ebp),%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x727>
+movzwl -0x2e(%ebp),%eax
 mov    %eax,0x8(%esp)
-mov    -0x38(%ebp),%eax
+mov    -0x34(%ebp),%eax
...
-call   <T> <_ZN17CTcpManagerServer7GetSockEv>
-mov    %eax,%ebx
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x7ef>
 movl   $0x1dc,0x8(%esp)
 movl   $"Load",0x4(%esp)
-lea    -0x6c(%ebp),%eax
+lea    -0x7c(%ebp),%eax
...
-cmpw   $0x0,-0x26(%ebp)
-je     <T> <_ZN12CApplication4LoadEiPPc+0xa6d>
+je     <T> <_ZN12CApplication4LoadEiPPc+0xa1f>
+cmpw   $0x0,-0x22(%ebp)
+je     <T> <_ZN12CApplication4LoadEiPPc+0xa1f>
 mov    0x8(%ebp),%eax
 add    $0x168,%eax
...
-mov    %eax,%esi
-lea    -0x5c(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x8a9>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x5c(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x8b6>
+lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-mov    %eax,%esi
-lea    -0x55(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x8ce>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x35(%ebp),%eax
 mov    %eax,(%esp)
...
-movzwl -0x26(%ebp),%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x999>
+movzwl -0x22(%ebp),%eax
 mov    %eax,0x8(%esp)
-mov    -0x2c(%ebp),%eax
+mov    -0x28(%ebp),%eax
...
-call   <T> <_ZN12CTcpDBServer7GetSockEv>
-mov    %eax,%ebx
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xa67>
 movl   $0x209,0x8(%esp)
 movl   $"Load",0x4(%esp)
-lea    -0x4c(%ebp),%eax
+lea    -0x94(%ebp),%eax
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xac1>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+mov    $0x1,%ecx
+cmp    %edx,%esi
+jg     <T> <_ZN12CApplication4LoadEiPPc+0xafc>
+cmp    %edx,%esi
+jl     <T> <_ZN12CApplication4LoadEiPPc+0xaf7>
 cmp    %eax,%ebx
-setge  %al
-test   %al,%al
-je     <T> <_ZN12CApplication4LoadEiPPc+0xb7b>
+jae    <T> <_ZN12CApplication4LoadEiPPc+0xafc>
+mov    $0x0,%ecx
+test   %cl,%cl
+je     <T> <_ZN12CApplication4LoadEiPPc+0xb62>
 movl   $0x0,(%esp)
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xb49>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    %ebx,-0x20(%ebp)
-mov    -0x20(%ebp),%edx
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xba1>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xbe9>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xc71>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+jne    <T> <_ZN12CApplication4LoadEiPPc+0xce1>
 movl   $0x298,(%esp)
 call   <T> <_Znwj>
 mov    %eax,%ebx
 mov    %ebx,%eax
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xcd6>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+jne    <T> <_ZN12CApplication4LoadEiPPc+0xd28>
 movl   $0x44,(%esp)
 call   <T> <_Znwj>
 mov    %eax,%ebx
 mov    %ebx,%eax
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xd1d>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xd6f>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xdf5>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xf0f>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
-mov    %esi,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1065>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xff5>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+jne    <T> <_ZN12CApplication4LoadEiPPc+0x10b3>
 mov    %eax,(%esp)
