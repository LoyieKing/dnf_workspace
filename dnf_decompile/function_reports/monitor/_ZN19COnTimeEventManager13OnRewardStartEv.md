...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a4834` | `0x181` | `0x809a1c4` | `0x19b` |
...
+jmp    <T> <_ZN19COnTimeEventManager13OnRewardStartEv+0x193>
 movl   $0x0,0x4(%esp)
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN19COnTimeEventManager10IsCurStateE23ENUM_ONTIME_EVENT_STATE>
...
+je     <T> <_ZN19COnTimeEventManager13OnRewardStartEv+0x193>
 movl   $0x0,0x4(%esp)
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN19COnTimeEventManager13OnRewardStartEv+0x131>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
定义于 [source/DNFServer/GameServer/Monitor/OnTimeEventManager.cpp](source/DNFServer/GameServer/Monitor/OnTimeEventManager.cpp)（约第 221 行）：
