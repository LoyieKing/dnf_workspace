...
|---|---|---|---|---|---|
| monitor | NEAR | `0x8088b38` | `0x10c` | `0x807426e` | `0x10c` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3183 行）：
