...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8065ba0` | `0x8a` | `0x805258a` | `0x8a` |
...
+je     <T> <_ZN12CApplication14SwitchQueueTCPEv+0x78>
 call   <T> <_ZN6IQueueISt5queueIP14CTcpRecvBufferSt5dequeIS2_SaIS2_EEEE3GetEv>
 mov    %eax,(%esp)
...

{
  ...
  *pIVar3;
  ...
  pCVar2 = (CMutex *)CTcpNetSystem::Get_TcpRecvQLock((CTcpNetSystem *)(this + 0x168));
  CGuard<CMutex>::CGuard(local_10,pCVar2);
                    /* try { // try from 08065bc7 to 08065bfa has its CatchHandler @ 08065bfd */
