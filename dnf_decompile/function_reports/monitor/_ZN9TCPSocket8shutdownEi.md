...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804f6dc` | `0xd` | `0x8085e3a` | `0xa` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFTcpSocket.cpp](source/DNFServer/GameServer/Monitor/DNFTcpSocket.cpp)（约第 322 行）：
