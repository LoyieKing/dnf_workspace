...
|---|---|---|---|---|---|
| monitor | NEAR | `0x807140a` | `0xdf` | `0x808c1ea` | `0xdf` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 455 行）：
