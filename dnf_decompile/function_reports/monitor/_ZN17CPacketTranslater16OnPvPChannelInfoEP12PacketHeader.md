...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8089cb6` | `0x196` | `0x8075404` | `0x184` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3589 行）：
