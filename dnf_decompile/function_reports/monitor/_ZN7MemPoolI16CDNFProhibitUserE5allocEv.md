...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806ce34` | `0x14e` | `0x8066ba4` | `0x15d` |
...
+jmp    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x156>
...
+jmp    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x153>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
...
+jmp    <T> <_ZN7MemPoolI16CDNFProhibitUserE5allocEv+0x97>
 mov    -0xc(%ebp),%edx
 mov    %edx,%eax
 add    %eax,%eax
 add    %edx,%eax
