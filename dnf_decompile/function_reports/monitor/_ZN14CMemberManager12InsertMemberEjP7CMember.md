...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8099d2a` | `0xf2` | `0x806269e` | `0xf5` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 342 行）：
