...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8052002` | `0x150` | `0x8066826` | `0x161` |
...
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x9c>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
...
+jne    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x6c>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x25e10,%eax,%eax
 sub    $0x1,%eax
-imul   $0x97840,%eax,%eax
-add    -0x10(%ebp),%eax
