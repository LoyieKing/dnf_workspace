...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8052002` | `0x150` | `0x806655e` | `0x161` |
...
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x9d>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
...
-add    -0x10(%ebp),%edx
-mov    %edx,0x9783c(%eax)
+imul   $0x25e0f,%edx,%edx
+sub    $0x1,%edx
+shl    $0x2,%edx
+lea    (%eax,%edx,1),%edx
+mov    -0xc(%ebp),%eax
+add    $0x1,%eax
+imul   $0x9783c,%eax,%ecx
+mov    -0x10(%ebp),%eax
+lea    (%ecx,%eax,1),%eax
+mov    %eax,(%edx)
 addl   $0x1,-0xc(%ebp)
...
+jne    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x6d>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x25e0f,%eax,%eax
 sub    $0x1,%eax
-imul   $0x97840,%eax,%eax
-add    -0x10(%ebp),%eax
