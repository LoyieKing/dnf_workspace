...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8052002` | `0x150` | `0x80668c6` | `0x15b` |
...
+jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x154>
...
+jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x151>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
...
+jmp    <T> <_ZN7MemPoolI5CPeerE5allocEv+0x93>
 mov    -0xc(%ebp),%eax
-imul   $0x97840,%eax,%eax
-add    -0x10(%ebp),%eax
+imul   $0x97840,%eax,%edx
+mov    -0x10(%ebp),%eax
+lea    (%edx,%eax,1),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
