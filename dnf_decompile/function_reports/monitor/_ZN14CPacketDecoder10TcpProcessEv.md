...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807cfd6` | `0x333` | `0x8067f92` | `0x33f` |
...
+jmp    <T> <_ZN14CPacketDecoder10TcpProcessEv+0x31e>
 mov    0x8(%ebp),%eax
 mov    0xc(%eax),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN14CPacketDecoder10TcpProcessEv+0x31d>
 mov    -0x24(%ebp),%eax
 mov    %eax,-0x20(%ebp)
 mov    0x8(%ebp),%eax
 mov    0xc(%eax),%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN14CPacketDecoder10TcpProcessEv+0x180>
+mov    0x8(%ebp),%eax
+mov    0x18(%eax),%eax
+mov    %eax,%ebx
 call   <T> <_Z23CAppLoadCheckerInstancev>
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN14CPacketDecoder10TcpProcessEv+0x2d3>
 mov    0x8(%ebp),%eax
 mov    0x14(%eax),%eax
 mov    %eax,0x4(%esp)
 lea    -0x38(%ebp),%eax
...
+jmp    <T> <_ZN14CPacketDecoder10TcpProcessEv+0x1dc>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN14CPacketDecoder10TcpProcessEv+0x27e>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 call   <T> <__cxa_free_exception>
...
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN14CPacketDecoder10TcpProcessEv+0x295>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%eax
+mov    %ebx,%edx
...
+jmp    <T> <_ZN14CPacketDecoder10TcpProcessEv+0x310>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Monitor/DNFPacketDecoder.cpp)（约第 201 行）：
