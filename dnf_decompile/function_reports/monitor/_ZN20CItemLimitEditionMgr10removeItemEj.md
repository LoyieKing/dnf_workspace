...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80935dc` | `0x87` | `0x8093d30` | `0x93` |
...
定义于 [source/DNFServer/GameServer/Monitor/ItemLimitEditionManager.cpp](source/DNFServer/GameServer/Monitor/ItemLimitEditionManager.cpp)（约第 90 行）：
