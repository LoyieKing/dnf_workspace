...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809a2c6` | `0xb8` | `0x8062562` | `0xbb` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 324 行）：
