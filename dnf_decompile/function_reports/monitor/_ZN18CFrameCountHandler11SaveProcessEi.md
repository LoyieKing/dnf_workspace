...
|---|---|---|---|---|---|
| monitor | NEAR | `0x804d04e` | `0x87` | `0x80868a4` | `0x87` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFTickHandler.cpp](source/DNFServer/GameServer/Monitor/DNFTickHandler.cpp)（约第 118 行）：
