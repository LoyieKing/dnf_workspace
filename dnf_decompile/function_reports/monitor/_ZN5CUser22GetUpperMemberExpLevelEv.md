...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806ddc8` | `0x5e` | `0x8088a6e` | `0x62` |
...
+je     <T> <_ZN5CUser22GetUpperMemberExpLevelEv+0x5b>
 mov    0x8(%ebp),%eax
-mov    0x14(%eax),%eax
+add    $0x14,%eax
+mov    (%eax),%eax
...
+je     <T> <_ZN5CUser22GetUpperMemberExpLevelEv+0x45>
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN5CUser22GetUpperMemberExpLevelEv+0x4a>
 mov    $0x0,%eax
 test   %al,%al
-je     <T> <_ZN5CUser22GetUpperMemberExpLevelEv+0x57>
-mov    0x8(%ebp),%eax
...
+jmp    <T> <_ZN5CUser22GetUpperMemberExpLevelEv+0x60>
 mov    $0x0,%eax
 leave
 ret
```
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUser.cpp](source/DNFServer/GameServer/Monitor/DNFUser.cpp)（约第 121 行）：
