...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8083100` | `0x2f4` | `0x806eede` | `0x2f8` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1720 行）：
