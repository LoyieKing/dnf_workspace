...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8080076` | `0x328` | `0x806c092` | `0x322` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1033 行）：
