...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8064fb2` | `0x36c` | `0x8052f9e` | `0x346` |
...
-lea    -0x2c(%ebp),%eax
-mov    -0xc(%ebp),%edx
+je     <T> <_ZN12CApplication15TranslateSignalEv+0x33c>
+lea    -0x30(%ebp),%eax
+mov    -0x10(%ebp),%edx
 mov    %edx,0x4(%esp)
 mov    %eax,(%esp)
...
-lea    -0x2c(%ebp),%eax
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x30d>
+lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
...
-jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x325>
+jne    <T> <_ZN12CApplication15TranslateSignalEv+0x12f>
 lea    -0x3e(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x302>
+mov    -0xc(%ebp),%eax
+mov    (%eax),%eax
+cmp    $0x2,%eax
+jne    <T> <_ZN12CApplication15TranslateSignalEv+0x171>
+lea    -0x50(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN26Packet_Monitor_Event_StartC1Ev>
+mov    -0xc(%ebp),%eax
...
+mov    (%eax),%eax
+cmp    $0x4,%eax
+jne    <T> <_ZN12CApplication15TranslateSignalEv+0x2cf>
 mov    0x8(%ebp),%eax
 mov    0x8c(%eax),%eax
 mov    %eax,(%esp)
...
-mov    %eax,%esi
-lea    -0x15(%ebp),%eax
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x206>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x213>
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x22e>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x19(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,%esi
-lea    -0xd(%ebp),%eax
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x29a>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x18(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x2a7>
+lea    -0x18(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x2c2>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x11(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    (%eax),%eax
+cmp    $0x7,%eax
+jne    <T> <_ZN12CApplication15TranslateSignalEv+0x302>
+lea    -0x5f(%ebp),%eax
 mov    %eax,(%esp)
...
-nop
+jne    <T> <_ZN12CApplication15TranslateSignalEv+0xf1>
 lea    -0x8(%ebp),%esp
 add    $0x0,%esp
 pop    %ebx
 pop    %esi
...
定义于 [source/DNFServer/GameServer/Monitor/DNFApplication.cpp](source/DNFServer/GameServer/Monitor/DNFApplication.cpp)（约第 947 行）：
