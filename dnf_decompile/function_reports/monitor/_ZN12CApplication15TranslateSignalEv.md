...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8064fb2` | `0x36c` | `0x8053014` | `0x36c` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFApplication.cpp](source/DNFServer/GameServer/Monitor/DNFApplication.cpp)（约第 944 行）：
