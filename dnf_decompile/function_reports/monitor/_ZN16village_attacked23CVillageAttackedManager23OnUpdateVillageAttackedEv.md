...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a95d8` | `0x61` | `0x80a780c` | `0x5c` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 399 行）：
