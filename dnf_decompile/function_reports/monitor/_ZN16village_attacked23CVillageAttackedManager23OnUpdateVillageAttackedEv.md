...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a95d8` | `0x61` | `0x80a7dd8` | `0x5c` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 401 行）：
