...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806d480` | `0x82` | `0x8088ba0` | `0x82` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUser.cpp](source/DNFServer/GameServer/Monitor/DNFUser.cpp)（约第 138 行）：
