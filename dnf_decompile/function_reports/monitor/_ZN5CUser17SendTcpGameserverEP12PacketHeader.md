...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806d480` | `0x82` | `0x8088cd8` | `0x82` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUser.cpp](source/DNFServer/GameServer/Monitor/DNFUser.cpp)（约第 126 行）：
