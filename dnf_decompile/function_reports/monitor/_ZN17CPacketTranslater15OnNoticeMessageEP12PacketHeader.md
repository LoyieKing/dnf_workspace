...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80870bc` | `0x22a` | `0x806fdae` | `0x229` |
...
-lea    -0x39(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater15OnNoticeMessageEP12PacketHeader+0x14d>
+lea    -0x21(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+jmp    <T> <_ZN17CPacketTranslater15OnNoticeMessageEP12PacketHeader+0x221>
+cmp    $0x2,%edx
+jne    <T> <_ZN17CPacketTranslater15OnNoticeMessageEP12PacketHeader+0x1c7>
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater15OnNoticeMessageEP12PacketHeader+0x1c0>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater15OnNoticeMessageEP12PacketHeader+0x21c>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1901 行）：
