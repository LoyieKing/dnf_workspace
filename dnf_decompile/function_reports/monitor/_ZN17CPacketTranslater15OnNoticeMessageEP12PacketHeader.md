...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80870bc` | `0x22a` | `0x806ff00` | `0x22a` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1907 行）：
