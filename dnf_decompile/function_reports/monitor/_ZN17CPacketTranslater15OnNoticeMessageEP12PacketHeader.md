...
|---|---|---|---|---|---|
| monitor | NEAR | `0x80870bc` | `0x22a` | `0x806ffd0` | `0x22a` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1948 行）：
