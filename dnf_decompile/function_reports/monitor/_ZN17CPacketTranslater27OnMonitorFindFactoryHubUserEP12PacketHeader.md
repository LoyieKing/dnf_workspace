...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808b754` | `0x4f4` | `0x8076dae` | `0x4cb` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3909 行）：
