...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807e32a` | `0x973` | `0x80699aa` | `0x9bd` |
...
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x9b1>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 add    $0x10,%eax
+mov    %eax,-0x78(%ebp)
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+mov    %eax,-0x70(%ebp)
+cmpl   $0x0,-0x70(%ebp)
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x6a>
+mov    0x8(%ebp),%eax
+add    $0x17,%eax
+movzbl (%eax),%eax
+test   %al,%al
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x6a>
+movl   $0x6,0x4(%esp)
+mov    -0x70(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %eax,-0x6c(%ebp)
+cmpl   $0x0,-0x6c(%ebp)
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x111>
+mov    0x8(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
+movl   $0x0,0x4(%esp)
...
-mov    %eax,-0x144(%ebp)
-mov    -0x4c(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x9b2>
+mov    -0x6c(%ebp),%eax
 mov    %eax,(%esp)
...
-movzbl -0x92(%ebp),%eax
+cmpl   $0x0,-0x58(%ebp)
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x26e>
+movzbl -0x8e(%ebp),%eax
 xor    $0x1,%eax
 movzbl %al,%eax
...
-mov    %eax,0x4(%esp)
-mov    -0x44(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x64c>
+mov    -0x6c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13GetUniqCharNoEv>
+mov    %eax,0x4(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x5ab>
+mov    -0x6c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13GetUniqCharNoEv>
+mov    -0x6c(%ebp),%eax
...
+mov    %eax,-0x3c(%ebp)
+movl   $0x0,-0x30(%ebp)
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x330>
+mov    -0x6c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13GetUniqCharNoEv>
+mov    -0x30(%ebp),%edx
...
-lea    -0x9e(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x304>
+lea    -0xa4(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0xa4(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x44b>
+lea    -0xbc(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x2c(%ebp)
+cmpl   $0x0,-0x2c(%ebp)
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x43d>
+lea    -0xbc(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNK9__gnu_cxx17__normal_iteratorIPjSt6vectorIjSaIjEEEdeEv>
+mov    (%eax),%eax
...
-mov    -0x48(%ebp),%eax
-movzbl 0xe(%eax),%eax
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x38f>
+mov    0x8(%ebp),%eax
+add    $0xf,%eax
+mov    (%eax),%eax
+mov    %eax,-0xb0(%ebp)
...
+movzbl (%eax),%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x548>
+mov    0x8(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%ebx
...
+mov    %eax,-0x34(%ebp)
+cmpl   $0x0,-0x34(%ebp)
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x59d>
+mov    -0x78(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x59d>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x9e(%ebp),%eax
+lea    -0xa4(%ebp),%eax
...
-lea    -0x9e(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x89d>
+lea    -0xa4(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt6vectorIjSaIjEED1Ev>
-lea    -0x6d(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x600>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x74(%ebp),%eax
+lea    -0x80(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x60d>
+lea    -0x80(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x625>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x6d(%ebp),%eax
+lea    -0x79(%ebp),%eax
...
+movzbl (%eax),%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x671>
+movl   $0x2,0x4(%esp)
+mov    -0x6c(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x6ac>
+movl   $0x0,0x4(%esp)
+mov    -0x6c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser14ResetBlackListEi>
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x6bf>
 movl   $0x1,0x4(%esp)
-mov    -0x4c(%ebp),%eax
+mov    -0x6c(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x4c(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x6f5>
+mov    -0x6c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser13GetGameServerEv>
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x6f5>
 mov    $0x1,%eax
-jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x6ba>
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x6fa>
 mov    $0x0,%eax
 test   %al,%al
...
-mov    %eax,0x4(%esp)
-mov    -0x44(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x7a5>
+mov    -0x6c(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    -0x78(%ebp),%eax
 mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x85c>
+mov    0x8(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
 movl   $0x0,0x4(%esp)
...
-mov    -0x4c(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x85c>
+mov    -0x6c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser13GetGameServerEv>
 test   %eax,%eax
...
+mov    %eax,-0x48(%ebp)
+cmpl   $0x0,-0x48(%ebp)
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x9b2>
+mov    -0x78(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x943>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x93c>
 mov    %edx,%ebx
 mov    %eax,%esi
...
-movl   $"./log/Except",0x4(%esp)
-lea    -0x54(%ebp),%eax
+movl   $"CPacketTranslater::OnLogout() Exception Break",0x8(%esp)
+movl   $"%s",0x4(%esp)
+lea    -0xdc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x963>
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x9aa>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
