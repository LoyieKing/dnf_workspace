...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8090c3e` | `0x22a` | `0x807c274` | `0x230` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5209 行）：
