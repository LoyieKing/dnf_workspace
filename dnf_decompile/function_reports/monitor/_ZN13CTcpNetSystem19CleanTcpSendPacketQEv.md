...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8053d1e` | `0x11c` | `0x80a364e` | `0x123` |
...
+je     <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0x3c>
+movl   $0x0,-0xc(%ebp)
+jmp    <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0x85>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0x85>
 ...
 call   <T> <_ZN6CGuardI6CMutexED1Ev>
+cmpl   $0x0,-0xc(%ebp)
+je     <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0xe5>
+mov    0x8(%ebp),%eax
+add    $0x100,%eax
+mov    %eax,0x4(%esp)
+lea    -0x20(%ebp),%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN14CTcpSendBufferdlEPv>
+jmp    <T> <_ZN13CTcpNetSystem19CleanTcpSendPacketQEv+0xd5>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp](source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp)（约第 371 行）：
