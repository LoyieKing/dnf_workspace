...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8099086` | `0xbf` | `0x8060b28` | `0xb0` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMember.cpp](source/DNFServer/GameServer/Monitor/DNFMember.cpp)（约第 399 行）：
