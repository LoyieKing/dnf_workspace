...
|---|---|---|---|---|---|
| monitor | DIFF | `0x805cb64` | `0xac` | `0x80a6f60` | `0xca` |
...
+je     <T> <_ZN41TowerOfDespairWaitGameServerResponse_Task10_DoExecuteEv+0xc2>
...
-mov    %ebx,%eax
-mov    %eax,%ebx
+jmp    <T> <_ZN41TowerOfDespairWaitGameServerResponse_Task10_DoExecuteEv+0xa3>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
