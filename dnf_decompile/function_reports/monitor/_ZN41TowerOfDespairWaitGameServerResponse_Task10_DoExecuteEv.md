...
|---|---|---|---|---|---|
| monitor | DIFF | `0x805cb64` | `0xac` | `0x80a687e` | `0xac` |
...
定义于 [source/DNFServer/GameServer/Monitor/TowerOfDespairReloadAPC.cpp](source/DNFServer/GameServer/Monitor/TowerOfDespairReloadAPC.cpp)（约第 70 行）：
