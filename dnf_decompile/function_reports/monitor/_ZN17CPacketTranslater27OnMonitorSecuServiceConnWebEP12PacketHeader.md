...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808e8ce` | `0x3bd` | `0x8079fac` | `0x3b0` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 4711 行）：
