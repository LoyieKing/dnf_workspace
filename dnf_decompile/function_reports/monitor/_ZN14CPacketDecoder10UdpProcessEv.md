...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x31a>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x319>
 mov    -0x24(%ebp),%eax
 mov    %eax,-0x20(%ebp)
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x17c>
+mov    0x8(%ebp),%eax
+mov    0x18(%eax),%eax
+mov    %eax,%ebx
 call   <T> <_Z23CAppLoadCheckerInstancev>
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x2cf>
 mov    0x8(%ebp),%eax
 mov    0x8(%eax),%eax
 mov    %eax,0x4(%esp)
 lea    -0x38(%ebp),%eax
...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x1d8>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x27a>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 call   <T> <__cxa_free_exception>
...
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x291>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x291>
 lea    -0x2c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x30c>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
