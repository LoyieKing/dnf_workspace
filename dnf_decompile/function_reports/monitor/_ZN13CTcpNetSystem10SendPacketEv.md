...
|---|---|---|---|---|---|
| monitor | DIFF | `0x805345c` | `0x2f1` | `0x80a2ac8` | `0x313` |
...
+cmpl   $0x0,-0x3c(%ebp)
+jne    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x98>
+mov    $0x0,%eax
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x308>
+mov    -0x3c(%ebp),%eax
+mov    0x6(%eax),%eax
+mov    %eax,-0x5c(%ebp)
+mov    0x8(%ebp),%eax
...
-movzwl %ax,%esi
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x172>
+mov    -0x3c(%ebp),%eax
+movzwl 0x2(%eax),%eax
+mov    %ax,-0x28(%ebp)
+mov    -0x3c(%ebp),%eax
...
+movb   $0x0,-0x2d(%ebp)
+cmpb   $0x0,-0x2d(%ebp)
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x24c>
+mov    -0x3c(%ebp),%eax
+movzwl 0x2(%eax),%eax
+mov    %ax,-0x24(%ebp)
+mov    -0x3c(%ebp),%eax
...
+mov    %eax,-0x2c(%ebp)
+cmpl   $0x0,-0x2c(%ebp)
+jg     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x2f3>
+mov    0x8(%ebp),%eax
+add    $0xc0,%eax
+mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp](source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp)（约第 267 行）：
