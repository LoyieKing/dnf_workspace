...
|---|---|---|---|---|---|
| monitor | DIFF | `0x805345c` | `0x2f1` | `0x80a305c` | `0x313` |
...
定义于 [source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp](source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp)（约第 245 行）：
