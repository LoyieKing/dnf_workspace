...
|---|---|---|---|---|---|
| monitor | DIFF | `0x805345c` | `0x2f1` | `0x80a266e` | `0x323` |
...
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x76>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
...
-mov    $0x1,%esi
-jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x77>
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x76>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x50(%ebp),%eax
+lea    -0x3c(%ebp),%eax
...
+cmpb   $0x0,-0x25(%ebp)
+jne    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x8d>
 cmpl   $0x0,-0x2c(%ebp)
...
-mov    %ecx,0x8(%esp)
-mov    %edx,0x4(%esp)
+jne    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x97>
+mov    $0x0,%eax
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x319>
+mov    -0x2c(%ebp),%eax
+add    $0x6,%eax
+mov    (%eax),%eax
+mov    %eax,-0x34(%ebp)
...
-movzwl (%eax),%eax
-movzwl %ax,%ebx
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x179>
+mov    -0x2c(%ebp),%eax
+add    $0x2,%eax
+movzwl (%eax),%eax
+mov    %ax,-0x18(%ebp)
...
-mov    -0x28(%ebp),%eax
-mov    0x6(%eax),%ebx
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1b7>
+mov    -0x34(%ebp),%eax
+mov    %eax,%ebx
 mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1b7>
 mov    $0x1,%eax
-jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1ad>
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1bc>
 mov    $0x0,%eax
 test   %al,%al
...
-movzwl (%eax),%eax
-movzwl %ax,%ebx
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1c4>
+movb   $0x0,-0x1d(%ebp)
+cmpb   $0x0,-0x1d(%ebp)
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x255>
+mov    -0x2c(%ebp),%eax
+add    $0x2,%eax
+movzwl (%eax),%eax
+mov    %ax,-0x14(%ebp)
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jg     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x304>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
...
-mov    %ebx,%eax
-lea    -0xc(%ebp),%esp
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x316>
+mov    -0x2c(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    0x8(%ebp),%eax
+mov    %eax,(%esp)
...

{
  ...
  CGuard<CMutex>::CGuard(local_54,(CMutex *)(this + 0xe8));
                    /* try { // try from 08053487 to 080534ab has its CatchHandler @ 080534b8 */
