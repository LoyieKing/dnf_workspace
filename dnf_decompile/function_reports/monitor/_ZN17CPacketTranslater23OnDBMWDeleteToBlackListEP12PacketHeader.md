...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8086350` | `0x269` | `0x8071b58` | `0x27b` |
...
-mov    -0x10(%ebp),%eax
-mov    0xa(%eax),%eax
+jmp    <T> <_ZN17CPacketTranslater23OnDBMWDeleteToBlackListEP12PacketHeader+0x274>
+mov    0x8(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN17CPacketTranslater23OnDBMWDeleteToBlackListEP12PacketHeader+0xad>
 movl   $0xd70,0x8(%esp)
 movl   $"OnDBMWDeleteToBlackList",0x4(%esp)
-lea    -0x2c(%ebp),%eax
+lea    -0x20(%ebp),%eax
...
-movb   $0x3,-0x35(%ebp)
-movzwl -0x63(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater23OnDBMWDeleteToBlackListEP12PacketHeader+0x11e>
+movb   $0x3,-0x31(%ebp)
+lea    -0x61(%ebp),%eax
+add    $0x2,%eax
+movzwl (%eax),%eax
...
-movb   $0x2,-0x35(%ebp)
-movzwl -0x63(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater23OnDBMWDeleteToBlackListEP12PacketHeader+0x16a>
+movb   $0x2,-0x31(%ebp)
+lea    -0x61(%ebp),%eax
+add    $0x2,%eax
+movzwl (%eax),%eax
...
+jne    <T> <_ZN17CPacketTranslater23OnDBMWDeleteToBlackListEP12PacketHeader+0x21a>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater23OnDBMWDeleteToBlackListEP12PacketHeader+0x213>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater23OnDBMWDeleteToBlackListEP12PacketHeader+0x26f>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
