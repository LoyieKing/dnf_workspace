...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8080fb0` | `0xc32` | `0x806cd52` | `0xc73` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1253 行）：
