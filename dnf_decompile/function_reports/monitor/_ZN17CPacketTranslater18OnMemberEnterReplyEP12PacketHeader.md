...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8080fb0` | `0xc32` | `0x806cd62` | `0xc18` |
...
+je     <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0xc0d>
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+add    $0x10,%eax
+mov    %eax,-0x40(%ebp)
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
-mov    -0x40(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0xc0d>
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0xa7b>
 mov    -0x38(%ebp),%eax
 movzbl 0x12(%eax),%eax
 cmp    $0x2,%al
-jne    <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0x315>
+jne    <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0x276>
 movl   $0x0,0x18(%esp)
 movl   $0x0,0x14(%esp)
 movl   $0x0,0x10(%esp)
 movl   $0x0,0xc(%esp)
...
-mov    -0x3c(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0x525>
+mov    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser11GetCharNameEv>
 mov    %eax,0x8(%esp)
...
+mov    %eax,-0x24(%ebp)
+cmpl   $0x0,-0x24(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0x9e8>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    0xa0(%eax),%eax
 mov    %eax,-0x20(%ebp)
 cmpl   $0x0,-0x20(%ebp)
...
+je     <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0xc0d>
+cmpl   $0x0,-0x2c(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0x58c>
+mov    -0x30(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    -0x3c(%ebp),%eax
+mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0x95d>
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser8GetLevelEv>
 cwtl
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0x8d2>
+mov    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser13GetUniqCharNoEv>
 movl   $0x1,0xc(%esp)
...
+setl   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0x815>
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0xba7>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0xba0>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnMemberEnterReplyEP12PacketHeader+0xc08>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1238 行）：
