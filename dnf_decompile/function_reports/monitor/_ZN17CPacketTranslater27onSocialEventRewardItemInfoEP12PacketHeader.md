...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808ffb6` | `0x40f` | `0x807b4d0` | `0x406` |
...
+jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x320>
 lea    -0x51(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+jne    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x252>
 mov    -0x28(%ebp),%eax
 mov    0x12(%eax),%esi
 mov    -0x28(%ebp),%eax
 mov    0xe(%eax),%eax
...
+jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x1f8>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x1f2>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x217>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x217>
 lea    -0x48(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-mov    %ebx,%eax
-jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x329>
+jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x22f>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x217>
...
+jg     <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x28e>
+mov    0x8(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    -0x24(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser17SendTcpGameserverEP12PacketHeader>
+jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x3fe>
 mov    -0x28(%ebp),%eax
 movl   $0x0,0x1a(%eax)
 mov    -0x20(%ebp),%edx
 mov    -0x28(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x3a0>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x399>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jmp    <T> <_ZN17CPacketTranslater27onSocialEventRewardItemInfoEP12PacketHeader+0x3f9>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5079 行）：
