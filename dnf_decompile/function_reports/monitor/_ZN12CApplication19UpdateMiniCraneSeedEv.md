...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8065eec` | `0x81` | `0x8053a0a` | `0x46` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFApplication.cpp](source/DNFServer/GameServer/Monitor/DNFApplication.cpp)（约第 1093 行）：
