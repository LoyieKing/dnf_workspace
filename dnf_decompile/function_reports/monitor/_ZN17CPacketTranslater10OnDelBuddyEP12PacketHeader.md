...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8087c3e` | `0x234` | `0x8072fb6` | `0x229` |
...
-mov    %eax,-0x14(%ebp)
-mov    -0x18(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater10OnDelBuddyEP12PacketHeader+0x222>
+mov    0x8(%ebp),%eax
 mov    0xa(%eax),%eax
...
+mov    %eax,-0x18(%ebp)
+cmpl   $0x0,-0x18(%ebp)
+jne    <T> <_ZN17CPacketTranslater10OnDelBuddyEP12PacketHeader+0xab>
+movl   $0x1092,0x8(%esp)
+movl   $&_ZZN17CPacketTranslater10OnDelBuddyEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
+lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x6d(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater10OnDelBuddyEP12PacketHeader+0x222>
+lea    -0x69(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater10OnDelBuddyEP12PacketHeader+0x1c8>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater10OnDelBuddyEP12PacketHeader+0x1c1>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater10OnDelBuddyEP12PacketHeader+0x21d>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2804 行）：
