...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809af94` | `0x50` | `0x8061c92` | `0x48` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 173 行）：
