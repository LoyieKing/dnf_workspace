...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806d85c` | `0xa8` | `0x80899a6` | `0xa1` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUser.cpp](source/DNFServer/GameServer/Monitor/DNFUser.cpp)（约第 526 行）：
