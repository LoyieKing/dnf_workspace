...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a97b4` | `0x1e` | `0x80a77e6` | `0x25` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 392 行）：
