...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807a4d8` | `0x98` | `0x808064e` | `0xa2` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFServerHandler.cpp](source/DNFServer/GameServer/Monitor/DNFServerHandler.cpp)（约第 226 行）：
