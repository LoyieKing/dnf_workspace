# _ZN12CApplication22AddChattableUserWithGMEjj

`CApplication::AddChattableUserWithGM(unsigned int, unsigned int)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| monitor | DIFF | `0x8065660` | `0x115` | `0x8052aca` | `0x115` |
...
+lea    -0x20(%ebp),%eax
 ...
 test   %al,%al
 je     <T> <_ZN12CApplication22AddChattableUserWithGMEjj+0x113>
-lea    -0x1c(%ebp),%eax
+lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
+lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNKSt14_List_iteratorIjEeqERKS0_>
 test   %al,%al
 je     <T> <_ZN12CApplication22AddChattableUserWithGMEjj+0x113>
-lea    -0x1c(%ebp),%eax
+lea    -0x20(%ebp),%eax
 ...
 mov    %eax,0x4(%esp)
 mov    %edx,(%esp)
 call   <T> <_ZNSt4listIjSaIjEE9push_backERKj>
 leave
 ret
```
## 2. Ghidra 反编译 C
...
void CApplication::_ZN12CApplication22AddChattableUserWithGMEjj(uint param_1,uint param_2)
