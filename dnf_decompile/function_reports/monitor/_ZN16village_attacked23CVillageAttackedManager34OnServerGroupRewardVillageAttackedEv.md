...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a931c` | `0x258` | `0x80a85bc` | `0x17a` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 492 行）：
