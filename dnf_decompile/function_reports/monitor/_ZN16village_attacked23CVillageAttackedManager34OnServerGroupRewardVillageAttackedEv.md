...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a931c` | `0x258` | `0x80a864a` | `0x258` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 474 行）：
