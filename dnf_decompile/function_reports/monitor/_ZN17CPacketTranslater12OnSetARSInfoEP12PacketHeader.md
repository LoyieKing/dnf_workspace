...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808cce0` | `0x252` | `0x8078076` | `0x252` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 4162 行）：
