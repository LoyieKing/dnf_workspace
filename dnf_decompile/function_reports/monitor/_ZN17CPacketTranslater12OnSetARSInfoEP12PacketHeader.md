...
|---|---|---|---|---|---|
| monitor | NEAR | `0x808cce0` | `0x252` | `0x807817e` | `0x252` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 4194 行）：
