...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804d774` | `0x150` | `0x8065062` | `0x161` |
...
-imul   $0x1804,%eax,%eax
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI14CTcpRecvBufferE5allocEv+0x9c>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
-imul   $0x1804,%edx,%edx
...
+jne    <T> <_ZN7MemPoolI14CTcpRecvBufferE5allocEv+0x6c>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x601,%eax,%eax
