...
|---|---|---|---|---|---|
| monitor | NEAR | `0x8086f12` | `0x1aa` | `0x8072a0a` | `0x1aa` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2708 行）：
