...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807fe66` | `0x210` | `0x806bec6` | `0x20d` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 894 行）：
