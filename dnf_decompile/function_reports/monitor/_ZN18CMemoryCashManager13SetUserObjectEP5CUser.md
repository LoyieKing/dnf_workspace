# _ZN18CMemoryCashManager13SetUserObjectEP5CUser

`CMemoryCashManager::SetUserObject(CUser*)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a0e78` | `0xb8` | `0x8098086` | `0xd6` |
...
+lea    -0x1c(%ebp),%eax
 ...
 test   %al,%al
-je     <T> <_ZN18CMemoryCashManager13SetUserObjectEP5CUser+0xb1>
-lea    -0x18(%ebp),%eax
+je     <T> <_ZN18CMemoryCashManager13SetUserObjectEP5CUser+0xaa>
+lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
 ...
 mov    0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser15GetMapBlackListEv>
 mov    %eax,0x4(%esp)
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN11CCashObject19SetBlackUsersObjectERSt3mapIjP10CBlackUserSt4lessIjESaISt4pairIKjS2_EEE>
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN18CMemoryCashManager19incBlackListCashCntEv>
 movl   $0x5,0x4(%esp)
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN11CCashObject11SetLifeTimeEj>
-mov    $0x1,%eax
-jmp    <T> <_ZN18CMemoryCashManager13SetUserObjectEP5CUser+0xb6>
-mov    $0x0,%eax
+mov    0x8(%ebp),%eax
+lea    0x18(%eax),%edx
+lea    -0x10(%ebp),%eax
...
bool __thiscall
CMemoryCashManager::_ZN18CMemoryCashManager13SetUserObjectEP5CUser
...

{
  ...
  if (cVar1 != '\0') {
    ...
    pmVar3 = (map *)CUser::GetMapBlackList(param_1);
    CCashObject::SetBlackUsersObject(local_10,pmVar3);
    incBlackListCashCnt(this);
    CCashObject::_ZN11CCashObject11SetLifeTimeEj(local_10,5);
  }
  return cVar1 != '\0';
}
```
