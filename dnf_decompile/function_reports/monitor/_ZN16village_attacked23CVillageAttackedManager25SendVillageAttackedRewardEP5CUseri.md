...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a9858` | `0x52` | `0x80a7b1c` | `0x4f` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 431 行）：
