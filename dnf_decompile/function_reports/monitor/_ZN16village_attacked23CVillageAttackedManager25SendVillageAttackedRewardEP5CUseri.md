# _ZN16village_attacked23CVillageAttackedManager25SendVillageAttackedRewardEP5CUseri

`village_attacked::CVillageAttackedManager::SendVillageAttackedReward(CUser*, int)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a9858` | `0x52` | `0x80a7934` | `0x4f` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 430 行）：
