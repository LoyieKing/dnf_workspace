...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806da5c` | `0x13d` | `0x80896a6` | `0x146` |
...
+je     <T> <_ZN5CUser12GetBlackListERhP17STBlackUserDBType+0x141>
 mov    0x8(%ebp),%eax
 lea    0x50(%eax),%edx
 lea    -0x10(%ebp),%eax
 mov    %edx,0x4(%esp)
...
+jmp    <T> <_ZN5CUser12GetBlackListERhP17STBlackUserDBType+0x10c>
 lea    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
+ja     <T> <_ZN5CUser12GetBlackListERhP17STBlackUserDBType+0x140>
 lea    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN5CUser12GetBlackListERhP17STBlackUserDBType+0x141>
 nop
 mov    -0x4(%ebp),%ebx
 leave
 ret
