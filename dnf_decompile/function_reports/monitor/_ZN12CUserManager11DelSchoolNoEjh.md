...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8072324` | `0x1a1` | `0x808ce72` | `0x194` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 688 行）：
