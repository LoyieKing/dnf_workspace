...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8086b34` | `0x3de` | `0x807244e` | `0x40c` |
...
+mov    %eax,-0x68(%ebp)
+cmpl   $0x0,-0x68(%ebp)
+je     <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x402>
+mov    -0x68(%ebp),%eax
+mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x1d3>
+mov    -0x6c(%ebp),%eax
+mov    %eax,(%esp)
...
+je     <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x14e>
 mov    -0x44(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser9GetMemberEv>
+mov    %eax,-0x38(%ebp)
...
+mov    %eax,-0x54(%ebp)
+jmp    <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x31a>
+subl   $0x1,-0x58(%ebp)
+mov    -0x54(%ebp),%eax
+mov    (%eax),%eax
+mov    %eax,0x4(%esp)
...
+mov    %eax,-0x28(%ebp)
+cmpl   $0x0,-0x28(%ebp)
+je     <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x312>
+mov    -0x6c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN14CMemberManager17GetMemberExpTableEv>
+mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+jne    <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x1fb>
+jmp    <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x402>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x377>
+jne    <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x3a8>
 mov    %eax,(%esp)
...
-mov    %eax,%ebx
 movl   $0xf29,0x8(%esp)
 movl   $"OnNoticeCharLiveOnTenMin",0x4(%esp)
-lea    -0x54(%ebp),%eax
+lea    -0x78(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x3a1>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater24OnNoticeCharLiveOnTenMinEP12PacketHeader+0x3fd>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2565 行）：
