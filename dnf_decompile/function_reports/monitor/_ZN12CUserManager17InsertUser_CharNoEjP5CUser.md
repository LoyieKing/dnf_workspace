...
|---|---|---|---|---|---|
| monitor | NEAR | `0x8071204` | `0xdf` | `0x808c298` | `0xdf` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 439 行）：
