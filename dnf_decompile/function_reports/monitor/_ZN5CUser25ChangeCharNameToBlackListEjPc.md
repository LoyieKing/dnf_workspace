...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806d904` | `0x9d` | `0x8088de8` | `0x93` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUser.cpp](source/DNFServer/GameServer/Monitor/DNFUser.cpp)（约第 214 行）：
