...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80903c6` | `0x371` | `0x807b954` | `0x376` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5105 行）：
