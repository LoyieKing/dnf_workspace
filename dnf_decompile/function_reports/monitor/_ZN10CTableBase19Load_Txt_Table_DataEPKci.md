...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8062678` | `0xda` | `0x808420c` | `0xeb` |
...
+movl   $0x0,-0xc(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x3c>
+movl   $0xffffffff,-0xc(%ebp)
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xe6>
+nop
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x3c>
+nop
+mov    -0x10(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <feof>
+test   %eax,%eax
+jne    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x73>
+mov    -0x10(%ebp),%eax
+mov    %eax,0x8(%esp)
+movl   $0x400,0x4(%esp)
+lea    -0x410(%ebp),%eax
...
+call   <T> <fgets>
+test   %eax,%eax
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x73>
+mov    $0x1,%eax
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x78>
+mov    $0x0,%eax
 test   %al,%al
-je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x86>
-mov    $0xffffffff,%eax
-jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xd8>
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xda>
 movzbl -0x410(%ebp),%eax
 cmp    $0x23,%al
-je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x85>
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x38>
+mov    0x10(%ebp),%eax
+cmp    -0xc(%ebp),%eax
+jg     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xa1>
 mov    -0x10(%ebp),%eax
-cmp    0x10(%ebp),%eax
...
+call   <T> <fclose>
 mov    $0xfffffffe,%eax
-jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xd8>
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xe9>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 add    $0xc,%eax
 mov    (%eax),%edx
...
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x3b>
+addl   $0x1,-0xc(%ebp)
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x3c>
 nop
-mov    -0xc(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFTableBase.cpp](source/DNFServer/GameServer/Monitor/DNFTableBase.cpp)（约第 53 行）：
