...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8086942` | `0x1f1` | `0x80723c4` | `0x200` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2564 行）：
