...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a98aa` | `0x59` | `0x80a7e4e` | `0x56` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 463 行）：
