# _ZNK12CUserManager15FindUser_CharNoEj

`CUserManager::FindUser_CharNo(unsigned int) const`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| monitor | DIFF | `0x80713a0` | `0x6a` | `0x808b12c` | `0x7f` |
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZNK12CUserManager15FindUser_CharNoEj+0x78>
 mov    0x8(%ebp),%eax
 lea    0x30(%eax),%ecx
 lea    -0x10(%ebp),%eax
 lea    0xc(%ebp),%edx
 ...
 mov    %ecx,0x4(%esp)
 mov    %eax,(%esp)
 call   <T> <_ZNKSt3mapIKjP5CUserSt4lessIS0_ESaISt4pairIS0_S2_EEE4findERS0_>
 sub    $0x4,%esp
 mov    0x8(%ebp),%eax
 lea    0x30(%eax),%edx
 lea    -0xc(%ebp),%eax
 mov    %edx,0x4(%esp)
 mov    %eax,(%esp)
 call   <T> <_ZNKSt3mapIKjP5CUserSt4lessIS0_ESaISt4pairIS0_S2_EEE3endEv>
 sub    $0x4,%esp
 lea    -0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
 lea    -0x10(%ebp),%eax
...
+call   <T> <_ZNKSt23_Rb_tree_const_iteratorISt4pairIKjP5CUserEEneERKS5_>
 test   %al,%al
-je     <T> <_ZNK12CUserManager15FindUser_CharNoEj+0x5a>
-mov    $0x0,%eax
-jmp    <T> <_ZNK12CUserManager15FindUser_CharNoEj+0x68>
+je     <T> <_ZNK12CUserManager15FindUser_CharNoEj+0x78>
 lea    -0x10(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNKSt23_Rb_tree_const_iteratorISt4pairIKjP5CUserEEptEv>
 mov    0x4(%eax),%eax
+jmp    <T> <_ZNK12CUserManager15FindUser_CharNoEj+0x7d>
+mov    $0x0,%eax
 leave
 ret
```
...
undefined4 CUserManager::_ZNK12CUserManager15FindUser_CharNoEj(uint param_1)
