...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804c572` | `0x8f` | `0x8083e66` | `0x7a` |
...
-mov    -0x10(%ebp),%eax
-or     $0x20000000,%eax
+jne    <T> <_ZN17CSignalTranslator13regist_signalEiPFviE+0x2d>
+mov    $0x20000000,%eax
+jmp    <T> <_ZN17CSignalTranslator13regist_signalEiPFviE+0x32>
+mov    $0x10000000,%eax
 mov    %eax,-0x10(%ebp)
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0xc(%ebp)
+jns    <T> <_ZN17CSignalTranslator13regist_signalEiPFviE+0x70>
 mov    0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
-movl   $"%d번 signal 등록 실패\n",(%esp)
+movl   $"regist signal error %d\n",(%esp)
 call   <T> <printf>
-mov    $0x0,%eax
