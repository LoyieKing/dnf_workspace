...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809e1e2` | `0x13a` | `0x806624e` | `0x143` |
...
+jmp    <T> <_ZN7MemPoolI6CBuddyE5allocEv+0x13c>
...
+jmp    <T> <_ZN7MemPoolI6CBuddyE5allocEv+0x139>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
...
+jmp    <T> <_ZN7MemPoolI6CBuddyE5allocEv+0x85>
 mov    -0xc(%ebp),%eax
-imul   $0x2c,%eax,%eax
-add    -0x10(%ebp),%eax
+imul   $0x2c,%eax,%edx
