...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809e1e2` | `0x13a` | `0x80661a8` | `0x162` |
...
+jmp    <T> <_ZN7MemPoolI6CBuddyE5allocEv+0x9a>
+mov    -0x10(%ebp),%ecx
 mov    -0xc(%ebp),%eax
-imul   $0x2c,%eax,%eax
-add    -0x10(%ebp),%eax
...
+jne    <T> <_ZN7MemPoolI6CBuddyE5allocEv+0x68>
+mov    -0x10(%ebp),%ecx
 mov    0x8(%ebp),%eax
-mov    0x4(%eax),%eax
+mov    0x4(%eax),%edx
...
+movl   $0x0,(%eax)
 ...
 mov    (%eax),%ebx
 movl   $0x7d,0x8(%esp)
 movl   $&_ZZN7MemPoolI6CBuddyE5allocEvE12__FUNCTION__,0x4(%esp)
 lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
