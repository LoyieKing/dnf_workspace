# _ZN7MemPoolI6CBuddyE4freeEPvj

`MemPool<CBuddy>::free(void*, unsigned int)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| monitor | NEAR | `0x809e31c` | `0x42` | `0x8066102` | `0x42` |
...
@@ -1,24 +1,24 @@
 ...
 sub    $0x28,%esp
 cmpl   $0x0,0xc(%ebp)
 je     <T> <_ZN7MemPoolI6CBuddyE4freeEPvj+0x3f>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 cmp    0x10(%ebp),%eax
 je     <T> <_ZN7MemPoolI6CBuddyE4freeEPvj+0x23>
 mov    0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZdlPv>
 jmp    <T> <_ZN7MemPoolI6CBuddyE4freeEPvj+0x40>
 mov    0xc(%ebp),%eax
 mov    %eax,-0xc(%ebp)
+mov    -0xc(%ebp),%eax
...
void __thiscall
MemPool<CBuddy>::_ZN7MemPoolI6CBuddyE4freeEPvj(MemPool<CBuddy> *this,void *param_1,uint param_2)
