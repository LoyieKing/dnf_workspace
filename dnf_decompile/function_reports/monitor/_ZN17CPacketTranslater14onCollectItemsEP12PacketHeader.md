...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8090f48` | `0x390` | `0x807c47a` | `0x3b5` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5365 行）：
