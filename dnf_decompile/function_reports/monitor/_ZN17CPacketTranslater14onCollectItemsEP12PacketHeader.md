...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8090f48` | `0x390` | `0x807c364` | `0x3a2` |
...
+jmp    <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x2c4>
 lea    -0x31(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+setb   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x39a>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    %eax,(%esp)
 call   <T> <_ZN12CApplication15getCollectItemsEv>
 mov    0x4(%eax),%eax
...
+je     <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x169>
 mov    -0x20(%ebp),%eax
 movzbl 0x1a(%eax),%eax
 movzbl %al,%ecx
 mov    -0x20(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x294>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    %eax,(%esp)
 call   <T> <_ZN12CApplication15getCollectItemsEv>
 mov    0x4(%eax),%edx
...
+je     <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x1f7>
 mov    -0x20(%ebp),%eax
 movzbl 0x1a(%eax),%eax
 movzbl %al,%ecx
 mov    -0x20(%ebp),%eax
...
+je     <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x294>
 mov    -0x20(%ebp),%eax
 movzbl 0x1a(%eax),%eax
 movzbl %al,%ecx
 mov    -0x20(%ebp),%eax
...
+lea    (%edx,%eax,1),%eax
+mov    %eax,0x4(%ebx)
+jmp    <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x39a>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x32b>
+jne    <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x340>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x339>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater14onCollectItemsEP12PacketHeader+0x395>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
