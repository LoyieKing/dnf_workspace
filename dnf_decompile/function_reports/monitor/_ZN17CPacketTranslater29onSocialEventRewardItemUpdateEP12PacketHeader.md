...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8090738` | `0x2ac` | `0x807bd94` | `0x2d8` |
...
-lea    -0x39(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater29onSocialEventRewardItemUpdateEP12PacketHeader+0x1fc>
+lea    -0x35(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+mov    (%eax),%eax
+test   %eax,%eax
+jne    <T> <_ZN17CPacketTranslater29onSocialEventRewardItemUpdateEP12PacketHeader+0x1db>
+mov    0x8(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
+mov    %eax,-0x30(%ebp)
...
-mov    0xe(%eax),%ebx
 movl   $0x1e46,0x8(%esp)
 movl   $"onSocialEventRewardItemUpdate",0x4(%esp)
-lea    -0x38(%ebp),%eax
+lea    -0x58(%ebp),%eax
 mov    %eax,(%esp)
...
-jmp    <T> <_ZN17CPacketTranslater29onSocialEventRewardItemUpdateEP12PacketHeader+0x2a4>
+jmp    <T> <_ZN17CPacketTranslater29onSocialEventRewardItemUpdateEP12PacketHeader+0x2d0>
+mov    0x8(%ebp),%ebx
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN12CApplication25getLimitNpcBuyItemManagerEv>
...
+jne    <T> <_ZN17CPacketTranslater29onSocialEventRewardItemUpdateEP12PacketHeader+0x276>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater29onSocialEventRewardItemUpdateEP12PacketHeader+0x26f>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater29onSocialEventRewardItemUpdateEP12PacketHeader+0x2cb>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5074 行）：
