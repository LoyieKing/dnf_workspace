...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8090738` | `0x2ac` | `0x807bbe8` | `0x2ce` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5143 行）：
