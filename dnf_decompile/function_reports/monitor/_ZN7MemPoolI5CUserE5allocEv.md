...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806e72a` | `0x150` | `0x80659cc` | `0x15b` |
...
+je     <T> <_ZN7MemPoolI5CUserE5allocEv+0x4a>
 mov    -0x14(%ebp),%eax
-mov    0xb8(%eax),%eax
+add    $0xb8,%eax
+mov    (%eax),%eax
...
-imul   $0xbc,%eax,%eax
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI5CUserE5allocEv+0x99>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
-imul   $0xbc,%edx,%edx
...
+jne    <T> <_ZN7MemPoolI5CUserE5allocEv+0x6c>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x2f,%eax,%eax
