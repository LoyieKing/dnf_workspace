...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806e72a` | `0x150` | `0x80656f0` | `0x15b` |
...
-imul   $0xbc,%eax,%eax
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI5CUserE5allocEv+0x9a>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
-imul   $0xbc,%edx,%edx
...
+jne    <T> <_ZN7MemPoolI5CUserE5allocEv+0x6d>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x2f,%eax,%eax
