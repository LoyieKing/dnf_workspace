...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809821a` | `0xcb` | `0x80607f8` | `0xcd` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMember.cpp](source/DNFServer/GameServer/Monitor/DNFMember.cpp)（约第 282 行）：
