...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8070c7c` | `0x2f9` | `0x808b492` | `0x2fa` |
...
+jmp    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x2f5>
 mov    0x8(%ebp),%eax
 lea    0x30(%eax),%edx
-lea    -0x2c(%ebp),%eax
+lea    -0x20(%ebp),%eax
...
-lea    -0x34(%ebp),%eax
+jmp    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x2be>
+lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjP5CUserEEptEv>
 mov    0x4(%eax),%eax
...
+je     <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x2b3>
 mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x27f>
 mov    -0x10(%ebp),%ebx
 test   %ebx,%ebx
