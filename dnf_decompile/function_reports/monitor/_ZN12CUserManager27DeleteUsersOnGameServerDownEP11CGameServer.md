...
+sub    $0x4,%esp
+jmp    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0xb9>
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjP5CUserEEptEv>
+mov    0x4(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x71>
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjP5CUserEEptEv>
+mov    0x4(%eax),%eax
...
+cmp    0xc(%ebp),%eax
+jne    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x71>
+mov    $0x1,%eax
+jmp    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x76>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0xae>
+lea    -0x24(%ebp),%eax
+movl   $0x0,0x8(%esp)
+lea    -0x20(%ebp),%edx
+mov    %edx,0x4(%esp)
...
+sub    $0x4,%esp
+jmp    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x181>
+lea    -0x28(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKSsP5CUserEEptEv>
+mov    0x4(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x139>
+lea    -0x28(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKSsP5CUserEEptEv>
+mov    0x4(%eax),%eax
...
+call   <T> <_ZN5CUser13GetGameServerEv>
+cmp    0xc(%ebp),%eax
+jne    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x139>
+mov    $0x1,%eax
+jmp    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x13e>
+mov    $0x0,%eax
+test   %al,%al
...
+test   %al,%al
+jne    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x105>
+mov    0x8(%ebp),%eax
+lea    0x18(%eax),%edx
+lea    -0x30(%ebp),%eax
+mov    %edx,0x4(%esp)
