...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807193a` | `0x1d0` | `0x808be94` | `0x19a` |
...
+je     <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0x2a>
 mov    $0x0,%eax
-jmp    <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0x1c8>
+jmp    <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0x193>
 mov    0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0x18e>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %al,-0xa(%ebp)
+cmpb   $0xff,-0xa(%ebp)
+je     <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0xcd>
+movzbl -0xa(%ebp),%eax
+cmp    -0x2c(%ebp),%al
+je     <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0xcd>
+movl   $0x2c7,0x8(%esp)
+movl   $"DeleteProhibitUser",0x4(%esp)
+lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
-call   <T> <_ZN16CDNFProhibitUser12GetChannelNoEv>
-cmp    -0x3c(%ebp),%al
...
+mov    %al,-0x9(%ebp)
+cmpb   $0x0,-0x9(%ebp)
+je     <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0x14b>
+cmpb   $0xff,-0x2c(%ebp)
+je     <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0x14b>
+movl   $0x2ce,0x8(%esp)
+movl   $"DeleteProhibitUser",0x4(%esp)
...
+je     <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0x18e>
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN12CUserManager18DeleteProhibitUserEjc+0x187>
+mov    -0x10(%ebp),%ebx
 test   %ebx,%ebx
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 385 行）：
