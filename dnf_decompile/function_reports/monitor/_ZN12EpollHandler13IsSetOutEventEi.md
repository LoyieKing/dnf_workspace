...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804ef70` | `0x24` | `0x80a1bf2` | `0x26` |
...
定义于 [source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp](source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp)（约第 120 行）：
