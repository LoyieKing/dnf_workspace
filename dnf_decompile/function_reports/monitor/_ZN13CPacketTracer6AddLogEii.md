...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807da7c` | `0xdf` | `0x8069090` | `0xbc` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTracer.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTracer.cpp)（约第 37 行）：
