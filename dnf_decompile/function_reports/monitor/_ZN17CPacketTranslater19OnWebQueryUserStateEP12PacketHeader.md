...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8085164` | `0x2c3` | `0x806fac6` | `0x2e8` |
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x46>
+mov    0x8(%ebp),%eax
+add    $0x12,%eax
+movb   $0x0,(%eax)
...
-mov    -0x28(%ebp),%eax
-mov    0xa(%eax),%eax
+jne    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x63>
+mov    $"true",%eax
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x68>
+mov    $"false",%eax
+mov    %eax,-0x2c(%ebp)
+mov    0x8(%ebp),%eax
+add    $0xa,%eax
...
+mov    %eax,-0x28(%ebp)
 movl   $0xb78,0x8(%esp)
 movl   $"OnWebQueryUserState",0x4(%esp)
-lea    -0x48(%ebp),%eax
+lea    -0x44(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x39(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x2e0>
+lea    -0x35(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
...
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x1ad>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x1a7>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x19d>
+jne    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x1c4>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%eax
 mov    %ebx,%edx
-jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x19d>
-lea    -0x40(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x1c4>
+lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x1b2>
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x1d9>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x19d>
+jne    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x1c4>
 call   <T> <_ZSt9terminatev>
...
-lea    -0x39(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x1fc>
+lea    -0x35(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+jne    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x27e>
 mov    %eax,(%esp)
...
+call   *%eax
+mov    %eax,0x10(%esp)
 movl   $"OnWebQueryUserState",0xc(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x277>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x2e0>
 mov    %eax,(%esp)
 call   <T> <__cxa_begin_catch>
 movl   $0xb84,0x8(%esp)
 movl   $"OnWebQueryUserState",0x4(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater19OnWebQueryUserStateEP12PacketHeader+0x2db>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1864 行）：
