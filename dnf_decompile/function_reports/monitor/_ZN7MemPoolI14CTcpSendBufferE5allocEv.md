...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804d960` | `0x150` | `0x8065128` | `0x161` |
...
-imul   $0x1804,%eax,%eax
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI14CTcpSendBufferE5allocEv+0x9d>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
-imul   $0x1804,%edx,%edx
...
+jne    <T> <_ZN7MemPoolI14CTcpSendBufferE5allocEv+0x6d>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x601,%eax,%eax
