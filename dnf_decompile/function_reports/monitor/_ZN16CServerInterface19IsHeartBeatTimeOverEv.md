...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807c2a8` | `0x58` | `0x80828dc` | `0x5a` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFServerInterface.cpp](source/DNFServer/GameServer/Monitor/DNFServerInterface.cpp)（约第 92 行）：
