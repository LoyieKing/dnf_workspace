...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a127a` | `0x293` | `0x8097a44` | `0x292` |
...
定义于 [source/DNFServer/GameServer/Monitor/MemoryCashManager.cpp](source/DNFServer/GameServer/Monitor/MemoryCashManager.cpp)（约第 76 行）：
