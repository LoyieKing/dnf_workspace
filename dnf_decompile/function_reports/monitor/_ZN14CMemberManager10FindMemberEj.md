# _ZN14CMemberManager10FindMemberEj

`CMemberManager::FindMember(unsigned int)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| monitor | DIFF | `0x8099be0` | `0x94` | `0x806223c` | `0x7f` |
...
+xor    $0x1,%eax
 test   %al,%al
-je     <T> <_ZN14CMemberManager10FindMemberEj+0x2a>
-mov    $0x0,%eax
-jmp    <T> <_ZN14CMemberManager10FindMemberEj+0x92>
+je     <T> <_ZN14CMemberManager10FindMemberEj+0x78>
 mov    0x8(%ebp),%eax
 lea    0x8(%eax),%ecx
-lea    -0x1c(%ebp),%eax
+lea    -0x10(%ebp),%eax
...
-lea    -0xc(%ebp),%eax
 ...
 test   %al,%al
-je     <T> <_ZN14CMemberManager10FindMemberEj+0x8d>
+je     <T> <_ZN14CMemberManager10FindMemberEj+0x78>
 lea    -0x10(%ebp),%eax
 mov    %eax,(%esp)
 ...
 mov    0x4(%eax),%eax
-jmp    <T> <_ZN14CMemberManager10FindMemberEj+0x92>
+jmp    <T> <_ZN14CMemberManager10FindMemberEj+0x7d>
 mov    $0x0,%eax
 leave
 ret
```
...
undefined4 CMemberManager::_ZN14CMemberManager10FindMemberEj(uint param_1)
