...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804ef94` | `0x1f` | `0x80a1bd0` | `0x21` |
...
定义于 [source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp](source/DNFServer/GameServer/Monitor/TcpNetSystem.cpp)（约第 115 行）：
