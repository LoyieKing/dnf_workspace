...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807a03e` | `0x122` | `0x8080b2c` | `0x122` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFServerHandler.cpp](source/DNFServer/GameServer/Monitor/DNFServerHandler.cpp)（约第 367 行）：
