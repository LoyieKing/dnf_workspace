...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8080846` | `0x76a` | `0x806c606` | `0x778` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1031 行）：
