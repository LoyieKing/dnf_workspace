...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8099e1c` | `0x14a` | `0x8061c42` | `0x14a` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 93 行）：
