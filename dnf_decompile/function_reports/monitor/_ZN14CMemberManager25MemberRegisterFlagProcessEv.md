...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809a37e` | `0x118` | `0x8061a82` | `0x117` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 62 行）：
