...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8084332` | `0x28a` | `0x806f746` | `0x29a` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1937 行）：
