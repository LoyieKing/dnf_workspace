...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808ab4c` | `0x566` | `0x807619c` | `0x51f` |
...
+je     <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x514>
+mov    0x8(%ebp),%eax
+add    $0xa,%eax
+movzbl (%eax),%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x44>
...
-mov    -0x2c(%ebp),%ecx
+movl   $0x0,-0x2c(%ebp)
+jmp    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0xad>
+mov    0x8(%ebp),%ecx
+mov    -0x2c(%ebp),%edx
 mov    %edx,%eax
 shl    $0x3,%eax
...
+jbe    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0xa9>
+cmpl   $0xf423f,-0x28(%ebp)
+ja     <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0xa9>
+mov    0x8(%ebp),%ecx
+mov    -0x2c(%ebp),%edx
 mov    %edx,%eax
 shl    $0x3,%eax
...
-movzbl 0xa(%eax),%eax
-movzbl %al,%ebx
+jne    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x4d>
 movl   $0x14c2,0x8(%esp)
 movl   $"onItemLimitEditionLoadDataRpy",0x4(%esp)
-lea    -0x44(%ebp),%eax
+lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
...
+movzbl (%eax),%eax
+test   %al,%al
+jne    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x403>
 movl   $0x0,-0x24(%ebp)
-jmp    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x44a>
+jmp    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x3eb>
+mov    0x8(%ebp),%ecx
 mov    -0x24(%ebp),%edx
-mov    -0x2c(%ebp),%ecx
 mov    %edx,%eax
...
+je     <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x3e7>
+lea    -0x42(%ebp),%ecx
 mov    -0x24(%ebp),%edx
-lea    -0x833(%ebp),%ecx
 mov    %edx,%eax
...
+jne    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x375>
+jmp    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x41f>
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN12CApplication22getItemLimitEditionMgrEv>
+lea    -0x42(%ebp),%edx
...
+jmp    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x514>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x4fe>
+jne    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x4ba>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x4b3>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater29onItemLimitEditionLoadDataRpyEP12PacketHeader+0x50f>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3671 行）：
