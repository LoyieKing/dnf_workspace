...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80513d4` | `0x489` | `0x809b8b6` | `0x442` |
...
+je     <T> <_ZN5CPeer7parsingEi+0x105>
 mov    0x8(%ebp),%eax
 mov    0x181c(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    0x1820(%eax),%eax
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x9,-0x10(%ebp)
+jbe    <T> <_ZN5CPeer7parsingEi+0x147>
+cmpl   $0x1800,-0x10(%ebp)
+jbe    <T> <_ZN5CPeer7parsingEi+0x1d5>
 movl   $0xd0,0x8(%esp)
 movl   $"parsing",0x4(%esp)
-lea    -0x48(%ebp),%eax
-mov    %eax,(%esp)
...
+mov    -0x18(%ebp),%eax
+cmp    -0x10(%ebp),%eax
+jae    <T> <_ZN5CPeer7parsingEi+0x21f>
+movl   $0x100,0x8(%esp)
+movl   $"parsing",0x4(%esp)
+lea    -0x40(%ebp),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN5CPeer7parsingEi+0x2d0>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x64(%ebp),%eax
+lea    -0x44(%ebp),%eax
...
+cmpl   $0x0,-0x18(%ebp)
+je     <T> <_ZN5CPeer7parsingEi+0x33c>
+jmp    <T> <_ZN5CPeer7parsingEi+0x34d>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x68(%ebp),%eax
+lea    -0x48(%ebp),%eax
...
+setg   %al
+test   %al,%al
+jne    <T> <_ZN5CPeer7parsingEi+0xd9>
 movl   $0xf8,0x8(%esp)
 movl   $"parsing",0x4(%esp)
-lea    -0x40(%ebp),%eax
-mov    %eax,(%esp)
