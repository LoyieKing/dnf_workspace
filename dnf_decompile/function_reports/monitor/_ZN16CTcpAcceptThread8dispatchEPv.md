...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8059e70` | `0x405` | `0x8084466` | `0x40c` |
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x1c4>
 mov    0x8(%ebp),%eax
 add    $0x18,%eax
 mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x1c4>
 mov    0x8(%ebp),%eax
 mov    0xc(%eax),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x301>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x291>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x28b>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2a9>
+jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2b0>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%ecx
 mov    %ebx,%eax
-jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2a9>
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2b0>
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x2ec>
 lea    -0x29(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x394>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x38e>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3ac>
+jne    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3b3>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%ecx
 mov    %ebx,%eax
-jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3ac>
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3b3>
 lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
+jmp    <T> <_ZN16CTcpAcceptThread8dispatchEPv+0x3ef>
 lea    -0x21(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
 movl   $&_ZN13CDNFExceptionD1Ev,0x8(%esp)
