...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8088880` | `0x178` | `0x8073dc2` | `0x178` |
...
+mov    %eax,-0xc(%ebp)
+movl   $0x1197,0x8(%esp)
+movl   $"onRequestCharacTowerUpdateRank",0x4(%esp)
+lea    -0x2c(%ebp),%eax
+mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3076 行）：
