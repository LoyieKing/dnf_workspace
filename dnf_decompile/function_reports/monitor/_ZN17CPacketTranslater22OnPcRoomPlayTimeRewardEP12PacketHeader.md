...
|---|---|---|---|---|---|
| monitor | NEAR | `0x80916e4` | `0x1df` | `0x807ccbc` | `0x1df` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5394 行）：
