...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804f4ba` | `0x3a` | `0x80854f6` | `0x38` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFTcpSocket.cpp](source/DNFServer/GameServer/Monitor/DNFTcpSocket.cpp)（约第 103 行）：
