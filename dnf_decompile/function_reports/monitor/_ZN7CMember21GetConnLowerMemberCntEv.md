...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809916a` | `0x82` | `0x8060c8c` | `0x7d` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMember.cpp](source/DNFServer/GameServer/Monitor/DNFMember.cpp)（约第 447 行）：
