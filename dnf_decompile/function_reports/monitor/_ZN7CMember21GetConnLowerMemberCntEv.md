...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809916a` | `0x82` | `0x8060bb8` | `0x70` |
...
-movl   $0x0,-0x10(%ebp)
+test   %al,%al
+je     <T> <_ZN7CMember21GetConnLowerMemberCntEv+0x6b>
 movl   $0x0,-0xc(%ebp)
...
-add    $0x20,%eax
-mov    0xe(%eax),%edx
+jmp    <T> <_ZN7CMember21GetConnLowerMemberCntEv+0x57>
+mov    0x8(%ebp),%eax
+mov    -0xc(%ebp),%edx
+imul   $0x27,%edx,%edx
+add    $0x2e,%edx
...
+je     <T> <_ZN7CMember21GetConnLowerMemberCntEv+0x53>
 addl   $0x1,-0x10(%ebp)
