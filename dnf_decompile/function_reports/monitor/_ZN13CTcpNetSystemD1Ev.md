...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8052d38` | `0x28a` | `0x80a1e38` | `0x2c9` |
...
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x184>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x100,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x196>
+mov    0x8(%ebp),%eax
+add    $0x100,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x1b0>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xe8,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x1c2>
+mov    0x8(%ebp),%eax
+add    $0xe8,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x1dc>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
...
-mov    %eax,(%esp)
-call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x1ee>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt5queueIP14CTcpSendBufferSt5dequeIS1_SaIS1_EEED1Ev>
-jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x239>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x208>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xa8,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x21a>
+mov    0x8(%ebp),%eax
+add    $0xa8,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x234>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x90,%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x286>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x60,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x296>
+mov    0x8(%ebp),%eax
+add    $0x60,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexD1Ev>
+jmp    <T> <_ZN13CTcpNetSystemD1Ev+0x2b4>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x8,%eax
