...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806c66e` | `0x3c` | `0x809cae8` | `0x41` |
...
定义于 [source/DNFServer/GameServer/Monitor/ServerLoadChecker.cpp](source/DNFServer/GameServer/Monitor/ServerLoadChecker.cpp)（约第 31 行）：
