...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809ed88` | `0xaf` | `0x8057fe0` | `0x9b` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFBuddyHandle.cpp](source/DNFServer/GameServer/Monitor/DNFBuddyHandle.cpp)（约第 228 行）：
