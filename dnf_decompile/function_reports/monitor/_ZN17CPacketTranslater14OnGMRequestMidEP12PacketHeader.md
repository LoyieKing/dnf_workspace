...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80883f2` | `0x296` | `0x807368c` | `0x270` |
...
+mov    %eax,-0x14(%ebp)
+cmpl   $0x0,-0x14(%ebp)
+je     <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x269>
+lea    -0x32(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x129>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x34(%ebp),%eax
+lea    -0x20(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x114>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x2d(%ebp),%eax
+lea    -0x19(%ebp),%eax
...
-lea    -0x2d(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x195>
+lea    -0x19(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
-test   %bl,%bl
...
-movzwl -0x6e(%ebp),%eax
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x148>
+lea    -0x32(%ebp),%eax
+add    $0xe,%eax
+movl   $0xffffffff,(%eax)
+jmp    <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x16e>
+lea    -0x32(%ebp),%eax
+lea    0x12(%eax),%ebx
+mov    -0x10(%ebp),%eax
+mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x20f>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x208>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater14OnGMRequestMidEP12PacketHeader+0x264>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2964 行）：
