...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a8d40` | `0x3a5` | `0x80a8950` | `0x366` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 583 行）：
