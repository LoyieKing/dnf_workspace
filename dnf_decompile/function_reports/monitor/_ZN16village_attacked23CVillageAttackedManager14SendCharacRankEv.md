...
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x74>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x48(%ebp),%eax
+lea    -0x30(%ebp),%eax
...
-mov    %eax,-0x64(%ebp)
-lea    -0x60(%ebp),%eax
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0xd7>
+lea    -0x48(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjN16village_attacked14stHuntingPointEEEptEv>
 mov    0x4(%eax),%eax
...
-add    $0x1,%edx
-lea    -0x5c(%ebp),%eax
+jne    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x99>
+lea    -0x44(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsC1Ev>
 mov    0x8(%ebp),%eax
...
-lea    -0x58(%ebp),%eax
+ja     <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x2b6>
+movl   $0x0,-0x14(%ebp)
+movl   $0x0,-0x10(%ebp)
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x29d>
+lea    -0x40(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0xc(%ebp)
+jne    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x1f5>
+lea    -0x40(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,0x8(%esp)
-mov    -0x1c(%ebp),%eax
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x299>
+addl   $0x1,-0x14(%ebp)
+mov    -0x14(%ebp),%eax
+mov    %eax,0x8(%esp)
+mov    -0xc(%ebp),%eax
...
+je     <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x273>
 movl   $",",0x4(%esp)
-lea    -0x5c(%ebp),%eax
+lea    -0x44(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x58(%ebp),%eax
+cmpl   $0x2,-0x14(%ebp)
+jg     <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x2b5>
+addl   $0x1,-0x10(%ebp)
+lea    -0x40(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x16d>
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x2b6>
 nop
-lea    -0x1182(%ebp),%eax
-mov    %eax,(%esp)
-call   <T> <_ZN21Packet_DBMW_Query_MsgC1Ev>
...
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x328>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x5c(%ebp),%eax
+lea    -0x44(%ebp),%eax
...
-lea    -0x5c(%ebp),%eax
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x335>
+lea    -0x44(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x38c>
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x350>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x58(%ebp),%eax
+lea    -0x40(%ebp),%eax
...
+jmp    <T> <_ZN16village_attacked23CVillageAttackedManager14SendCharacRankEv+0x35e>
 nop
-lea    -0xc(%ebp),%esp
+lea    -0x8(%ebp),%esp
 add    $0x0,%esp
