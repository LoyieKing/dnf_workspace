# _ZN7MemPoolI7CMemberE5allocEv

`MemPool<CMember>::alloc()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| monitor | DIFF | `0x80997a6` | `0x150` | `0x8065bec` | `0x15b` |
...
@@ -1,93 +1,102 @@
 ...
 mov    (%eax),%eax
 cmp    $0x1c8,%eax
 je     <T> <_ZN7MemPoolI7CMemberE5allocEv+0x25>
 movl   $0x1c8,(%esp)
 call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x149>
+jmp    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x154>
 mov    &_ZN7MemPoolI7CMemberE15headOfFreeList_E,%eax
 mov    %eax,-0x14(%ebp)
 cmpl   $0x0,-0x14(%ebp)
-je     <T> <_ZN7MemPoolI7CMemberE5allocEv+0x46>
+je     <T> <_ZN7MemPoolI7CMemberE5allocEv+0x4a>
 mov    -0x14(%ebp),%eax
-mov    0x1c4(%eax),%eax
+add    $0x1c4,%eax
+mov    (%eax),%eax
 mov    %eax,&_ZN7MemPoolI7CMemberE15headOfFreeList_E
-jmp    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x146>
+mov    -0x14(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x154>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%edx
 ...
 mov    %eax,-0x10(%ebp)
 movl   $0x0,-0xc(%ebp)
-jmp    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x8d>
-mov    -0xc(%ebp),%eax
-imul   $0x1c8,%eax,%eax
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x99>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
-imul   $0x1c8,%edx,%edx
...
+mov    %eax,(%edx)
 ...
 seta   %al
 test   %al,%al
-jne    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x68>
+jne    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x6c>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x72,%eax,%eax
...
+movl   $0x0,(%eax)
 ...
 mov    (%eax),%ebx
 movl   $0x7d,0x8(%esp)
 movl   $&_ZZN7MemPoolI7CMemberE5allocEvE12__FUNCTION__,0x4(%esp)
 lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
void * __thiscall MemPool<CMember>::_ZN7MemPoolI7CMemberE5allocEv(MemPool<CMember> *this)
  ...
  if (*(int *)this == 0x1c8) {
    ...
    if (headOfFreeList_ == (void *)0x0) {
      ...
      for (local_10 = 0; local_10 < *(int *)(this + 4) - 1U; local_10 = local_10 + 1) {
        *(void **)((int)local_24 + local_10 * 0x1c8 + 0x1c4) =
             (void *)((local_10 + 1) * 0x1c8 + (int)local_24);
      }
      *(undefined4 *)((int)local_24 + (*(int *)(this + 4) + -1) * 0x1c8 + 0x1c4) = 0;
      headOfFreeList_ = (void *)((int)local_24 + 0x1c8);
      local_18 = local_24;
      local_14 = local_24;
      ...
      headOfFreeList_ = *(void **)((int)headOfFreeList_ + 0x1c4);
    }
  }
  else {
    local_18 = operator_new(0x1c8);
  }
  return local_18;
}
```
