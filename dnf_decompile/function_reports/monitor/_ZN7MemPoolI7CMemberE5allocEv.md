...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80997a6` | `0x150` | `0x80659ce` | `0x15b` |
...
-imul   $0x1c8,%eax,%eax
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x9a>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
-imul   $0x1c8,%edx,%edx
...
+jne    <T> <_ZN7MemPoolI7CMemberE5allocEv+0x6d>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x72,%eax,%eax
