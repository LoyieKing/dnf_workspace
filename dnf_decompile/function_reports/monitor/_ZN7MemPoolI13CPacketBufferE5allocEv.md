...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804db4c` | `0x150` | `0x80657b2` | `0x15b` |
...
+jmp    <T> <_ZN7MemPoolI13CPacketBufferE5allocEv+0x154>
...
+jmp    <T> <_ZN7MemPoolI13CPacketBufferE5allocEv+0x151>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
...
+jmp    <T> <_ZN7MemPoolI13CPacketBufferE5allocEv+0x93>
 mov    -0xc(%ebp),%eax
-imul   $0x1804,%eax,%eax
-add    -0x10(%ebp),%eax
+imul   $0x1804,%eax,%edx
