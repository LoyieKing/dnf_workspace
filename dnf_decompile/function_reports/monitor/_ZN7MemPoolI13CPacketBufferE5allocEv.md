...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804db4c` | `0x150` | `0x806540c` | `0x161` |
...
-imul   $0x1804,%eax,%eax
-add    -0x10(%ebp),%eax
+jmp    <T> <_ZN7MemPoolI13CPacketBufferE5allocEv+0x9d>
+mov    -0x10(%ebp),%eax
 mov    -0xc(%ebp),%edx
 add    $0x1,%edx
-imul   $0x1804,%edx,%edx
...
+jne    <T> <_ZN7MemPoolI13CPacketBufferE5allocEv+0x6d>
+mov    -0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
+imul   $0x601,%eax,%eax
