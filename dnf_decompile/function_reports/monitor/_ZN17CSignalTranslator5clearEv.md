...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804b3b4` | `0x116` | `0x8083ef4` | `0x112` |
...
-mov    0x8(%ebp),%eax
-mov    0x10(%eax),%eax
+je     <T> <_ZN17CSignalTranslator5clearEv+0x40>
+mov    -0xc(%ebp),%eax
+add    $0x10,%eax
+mov    (%eax),%eax
 mov    (%eax),%eax
...
-mov    0x8(%ebp),%eax
-mov    0x28(%eax),%eax
+je     <T> <_ZN17CSignalTranslator5clearEv+0x74>
+mov    -0xc(%ebp),%eax
+add    $0x28,%eax
+mov    (%eax),%eax
 mov    (%eax),%eax
...
-mov    0x8(%ebp),%eax
-mov    0x18(%eax),%eax
+je     <T> <_ZN17CSignalTranslator5clearEv+0xdc>
+mov    -0xc(%ebp),%eax
+add    $0x18,%eax
+mov    (%eax),%eax
 mov    (%eax),%eax
...
-mov    0x8(%ebp),%eax
-mov    0x3c(%eax),%eax
+je     <T> <_ZN17CSignalTranslator5clearEv+0x110>
+mov    -0xc(%ebp),%eax
+add    $0x3c,%eax
+mov    (%eax),%eax
 mov    (%eax),%eax
