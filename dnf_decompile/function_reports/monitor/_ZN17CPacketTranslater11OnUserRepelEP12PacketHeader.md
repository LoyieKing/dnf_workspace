...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8083aec` | `0x2ea` | `0x806efa6` | `0x2ee` |
...
-lea    -0x41(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x1e0>
+lea    -0x29(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+call   <T> <_ZNK12CUserManager8FindUserEj>
 mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+je     <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x1a1>
+mov    0x8(%ebp),%eax
+add    $0xe,%eax
+mov    (%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x19a>
+mov    0x8(%ebp),%eax
+add    $0xe,%eax
+mov    (%eax),%eax
+mov    %eax,0x4(%esp)
...
+je     <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x1a1>
+mov    $0x1,%eax
+jmp    <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x1a6>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x2e6>
+mov    0x8(%ebp),%eax
+lea    0xa(%eax),%ebx
 mov    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x2e6>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x276>
+jne    <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x280>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x279>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater11OnUserRepelEP12PacketHeader+0x2e1>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1717 行）：
