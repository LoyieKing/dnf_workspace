...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809a698` | `0x3c9` | `0x8062cf2` | `0x3c6` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp](source/DNFServer/GameServer/Monitor/DNFMemberManager.cpp)（约第 522 行）：
