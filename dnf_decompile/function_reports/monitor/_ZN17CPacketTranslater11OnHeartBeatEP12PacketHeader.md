...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807ec9e` | `0x313` | `0x806ab5e` | `0x300` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 554 行）：
