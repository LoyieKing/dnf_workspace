...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a9758` | `0x4f` | `0x80a7608` | `0x4a` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 224 行）：
