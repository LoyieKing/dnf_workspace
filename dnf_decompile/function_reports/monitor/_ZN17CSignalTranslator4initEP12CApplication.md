...
|---|---|---|---|---|---|
| monitor | NEAR | `0x804b4ca` | `0xa8` | `0x8082d38` | `0xa8` |
...
+movl   $"CSignalTranslator::init() Exception : %s\n",(%esp)
 call   <T> <printf>
...
+movl   $"CSignalTranslator::init() Exception",(%esp)
 call   <T> <puts>
 call   <T> <__cxa_rethrow>
 mov    %edx,%ebx
 mov    %eax,%esi
...
{
                    /* try { // try from 0804b4d8 to 0804b4ee has its CatchHandler @ 0804b4f1 */
