...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a88c6` | `0x1bd` | `0x80a7724` | `0x243` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 177 行）：
