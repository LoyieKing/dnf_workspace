...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a88c6` | `0x1bd` | `0x80a6d52` | `0x239` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 173 行）：
