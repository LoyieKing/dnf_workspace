...
|---|---|---|---|---|---|
| monitor | NEAR | `0x808a180` | `0x148` | `0x80758cc` | `0x148` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3578 行）：
