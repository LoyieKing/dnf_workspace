...
|---|---|---|---|---|---|
| monitor | NEAR | `0x808d722` | `0x140` | `0x8078d32` | `0x140` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 4398 行）：
