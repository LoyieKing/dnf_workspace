...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8065b48` | `0x57` | `0x805297a` | `0x57` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFApplication.cpp](source/DNFServer/GameServer/Monitor/DNFApplication.cpp)（约第 792 行）：
