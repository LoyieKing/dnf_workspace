...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80a8ba8` | `0x9f` | `0x80a7a9a` | `0xa3` |
...
定义于 [source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp](source/DNFServer/GameServer/Monitor/VillageAttackedManager.cpp)（约第 471 行）：
