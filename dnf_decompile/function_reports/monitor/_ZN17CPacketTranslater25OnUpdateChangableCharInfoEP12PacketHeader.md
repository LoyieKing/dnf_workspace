...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808259e` | `0x24c` | `0x806ea62` | `0x242` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1174 行）：
