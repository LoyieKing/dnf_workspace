...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8083dd6` | `0x300` | `0x8073a48` | `0x2f0` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3149 行）：
