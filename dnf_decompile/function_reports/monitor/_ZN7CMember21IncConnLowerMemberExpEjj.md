...
|---|---|---|---|---|---|
| monitor | DIFF | `0x809901c` | `0x6a` | `0x80608d8` | `0xa9` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMember.cpp](source/DNFServer/GameServer/Monitor/DNFMember.cpp)（约第 350 行）：
