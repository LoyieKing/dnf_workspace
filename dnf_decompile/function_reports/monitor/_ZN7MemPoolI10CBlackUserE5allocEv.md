...
|---|---|---|---|---|---|
| monitor | DIFF | `0x806c9d4` | `0x151` | `0x806627e` | `0x164` |
...
-mov    %eax,%ecx
-add    -0x10(%ebp),%ecx
+jmp    <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x9f>
+mov    -0x10(%ebp),%ecx
 mov    -0xc(%ebp),%eax
 lea    0x1(%eax),%edx
 mov    %edx,%eax
...
+jne    <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x69>
+mov    -0x10(%ebp),%ecx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
-lea    -0x1(%eax),%edx
