...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8050994` | `0x25d` | `0x8088496` | `0x1ca` |
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x58,-0xc(%ebp)
+jne    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0xc4>
...
+cmpl   $0x68,-0xc(%ebp)
+jne    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x10e>
