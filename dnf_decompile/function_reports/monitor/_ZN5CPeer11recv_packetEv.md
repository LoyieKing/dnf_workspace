...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8051232` | `0x1a1` | `0x809b438` | `0x194` |
...
+mov    %eax,-0x14(%ebp)
+cmpl   $0x0,-0x14(%ebp)
+jns    <T> <_ZN5CPeer11recv_packetEv+0x26>
 mov    $0x0,%eax
-jmp    <T> <_ZN5CPeer11recv_packetEv+0x19a>
+jmp    <T> <_ZN5CPeer11recv_packetEv+0x18d>
...
+jne    <T> <_ZN5CPeer11recv_packetEv+0x76>
 mov    0x8(%ebp),%eax
 lea    0x1c(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0x181c(%eax)
...
+cmpl   $0x0,-0xc(%ebp)
+jns    <T> <_ZN5CPeer11recv_packetEv+0x119>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0xb,%eax
-je     <T> <_ZN5CPeer11recv_packetEv+0xda>
+je     <T> <_ZN5CPeer11recv_packetEv+0xcd>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0x4,%eax
-je     <T> <_ZN5CPeer11recv_packetEv+0xda>
...
+jne    <T> <_ZN5CPeer11recv_packetEv+0x18a>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 mov    %eax,(%esp)
 call   <T> <strerror>
...
定义于 [source/DNFServer/GameServer/Monitor/Peer.cpp](source/DNFServer/GameServer/Monitor/Peer.cpp)（约第 34 行）：
