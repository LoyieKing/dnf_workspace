...
|---|---|---|---|---|---|
| monitor | NEAR | `0x80790ac` | `0x13b` | `0x807f9c2` | `0x13b` |
...
+add    $0x58,%eax
 mov    %eax,(%esp)
 call   <T> <_ZN17CTcpManagerServerD1Ev>
 mov    %esi,%eax
 mov    %ebx,%edx
...
+add    $0x58,%eax
 ...
 mov    %eax,(%esp)
 call   <T> <_ZN12CTcpDBServerD1Ev>
 jmp    <T> <_ZN14CServerHandlerD1Ev+0xfe>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x28,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
 jmp    <T> <_ZN14CServerHandlerD1Ev+0x10e>
 mov    0x8(%ebp),%eax
 add    $0x28,%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt3mapIjP14CTcpGameServerSt4lessIjESaISt4pairIKjS1_EEED1Ev>
 jmp    <T> <_ZN14CServerHandlerD1Ev+0x129>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...

{
  ...
  if (*(int *)(this + 0x18) != 0) {
                    /* try { // try from 080790d4 to 0807912d has its CatchHandler @ 08079142 */
  ...
  if (*(int *)(this + 0x1c) != 0) {
    ...
    *(undefined4 *)(this + 0x1c) = 0;
                    ...
                    /* try { // try from 08079163 to 08079167 has its CatchHandler @ 0807916a */
  CTcpManagerServer::~CTcpManagerServer((CTcpManagerServer *)(this + 0x54));
                    /* try { // try from 0807918b to 0807918f has its CatchHandler @ 08079192 */
  CTcpDBServer::~CTcpDBServer((CTcpDBServer *)(this + 0x40));
                    /* try { // try from 080791b3 to 080791b7 has its CatchHandler @ 080791ba */
  std::
