...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80895a0` | `0x142` | `0x8074b32` | `0x147` |
...
@@ -1,83 +1,85 @@
 ...
 sub    $0x30,%esp
 movl   $0x1307,0x8(%esp)
 movl   $"onLoadBlackIPMonitorPartLoad",0x4(%esp)
-lea    -0x24(%ebp),%eax
+lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater28onLoadBlackIPMonitorPartLoadEP12PacketHeader+0x140>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater28onLoadBlackIPMonitorPartLoadEP12PacketHeader+0xe1>
+jne    <T> <_ZN17CPacketTranslater28onLoadBlackIPMonitorPartLoadEP12PacketHeader+0xe6>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater28onLoadBlackIPMonitorPartLoadEP12PacketHeader+0xdf>
 mov    %edx,%ebx
 mov    %eax,%esi
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3326 行）：
