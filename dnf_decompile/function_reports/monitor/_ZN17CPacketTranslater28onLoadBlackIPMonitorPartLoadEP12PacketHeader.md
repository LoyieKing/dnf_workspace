...
|---|---|---|---|---|---|
| monitor | NEAR | `0x80895a0` | `0x142` | `0x8074d0e` | `0x142` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3379 行）：
