...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80895a0` | `0x142` | `0x8074c8a` | `0x148` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3341 行）：
