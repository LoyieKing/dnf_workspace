...
|---|---|---|---|---|---|
| monitor | NEAR | `0x80865ba` | `0x119` | `0x8071f98` | `0x119` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2474 行）：
