...
|---|---|---|---|---|---|
| monitor | NEAR | `0x80896e2` | `0x142` | `0x8074e50` | `0x142` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3399 行）：
