...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807f5a2` | `0x8c3` | `0x806ae56` | `0x858` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 721 行）：
