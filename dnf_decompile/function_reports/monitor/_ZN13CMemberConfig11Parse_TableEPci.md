...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8061c80` | `0xa1` | `0x806117e` | `0xac` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberConfig.cpp](source/DNFServer/GameServer/Monitor/DNFMemberConfig.cpp)（约第 53 行）：
