...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8088688` | `0x1f8` | `0x8073d38` | `0x1d7` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3189 行）：
