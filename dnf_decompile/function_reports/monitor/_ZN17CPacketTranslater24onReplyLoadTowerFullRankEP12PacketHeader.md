...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8088688` | `0x1f8` | `0x8073d1c` | `0x1dd` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3081 行）：
