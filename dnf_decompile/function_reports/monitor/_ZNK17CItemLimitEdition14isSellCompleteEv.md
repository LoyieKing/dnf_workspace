...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80933e8` | `0x32` | `0x8094290` | `0x35` |
...
定义于 [source/DNFServer/GameServer/Monitor/ItemLimitEditionManager.cpp](source/DNFServer/GameServer/Monitor/ItemLimitEditionManager.cpp)（约第 206 行）：
