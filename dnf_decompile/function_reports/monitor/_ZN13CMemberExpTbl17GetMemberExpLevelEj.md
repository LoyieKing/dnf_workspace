...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8062120` | `0x82` | `0x8061376` | `0xa0` |
...
-mov    -0xc(%ebp),%eax
+jbe    <T> <_ZN13CMemberExpTbl17GetMemberExpLevelEj+0x89>
+cmpl   $0x0,0xc(%ebp)
+jne    <T> <_ZN13CMemberExpTbl17GetMemberExpLevelEj+0x43>
+movl   $0x1,-0xc(%ebp)
+jmp    <T> <_ZN13CMemberExpTbl17GetMemberExpLevelEj+0x9b>
+mov    0x8(%ebp),%eax
+add    $0x8,%eax
+mov    %eax,-0x8(%ebp)
+cmpl   $0x0,-0x10(%ebp)
...
+xor    $0x1,%eax
+test   %al,%al
+jne    <T> <_ZN13CMemberExpTbl17GetMemberExpLevelEj+0x7c>
+mov    -0x8(%ebp),%eax
+mov    (%eax),%eax
+cmp    0xc(%ebp),%eax
+jae    <T> <_ZN13CMemberExpTbl17GetMemberExpLevelEj+0x7f>
+mov    -0x8(%ebp),%eax
 add    $0x4,%eax
 mov    (%eax),%eax
 cmp    0xc(%ebp),%eax
...
+jb     <T> <_ZN13CMemberExpTbl17GetMemberExpLevelEj+0x7f>
 nop
-mov    -0x4(%ebp),%eax
+jmp    <T> <_ZN13CMemberExpTbl17GetMemberExpLevelEj+0x9b>
+addl   $0x1,-0xc(%ebp)
+addl   $0x4,-0x8(%ebp)
+jmp    <T> <_ZN13CMemberExpTbl17GetMemberExpLevelEj+0x4c>
+mov    0x8(%ebp),%eax
+add    $0x4,%eax
+movzbl (%eax),%eax
+movzbl %al,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberConfig.cpp](source/DNFServer/GameServer/Monitor/DNFMemberConfig.cpp)（约第 107 行）：
