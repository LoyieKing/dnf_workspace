...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8062120` | `0x82` | `0x80616bc` | `0x86` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFMemberConfig.cpp](source/DNFServer/GameServer/Monitor/DNFMemberConfig.cpp)（约第 104 行）：
