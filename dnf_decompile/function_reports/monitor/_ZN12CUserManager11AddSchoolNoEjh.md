...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8071f08` | `0x41b` | `0x808c830` | `0x371` |
...
-lea    -0xd4(%ebp),%eax
+je     <T> <_ZN12CUserManager11AddSchoolNoEjh+0x209>
+lea    -0x74(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+je     <T> <_ZN12CUserManager11AddSchoolNoEjh+0x142>
+lea    -0x78(%ebp),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CUserManager11AddSchoolNoEjh+0x367>
+movl   $0x1,-0x50(%ebp)
+lea    -0x50(%ebp),%eax
+mov    %eax,0x8(%esp)
+lea    -0xac(%ebp),%eax
...
+jmp    <T> <_ZN12CUserManager11AddSchoolNoEjh+0x2c5>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x8c(%ebp),%eax
+lea    -0x28(%ebp),%eax
...
+jmp    <T> <_ZN12CUserManager11AddSchoolNoEjh+0x33b>
+movl   $0x3ed,0x8(%esp)
+movl   $"AddSchoolNo",0x4(%esp)
+lea    -0xa8(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN12CUserManager11AddSchoolNoEjh+0x359>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x70(%ebp),%eax
-mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 590 行）：
