...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8071f08` | `0x41b` | `0x808c8f8` | `0x3b8` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFUserManager.cpp](source/DNFServer/GameServer/Monitor/DNFUserManager.cpp)（约第 592 行）：
