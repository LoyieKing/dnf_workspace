...
|---|---|---|---|---|---|
| monitor | DIFF | `0x804f60c` | `0xc6` | `0x8085dd6` | `0xba` |
...
+jmp    <T> <_ZN9TCPSocket4recvEPci+0xb8>
 mov    0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 mov    %edx,0x8(%esp)
...
+jns    <T> <_ZN9TCPSocket4recvEPci+0x76>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0xb,%eax
-je     <T> <_ZN9TCPSocket4recvEPci+0x7b>
+je     <T> <_ZN9TCPSocket4recvEPci+0x6f>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0x4,%eax
-je     <T> <_ZN9TCPSocket4recvEPci+0x7b>
...
+jne    <T> <_ZN9TCPSocket4recvEPci+0xa2>
 mov    $0x0,%eax
-jmp    <T> <_ZN9TCPSocket4recvEPci+0xc4>
+jmp    <T> <_ZN9TCPSocket4recvEPci+0xb8>
 cmpl   $0x0,-0xc(%ebp)
