...
|---|---|---|---|---|---|
| monitor | DIFF | `0x808fce4` | `0x2d2` | `0x807b226` | `0x305` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 5009 行）：
