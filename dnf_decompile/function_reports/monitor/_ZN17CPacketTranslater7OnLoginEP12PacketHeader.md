...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807dd0e` | `0x61c` | `0x8069302` | `0x6a7` |
...
+test   %eax,%eax
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x69d>
+mov    0x8(%ebp),%eax
+add    $0x12,%eax
+movzbl (%eax),%eax
+movzbl %al,%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x69d>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x38(%ebp)
+cmpl   $0x0,-0x38(%ebp)
+jne    <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x3eb>
+mov    0x8(%ebp),%eax
+add    $0xe,%eax
+mov    (%eax),%eax
+mov    %eax,0x4(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x35c>
+mov    -0x50(%ebp),%ecx
+mov    0x8(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%edx
...
+mov    %ecx,0x14(%esp)
+mov    %edx,0x10(%esp)
+movl   $&data#4f83f921(.rodata),0xc(%esp)
+movl   $0x0,0x8(%esp)
+mov    %eax,0x4(%esp)
+mov    -0x3c(%ebp),%eax
+mov    %eax,(%esp)
...
+call   <T> <_ZN12CApplication24GetLoginLogoutStatisticsEv>
 mov    %eax,-0x30(%ebp)
+cmpl   $0x0,-0x30(%ebp)
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x30c>
+mov    -0x3c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN12CUserManager4SizeEv>
+mov    %eax,0x8(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x347>
+mov    -0x38(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13SendBlackListEv>
+jmp    <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x4f4>
+mov    0x8(%ebp),%eax
+add    $0xe,%eax
+mov    (%eax),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x4f4>
+cmpl   $0x0,-0x44(%ebp)
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x36b>
+mov    -0x40(%ebp),%eax
+add    $0x23,%eax
+movb   $0x3,(%eax)
 mov    -0x50(%ebp),%eax
...
+mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x445>
 movl   $0xe,0x8(%esp)
 movl   $0x3ee,0x4(%esp)
-mov    -0x48(%ebp),%eax
+mov    -0x20(%ebp),%eax
...
-mov    %ecx,0x14(%esp)
-mov    %edx,0x10(%esp)
-movl   $&data#1d3cc2f5(.rodata),0xc(%esp)
-movl   $0x0,0x8(%esp)
-mov    %eax,0x4(%esp)
-mov    -0x30(%ebp),%eax
-mov    %eax,(%esp)
...
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+cmpl   $0x0,-0x44(%ebp)
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x4f4>
+mov    -0x40(%ebp),%eax
+add    $0x23,%eax
+movb   $0x2,(%eax)
+cmpl   $0x0,-0x44(%ebp)
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x542>
+mov    -0x40(%ebp),%eax
+add    $0x28,%eax
+movb   $0x0,(%eax)
+mov    -0x40(%ebp),%eax
...
-mov    %eax,0x4(%esp)
-mov    -0x4c(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x573>
+cmpl   $0x0,-0x44(%ebp)
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x573>
+mov    $0x1,%eax
+jmp    <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x578>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x592>
+mov    -0x40(%ebp),%eax
+lea    0x28(%eax),%edx
+mov    -0x68(%ebp),%eax
+mov    %eax,(%edx)
...
+jne    <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x63d>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x636>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater7OnLoginEP12PacketHeader+0x698>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
