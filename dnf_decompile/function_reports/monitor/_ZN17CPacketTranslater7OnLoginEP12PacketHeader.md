...
|---|---|---|---|---|---|
| monitor | DIFF | `0x807dd0e` | `0x61c` | `0x8069614` | `0x684` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 159 行）：
