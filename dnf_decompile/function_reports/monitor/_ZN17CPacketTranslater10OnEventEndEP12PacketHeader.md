...
|---|---|---|---|---|---|
| monitor | NEAR | `0x80845bc` | `0x273` | `0x806f9a8` | `0x273` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 1866 行）：
