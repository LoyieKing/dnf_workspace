...
|---|---|---|---|---|---|
| monitor | DIFF | `0x80880d0` | `0x258` | `0x8073502` | `0x254` |
...
-mov    -0x18(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater23OnQueryBuddyInfoDBReplyEP12PacketHeader+0xcb>
+mov    0x8(%ebp),%eax
 movzbl 0xe(%eax),%eax
 test   %al,%al
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 2904 行）：
