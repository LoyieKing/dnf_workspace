...
+sub    $0x4,%esp
+jmp    <T> <_ZN8WongWork11CGMAccounts12AppendGM_SysEjc+0x45>
+lea    -0x18(%ebp),%eax
+mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+jne    <T> <_ZN8WongWork11CGMAccounts12AppendGM_SysEjc+0x91>
+lea    -0x18(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+jne    <T> <_ZN8WongWork11CGMAccounts12AppendGM_SysEjc+0x23>
 mov    0xc(%ebp),%eax
-mov    %eax,-0x18(%ebp)
+mov    %eax,-0x14(%ebp)
 movsbl -0x1c(%ebp),%eax
...
-pop    %ebx
-pop    %ebp
+jmp    <T> <_ZN8WongWork11CGMAccounts12AppendGM_SysEjc+0x92>
+nop
+leave
 ret
```
