...
|---|---|---|---|---|---|
| monitor | NEAR | `0x8089270` | `0x1e7` | `0x80749de` | `0x1e7` |
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3333 行）：
