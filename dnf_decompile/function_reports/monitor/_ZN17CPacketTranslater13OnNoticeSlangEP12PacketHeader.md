...
|---|---|---|---|---|---|
| monitor | DIFF | `0x8089270` | `0x1e7` | `0x80747fe` | `0x1e6` |
...
-lea    -0x31(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater13OnNoticeSlangEP12PacketHeader+0x10a>
+lea    -0x21(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+jmp    <T> <_ZN17CPacketTranslater13OnNoticeSlangEP12PacketHeader+0x1de>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater13OnNoticeSlangEP12PacketHeader+0x185>
+jne    <T> <_ZN17CPacketTranslater13OnNoticeSlangEP12PacketHeader+0x184>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater13OnNoticeSlangEP12PacketHeader+0x17d>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater13OnNoticeSlangEP12PacketHeader+0x1d9>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Monitor/DNFPacketTranslater.cpp)（约第 3279 行）：
