...
|---|---|---|---|---|---|
| coserver | NEAR | `0x804dab8` | `0x8e` | `0x804c408` | `0x8e` |
...

{
  ...
  this = (CAppBase *)CApplicationInstance();
                    /* try { // try from 0804dae1 to 0804db05 has its CatchHandler @ 0804db08 */
...
定义于 [source/DNFServer/GameServer/COServer/DNFApplication.cpp](source/DNFServer/GameServer/COServer/DNFApplication.cpp)（约第 71 行）：
