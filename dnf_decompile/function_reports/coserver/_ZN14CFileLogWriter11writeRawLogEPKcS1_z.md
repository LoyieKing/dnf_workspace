...
|---|---|---|---|---|---|
| coserver | DIFF | `0x8054d20` | `0x3ef` | `0x804eea2` | `0x3f9` |
...

{
  ...
  std::allocator<char>::allocator();
                    /* try { // try from 08054dd4 to 08054dd8 has its CatchHandler @ 08054ddb */
  std::string::string(local_60,local_1cc,&local_4d);
  std::allocator<char>::~allocator((allocator<char> *)&local_4d);
                    /* try { // try from 08054e15 to 08054e74 has its CatchHandler @ 080550bc */
  std::
  map<std::string,CFLog*,std::less<std::string>,std::allocator<std::pair<std::string_const,CFLog*>>>
  ::find(local_64);
  std::
  ...
  if (cVar2 == '\0') {
    ...
    sprintf(local_2cc,"%s%04d%02d%02d.log",param_1,local_24->tm_year + 0x76c,local_24->tm_mon + 1,
            local_24->tm_mday);
    std::allocator<char>::allocator();
                    /* try { // try from 08054f03 to 08054f07 has its CatchHandler @ 08054f0a */
    std::string::string(local_6c,local_2cc,&local_45);
    std::allocator<char>::~allocator((allocator<char> *)&local_45);
    psVar5 = local_6c;
                    /* try { // try from 08054f44 to 08054fb8 has its CatchHandler @ 0805509a */
    std::
    map<std::string,CFLog*,std::less<std::string>,std::allocator<std::pair<std::string_const,CFLog*>>>
    ...
    this_00 = operator_new(0xc);
                    /* try { // try from 08054fc7 to 08054fcb has its CatchHandler @ 08054fce */
    CFLog::CFLog(this_00,local_60);
    local_74 = this_00;
                    /* try { // try from 08054ffc to 08055000 has its CatchHandler @ 0805509a */
    std::make_pair<std::string&,CFLog*&>(local_30,(CFLog **)local_60);
                    /* try { // try from 08055011 to 08055015 has its CatchHandler @ 0805505b */
    std::pair<std::string_const,CFLog*>::pair<std::string,CFLog*>(local_38,local_30);
                    /* try { // try from 0805502d to 08055031 has its CatchHandler @ 08055046 */
    std::
    map<std::string,CFLog*,std::less<std::string>,std::allocator<std::pair<std::string_const,CFLog*>>>
    ::insert(local_40);
                    /* try { // try from 0805503f to 08055043 has its CatchHandler @ 0805505b */
    std::pair<std::string_const,CFLog*>::~pair(local_38);
                    /* try { // try from 08055076 to 08055097 has its CatchHandler @ 0805509a */
    std::pair<std::string,CFLog*>::~pair((pair<std::string,CFLog*> *)local_30);
    if (local_3c != '\0') {
      CFLog::writeLog(local_74,param_2,local_5c);
    }
                    /* try { // try from 080550b5 to 080550b9 has its CatchHandler @ 080550bc */
    ...
    CFLog::writeLog(local_20,param_2,local_5c);
                    ...
                    /* try { // try from 080550d7 to 080550db has its CatchHandler @ 080550de */
