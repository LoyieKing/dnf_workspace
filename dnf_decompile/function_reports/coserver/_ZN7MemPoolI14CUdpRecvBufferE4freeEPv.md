...
|---|---|---|---|---|---|
| coserver | DIFF | `0x8058732` | `0x2e` | `0x805795c` | `0x2c` |
...
+je     <T> <_ZN7MemPoolI14CUdpRecvBufferE4freeEPv+0x2a>
 mov    0xc(%ebp),%eax
 mov    %eax,-0x4(%ebp)
...
{
  if (param_1 != (void *)0x0) {
    *(void **)((int)param_1 + 0x200) = headOfFreeList_;
...
定义于 [source/DNFServer/GameServer/COServer/DNFUdpRecvBuffer.cpp](source/DNFServer/GameServer/COServer/DNFUdpRecvBuffer.cpp)（约第 66 行）：
