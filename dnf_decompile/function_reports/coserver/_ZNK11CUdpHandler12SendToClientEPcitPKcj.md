...
|---|---|---|---|---|---|
| coserver | DIFF | `0x804d0f2` | `0x309` | `0x8056f12` | `0x311` |
...
+jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x30b>
 cmpl   $0x0,0x18(%ebp)
...
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x88>
 cmpl   $0x0,0x1c(%ebp)
-jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0xf9>
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x109>
 mov    0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 movl   $0x0,0xc(%esp)
...
+jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x109>
 movl   $0x10,0x8(%esp)
 movl   $0x0,0x4(%esp)
-lea    -0x48(%ebp),%eax
+lea    -0x28(%ebp),%eax
...
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x24a>
 call   <T> <_Z8getErrnov>
 mov    %eax,-0xc(%ebp)
-mov    -0xc(%ebp),%eax
-cmp    $0x61,%eax
...
+cmpl   $0x61,-0xc(%ebp)
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x16f>
...
+movl   $"SendToClient",0x4(%esp)
 ...
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x238>
+jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x240>
+cmpl   $0x60,-0xc(%ebp)
+jle    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x180>
+mov    -0xc(%ebp),%eax
+sub    $0x6f,%eax
+cmp    $0x2,%eax
+jbe    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x1f0>
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <strerror>
 mov    %eax,0x8(%esp)
...
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x299>
...
+jne    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x2a8>
+mov    $0x1,%eax
+jmp    <T> <_ZNK11CUdpHandler12SendToClientEPcitPKcj+0x30b>
 mov    0x10(%ebp),%eax
 mov    %eax,0x8(%esp)
...
*未能在以下候选源文件中定位定义：mnt/d/Docs/my_sources/dnf_workspace/dnf_decompile/source/DNFServer/GameServer/COServer/DNFUdpHandler.cpp, source/DNFServer/GameServer/COServer/DNFUdpHandler.cpp, source/DNFServer/GameServer/COServer/DNFUdpHandler.h, source/DNFServer/ServerCommon/DNFFileLog.h, source/DNFServer/ServerCommon/Thread.h, source/shared/common/include/ReverseEngineerLib.h, source/shared/packet/include/PacketHeader.h, source/DNFServer/ServerCommon/DNFFileLog.h 等 222 个文件*
