...
|---|---|---|---|---|---|
| coserver | DIFF | `0x805858e` | `0x15e` | `0x80577f2` | `0x169` |
...
+je     <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x27>
 movl   $0x204,(%esp)
 call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x157>
+mov    %eax,-0x10(%ebp)
+jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x160>
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x49>
+mov    -0x10(%ebp),%eax
+add    $0x200,%eax
+mov    (%eax),%eax
 mov    %eax,&_ZN7MemPoolI14CUdpRecvBufferE15headOfFreeList_E
-jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x154>
+jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x160>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%edx
 mov    0x8(%ebp),%eax
...
+mov    %eax,-0x18(%ebp)
 movl   $0x0,-0xc(%ebp)
-jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x97>
+jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0xa3>
 mov    -0xc(%ebp),%eax
 shl    $0x2,%eax
 mov    %eax,%edx
 shl    $0x7,%edx
...
+jne    <T> <_ZN7MemPoolI14CUdpRecvBufferE5allocEv+0x6b>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
-sub    $0x1,%eax
 shl    $0x2,%eax
  ...
  if (*(int *)this == 0x204) {
    ...
    if (headOfFreeList_ == (void *)0x0) {
      ...
      for (local_10 = 0; local_10 < *(int *)(this + 4) - 1U; local_10 = local_10 + 1) {
        *(void **)((int)local_24 + local_10 * 0x204 + 0x200) =
             (void *)((local_10 + 1) * 0x204 + (int)local_24);
      }
      *(undefined4 *)((int)local_24 + (*(int *)(this + 4) + -1) * 0x204 + 0x200) = 0;
      headOfFreeList_ = (void *)((int)local_24 + 0x204);
      local_18 = local_24;
      local_14 = local_24;
