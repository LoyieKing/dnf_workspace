...
|---|---|---|---|---|---|
| coserver | DIFF | `0x804ce7e` | `0x273` | `0x8056ca2` | `0x270` |
...
-lea    -0x58(%ebp),%ebx
-lea    -0x54(%ebp),%ecx
+jmp    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x26a>
+movl   $0x10,-0x1c(%ebp)
+lea    -0x2c(%ebp),%ecx
 mov    0x10(%ebp),%eax
 mov    (%eax),%eax
...
+jmp    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x26a>
+cmpl   $0x0,-0x18(%ebp)
+jg     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x185>
+mov    -0x18(%ebp),%eax
 mov    %eax,0x4(%esp)
...
-mov    -0x20(%ebp),%eax
+je     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1fa>
+mov    0xc(%ebp),%eax
 movzwl (%eax),%eax
 cmp    $0x4c9,%ax
-je     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1fb>
