...
|---|---|---|---|---|---|
| coserver | DIFF | `0x804d65a` | `0x27b` | `0x805747e` | `0x283` |
...
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x27d>
 cmpw   $0x0,-0x4c(%ebp)
-jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x5d>
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x60>
 cmpl   $0x0,0x18(%ebp)
-jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0xd2>
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0xe2>
 mov    0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
 movl   $0x0,0xc(%esp)
...
-lea    -0x48(%ebp),%eax
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0xe2>
 movl   $0x10,0x8(%esp)
 movl   $0x0,0x4(%esp)
+lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x1e2>
 call   <T> <_Z8getErrnov>
 mov    %eax,-0xc(%ebp)
-mov    -0xc(%ebp),%eax
-cmp    $0x61,%eax
...
+cmpl   $0x61,-0xc(%ebp)
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x13c>
 movl   $0x1b8,0x8(%esp)
 movl   $&_ZZNK11CUdpHandler12SendToServerEPcitPKcE12__FUNCTION__,0x4(%esp)
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 ...
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x1d0>
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x1d8>
+cmpl   $0x60,-0xc(%ebp)
+jle    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x14d>
+mov    -0xc(%ebp),%eax
+sub    $0x6f,%eax
+cmp    $0x2,%eax
+jbe    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x19b>
+movl   $0x1be,0x8(%esp)
+movl   $&_ZZNK11CUdpHandler12SendToServerEPcitPKcE12__FUNCTION__,0x4(%esp)
+lea    -0x38(%ebp),%eax
+mov    %eax,(%esp)
...
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x225>
 movl   $0x1c7,0x8(%esp)
 movl   $&_ZZNK11CUdpHandler12SendToServerEPcitPKcE12__FUNCTION__,0x4(%esp)
-lea    -0x20(%ebp),%eax
+lea    -0x48(%ebp),%eax
...
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x234>
+mov    $0x1,%eax
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x27d>
 movl   $0x1ce,0x8(%esp)
 movl   $&_ZZNK11CUdpHandler12SendToServerEPcitPKcE12__FUNCTION__,0x4(%esp)
...
定义于 [source/DNFServer/GameServer/COServer/DNFUdpHandler.cpp](source/DNFServer/GameServer/COServer/DNFUdpHandler.cpp)（约第 242 行）：
