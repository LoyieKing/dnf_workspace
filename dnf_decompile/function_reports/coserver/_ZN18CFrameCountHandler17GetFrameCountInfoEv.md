...
|---|---|---|---|---|---|
| coserver | DIFF | `0x804c572` | `0x37c` | `0x80565b0` | `0x37a` |
...

{
  ...
  if (*this == (CFrameCountHandler)0x0) {
    ...
    *(clock_t *)(this + 0xc) = cVar1;
    if (*(int *)(this + 0xc) == -1) {
      std::allocator<char>::allocator();
                    /* try { // try from 0804c603 to 0804c607 has its CatchHandler @ 0804c67d */
      ...
      pCVar2 = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 0804c622 to 0804c626 has its CatchHandler @ 0804c629 */
      CDNFException::CDNFException(pCVar2,local_40);
                    /* try { // try from 0804c668 to 0804c66c has its CatchHandler @ 0804c66f */
      std::string::~string(local_40);
    ...
    *(clock_t *)(this + 0x10) = cVar1;
    if (*(int *)(this + 0x10) == -1) {
      std::allocator<char>::allocator();
                    /* try { // try from 0804c706 to 0804c70a has its CatchHandler @ 0804c780 */
      std::string::string(local_38,
                          "CFrameCountHandler::GetFrameCountInfo() times() Exception Break!",
                          &local_31);
      pCVar2 = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 0804c725 to 0804c729 has its CatchHandler @ 0804c72c */
      CDNFException::CDNFException(pCVar2,local_38);
                    /* try { // try from 0804c76b to 0804c76f has its CatchHandler @ 0804c772 */
      std::string::~string(local_38);
