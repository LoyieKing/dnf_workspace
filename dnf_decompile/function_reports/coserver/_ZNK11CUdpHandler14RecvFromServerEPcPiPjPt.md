...
|---|---|---|---|---|---|
| coserver | DIFF | `0x804d3fc` | `0x25d` | `0x8057224` | `0x25a` |
...
-lea    -0x58(%ebp),%ebx
-lea    -0x54(%ebp),%ecx
+jmp    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x254>
+movl   $0x10,-0x1c(%ebp)
+lea    -0x2c(%ebp),%ecx
 mov    0x10(%ebp),%eax
 mov    (%eax),%eax
...
+jmp    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x254>
+cmpl   $0x0,-0x18(%ebp)
+jg     <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x187>
+mov    -0x18(%ebp),%eax
 mov    %eax,0x4(%esp)
...
-mov    -0x20(%ebp),%eax
+je     <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x1e4>
+mov    0xc(%ebp),%eax
 movzwl (%eax),%eax
 cmp    $0x4c9,%ax
-jne    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x245>
+jne    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x244>
+movl   $0x179,0x8(%esp)
+movl   $"RecvFromServer",0x4(%esp)
+lea    -0x4c(%ebp),%eax
+mov    %eax,(%esp)
