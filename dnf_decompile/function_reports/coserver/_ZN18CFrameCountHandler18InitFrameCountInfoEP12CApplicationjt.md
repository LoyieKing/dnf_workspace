...
|---|---|---|---|---|---|
| coserver | DIFF | `0x804c436` | `0x13c` | `0x8056472` | `0x13d` |
...

{
  ...
  std::allocator<char>::allocator();
                    /* try { // try from 0804c4b6 to 0804c4ba has its CatchHandler @ 0804c530 */
  std::string::string(local_24,"CFrameCountHandler::InitFrameCountInfo() Exception Break!",local_1d)
  ;
  this = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 0804c4d5 to 0804c4d9 has its CatchHandler @ 0804c4dc */
  CDNFException::CDNFException(this,local_24);
                    /* try { // try from 0804c51b to 0804c51f has its CatchHandler @ 0804c522 */
...
*未能在以下候选源文件中定位定义：mnt/d/Docs/my_sources/dnf_workspace/dnf_decompile/source/DNFServer/GameServer/COServer/DNFTickHandler.cpp, source/DNFServer/GameServer/COServer/DNFAppThread.h, source/DNFServer/GameServer/COServer/DNFApplication.h, source/DNFServer/GameServer/COServer/DNFTableBase.h, source/DNFServer/GameServer/COServer/DNFThreadInterface.h, source/DNFServer/GameServer/COServer/DNFTickHandler.cpp, source/DNFServer/GameServer/COServer/DNFTickHandler.h, source/DNFServer/GameServer/COServer/DNFUser.h 等 227 个文件*
