...
|---|---|---|---|---|---|
| coserver | DIFF | `0x8053ce8` | `0xda` | `0x8056136` | `0xd4` |
...
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x80>
 mov    $0xffffffff,%eax
-jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xd8>
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xd2>
...
+jne    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xb7>
 mov    -0xc(%ebp),%eax
 mov    %eax,0x8(%esp)
 movl   $0x400,0x4(%esp)
 lea    -0x410(%ebp),%eax
...
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xb7>
 mov    $0x1,%eax
-jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xc2>
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xbc>
 mov    $0x0,%eax
 test   %al,%al
