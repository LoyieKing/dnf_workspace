...
|---|---|---|---|---|---|
| coserver | DIFF | `0x8054922` | `0x3fd` | `0x804ea9a` | `0x407` |
...

{
  ...
  std::allocator<char>::allocator();
                    /* try { // try from 080549d6 to 080549da has its CatchHandler @ 080549dd */
  std::string::string(local_60,local_1cc,&local_4d);
  std::allocator<char>::~allocator((allocator<char> *)&local_4d);
                    /* try { // try from 08054a17 to 08054a7d has its CatchHandler @ 08054ccc */
  std::
  map<std::string,CFLog*,std::less<std::string>,std::allocator<std::pair<std::string_const,CFLog*>>>
  ::find(local_64);
  std::
  ...
  if (cVar2 == '\0') {
    ...
    sprintf(local_2cc,"%s%04d%02d%02d.log",param_1,local_24->tm_year + 0x76c,local_24->tm_mon + 1,
            local_24->tm_mday);
    std::allocator<char>::allocator();
                    /* try { // try from 08054b0c to 08054b10 has its CatchHandler @ 08054b13 */
    std::string::string(local_6c,local_2cc,&local_45);
    std::allocator<char>::~allocator((allocator<char> *)&local_45);
    psVar5 = local_6c;
                    /* try { // try from 08054b4d to 08054bc1 has its CatchHandler @ 08054caa */
    std::
    map<std::string,CFLog*,std::less<std::string>,std::allocator<std::pair<std::string_const,CFLog*>>>
    ...
    this_00 = operator_new(0xc);
                    /* try { // try from 08054bd0 to 08054bd4 has its CatchHandler @ 08054bd7 */
    CFLog::CFLog(this_00,local_60);
    local_74 = this_00;
                    /* try { // try from 08054c05 to 08054c09 has its CatchHandler @ 08054caa */
    std::make_pair<std::string&,CFLog*&>(local_30,(CFLog **)local_60);
                    /* try { // try from 08054c1a to 08054c1e has its CatchHandler @ 08054c64 */
    std::pair<std::string_const,CFLog*>::pair<std::string,CFLog*>(local_38,local_30);
                    /* try { // try from 08054c36 to 08054c3a has its CatchHandler @ 08054c4f */
    std::
    map<std::string,CFLog*,std::less<std::string>,std::allocator<std::pair<std::string_const,CFLog*>>>
    ::insert(local_40);
                    /* try { // try from 08054c48 to 08054c4c has its CatchHandler @ 08054c64 */
    std::pair<std::string_const,CFLog*>::~pair(local_38);
                    /* try { // try from 08054c7f to 08054ca7 has its CatchHandler @ 08054caa */
    std::pair<std::string,CFLog*>::~pair((pair<std::string,CFLog*> *)local_30);
    if (local_3c != '\0') {
      CFLog::writeLog(local_74,local_28,param_2,local_5c);
    }
                    /* try { // try from 08054cc5 to 08054cc9 has its CatchHandler @ 08054ccc */
    ...
    CFLog::writeLog(local_20,local_28,param_2,local_5c);
                    ...
                    /* try { // try from 08054ce7 to 08054ceb has its CatchHandler @ 08054cee */
