...
|---|---|---|---|---|---|
| guild | DIFF | `0x8097666` | `0x160` | `0x805d69e` | `0x184` |
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+je     <T> <_ZN13CGuildManager17GetAttendanceInfoEjR16STAttendanceInfo+0x17f>
+mov    0x10(%ebp),%eax
+lea    0x4(%eax),%ebx
+mov    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,(%edx)
+cmpl   $0x0,-0x18(%ebp)
+js     <T> <_ZN13CGuildManager17GetAttendanceInfoEjR16STAttendanceInfo+0x122>
+cmpl   $0x8,-0x18(%ebp)
+jg     <T> <_ZN13CGuildManager17GetAttendanceInfoEjR16STAttendanceInfo+0x122>
+mov    0x10(%ebp),%eax
+lea    0x10(%eax),%edx
+mov    -0x18(%ebp),%eax
...
+mov    %eax,-0x14(%ebp)
+cmpl   $0x0,-0x14(%ebp)
+js     <T> <_ZN13CGuildManager17GetAttendanceInfoEjR16STAttendanceInfo+0x17f>
+cmpl   $0x8,-0x14(%ebp)
+jg     <T> <_ZN13CGuildManager17GetAttendanceInfoEjR16STAttendanceInfo+0x17f>
+mov    0x10(%ebp),%eax
+lea    0x8(%eax),%edx
+mov    -0x14(%ebp),%eax
+mov    &_ZZN13CGuildManager17GetAttendanceInfoEjR16STAttendanceInfoE19guild_att_phase_tbl(,%eax,4),%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 759 行）：
