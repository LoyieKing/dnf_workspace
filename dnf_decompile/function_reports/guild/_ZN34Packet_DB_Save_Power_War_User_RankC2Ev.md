...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a571a` | `0x98` | `0x809ba76` | `0xbb` |
...
定义于 [source/DNFServer/GameServer/Guild/PowerManager.cpp](source/DNFServer/GameServer/Guild/PowerManager.cpp)（约第 735 行）：
