...
|---|---|---|---|---|---|
| guild | DIFF | `0x8068f72` | `0x2af` | `0x808c396` | `0x2a2` |
...
+jne    <T> <_ZN12CUserManager27DeleteUsersOnGameServerDownEP11CGameServer+0x34>
 mov    0x8(%ebp),%eax
 lea    0x30(%eax),%edx
 lea    -0x30(%ebp),%eax
 mov    %edx,0x4(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFUserManager.cpp](source/DNFServer/GameServer/Guild/DNFUserManager.cpp)（约第 220 行）：
