...
|---|---|---|---|---|---|
| guild | DIFF | `0x80776e4` | `0x4e6` | `0x806dd9e` | `0x4e7` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1575 行）：
