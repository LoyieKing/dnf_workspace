...
-mov    -0x20(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater24OnDBReplyGuildAllMembersEP12PacketHeader+0x4cd>
+mov    0x8(%ebp),%eax
 mov    0xe(%eax),%eax
 mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
 add    $0x10,%edx
...
+mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+je     <T> <_ZN17CPacketTranslater24OnDBReplyGuildAllMembersEP12PacketHeader+0x4cd>
 movl   $0x10,0x4(%esp)
 mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %ebx,(%esp)
-call   <T> <__cxa_throw>
+jmp    <T> <_ZN17CPacketTranslater24OnDBReplyGuildAllMembersEP12PacketHeader+0x4cd>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0x2,%eax
-jne    <T> <_ZN17CPacketTranslater24OnDBReplyGuildAllMembersEP12PacketHeader+0x474>
+jne    <T> <_ZN17CPacketTranslater24OnDBReplyGuildAllMembersEP12PacketHeader+0x463>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater24OnDBReplyGuildAllMembersEP12PacketHeader+0x45c>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jmp    <T> <_ZN17CPacketTranslater24OnDBReplyGuildAllMembersEP12PacketHeader+0x4c8>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
