...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087816` | `0x208` | `0x807cd1c` | `0x129` |
...
+jne    <T> <_ZN17CPacketTranslater31OnDBLoadReplyWebGuildBoardWriteEP12PacketHeader+0x52>
 movl   $0x1ded,0x8(%esp)
 movl   $"OnDBLoadReplyWebGuildBoardWrite",0x4(%esp)
-lea    -0x44(%ebp),%eax
+lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,0x4(%esp)
-mov    %edx,(%esp)
+jmp    <T> <_ZN17CPacketTranslater31OnDBLoadReplyWebGuildBoardWriteEP12PacketHeader+0x122>
+mov    -0x14(%ebp),%eax
+add    $0xc,%eax
+mov    (%eax),%eax
+mov    %eax,-0x10(%ebp)
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0xc(%ebp)
+jne    <T> <_ZN17CPacketTranslater31OnDBLoadReplyWebGuildBoardWriteEP12PacketHeader+0xba>
 movl   $0x1df4,0x8(%esp)
 movl   $"OnDBLoadReplyWebGuildBoardWrite",0x4(%esp)
-lea    -0x3c(%ebp),%eax
+lea    -0x24(%ebp),%eax
...
-mov    0xc(%eax),%ebx
-mov    -0x24(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater31OnDBLoadReplyWebGuildBoardWriteEP12PacketHeader+0x122>
+mov    -0x14(%ebp),%eax
+lea    0x14(%eax),%esi
+mov    -0x14(%ebp),%eax
+add    $0x10,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5113 行）：
