...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087816` | `0x208` | `0x807c782` | `0x122` |
...
-mov    -0x20(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater31OnDBLoadReplyWebGuildBoardWriteEP12PacketHeader+0x11b>
+mov    0x8(%ebp),%eax
 mov    0xc(%eax),%eax
...
+je     <T> <_ZN17CPacketTranslater31OnDBLoadReplyWebGuildBoardWriteEP12PacketHeader+0xb5>
 movl   $0x1df4,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater31OnDBLoadReplyWebGuildBoardWriteEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x3c(%ebp),%eax
+lea    -0x18(%ebp),%eax
...
-mov    0xc(%eax),%ebx
-mov    -0x24(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater31OnDBLoadReplyWebGuildBoardWriteEP12PacketHeader+0x11b>
+mov    0x8(%ebp),%eax
+add    $0x14,%eax
+mov    %eax,%esi
+mov    0x8(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 6033 行）：
