...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087816` | `0x208` | `0x807ca16` | `0x12c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5290 行）：
