...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087816` | `0x208` | `0x807d674` | `0x204` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 6141 行）：
