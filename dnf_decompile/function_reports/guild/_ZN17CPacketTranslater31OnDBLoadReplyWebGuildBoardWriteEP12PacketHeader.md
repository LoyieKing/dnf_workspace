...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087816` | `0x208` | `0x807caac` | `0x12c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5295 行）：
