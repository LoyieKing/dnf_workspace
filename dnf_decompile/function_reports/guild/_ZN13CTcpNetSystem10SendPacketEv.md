...
|---|---|---|---|---|---|
| guild | DIFF | `0x80532b0` | `0x2f1` | `0x80a7b46` | `0x32d` |
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x64>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x30(%ebp)
+movb   $0x1,-0x29(%ebp)
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x8c>
+movb   $0x0,-0x29(%ebp)
+movl   $0x0,-0x28(%ebp)
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x8c>
 mov    %edx,%ebx
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0xaa>
+mov    -0x28(%ebp),%eax
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x322>
+cmpl   $0x0,-0x30(%ebp)
+jne    <T> <_ZN13CTcpNetSystem10SendPacketEv+0xba>
+mov    $0x0,%eax
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x322>
+mov    -0x30(%ebp),%eax
+lea    0x6(%eax),%ecx
...
-mov    -0x28(%ebp),%eax
-movzwl 0x2(%eax),%eax
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x18b>
+mov    -0x30(%ebp),%eax
+add    $0x6,%eax
+mov    (%eax),%edi
+mov    -0x30(%ebp),%eax
...
-mov    -0x28(%ebp),%eax
-mov    0x6(%eax),%ebx
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1cc>
+mov    -0x30(%ebp),%eax
+add    $0x6,%eax
+mov    (%eax),%ebx
 mov    -0x24(%ebp),%eax
...
+jne    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1cc>
 mov    $0x1,%eax
...
-mov    -0x28(%ebp),%eax
-movzwl 0x2(%eax),%eax
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1d1>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x1d9>
+movb   $0x0,-0x1d(%ebp)
+cmpb   $0x0,-0x1d(%ebp)
+je     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x265>
+mov    -0x30(%ebp),%eax
+add    $0x6,%eax
+mov    (%eax),%edi
+mov    -0x30(%ebp),%eax
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jg     <T> <_ZN13CTcpNetSystem10SendPacketEv+0x30d>
 mov    0x8(%ebp),%eax
 add    $0xc0,%eax
 mov    %eax,(%esp)
...
-mov    -0x20(%ebp),%ebx
-mov    %ebx,%eax
+jmp    <T> <_ZN13CTcpNetSystem10SendPacketEv+0x31f>
+mov    -0x30(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    0x8(%ebp),%eax
+mov    %eax,(%esp)
