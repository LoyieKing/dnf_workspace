...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082be6` | `0x25e` | `0x8078e6a` | `0x16d` |
...
+jne    <T> <_ZN17CPacketTranslater19OnDBDeleteGuildAgitEP12PacketHeader+0x50>
 movl   $0x16dd,0x8(%esp)
 movl   $"OnDBDeleteGuildAgit",0x4(%esp)
-lea    -0x50(%ebp),%eax
+lea    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x20(%ebp),%eax
-mov    0x12(%eax),%eax
+jmp    <T> <_ZN17CPacketTranslater19OnDBDeleteGuildAgitEP12PacketHeader+0x16b>
+mov    -0x14(%ebp),%eax
+add    $0x12,%eax
+mov    (%eax),%eax
 test   %eax,%eax
...
-movl   $"OnDBDeleteGuildAgit",0x4(%esp)
-lea    -0x48(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater19OnDBDeleteGuildAgitEP12PacketHeader+0x111>
+mov    -0x14(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
+mov    %eax,-0x10(%ebp)
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN17CPacketTranslater19OnDBDeleteGuildAgitEP12PacketHeader+0x96>
+cmpl   $0x0,-0xc(%ebp)
+jne    <T> <_ZN17CPacketTranslater19OnDBDeleteGuildAgitEP12PacketHeader+0xd2>
 movl   $0x16ef,0x8(%esp)
 movl   $"OnDBDeleteGuildAgit",0x4(%esp)
-lea    -0x40(%ebp),%eax
+lea    -0x2c(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3958 行）：
