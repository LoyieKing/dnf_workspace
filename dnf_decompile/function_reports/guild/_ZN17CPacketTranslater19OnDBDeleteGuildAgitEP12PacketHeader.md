...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082be6` | `0x25e` | `0x8078b9c` | `0x174` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4134 行）：
