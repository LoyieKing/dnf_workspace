...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082be6` | `0x25e` | `0x8078f8a` | `0x174` |
...
-mov    0x8(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater19OnDBDeleteGuildAgitEP12PacketHeader+0x16c>
+mov    -0x24(%ebp),%eax
+add    $0x12,%eax
+mov    (%eax),%eax
+test   %eax,%eax
+jne    <T> <_ZN17CPacketTranslater19OnDBDeleteGuildAgitEP12PacketHeader+0x112>
+mov    -0x24(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
 mov    %eax,-0x20(%ebp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4292 行）：
