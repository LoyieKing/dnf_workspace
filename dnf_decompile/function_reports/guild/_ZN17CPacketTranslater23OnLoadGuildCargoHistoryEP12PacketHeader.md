...
|---|---|---|---|---|---|
| guild | NEAR | `0x8083b62` | `0x1c2` | `0x8079cba` | `0x1c2` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4364 行）：
