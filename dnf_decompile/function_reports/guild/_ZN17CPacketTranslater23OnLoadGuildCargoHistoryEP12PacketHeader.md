...
|---|---|---|---|---|---|
| guild | DIFF | `0x8083b62` | `0x1c2` | `0x807973a` | `0x1c2` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4368 行）：
