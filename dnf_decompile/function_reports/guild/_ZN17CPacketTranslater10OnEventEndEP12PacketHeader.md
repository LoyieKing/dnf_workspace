...
|---|---|---|---|---|---|
| guild | NEAR | `0x807d804` | `0x256` | `0x8073b1a` | `0x256` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2790 行）：
