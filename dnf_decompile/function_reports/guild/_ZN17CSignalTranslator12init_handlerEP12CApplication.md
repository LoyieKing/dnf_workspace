...
|---|---|---|---|---|---|
| guild | DIFF | `0x804c26e` | `0x1b3` | `0x8084c46` | `0x23e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFSignalTranslator.cpp](source/DNFServer/GameServer/Guild/DNFSignalTranslator.cpp)（约第 193 行）：
