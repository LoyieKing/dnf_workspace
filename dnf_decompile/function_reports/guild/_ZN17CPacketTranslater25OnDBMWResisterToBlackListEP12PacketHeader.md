...
|---|---|---|---|---|---|
| guild | DIFF | `0x807e1e2` | `0x2c5` | `0x80744cc` | `0x2c3` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2925 行）：
