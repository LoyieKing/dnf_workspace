...
|---|---|---|---|---|---|
| guild | DIFF | `0x807e1e2` | `0x2c5` | `0x80745e0` | `0x2e9` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2948 行）：
