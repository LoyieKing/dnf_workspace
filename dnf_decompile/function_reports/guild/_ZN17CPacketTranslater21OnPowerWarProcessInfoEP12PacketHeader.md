...
|---|---|---|---|---|---|
| guild | NEAR | `0x8082e44` | `0x167` | `0x8078ffe` | `0x167` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4147 行）：
