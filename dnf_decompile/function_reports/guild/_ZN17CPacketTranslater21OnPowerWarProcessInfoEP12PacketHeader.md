...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082e44` | `0x167` | `0x8078c66` | `0x155` |
...
-mov    0x8(%ebp),%eax
-mov    %eax,-0x14(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnPowerWarProcessInfoEP12PacketHeader+0x14e>
+mov    -0x10(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%ebx
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+jne    <T> <_ZN17CPacketTranslater21OnPowerWarProcessInfoEP12PacketHeader+0xf4>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater21OnPowerWarProcessInfoEP12PacketHeader+0xed>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater21OnPowerWarProcessInfoEP12PacketHeader+0x149>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3988 行）：
