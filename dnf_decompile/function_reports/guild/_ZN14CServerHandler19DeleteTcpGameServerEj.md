...
|---|---|---|---|---|---|
| guild | DIFF | `0x806da54` | `0xd2` | `0x8081c3a` | `0xcd` |
...
+jne    <T> <_ZN14CServerHandler19DeleteTcpGameServerEj+0xc7>
 lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN14CServerHandler19DeleteTcpGameServerEj+0x7a>
+test   %ebx,%ebx
+je     <T> <_ZN14CServerHandler19DeleteTcpGameServerEj+0x7a>
 mov    %ebx,(%esp)
...
-mov    $0x0,%eax
+jmp    <T> <_ZN14CServerHandler19DeleteTcpGameServerEj+0xc8>
+nop
 mov    -0x4(%ebp),%ebx
 leave
 ret
...
定义于 [source/DNFServer/GameServer/Guild/DNFServerHandler.cpp](source/DNFServer/GameServer/Guild/DNFServerHandler.cpp)（约第 439 行）：

```cpp
bool CServerHandler::DeleteTcpGameServer(unsigned int group)
{
