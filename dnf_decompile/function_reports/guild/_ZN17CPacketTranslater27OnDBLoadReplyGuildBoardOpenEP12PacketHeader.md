...
|---|---|---|---|---|---|
| guild | DIFF | `0x8086836` | `0x2c0` | `0x807c52e` | `0x1c1` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5117 行）：
