...
|---|---|---|---|---|---|
| guild | DIFF | `0x8086836` | `0x2c0` | `0x807c71c` | `0x1c1` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5266 行）：
