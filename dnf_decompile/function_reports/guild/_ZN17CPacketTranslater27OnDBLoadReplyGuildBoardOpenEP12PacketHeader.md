...
|---|---|---|---|---|---|
| guild | DIFF | `0x8086836` | `0x2c0` | `0x807c218` | `0x1c3` |
...
+jmp    <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0x1c1>
+mov    -0x20(%ebp),%eax
+add    $0x11,%eax
+mov    (%eax),%eax
+mov    %eax,-0x1c(%ebp)
...
+mov    %eax,-0x18(%ebp)
+cmpl   $0x0,-0x18(%ebp)
+jne    <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0xbb>
 movl   $0x1ca7,0x8(%esp)
 movl   $"OnDBLoadReplyGuildBoardOpen",0x4(%esp)
-lea    -0x4c(%ebp),%eax
+lea    -0x30(%ebp),%eax
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0x126>
 movl   $0x1cae,0x8(%esp)
 movl   $"OnDBLoadReplyGuildBoardOpen",0x4(%esp)
-lea    -0x44(%ebp),%eax
+lea    -0x38(%ebp),%eax
...
-mov    -0x2c(%ebp),%edx
-mov    %edx,0x10(%esp)
+je     <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0x1c1>
+mov    -0x18(%ebp),%eax
+mov    %eax,0x10(%esp)
 movl   $0x232a,0xc(%esp)
-mov    %esi,0x8(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4894 行）：
