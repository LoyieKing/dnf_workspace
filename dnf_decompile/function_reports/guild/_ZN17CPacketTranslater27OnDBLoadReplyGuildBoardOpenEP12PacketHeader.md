...
|---|---|---|---|---|---|
| guild | DIFF | `0x8086836` | `0x2c0` | `0x807bd3e` | `0x1b5` |
...
+jne    <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0x4a>
 movl   $0x1c9d,0x8(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0x1b3>
+mov    0x8(%ebp),%eax
+mov    0xf(%eax),%eax
+mov    %eax,-0x1c(%ebp)
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+mov    %eax,-0x18(%ebp)
+cmpl   $0x0,-0x18(%ebp)
+jne    <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0xae>
 movl   $0x1ca7,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x4c(%ebp),%eax
+lea    -0x2c(%ebp),%eax
...
+je     <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0x11a>
 movl   $0x1cae,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x44(%ebp),%eax
+lea    -0x24(%ebp),%eax
...
-mov    -0x2c(%ebp),%edx
-mov    %edx,0x10(%esp)
+je     <T> <_ZN17CPacketTranslater27OnDBLoadReplyGuildBoardOpenEP12PacketHeader+0x1b3>
+mov    -0x18(%ebp),%eax
+mov    %eax,0x10(%esp)
 movl   $0x232a,0xc(%esp)
-mov    %esi,0x8(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5814 行）：
