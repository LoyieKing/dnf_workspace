...
|---|---|---|---|---|---|
| guild | DIFF | `0x808902a` | `0x287` | `0x807da68` | `0x26b` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 6387 行）：
