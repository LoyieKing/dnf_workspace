...
|---|---|---|---|---|---|
| guild | DIFF | `0x808902a` | `0x287` | `0x807dd08` | `0x286` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5639 行）：
