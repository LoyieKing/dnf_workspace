...
|---|---|---|---|---|---|
| guild | DIFF | `0x80743e8` | `0x589` | `0x806a7e0` | `0x54e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1549 行）：
