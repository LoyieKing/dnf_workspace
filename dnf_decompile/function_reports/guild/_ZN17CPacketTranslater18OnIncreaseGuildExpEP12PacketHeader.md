...
|---|---|---|---|---|---|
| guild | DIFF | `0x80743e8` | `0x589` | `0x806a844` | `0x550` |
...
+mov    %eax,-0x40(%ebp)
+cmpl   $0x0,-0x40(%ebp)
+je     <T> <_ZN17CPacketTranslater18OnIncreaseGuildExpEP12PacketHeader+0x545>
+mov    -0x40(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CGuild11GetGuildExpEv>
+mov    %eax,-0x3c(%ebp)
...
+jne    <T> <_ZN17CPacketTranslater18OnIncreaseGuildExpEP12PacketHeader+0x4db>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnIncreaseGuildExpEP12PacketHeader+0x4d4>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnIncreaseGuildExpEP12PacketHeader+0x540>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
