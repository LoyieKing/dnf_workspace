...
|---|---|---|---|---|---|
| guild | DIFF | `0x80743e8` | `0x589` | `0x806aa66` | `0x566` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 912 行）：
