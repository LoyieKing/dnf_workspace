# _ZN13STGuildDBInfoC1Ev

`STGuildDBInfo::STGuildDBInfo()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x80929e2` | `0x43` | `0x80585d6` | `0xa6` |
...
void __thiscall STGuildDBInfo::_ZN13STGuildDBInfoC1Ev(STGuildDBInfo *this)
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 2232 行）：
