...
|---|---|---|---|---|---|
| guild | DIFF | `0x8080360` | `0x4d3` | `0x8076c26` | `0x4cb` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3696 行）：
