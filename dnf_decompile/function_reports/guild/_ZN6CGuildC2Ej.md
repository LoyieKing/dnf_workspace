...
|---|---|---|---|---|---|
| guild | DIFF | `0x808cc46` | `0x162` | `0x8052d0e` | `0x162` |
...
void __thiscall CGuild::_ZN6CGuildC2Ej(CGuild *this,uint param_1)
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 353 行）：
