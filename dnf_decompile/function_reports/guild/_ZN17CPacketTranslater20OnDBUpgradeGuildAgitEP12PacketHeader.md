...
|---|---|---|---|---|---|
| guild | DIFF | `0x80834ae` | `0x232` | `0x80796bc` | `0x21b` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5010 行）：
