...
|---|---|---|---|---|---|
| guild | DIFF | `0x80834ae` | `0x232` | `0x807970c` | `0x21d` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4313 行）：
