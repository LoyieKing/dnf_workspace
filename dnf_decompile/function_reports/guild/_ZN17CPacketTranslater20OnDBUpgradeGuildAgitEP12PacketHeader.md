...
|---|---|---|---|---|---|
| guild | DIFF | `0x80834ae` | `0x232` | `0x8079262` | `0x14a` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4269 行）：
