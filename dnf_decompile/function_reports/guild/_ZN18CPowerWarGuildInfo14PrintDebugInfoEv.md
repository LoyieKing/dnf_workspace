...
|---|---|---|---|---|---|
| guild | DIFF | `0x80aa64c` | `0x195` | `0x80a087a` | `0x193` |
...
-lea    -0x48(%ebp),%eax
+jmp    <T> <_ZN18CPowerWarGuildInfo14PrintDebugInfoEv+0x129>
+lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+test   %al,%al
+jne    <T> <_ZN18CPowerWarGuildInfo14PrintDebugInfoEv+0xa0>
+movl   $0x199,0x8(%esp)
 movl   $"PrintDebugInfo",0x4(%esp)
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/PowerWarGuildInfo.cpp](source/DNFServer/GameServer/Guild/PowerWarGuildInfo.cpp)（约第 339 行）：
