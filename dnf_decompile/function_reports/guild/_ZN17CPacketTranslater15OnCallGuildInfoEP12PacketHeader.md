...
|---|---|---|---|---|---|
| guild | DIFF | `0x807cd58` | `0x402` | `0x807336e` | `0x408` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2542 行）：
