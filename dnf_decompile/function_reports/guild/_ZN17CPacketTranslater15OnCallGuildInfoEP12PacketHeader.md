...
|---|---|---|---|---|---|
| guild | DIFF | `0x807cd58` | `0x402` | `0x8072f7c` | `0x3e5` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3363 行）：
