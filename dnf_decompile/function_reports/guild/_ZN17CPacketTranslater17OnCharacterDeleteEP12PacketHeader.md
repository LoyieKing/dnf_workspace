...
|---|---|---|---|---|---|
| guild | DIFF | `0x807697a` | `0x320` | `0x806d470` | `0x22b` |
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jne    <T> <_ZN17CPacketTranslater17OnCharacterDeleteEP12PacketHeader+0x16f>
 movl   $0x7bb,0x8(%esp)
...
-lea    -0x8b(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater17OnCharacterDeleteEP12PacketHeader+0x223>
+lea    -0x77(%ebp),%eax
 mov    %eax,(%esp)
