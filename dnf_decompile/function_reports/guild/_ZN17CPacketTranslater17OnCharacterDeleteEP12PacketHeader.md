...
|---|---|---|---|---|---|
| guild | DIFF | `0x807697a` | `0x320` | `0x806cf1a` | `0x33e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1596 行）：
