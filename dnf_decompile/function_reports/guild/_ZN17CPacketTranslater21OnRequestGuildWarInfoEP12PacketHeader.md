...
|---|---|---|---|---|---|
| guild | NEAR | `0x8076700` | `0x27a` | `0x806caa6` | `0x27a` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1382 行）：
