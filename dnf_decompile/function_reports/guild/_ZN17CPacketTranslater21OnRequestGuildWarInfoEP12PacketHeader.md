...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076700` | `0x27a` | `0x806cde4` | `0x1b3` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1428 行）：
