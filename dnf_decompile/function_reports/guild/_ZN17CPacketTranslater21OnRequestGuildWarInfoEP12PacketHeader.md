...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076700` | `0x27a` | `0x806d2ba` | `0x1b5` |
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jne    <T> <_ZN17CPacketTranslater21OnRequestGuildWarInfoEP12PacketHeader+0x17e>
 movl   $0x78d,0x8(%esp)
 movl   $"OnRequestGuildWarInfo",0x4(%esp)
-lea    -0x40(%ebp),%eax
+lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater21OnRequestGuildWarInfoEP12PacketHeader+0x1ad>
 mov    -0x20(%ebp),%eax
 add    $0x12,%eax
 mov    %eax,0x4(%esp)
 mov    -0x24(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1290 行）：
