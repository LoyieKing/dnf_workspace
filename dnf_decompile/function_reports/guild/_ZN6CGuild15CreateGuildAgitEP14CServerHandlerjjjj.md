# _ZN6CGuild15CreateGuildAgitEP14CServerHandlerjjjj

`CGuild::CreateGuildAgit(CServerHandler*, unsigned int, unsigned int, unsigned int, unsigned int)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x8091c16` | `0x79` | `0x80578d4` | `0x83` |
...
@@ -1,37 +1,41 @@
 ...
 and    $0x4,%eax
 test   %eax,%eax
-je     <T> <_ZN6CGuild15CreateGuildAgitEP14CServerHandlerjjjj+0x77>
+je     <T> <_ZN6CGuild15CreateGuildAgitEP14CServerHandlerjjjj+0x81>
 mov    0x1c(%ebp),%eax
 mov    %eax,0x4(%esp)
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...
+lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN27Packet_DB_Create_Guild_AgitC1Ev>
+lea    -0x1c(%ebp),%eax
+lea    0xa(%eax),%edx
 mov    0x10(%ebp),%eax
-mov    %eax,-0x10(%ebp)
...
void __thiscall
CGuild::_ZN6CGuild15CreateGuildAgitEP14CServerHandlerjjjj
          (CGuild *this,CServerHandler *param_1,uint param_2,uint param_3,uint param_4,uint param_5)

{
  Packet_DB_Create_Guild_Agit local_1e [10];
  uint local_14;
  uint local_10;
  
  if ((*(ushort *)(this + 0x1c) & 4) != 0) {
    _ZN6CGuild12SubGuildFundEj(this,param_5);
    SubPowerWarPoint(this,param_4);
    SendGuildInfoToMembers(this,false);
    Packet_DB_Create_Guild_Agit::_ZN27Packet_DB_Create_Guild_AgitC2Ev(local_1e);
    local_14 = param_2;
    local_10 = param_3;
