...
|---|---|---|---|---|---|
| guild | DIFF | `0x809686c` | `0x207` | `0x805c85a` | `0x208` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 472 行）：
