...
|---|---|---|---|---|---|
| guild | DIFF | `0x80732b8` | `0x2bb` | `0x8069ac0` | `0x2b6` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 745 行）：
