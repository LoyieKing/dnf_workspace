...
|---|---|---|---|---|---|
| guild | DIFF | `0x8081d32` | `0x277` | `0x80785ae` | `0x17e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4074 行）：
