...
|---|---|---|---|---|---|
| guild | DIFF | `0x8081d32` | `0x277` | `0x8078040` | `0x25f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3922 行）：
