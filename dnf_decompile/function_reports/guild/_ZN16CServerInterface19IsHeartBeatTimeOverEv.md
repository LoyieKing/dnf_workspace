...
|---|---|---|---|---|---|
| guild | DIFF | `0x806f7b0` | `0x58` | `0x8083898` | `0x52` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFServerInterface.cpp](source/DNFServer/GameServer/Guild/DNFServerInterface.cpp)（约第 142 行）：
