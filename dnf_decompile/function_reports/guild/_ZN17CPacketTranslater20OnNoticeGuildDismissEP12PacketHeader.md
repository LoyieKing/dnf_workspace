...
|---|---|---|---|---|---|
| guild | DIFF | `0x8073948` | `0x328` | `0x806a026` | `0x33f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 941 行）：
