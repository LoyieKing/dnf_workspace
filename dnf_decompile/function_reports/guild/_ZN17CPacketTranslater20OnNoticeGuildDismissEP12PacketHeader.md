...
|---|---|---|---|---|---|
| guild | DIFF | `0x8073948` | `0x328` | `0x8069e62` | `0x323` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 783 行）：
