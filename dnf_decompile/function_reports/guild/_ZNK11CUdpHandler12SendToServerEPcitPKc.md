...
|---|---|---|---|---|---|
| guild | DIFF | `0x8050a46` | `0x27b` | `0x8089be4` | `0x27b` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFUdpHandler.cpp](source/DNFServer/GameServer/Guild/DNFUdpHandler.cpp)（约第 309 行）：
