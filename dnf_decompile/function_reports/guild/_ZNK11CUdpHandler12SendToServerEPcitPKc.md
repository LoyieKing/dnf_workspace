...
|---|---|---|---|---|---|
| guild | DIFF | `0x8050a46` | `0x27b` | `0x8089904` | `0x27b` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFUdpHandler.cpp](source/DNFServer/GameServer/Guild/DNFUdpHandler.cpp)（约第 307 行）：
