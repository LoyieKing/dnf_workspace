...
|---|---|---|---|---|---|
| guild | DIFF | `0x8085112` | `0x798` | `0x807afc2` | `0x69e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4888 行）：
