...
|---|---|---|---|---|---|
| guild | DIFF | `0x8085112` | `0x798` | `0x807a938` | `0x67f` |
...
+mov    %al,-0x15(%ebp)
+cmpb   $0x3,-0x15(%ebp)
+je     <T> <_ZN17CPacketTranslater19OnGuildCargoPopItemEP12PacketHeader+0x405>
+cmpb   $0x1,-0x15(%ebp)
+je     <T> <_ZN17CPacketTranslater19OnGuildCargoPopItemEP12PacketHeader+0x405>
+cmpb   $0x2,-0x15(%ebp)
+je     <T> <_ZN17CPacketTranslater19OnGuildCargoPopItemEP12PacketHeader+0x405>
...
+mov    %eax,-0xff(%ebp)
+cmpl   $0xc1,-0x14(%ebp)
+jne    <T> <_ZN17CPacketTranslater19OnGuildCargoPopItemEP12PacketHeader+0x57b>
+movl   $0x35,0x8(%esp)
+lea    -0xc1(%ebp),%eax
+mov    %eax,0x4(%esp)
+lea    -0x111(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater19OnGuildCargoPopItemEP12PacketHeader+0x615>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater19OnGuildCargoPopItemEP12PacketHeader+0x60e>
 mov    %edx,%ebx
 mov    %eax,%esi
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5436 行）：
