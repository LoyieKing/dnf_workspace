...
|---|---|---|---|---|---|
| guild | DIFF | `0x8085112` | `0x798` | `0x807ab00` | `0x67d` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4711 行）：
