...
|---|---|---|---|---|---|
| guild | DIFF | `0x8085112` | `0x798` | `0x807a9e0` | `0x67f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5319 行）：
