...
|---|---|---|---|---|---|
| guild | DIFF | `0x806d676` | `0xf5` | `0x80816ec` | `0xea` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFServerHandler.cpp](source/DNFServer/GameServer/Guild/DNFServerHandler.cpp)（约第 319 行）：
