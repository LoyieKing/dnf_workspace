...
|---|---|---|---|---|---|
| guild | DIFF | `0x809fe24` | `0x79` | `0x809248a` | `0x79` |
...
定义于 [source/DNFServer/GameServer/Guild/GuildCargo.cpp](source/DNFServer/GameServer/Guild/GuildCargo.cpp)（约第 373 行）：
