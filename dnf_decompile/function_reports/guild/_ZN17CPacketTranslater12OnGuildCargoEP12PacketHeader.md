...
|---|---|---|---|---|---|
| guild | DIFF | `0x8083d24` | `0x3de` | `0x8079ea8` | `0x3e5` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5151 行）：
