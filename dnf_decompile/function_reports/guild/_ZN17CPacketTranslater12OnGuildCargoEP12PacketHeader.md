...
|---|---|---|---|---|---|
| guild | DIFF | `0x8083d24` | `0x3de` | `0x8079808` | `0x3db` |
...
+test   %eax,%eax
+jne    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x4f>
+movl   $0x188c,0x8(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x3d1>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x30(%ebp)
-mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
-test   %eax,%eax
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jne    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0xb3>
+movl   $0x1896,0x8(%esp)
+movl   $&_ZZN17CPacketTranslater12OnGuildCargoEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
+lea    -0x48(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %eax,-0x14(%ebp)
+cmpl   $0x0,-0x14(%ebp)
+jne    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x11a>
 movl   $0x189e,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater12OnGuildCargoEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x60(%ebp),%eax
+lea    -0x40(%ebp),%eax
...
-jmp    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x3d3>
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x29b>
+mov    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %al,-0xd(%ebp)
+cmpb   $0x3,-0xd(%ebp)
+je     <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x18c>
+cmpb   $0x1,-0xd(%ebp)
+je     <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x18c>
+cmpb   $0x2,-0xd(%ebp)
+jne    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x231>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 add    $0x290,%eax
 mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x1e3>
+movb   $0xcc,-0x61(%ebp)
 movl   $0x18c2,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater12OnGuildCargoEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x48(%ebp),%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x217>
+movb   $0xc1,-0x61(%ebp)
+mov    -0x14(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN6CGuild13GetGuildCargoEv>
...
+jne    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x377>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x370>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater12OnGuildCargoEP12PacketHeader+0x3cc>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5001 行）：
