...
|---|---|---|---|---|---|
| guild | DIFF | `0x80836e6` | `0x2c3` | `0x8079930` | `0x2a2` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4355 行）：
