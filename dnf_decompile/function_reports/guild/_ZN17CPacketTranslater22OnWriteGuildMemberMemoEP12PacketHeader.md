...
|---|---|---|---|---|---|
| guild | DIFF | `0x80836e6` | `0x2c3` | `0x807968e` | `0x1d0` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4331 行）：
