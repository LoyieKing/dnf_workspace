...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076014` | `0x23c` | `0x806c396` | `0x262` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1302 行）：
