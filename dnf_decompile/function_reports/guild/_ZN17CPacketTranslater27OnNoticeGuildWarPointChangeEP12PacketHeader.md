...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076014` | `0x23c` | `0x806c34a` | `0x260` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1887 行）：
