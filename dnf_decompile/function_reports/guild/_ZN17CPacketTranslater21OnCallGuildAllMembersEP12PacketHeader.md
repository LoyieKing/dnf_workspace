...
|---|---|---|---|---|---|
| guild | DIFF | `0x80771b6` | `0x52d` | `0x806d62a` | `0x522` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1506 行）：
