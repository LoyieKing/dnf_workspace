...
|---|---|---|---|---|---|
| guild | DIFF | `0x80771b6` | `0x52d` | `0x806d4e8` | `0x516` |
...
-lea    -0x45(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater21OnCallGuildAllMembersEP12PacketHeader+0x50e>
+lea    -0x2d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x45(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater21OnCallGuildAllMembersEP12PacketHeader+0x4a4>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater21OnCallGuildAllMembersEP12PacketHeader+0x49d>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jmp    <T> <_ZN17CPacketTranslater21OnCallGuildAllMembersEP12PacketHeader+0x509>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2161 行）：
