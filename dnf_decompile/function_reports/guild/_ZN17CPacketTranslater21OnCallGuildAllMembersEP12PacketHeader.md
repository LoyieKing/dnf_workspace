...
|---|---|---|---|---|---|
| guild | DIFF | `0x80771b6` | `0x52d` | `0x806d508` | `0x516` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2071 行）：
