...
|---|---|---|---|---|---|
| guild | DIFF | `0x80795e6` | `0x205` | `0x806f944` | `0x1ff` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2615 行）：
