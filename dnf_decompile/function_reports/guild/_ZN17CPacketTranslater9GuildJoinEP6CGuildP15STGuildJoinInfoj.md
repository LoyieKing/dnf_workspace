...
|---|---|---|---|---|---|
| guild | DIFF | `0x80795e6` | `0x205` | `0x806fba4` | `0x202` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1953 行）：
