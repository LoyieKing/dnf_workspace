...
|---|---|---|---|---|---|
| guild | DIFF | `0x806c47e` | `0x61` | `0x80525c6` | `0x5f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGameServer.cpp](source/DNFServer/GameServer/Guild/DNFGameServer.cpp)（约第 142 行）：
