...
|---|---|---|---|---|---|
| guild | NEAR | `0x807e712` | `0x116` | `0x80749f0` | `0x116` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3029 行）：
