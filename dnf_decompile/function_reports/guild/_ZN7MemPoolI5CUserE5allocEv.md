...
|---|---|---|---|---|---|
| guild | DIFF | `0x8067998` | `0x150` | `0x8095620` | `0x193` |
...
+jne    <T> <_ZN7MemPoolI5CUserE5allocEv+0x17a>
...
-mov    0x4(%eax),%edx
+test   %eax,%eax
+jne    <T> <_ZN7MemPoolI5CUserE5allocEv+0x157>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
...
+jmp    <T> <_ZN7MemPoolI5CUserE5allocEv+0x7f>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
...
+jne    <T> <_ZN7MemPoolI5CUserE5allocEv+0x48>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
...
-mov    -0x14(%ebp),%eax
-add    $0x40,%esp
+jmp    <T> <_ZN7MemPoolI5CUserE5allocEv+0x18a>
+mov    &_ZN7MemPoolI5CUserE15headOfFreeList_E,%eax
+mov    %eax,-0x10(%ebp)
+mov    &_ZN7MemPoolI5CUserE15headOfFreeList_E,%eax
+mov    %eax,%edx
  ...
  if (*(int *)this == 0x8c) {
    ...
    if (headOfFreeList_ == (void *)0x0) {
      ...
      for (local_10 = 0; local_10 < *(int *)(this + 4) - 1U; local_10 = local_10 + 1) {
        *(void **)((int)local_24 + local_10 * 0x8c + 0x88) =
             (void *)((local_10 + 1) * 0x8c + (int)local_24);
      }
      *(undefined4 *)((int)local_24 + (*(int *)(this + 4) + -1) * 0x8c + 0x88) = 0;
      headOfFreeList_ = (void *)((int)local_24 + 0x8c);
      local_18 = local_24;
      local_14 = local_24;
      ...
      headOfFreeList_ = *(void **)((int)headOfFreeList_ + 0x88);
    }
  }
  else {
    local_18 = operator_new(0x8c);
  }
  return local_18;
}
```
