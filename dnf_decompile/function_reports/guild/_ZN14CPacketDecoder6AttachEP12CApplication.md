...
|---|---|---|---|---|---|
| guild | DIFF | `0x80707bc` | `0xa8` | `0x80673ca` | `0xe5` |
...
+je     <T> <_ZN14CPacketDecoder6AttachEP12CApplication+0xdf>
+mov    0x8(%ebp),%eax
+mov    %eax,%ebx
 mov    0xc(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN14CPacketDecoder6AttachEP12CApplication+0x80>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
-call   <T> <_ZN12CApplication16Get_TcpNetSystemEv>
+mov    %eax,(%ebx)
+jmp    <T> <_ZN14CPacketDecoder6AttachEP12CApplication+0x8c>
+mov    0x8(%ebp),%eax
+add    $0xc,%eax
+movl   $0x0,(%eax)
+mov    0x8(%ebp),%eax
+lea    0x10(%eax),%ebx
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN14CPacketDecoder6AttachEP12CApplication+0xa5>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,(%esp)
-call   <T> <_ZN12CApplication16Get_TcpNetSystemEv>
+jmp    <T> <_ZN14CPacketDecoder6AttachEP12CApplication+0xaa>
+mov    $0x0,%eax
+mov    %eax,(%ebx)
+mov    0x8(%ebp),%eax
+lea    0x14(%eax),%ebx
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN14CPacketDecoder6AttachEP12CApplication+0xc5>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN13CTcpNetSystem16Get_TcpRecvBLockEv>
-mov    0x8(%ebp),%edx
-mov    %eax,0x14(%edx)
+jmp    <T> <_ZN14CPacketDecoder6AttachEP12CApplication+0xca>
+mov    $0x0,%eax
+mov    %eax,(%ebx)
+mov    0x8(%ebp),%eax
+lea    0x18(%eax),%ebx
