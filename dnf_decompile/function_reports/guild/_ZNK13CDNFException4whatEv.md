...
|---|---|---|---|---|---|
| guild | DIFF | `0x804c5ac` | `0x7a` | `0x80851e4` | `0x65` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFTableBase.cpp](source/DNFServer/GameServer/Guild/DNFTableBase.cpp)（约第 77 行）：
