...
|---|---|---|---|---|---|
| guild | DIFF | `0x807ea8a` | `0x47c` | `0x8074f62` | `0x3b1` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2968 行）：
