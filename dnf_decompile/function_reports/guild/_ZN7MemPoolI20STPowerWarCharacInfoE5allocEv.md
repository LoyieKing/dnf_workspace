# _ZN7MemPoolI20STPowerWarCharacInfoE5allocEv

`MemPool<STPowerWarCharacInfo>::alloc()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x80a81bc` | `0x14e` | `0x809503e` | `0x191` |
...
+sub    $0x44,%esp
 ...
 mov    (%eax),%eax
-cmp    $0xc,%eax
-je     <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x23>
-movl   $0xc,(%esp)
-call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x147>
+cmp    $0x10,%eax
+jne    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x178>
 mov    &_ZN7MemPoolI20STPowerWarCharacInfoE15headOfFreeList_E,%eax
-mov    %eax,-0x14(%ebp)
-cmpl   $0x0,-0x14(%ebp)
-je     <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x41>
-mov    -0x14(%ebp),%eax
-mov    0x8(%eax),%eax
-mov    %eax,&_ZN7MemPoolI20STPowerWarCharacInfoE15headOfFreeList_E
-jmp    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x144>
-mov    0x8(%ebp),%eax
-mov    0x4(%eax),%edx
+test   %eax,%eax
+jne    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x155>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
...
+mov    %eax,-0x18(%ebp)
 movl   $0x0,-0xc(%ebp)
-jmp    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x8d>
-mov    -0xc(%ebp),%edx
-mov    %edx,%eax
-add    %eax,%eax
-add    %edx,%eax
-shl    $0x2,%eax
+jmp    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x7d>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
...
+mov    %eax,(%edx)
 ...
 seta   %al
 test   %al,%al
-jne    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x63>
+jne    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x46>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
...
-mov    -0x14(%ebp),%eax
-add    $0x40,%esp
+jmp    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x188>
+mov    &_ZN7MemPoolI20STPowerWarCharacInfoE15headOfFreeList_E,%eax
+mov    %eax,-0x10(%ebp)
+mov    &_ZN7MemPoolI20STPowerWarCharacInfoE15headOfFreeList_E,%eax
+mov    %eax,%edx
...
void * __thiscall
MemPool<STPowerWarCharacInfo>::_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv
          (MemPool<STPowerWarCharacInfo> *this)
  ...
  if (*(int *)this == 0xc) {
    ...
    if (headOfFreeList_ == (void *)0x0) {
      ...
      for (local_10 = 0; local_10 < *(int *)(this + 4) - 1U; local_10 = local_10 + 1) {
        *(void **)((int)local_24 + local_10 * 0xc + 8) =
             (void *)((local_10 + 1) * 0xc + (int)local_24);
      }
      *(undefined4 *)((int)local_24 + (*(int *)(this + 4) + -1) * 0xc + 8) = 0;
      headOfFreeList_ = (void *)((int)local_24 + 0xc);
      local_18 = local_24;
      local_14 = local_24;
      ...
      headOfFreeList_ = *(void **)((int)headOfFreeList_ + 8);
    }
  }
  else {
