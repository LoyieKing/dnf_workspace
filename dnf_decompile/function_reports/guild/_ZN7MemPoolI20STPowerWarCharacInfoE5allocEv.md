...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a81bc` | `0x14e` | `0x8094cd0` | `0x15d` |
...
+jmp    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x156>
...
+jmp    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x153>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
...
+jmp    <T> <_ZN7MemPoolI20STPowerWarCharacInfoE5allocEv+0x97>
 mov    -0xc(%ebp),%edx
 mov    %edx,%eax
 add    %eax,%eax
 add    %edx,%eax
...
+sub    $0xc,%eax
 ...
 mov    (%eax),%ebx
 movl   $0x7d,0x8(%esp)
 movl   $&_ZZN7MemPoolI20STPowerWarCharacInfoE5allocEvE12__FUNCTION__,0x4(%esp)
 lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
