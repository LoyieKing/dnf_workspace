...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a1d5a` | `0x94` | `0x8096690` | `0xaf` |
...
+lea    -0x1c(%ebp),%eax
 ...
 test   %al,%al
-je     <T> <_ZN18CMemoryCashManager13SetUserObjectEP5CUser+0x8d>
-lea    -0x18(%ebp),%eax
+je     <T> <_ZN18CMemoryCashManager13SetUserObjectEP5CUser+0x86>
+lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    $0x1,%eax
-jmp    <T> <_ZN18CMemoryCashManager13SetUserObjectEP5CUser+0x92>
-mov    $0x0,%eax
+mov    0x8(%ebp),%edx
+lea    -0x10(%ebp),%eax
+mov    %edx,0x4(%esp)
