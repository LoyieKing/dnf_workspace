...
|---|---|---|---|---|---|
| guild | DIFF | `0x8086dae` | `0x338` | `0x807c5e4` | `0x268` |
...
+jne    <T> <_ZN17CPacketTranslater28OnDBLoadReplyGuildBoardWriteEP12PacketHeader+0x54>
 movl   $0x1d0c,0x8(%esp)
 movl   $"OnDBLoadReplyGuildBoardWrite",0x4(%esp)
-lea    -0x5c(%ebp),%eax
+lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater28OnDBLoadReplyGuildBoardWriteEP12PacketHeader+0x25f>
+mov    -0x20(%ebp),%eax
+add    $0x10,%eax
+mov    (%eax),%eax
+mov    %eax,-0x1c(%ebp)
...
+mov    %eax,-0x18(%ebp)
+cmpl   $0x0,-0x18(%ebp)
+jne    <T> <_ZN17CPacketTranslater28OnDBLoadReplyGuildBoardWriteEP12PacketHeader+0xbf>
 movl   $0x1d16,0x8(%esp)
 movl   $"OnDBLoadReplyGuildBoardWrite",0x4(%esp)
-lea    -0x54(%ebp),%eax
+lea    -0x30(%ebp),%eax
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN17CPacketTranslater28OnDBLoadReplyGuildBoardWriteEP12PacketHeader+0x12a>
 movl   $0x1d1d,0x8(%esp)
 movl   $"OnDBLoadReplyGuildBoardWrite",0x4(%esp)
-lea    -0x4c(%ebp),%eax
+lea    -0x38(%ebp),%eax
...
-mov    0xc(%eax),%ebx
-mov    -0x28(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater28OnDBLoadReplyGuildBoardWriteEP12PacketHeader+0x1b7>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x2c(%ebp),%edx
-mov    %edx,0x10(%esp)
+je     <T> <_ZN17CPacketTranslater28OnDBLoadReplyGuildBoardWriteEP12PacketHeader+0x25f>
+mov    -0x18(%ebp),%eax
+mov    %eax,0x10(%esp)
 movl   $0x232e,0xc(%esp)
-mov    %esi,0x8(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4964 行）：
