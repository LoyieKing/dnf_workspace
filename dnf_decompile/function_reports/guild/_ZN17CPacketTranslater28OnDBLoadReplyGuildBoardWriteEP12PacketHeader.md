...
|---|---|---|---|---|---|
| guild | DIFF | `0x8086dae` | `0x338` | `0x807c25e` | `0x266` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5135 行）：
