...
|---|---|---|---|---|---|
| guild | DIFF | `0x8086dae` | `0x338` | `0x807ccb4` | `0x335` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5149 行）：
