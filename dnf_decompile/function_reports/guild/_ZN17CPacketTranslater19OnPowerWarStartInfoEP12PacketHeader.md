...
|---|---|---|---|---|---|
| guild | NEAR | `0x807f8e2` | `0x1ed` | `0x8075c04` | `0x1ed` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3331 行）：
