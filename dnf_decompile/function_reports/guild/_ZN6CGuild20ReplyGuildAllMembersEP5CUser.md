...
|---|---|---|---|---|---|
| guild | DIFF | `0x808fcd4` | `0xa29` | `0x8055a6c` | `0x74f` |
...
-je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0xa1e>
-lea    -0x2fcb(%ebp),%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x743>
+lea    -0x2fef(%ebp),%eax
 mov    %eax,(%esp)
...
+movzwl -0x46(%ebp),%eax
+cmp    -0x44(%ebp),%eax
+jle    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x744>
+lea    -0x181b(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x1c(%ebp),%edx
+mov    %eax,-0x28(%ebp)
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x6c7>
+mov    -0x28(%ebp),%edx
 mov    %edx,%eax
 shl    $0x6,%eax
 add    %edx,%eax
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jne    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x51f>
+mov    -0x20(%ebp),%eax
+movb   $0xff,(%eax)
+mov    -0x20(%ebp),%eax
+add    $0x22,%eax
...
+add    $0x38,%eax
+movb   $0x0,(%eax)
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x664>
+mov    -0x20(%ebp),%eax
+lea    0x1(%eax),%ebx
+mov    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,-0x2fdc(%ebp)
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x5e1>
+mov    -0x24(%ebp),%eax
+mov    (%eax),%eax
+mov    %eax,-0x2ffc(%ebp)
+mov    -0x1c(%ebp),%eax
...
+lea    -0x54(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x638>
+mov    -0x20(%ebp),%eax
+lea    0x37(%eax),%ebx
+mov    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
-lea    (%edx,%eax,1),%eax
-sub    $0x178f,%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x664>
+mov    -0x20(%ebp),%eax
+add    $0x39,%eax
 movb   $0x1,(%eax)
...
+addl   $0x1,-0x2c(%ebp)
+cmpl   $0x5f,-0x2c(%ebp)
+jle    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x6c3>
+mov    -0x30(%ebp),%eax
+lea    0x16(%eax),%edx
+mov    -0x2c(%ebp),%eax
+mov    %al,(%edx)
...
-movzbl %al,%edx
+jne    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x422>
+cmpl   $0x0,-0x2c(%ebp)
...
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x744>
 nop
-add    $0x2ffc,%esp
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x744>
+nop
