...
|---|---|---|---|---|---|
| guild | DIFF | `0x808fcd4` | `0xa29` | `0x8055cd8` | `0x734` |
...
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x722>
 mov    0x8(%ebp),%eax
 movzwl 0x1c(%eax),%eax
 movzwl %ax,%eax
 and    $0x4,%eax
...
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x725>
 mov    0x8(%ebp),%eax
 movzwl 0x1c(%eax),%eax
 movzwl %ax,%eax
 and    $0x10,%eax
...
-je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0xa1e>
-lea    -0x2fcb(%ebp),%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x728>
+lea    -0x56(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x122>
 movl   $0x63b,0x8(%esp)
 movl   $"ReplyGuildAllMembers",0x4(%esp)
-lea    -0x40(%ebp),%eax
+lea    -0x60(%ebp),%eax
 mov    %eax,(%esp)
...
+movl   $0x0,-0x40(%ebp)
+movl   $0x0,-0x40(%ebp)
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x368>
+mov    0x8(%ebp),%ecx
+mov    -0x40(%ebp),%edx
+mov    %edx,%eax
 shl    $0x6,%eax
...
+mov    %eax,(%esp)
+call   <T> <memcpy>
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x35a>
+mov    -0x38(%ebp),%eax
+lea    0x1(%eax),%ebx
+mov    -0x34(%ebp),%eax
+mov    %eax,(%esp)
...
-mov    %dx,0x6(%eax)
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x2d5>
+movl   $0x658,0x8(%esp)
+movl   $"ReplyGuildAllMembers",0x4(%esp)
+lea    -0x68(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x32e>
+mov    -0x38(%ebp),%eax
+lea    0x37(%eax),%ebx
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    (%edx,%eax,1),%eax
-sub    $0x2f46,%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x35a>
+mov    -0x38(%ebp),%eax
+add    $0x39,%eax
 movb   $0x1,(%eax)
...
+addl   $0x1,-0x44(%ebp)
+cmpl   $0x5f,-0x44(%ebp)
+jg     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x37c>
+addl   $0x1,-0x40(%ebp)
+movzwl -0x46(%ebp),%eax
+cmp    -0x40(%ebp),%eax
 setg   %al
...
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x37d>
 nop
-mov    -0x20(%ebp),%eax
-mov    %al,-0x2f98(%ebp)
...
+movzwl -0x46(%ebp),%eax
+cmp    -0x44(%ebp),%eax
+jle    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x729>
+lea    -0x72(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    -0x40(%ebp),%eax
+mov    %eax,-0x28(%ebp)
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x6ac>
+mov    0x8(%ebp),%ecx
+mov    -0x28(%ebp),%edx
+mov    %edx,%eax
 shl    $0x6,%eax
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jne    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x514>
+mov    -0x20(%ebp),%eax
+movb   $0xff,(%eax)
+mov    -0x20(%ebp),%eax
+add    $0x22,%eax
...
+add    $0x38,%eax
+movb   $0x0,(%eax)
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x649>
+mov    -0x20(%ebp),%eax
+lea    0x1(%eax),%ebx
+mov    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x5c4>
+movl   $0x695,0x8(%esp)
+movl   $"ReplyGuildAllMembers",0x4(%esp)
+lea    -0x7c(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x61d>
+mov    -0x20(%ebp),%eax
+lea    0x37(%eax),%ebx
+mov    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
-mov    %eax,(%esp)
-call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x649>
+mov    -0x20(%ebp),%eax
+add    $0x39,%eax
+movb   $0x1,(%eax)
+addl   $0x1,-0x2c(%ebp)
+cmpl   $0x5f,-0x2c(%ebp)
+jle    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x6a8>
+mov    -0x30(%ebp),%eax
+lea    0x16(%eax),%edx
+mov    -0x2c(%ebp),%eax
+mov    %al,(%edx)
...
-movzbl %al,%edx
+jne    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x417>
+cmpl   $0x0,-0x2c(%ebp)
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x729>
+mov    -0x30(%ebp),%eax
+lea    0x16(%eax),%edx
+mov    -0x2c(%ebp),%eax
+mov    %al,(%edx)
...
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x729>
 nop
-add    $0x2ffc,%esp
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x729>
+nop
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 1280 行）：
