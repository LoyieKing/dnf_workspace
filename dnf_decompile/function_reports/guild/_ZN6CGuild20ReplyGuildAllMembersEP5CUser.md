...
|---|---|---|---|---|---|
| guild | DIFF | `0x808fcd4` | `0xa29` | `0x8055a6e` | `0x74c` |
...
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x73a>
 mov    0x8(%ebp),%eax
 movzwl 0x1c(%eax),%eax
 movzwl %ax,%eax
 and    $0x4,%eax
...
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x73d>
 mov    0x8(%ebp),%eax
 movzwl 0x1c(%eax),%eax
 movzwl %ax,%eax
 and    $0x10,%eax
...
-je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0xa1e>
-lea    -0x2fcb(%ebp),%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x740>
+lea    -0x2fef(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x114>
 mov    0x8(%ebp),%eax
 movzwl 0x1e(%eax),%eax
 movzwl %ax,%esi
 mov    0x8(%ebp),%eax
...
+mov    %eax,(%esp)
+call   <T> <memcpy>
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x35c>
+mov    -0x38(%ebp),%eax
+lea    0x1(%eax),%ebx
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+lea    -0x5c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x330>
+mov    -0x38(%ebp),%eax
+lea    0x37(%eax),%ebx
+mov    -0x34(%ebp),%eax
+mov    %eax,(%esp)
...
-lea    (%edx,%eax,1),%eax
-sub    $0x2f46,%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x35c>
+mov    -0x38(%ebp),%eax
+add    $0x39,%eax
 movb   $0x1,(%eax)
...
+addl   $0x1,-0x44(%ebp)
+cmpl   $0x5f,-0x44(%ebp)
+jg     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x37e>
+addl   $0x1,-0x40(%ebp)
+movzwl -0x46(%ebp),%eax
+cmp    -0x40(%ebp),%eax
 setg   %al
...
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x37f>
 nop
-mov    -0x20(%ebp),%eax
-mov    %al,-0x2f98(%ebp)
...
+movzwl -0x46(%ebp),%eax
+cmp    -0x44(%ebp),%eax
+jle    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x741>
+lea    -0x181b(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    -0x40(%ebp),%eax
+mov    %eax,-0x28(%ebp)
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x6c4>
+mov    -0x28(%ebp),%edx
 mov    %edx,%eax
 shl    $0x6,%eax
 add    %edx,%eax
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jne    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x51c>
+mov    -0x20(%ebp),%eax
+movb   $0xff,(%eax)
+mov    -0x20(%ebp),%eax
+add    $0x22,%eax
...
+add    $0x38,%eax
+movb   $0x0,(%eax)
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x661>
+mov    -0x20(%ebp),%eax
+lea    0x1(%eax),%ebx
+mov    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,-0x2fdc(%ebp)
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x5de>
+mov    -0x24(%ebp),%eax
+mov    (%eax),%eax
+mov    %eax,-0x2ffc(%ebp)
+mov    -0x1c(%ebp),%eax
...
+lea    -0x54(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x635>
+mov    -0x20(%ebp),%eax
+lea    0x37(%eax),%ebx
+mov    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
-lea    (%edx,%eax,1),%eax
-sub    $0x178f,%eax
+je     <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x661>
+mov    -0x20(%ebp),%eax
+add    $0x39,%eax
 movb   $0x1,(%eax)
...
+addl   $0x1,-0x2c(%ebp)
+cmpl   $0x5f,-0x2c(%ebp)
+jle    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x6c0>
+mov    -0x30(%ebp),%eax
+lea    0x16(%eax),%edx
+mov    -0x2c(%ebp),%eax
+mov    %al,(%edx)
...
-movzbl %al,%edx
+jne    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x41f>
+cmpl   $0x0,-0x2c(%ebp)
...
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x741>
 nop
-add    $0x2ffc,%esp
+jmp    <T> <_ZN6CGuild20ReplyGuildAllMembersEP5CUser+0x741>
+nop
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 1466 行）：
