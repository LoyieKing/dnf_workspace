...
|---|---|---|---|---|---|
| guild | DIFF | `0x8095e46` | `0x4f8` | `0x805c3a4` | `0x500` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 340 行）：
