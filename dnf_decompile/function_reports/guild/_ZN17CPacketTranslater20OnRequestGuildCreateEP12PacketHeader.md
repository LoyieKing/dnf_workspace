...
|---|---|---|---|---|---|
| guild | NEAR | `0x807f108` | `0x38c` | `0x8075476` | `0x38c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3212 行）：
