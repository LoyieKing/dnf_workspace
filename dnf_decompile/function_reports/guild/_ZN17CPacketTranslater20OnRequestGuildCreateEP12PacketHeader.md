...
|---|---|---|---|---|---|
| guild | DIFF | `0x807f108` | `0x38c` | `0x80757f2` | `0x3bf` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3282 行）：
