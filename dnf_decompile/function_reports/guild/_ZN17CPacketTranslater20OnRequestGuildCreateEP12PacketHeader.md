...
|---|---|---|---|---|---|
| guild | DIFF | `0x807f108` | `0x38c` | `0x807590a` | `0x3bf` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3413 行）：
