...
|---|---|---|---|---|---|
| guild | DIFF | `0x807f108` | `0x38c` | `0x8075428` | `0x382` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3213 行）：
