...
|---|---|---|---|---|---|
| guild | DIFF | `0x8072c3c` | `0x2e2` | `0x8069302` | `0x2e7` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 644 行）：
