...
|---|---|---|---|---|---|
| guild | DIFF | `0x8072c3c` | `0x2e2` | `0x80693d6` | `0x2d9` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 773 行）：
