...
|---|---|---|---|---|---|
| guild | DIFF | `0x807a25a` | `0x62d` | `0x8070920` | `0x630` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2138 行）：
