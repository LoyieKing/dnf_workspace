...
|---|---|---|---|---|---|
| guild | DIFF | `0x807a25a` | `0x62d` | `0x80705a8` | `0x5f6` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2697 行）：
