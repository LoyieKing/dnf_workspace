...
|---|---|---|---|---|---|
| guild | DIFF | `0x8074972` | `0x56b` | `0x806b12c` | `0x570` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1120 行）：
