...
|---|---|---|---|---|---|
| guild | NEAR | `0x8074972` | `0x56b` | `0x806ad96` | `0x56b` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 948 行）：
