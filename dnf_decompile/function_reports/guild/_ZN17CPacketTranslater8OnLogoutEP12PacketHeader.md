...
|---|---|---|---|---|---|
| guild | DIFF | `0x8071554` | `0x416` | `0x8067b12` | `0x451` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 293 行）：
