...
|---|---|---|---|---|---|
| guild | DIFF | `0x8071554` | `0x416` | `0x806796c` | `0x410` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 914 行）：
