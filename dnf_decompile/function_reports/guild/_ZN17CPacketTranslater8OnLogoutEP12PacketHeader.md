...
|---|---|---|---|---|---|
| guild | DIFF | `0x8071554` | `0x416` | `0x8067a94` | `0x42a` |
...
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x420>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 add    $0x10,%eax
-mov    %eax,-0x24(%ebp)
-mov    -0x28(%ebp),%eax
...
-mov    -0x28(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x420>
+mov    -0x40(%ebp),%eax
 movzbl 0x17(%eax),%eax
 movzbl %al,%eax
-mov    %eax,-0x64(%ebp)
...
-mov    -0x2c(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x14e>
+mov    -0x38(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser11GetGuildKeyEv>
...
-mov    %eax,0x4(%esp)
-mov    -0x24(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x205>
+mov    -0x38(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13GetUniqCharNoEv>
+mov    %eax,0x4(%esp)
...
-lea    -0x4c(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x1d5>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x48(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x1e2>
+lea    -0x48(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-mov    %esi,%eax
...
-mov    %eax,%esi
-lea    -0x45(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x1fa>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x41(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x45(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x31a>
+lea    -0x41(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
-mov    -0x2c(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x302>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x420>
 movl   $0x2,0x4(%esp)
-mov    -0x2c(%ebp),%eax
+mov    -0x38(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x3ba>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x3b3>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater8OnLogoutEP12PacketHeader+0x41b>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
    ...
    try
    {
        if (m_pclApp != 0)
        {
            ...
            else
            {
                ...
                unsigned short gflag = user->GetGuildMemFlag();
