# _ZN31Packet_Request_Result_BlackListC1Ev

`Packet_Request_Result_BlackList::Packet_Request_Result_BlackList()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x8089e6a` | `0x51` | `0x807e58c` | `0x9c` |
...
void __thiscall
Packet_Request_Result_BlackList::_ZN31Packet_Request_Result_BlackListC1Ev
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5746 行）：
