...
|---|---|---|---|---|---|
| guild | DIFF | `0x8073c70` | `0x3a9` | `0x806a2fe` | `0x3ad` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 837 行）：
