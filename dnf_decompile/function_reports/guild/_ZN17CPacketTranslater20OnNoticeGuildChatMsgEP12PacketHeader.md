...
|---|---|---|---|---|---|
| guild | DIFF | `0x8073c70` | `0x3a9` | `0x806a186` | `0x39f` |
...
+jmp    <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x287>
 lea    -0x41(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
-mov    -0x20(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x1ad>
+mov    -0x28(%ebp),%eax
 mov    0xa(%eax),%eax
 test   %eax,%eax
-je     <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x1b7>
...
-je     <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x1b1>
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x1a7>
+cmpl   $0x0,-0x20(%ebp)
+je     <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x1a7>
+mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x22c>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x226>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x24b>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x24b>
 lea    -0x40(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-mov    %ebx,%eax
-jmp    <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x291>
+jmp    <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x260>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater20OnNoticeGuildChatMsgEP12PacketHeader+0x24b>
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 820 行）：
