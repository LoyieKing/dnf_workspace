...
|---|---|---|---|---|---|
| guild | DIFF | `0x806dcaa` | `0xd0` | `0x8081eac` | `0xcb` |
...
+jne    <T> <_ZN14CServerHandler18UnregistGameServerEj+0xc5>
 lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN14CServerHandler18UnregistGameServerEj+0x74>
+test   %ebx,%ebx
+je     <T> <_ZN14CServerHandler18UnregistGameServerEj+0x74>
 mov    %ebx,(%esp)
...
-mov    $0x1,%eax
+jmp    <T> <_ZN14CServerHandler18UnregistGameServerEj+0xc6>
+nop
 mov    -0x4(%ebp),%ebx
 leave
 ret
...
```cpp
bool CServerHandler::UnregistGameServer(unsigned int group)
{
