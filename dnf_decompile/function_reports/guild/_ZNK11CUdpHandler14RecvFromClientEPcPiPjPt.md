...
|---|---|---|---|---|---|
| guild | DIFF | `0x805026a` | `0x273` | `0x8088192` | `0x263` |
...
+jne    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1a>
 mov    $0x0,%eax
-jmp    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x26b>
-movl   $0x10,-0x58(%ebp)
-lea    -0x58(%ebp),%ebx
-lea    -0x54(%ebp),%ecx
+jmp    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x261>
+movl   $0x10,-0x1c(%ebp)
 mov    0x10(%ebp),%eax
 mov    (%eax),%eax
 mov    %eax,%edx
...
+mov    -0x18(%ebp),%edx
+mov    %edx,(%eax)
+cmpl   $0xffffffff,-0x18(%ebp)
+jne    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x124>
 call   <T> <_Z8getErrnov>
-mov    %eax,-0x1c(%ebp)
-mov    -0x1c(%ebp),%eax
-cmp    $0x58,%eax
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x58,-0xc(%ebp)
+jne    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0xbd>
...
+jmp    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x11a>
+cmpl   $0x68,-0xc(%ebp)
+jne    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x107>
...
+jmp    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x261>
+cmpl   $0x0,-0x18(%ebp)
+jg     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x184>
+mov    -0x18(%ebp),%eax
 mov    %eax,0x4(%esp)
...
+mov    %ax,-0xe(%ebp)
+cmpw   $0x4c8,-0xe(%ebp)
+je     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1f6>
+cmpw   $0x4c9,-0xe(%ebp)
+je     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1f6>
+cmpw   $0x44f,-0xe(%ebp)
+je     <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x1f6>
+cmpw   $0x450,-0xe(%ebp)
+jne    <T> <_ZNK11CUdpHandler14RecvFromClientEPcPiPjPt+0x251>
+movl   $0xd1,0x8(%esp)
+movl   $"RecvFromClient",0x4(%esp)
+lea    -0x4c(%ebp),%eax
+mov    %eax,(%esp)
...
*未能在以下候选源文件中定位定义：source/DNFServer/GameServer/COServer/DNFUdpHandler.cpp, source/DNFServer/GameServer/DBMW/DNFUdpHandler.cpp, source/DNFServer/GameServer/Guild/DNFUdpHandler.cpp, source/DNFServer/GameServer/Manager/DNFUdpHandler.cpp, source/DNFServer/GameServer/Monitor/DNFUdpHandler.cpp, source/DNFServer/GameServer/Statics/DNFUdpHandler.cpp, source/ChannelOld/DNFChannelBridge/Authenticator.h, source/ChannelOld/DNFChannelBridge/ChannelService.h 等 624 个文件*
