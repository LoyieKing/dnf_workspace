...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087a1e` | `0x23d` | `0x807d0ba` | `0x244` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5497 行）：
