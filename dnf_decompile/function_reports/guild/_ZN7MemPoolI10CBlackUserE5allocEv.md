# _ZN7MemPoolI10CBlackUserE5allocEv

`MemPool<CBlackUser>::alloc()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x80663d6` | `0x151` | `0x8093e98` | `0x191` |
...
+sub    $0x44,%esp
 ...
 mov    (%eax),%eax
 cmp    $0x28,%eax
-je     <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x23>
-movl   $0x28,(%esp)
-call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x14a>
+jne    <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x178>
...
-mov    0x4(%eax),%edx
+test   %eax,%eax
+jne    <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x155>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
...
-add    %edx,%eax
-shl    $0x3,%eax
+jmp    <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x7d>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
...
+jne    <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x46>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
...
-mov    -0x14(%ebp),%eax
-add    $0x40,%esp
+jmp    <T> <_ZN7MemPoolI10CBlackUserE5allocEv+0x188>
+mov    &_ZN7MemPoolI10CBlackUserE15headOfFreeList_E,%eax
+mov    %eax,-0x10(%ebp)
+mov    &_ZN7MemPoolI10CBlackUserE15headOfFreeList_E,%eax
+mov    %eax,%edx
...
void * __thiscall MemPool<CBlackUser>::_ZN7MemPoolI10CBlackUserE5allocEv(MemPool<CBlackUser> *this)
  ...
  if (*(int *)this == 0x28) {
    ...
    if (headOfFreeList_ == (void *)0x0) {
      ...
      for (local_10 = 0; local_10 < *(int *)(this + 4) - 1U; local_10 = local_10 + 1) {
        *(void **)((int)local_24 + local_10 * 0x28 + 0x24) =
             (void *)((local_10 + 1) * 0x28 + (int)local_24);
      }
      *(undefined4 *)((int)local_24 + (*(int *)(this + 4) + -1) * 0x28 + 0x24) = 0;
      headOfFreeList_ = (void *)((int)local_24 + 0x28);
      local_18 = local_24;
      local_14 = local_24;
      ...
      headOfFreeList_ = *(void **)((int)headOfFreeList_ + 0x24);
    }
  }
  else {
    local_18 = operator_new(0x28);
  }
  return local_18;
}
```
