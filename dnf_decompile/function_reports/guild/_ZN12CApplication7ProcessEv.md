...
|---|---|---|---|---|---|
| guild | DIFF | `0x8062d12` | `0x261` | `0x804e850` | `0x260` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFApplication.cpp](source/DNFServer/GameServer/Guild/DNFApplication.cpp)（约第 298 行）：
