...
|---|---|---|---|---|---|
| guild | DIFF | `0x8088ae6` | `0x272` | `0x807ecc8` | `0x26b` |
...
+jne    <T> <_ZN17CPacketTranslater18OnApproveJoinGuildEP12PacketHeader+0x52>
 movl   $0x1fa0,0x8(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnApproveJoinGuildEP12PacketHeader+0x264>
+mov    -0x1c(%ebp),%eax
+mov    0xa(%eax),%eax
+mov    %eax,-0x18(%ebp)
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnApproveJoinGuildEP12PacketHeader+0x153>
+mov    -0x1c(%ebp),%eax
+mov    0xe(%eax),%eax
+mov    %eax,-0x10(%ebp)
+mov    -0x10(%ebp),%eax
...
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnApproveJoinGuildEP12PacketHeader+0x118>
+lea    -0x60(%ebp),%eax
+mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater18OnApproveJoinGuildEP12PacketHeader+0x20a>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnApproveJoinGuildEP12PacketHeader+0x203>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
+jmp    <T> <_ZN17CPacketTranslater18OnApproveJoinGuildEP12PacketHeader+0x25f>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5718 行）：
