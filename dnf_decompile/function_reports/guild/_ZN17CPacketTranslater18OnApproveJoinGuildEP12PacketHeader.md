...
|---|---|---|---|---|---|
| guild | DIFF | `0x8088ae6` | `0x272` | `0x807daaa` | `0x16a` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5578 行）：
