...
|---|---|---|---|---|---|
| guild | DIFF | `0x8088ae6` | `0x272` | `0x807ea5a` | `0x26b` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5628 行）：
