...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a7946` | `0x77` | `0x809d646` | `0x7e` |
...
定义于 [source/DNFServer/GameServer/Guild/PowerWarCharacInfo.cpp](source/DNFServer/GameServer/Guild/PowerWarCharacInfo.cpp)（约第 157 行）：
