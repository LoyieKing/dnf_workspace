...
|---|---|---|---|---|---|
| guild | DIFF | `0x808dcb0` | `0x131` | `0x8053c1e` | `0x12c` |
...
-lea    -0x4c(%ebp),%eax
+jne    <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0x5c>
+movl   $0x2bd,0x8(%esp)
...
+jmp    <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0x12a>
+lea    -0x4b(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0xfb>
 lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0xef>
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0xf0>
 nop
 lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
-call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-mov    -0x4(%ebp),%ebx
+jne    <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0x9b>
 leave
 ret
+push   %ebp
+mov    %esp,%ebp
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 844 行）：
