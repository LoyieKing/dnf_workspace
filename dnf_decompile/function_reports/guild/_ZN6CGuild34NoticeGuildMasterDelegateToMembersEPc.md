...
|---|---|---|---|---|---|
| guild | DIFF | `0x808dcb0` | `0x131` | `0x8053c56` | `0x137` |
...
+je     <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0x131>
 lea    -0x4c(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0xc0>
 lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0xb4>
+lea    -0x4c(%ebp),%eax
+lea    0xe(%eax),%ebx
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN6CGuild34NoticeGuildMasterDelegateToMembersEPc+0x132>
+nop
 mov    -0x4(%ebp),%ebx
 leave
 ret
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 820 行）：
