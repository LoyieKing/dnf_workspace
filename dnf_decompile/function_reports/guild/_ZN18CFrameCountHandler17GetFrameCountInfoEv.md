...
|---|---|---|---|---|---|
| guild | DIFF | `0x804caa6` | `0x37c` | `0x808788c` | `0x36a` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFTickHandler.cpp](source/DNFServer/GameServer/Guild/DNFTickHandler.cpp)（约第 93 行）：
