...
|---|---|---|---|---|---|
| guild | DIFF | `0x8080a3e` | `0x17c` | `0x8076e26` | `0x180` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3612 行）：
