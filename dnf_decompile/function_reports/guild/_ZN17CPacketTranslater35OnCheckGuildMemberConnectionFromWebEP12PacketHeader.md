...
|---|---|---|---|---|---|
| guild | DIFF | `0x807c28a` | `0x61d` | `0x8072b22` | `0x4bf` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2621 行）：
