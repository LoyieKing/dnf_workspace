...
|---|---|---|---|---|---|
| guild | DIFF | `0x807da5a` | `0x2e7` | `0x8073d7c` | `0x2d1` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2807 行）：
