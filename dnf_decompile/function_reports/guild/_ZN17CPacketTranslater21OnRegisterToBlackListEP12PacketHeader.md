...
+call   <T> <strcmp>
+test   %eax,%eax
+je     <T> <_ZN17CPacketTranslater21OnRegisterToBlackListEP12PacketHeader+0x131>
+mov    -0x18(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser16GetBlackListSizeEv>
+cmp    $0x9,%ax
+ja     <T> <_ZN17CPacketTranslater21OnRegisterToBlackListEP12PacketHeader+0x131>
+mov    $0x1,%eax
+jmp    <T> <_ZN17CPacketTranslater21OnRegisterToBlackListEP12PacketHeader+0x136>
+mov    $0x0,%eax
+test   %al,%al
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater21OnRegisterToBlackListEP12PacketHeader+0x1b8>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x24(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN17CPacketTranslater21OnRegisterToBlackListEP12PacketHeader+0x1a3>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x1d(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN17CPacketTranslater21OnRegisterToBlackListEP12PacketHeader+0x20c>
+lea    -0x1d(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSaIcED1Ev>
+cmpl   $0x0,-0x10(%ebp)
...
+jne    <T> <_ZN17CPacketTranslater21OnRegisterToBlackListEP12PacketHeader+0x286>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater21OnRegisterToBlackListEP12PacketHeader+0x2db>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
