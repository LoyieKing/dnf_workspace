...
|---|---|---|---|---|---|
| guild | DIFF | `0x807da5a` | `0x2e7` | `0x8073c92` | `0x2cf` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3511 行）：
