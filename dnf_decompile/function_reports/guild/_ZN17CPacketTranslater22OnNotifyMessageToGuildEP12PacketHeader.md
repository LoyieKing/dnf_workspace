...
|---|---|---|---|---|---|
| guild | NEAR | `0x807ef06` | `0x202` | `0x80751cc` | `0x202` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3179 行）：
