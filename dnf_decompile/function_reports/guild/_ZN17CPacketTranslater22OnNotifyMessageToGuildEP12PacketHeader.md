...
|---|---|---|---|---|---|
| guild | DIFF | `0x807ef06` | `0x202` | `0x80755ea` | `0x207` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3243 行）：
