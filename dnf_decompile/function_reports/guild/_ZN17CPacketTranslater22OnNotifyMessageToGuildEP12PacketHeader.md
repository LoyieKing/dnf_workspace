...
|---|---|---|---|---|---|
| guild | DIFF | `0x807ef06` | `0x202` | `0x8075206` | `0x129` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3202 行）：
