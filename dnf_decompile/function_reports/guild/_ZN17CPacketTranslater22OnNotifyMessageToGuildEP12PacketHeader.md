...
|---|---|---|---|---|---|
| guild | DIFF | `0x807ef06` | `0x202` | `0x80753ee` | `0x129` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3227 行）：
