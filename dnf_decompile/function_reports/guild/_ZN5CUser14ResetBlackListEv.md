...
|---|---|---|---|---|---|
| guild | DIFF | `0x806718c` | `0x2b` | `0x8089852` | `0x2b` |
...
+je     <T> <_ZN5CUser14ResetBlackListEv+0x29>
 mov    0x8(%ebp),%eax
 add    $0x64,%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFUser.cpp](source/DNFServer/GameServer/Guild/DNFUser.cpp)（约第 370 行）：
