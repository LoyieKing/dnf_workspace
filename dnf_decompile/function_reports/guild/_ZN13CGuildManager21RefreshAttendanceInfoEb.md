...
|---|---|---|---|---|---|
| guild | DIFF | `0x80977c6` | `0xe0` | `0x805d534` | `0xbd` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 862 行）：
