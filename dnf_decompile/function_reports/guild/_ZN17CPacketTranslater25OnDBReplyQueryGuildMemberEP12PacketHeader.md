...
|---|---|---|---|---|---|
| guild | DIFF | `0x8072998` | `0x2a4` | `0x806900c` | `0x2a1` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1244 行）：
