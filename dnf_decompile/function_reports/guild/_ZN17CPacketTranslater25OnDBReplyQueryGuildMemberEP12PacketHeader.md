...
|---|---|---|---|---|---|
| guild | DIFF | `0x8072998` | `0x2a4` | `0x8068fc4` | `0x3a9` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 613 行）：
