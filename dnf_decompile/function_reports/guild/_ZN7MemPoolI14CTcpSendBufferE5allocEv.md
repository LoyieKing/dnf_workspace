...
|---|---|---|---|---|---|
| guild | DIFF | `0x804d7b4` | `0x150` | `0x8094a5c` | `0x193` |
...
+jne    <T> <_ZN7MemPoolI14CTcpSendBufferE5allocEv+0x17a>
...
-mov    0x4(%eax),%edx
+test   %eax,%eax
+jne    <T> <_ZN7MemPoolI14CTcpSendBufferE5allocEv+0x157>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
...
+jmp    <T> <_ZN7MemPoolI14CTcpSendBufferE5allocEv+0x7f>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
...
+jne    <T> <_ZN7MemPoolI14CTcpSendBufferE5allocEv+0x48>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
...
-mov    -0x14(%ebp),%eax
-add    $0x40,%esp
+jmp    <T> <_ZN7MemPoolI14CTcpSendBufferE5allocEv+0x18a>
+mov    &_ZN7MemPoolI14CTcpSendBufferE15headOfFreeList_E,%eax
+mov    %eax,-0x10(%ebp)
+mov    &_ZN7MemPoolI14CTcpSendBufferE15headOfFreeList_E,%eax
+mov    %eax,%edx
