# _ZN18CFrameCountHandler11SaveProcessEv

`CFrameCountHandler::SaveProcess()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x804ce22` | `0x80` | `0x80878b8` | `0x7f` |
...
+mov    0x28(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN18CFrameCountHandler11SaveProcessEv+0x78>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%esi
 mov    0x8(%ebp),%eax
 mov    0x18(%eax),%ebx
...
void __thiscall CFrameCountHandler::_ZN18CFrameCountHandler11SaveProcessEv(CFrameCountHandler *this)

{
  ...
  if (this[0x28] != (CFrameCountHandler)0x0) {
    ...
    CMyFileLog::CMyFileLog(local_14,"SaveProcess",0xa8);
    CMyFileLog::_ZN10CMyFileLogclEPKcS1_z
              (local_14,"./log/frame","FPS(%02d) / DFC(%02d)\n",uVar2,uVar1);
...
定义于 [source/DNFServer/GameServer/Guild/DNFTickHandler.cpp](source/DNFServer/GameServer/Guild/DNFTickHandler.cpp)（约第 165 行）：
