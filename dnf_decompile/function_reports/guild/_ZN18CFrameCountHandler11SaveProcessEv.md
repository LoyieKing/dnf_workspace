...
|---|---|---|---|---|---|
| guild | NEAR | `0x804ce22` | `0x80` | `0x8087cfe` | `0x80` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFTickHandler.cpp](source/DNFServer/GameServer/Guild/DNFTickHandler.cpp)（约第 152 行）：
