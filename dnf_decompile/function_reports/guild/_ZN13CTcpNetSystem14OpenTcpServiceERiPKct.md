...
|---|---|---|---|---|---|
| guild | DIFF | `0x80537ac` | `0x1b1` | `0x80a85c8` | `0x1b0` |
...
+je     <T> <_ZN13CTcpNetSystem14OpenTcpServiceERiPKct+0x150>
 movzwl -0x2c(%ebp),%eax
 mov    %eax,0x8(%esp)
 mov    0x10(%ebp),%eax
 mov    %eax,0x4(%esp)
...
-mov    $0x0,%eax
-jmp    <T> <_ZN13CTcpNetSystem14OpenTcpServiceERiPKct+0x1aa>
+je     <T> <_ZN13CTcpNetSystem14OpenTcpServiceERiPKct+0xe6>
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
 ...
 mov    %eax,(%edx)
 mov    $0x1,%eax
+jmp    <T> <_ZN13CTcpNetSystem14OpenTcpServiceERiPKct+0x1a9>
+movl   $"tcpSock.connect Fail!",(%esp)
+call   <T> <puts>
+movl   $0x123,0x8(%esp)
+movl   $"OpenTcpService",0x4(%esp)
...

{
  ...
  *this_00;
  ...
  local_14 = (CPeer *)CreatePeer(this);
