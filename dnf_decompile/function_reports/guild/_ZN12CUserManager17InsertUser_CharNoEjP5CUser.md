...
|---|---|---|---|---|---|
| guild | DIFF | `0x80694aa` | `0xdf` | `0x808be66` | `0xe5` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFUserManager.cpp](source/DNFServer/GameServer/Guild/DNFUserManager.cpp)（约第 314 行）：
