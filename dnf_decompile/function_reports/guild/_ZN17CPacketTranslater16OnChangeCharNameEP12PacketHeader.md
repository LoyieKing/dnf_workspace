...
|---|---|---|---|---|---|
| guild | DIFF | `0x8081942` | `0x3ef` | `0x8078282` | `0x3b7` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3887 行）：
