...
|---|---|---|---|---|---|
| guild | DIFF | `0x8081942` | `0x3ef` | `0x8077bda` | `0x395` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3805 行）：
