...
|---|---|---|---|---|---|
| guild | DIFF | `0x8081942` | `0x3ef` | `0x8077c8a` | `0x3b7` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3835 行）：
