...
|---|---|---|---|---|---|
| guild | DIFF | `0x805296c` | `0x220` | `0x80a7756` | `0x3a4` |
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13CTcpNetSystemC1Ev+0x6f>
+mov    %ebx,%eax
 mov    %eax,(%esp)
...
-call   <T> <_ZN6CMutexC1Ev>
-lea    -0x58(%ebp),%eax
+jmp    <T> <_ZN13CTcpNetSystemC1Ev+0x6f>
+mov    %edx,%edi
+mov    %eax,-0x90(%ebp)
+mov    %esi,0x4(%esp)
+mov    %ebx,(%esp)
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13CTcpNetSystemC1Ev+0xbd>
+mov    %ebx,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexC1Ev>
+jmp    <T> <_ZN13CTcpNetSystemC1Ev+0xbd>
+mov    %edx,%edi
+mov    %eax,-0x8c(%ebp)
+mov    %esi,0x4(%esp)
+mov    %ebx,(%esp)
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13CTcpNetSystemC1Ev+0x10b>
+mov    %ebx,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexC1Ev>
+jmp    <T> <_ZN13CTcpNetSystemC1Ev+0x10b>
+mov    %edx,%edi
+mov    %eax,-0x88(%ebp)
+mov    %esi,0x4(%esp)
+mov    %ebx,(%esp)
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13CTcpNetSystemC1Ev+0x15c>
+mov    %ebx,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexC1Ev>
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13CTcpNetSystemC1Ev+0x1a7>
+mov    %ebx,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexC1Ev>
+jmp    <T> <_ZN13CTcpNetSystemC1Ev+0x1a7>
+mov    %edx,%edi
+mov    %eax,-0x80(%ebp)
+mov    %esi,0x4(%esp)
+mov    %ebx,(%esp)
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13CTcpNetSystemC1Ev+0x26d>
+mov    %ebx,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexC1Ev>
+jmp    <T> <_ZN13CTcpNetSystemC1Ev+0x26d>
+mov    %edx,%edi
+mov    %eax,-0x78(%ebp)
+mov    %esi,0x4(%esp)
+mov    %ebx,(%esp)
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13CTcpNetSystemC1Ev+0x2b8>
+mov    %ebx,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CMutexC1Ev>
+jmp    <T> <_ZN13CTcpNetSystemC1Ev+0x2b8>
+mov    %edx,%edi
+mov    %eax,-0x74(%ebp)
+mov    %esi,0x4(%esp)
+mov    %ebx,(%esp)
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13CTcpNetSystemC1Ev+0x38c>
+mov    %ebx,%eax
 mov    %eax,(%esp)
...
-movw   $0x0,0x15c(%eax)
-add    $0x60,%esp
+jmp    <T> <_ZN13CTcpNetSystemC1Ev+0x38c>
+mov    %edx,%edi
+mov    %eax,-0x6c(%ebp)
+mov    %esi,0x4(%esp)
+mov    %ebx,(%esp)
