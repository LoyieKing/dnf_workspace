...
|---|---|---|---|---|---|
| guild | DIFF | `0x8086af6` | `0x2b7` | `0x807c8e6` | `0x200` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5302 行）：
