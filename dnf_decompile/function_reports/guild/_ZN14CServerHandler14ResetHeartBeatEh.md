...
|---|---|---|---|---|---|
| guild | DIFF | `0x806d252` | `0xe1` | `0x808180e` | `0xdd` |
...
-lea    -0x20(%ebp),%eax
+je     <T> <_ZN14CServerHandler14ResetHeartBeatEh+0x9d>
+lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN14CServerHandler14ResetHeartBeatEh+0x87>
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN14CServerHandler14ResetHeartBeatEh+0x8c>
 mov    $0x0,%eax
 test   %al,%al
-je     <T> <_ZN14CServerHandler14ResetHeartBeatEh+0xdc>
+je     <T> <_ZN14CServerHandler14ResetHeartBeatEh+0xdb>
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN16CServerInterface14ResetHeartBeatEv>
-jmp    <T> <_ZN14CServerHandler14ResetHeartBeatEh+0xdc>
-movzbl -0x2c(%ebp),%ebx
+jmp    <T> <_ZN14CServerHandler14ResetHeartBeatEh+0xdb>
 movl   $0x15b,0x8(%esp)
...

{
  ...
  CMyFileLog::CMyFileLog(local_18,"ResetHeartBeat",0x15b);
