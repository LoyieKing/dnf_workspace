...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a0076` | `0x83` | `0x8093a8c` | `0x7d` |
...
定义于 [source/DNFServer/GameServer/Guild/GuildCargo.cpp](source/DNFServer/GameServer/Guild/GuildCargo.cpp)（约第 424 行）：
