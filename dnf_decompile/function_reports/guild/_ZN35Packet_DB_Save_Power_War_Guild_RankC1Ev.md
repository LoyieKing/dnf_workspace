...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a567a` | `0x87` | `0x809b20c` | `0xa3` |
...
定义于 [source/DNFServer/GameServer/Guild/PowerManager.cpp](source/DNFServer/GameServer/Guild/PowerManager.cpp)（约第 740 行）：
