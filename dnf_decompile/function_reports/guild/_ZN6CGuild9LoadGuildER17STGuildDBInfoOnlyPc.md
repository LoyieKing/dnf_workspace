...
|---|---|---|---|---|---|
| guild | DIFF | `0x808d268` | `0x172` | `0x80532a6` | `0x175` |
...
-movzbl 0x44(%eax),%eax
-movzbl %al,%ebx
+je     <T> <_ZN6CGuild9LoadGuildER17STGuildDBInfoOnlyPc+0x113>
 movl   $0x11b,0x8(%esp)
 movl   $"LoadGuild",0x4(%esp)
 lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 450 行）：
