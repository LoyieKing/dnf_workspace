...
|---|---|---|---|---|---|
| guild | DIFF | `0x807fad0` | `0x4ba` | `0x8075d98` | `0x4b5` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3354 行）：
