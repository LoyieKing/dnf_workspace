...
|---|---|---|---|---|---|
| guild | DIFF | `0x807fad0` | `0x4ba` | `0x807636a` | `0x4eb` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3573 行）：
