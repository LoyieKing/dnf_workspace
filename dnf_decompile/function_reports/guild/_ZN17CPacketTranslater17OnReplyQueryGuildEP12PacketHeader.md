...
|---|---|---|---|---|---|
| guild | DIFF | `0x80726ba` | `0x2dd` | `0x8068ca2` | `0x2df` |
...
+jne    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x157>
 mov    -0x18(%ebp),%eax
 lea    0xd0(%eax),%ebx
 mov    -0x18(%ebp),%eax
 lea    0x13(%eax),%ecx
...
+je     <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x9b>
 mov    -0x18(%ebp),%eax
 mov    0xb(%eax),%ebx
 movl   $0x202,0x8(%esp)
...
+je     <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2d8>
 mov    -0x18(%ebp),%eax
 mov    0xb(%eax),%eax
 mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
 add    $0x290,%edx
...
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2d8>
 mov    -0x18(%ebp),%eax
 mov    0xb(%eax),%eax
 mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
 add    $0x290,%edx
...
+jne    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x272>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x26b>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2d3>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 484 行）：
