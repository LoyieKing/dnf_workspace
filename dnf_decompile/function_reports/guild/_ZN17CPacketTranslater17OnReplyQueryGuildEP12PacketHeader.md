...
|---|---|---|---|---|---|
| guild | NEAR | `0x80726ba` | `0x2dd` | `0x8068c16` | `0x2dd` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 516 行）：
