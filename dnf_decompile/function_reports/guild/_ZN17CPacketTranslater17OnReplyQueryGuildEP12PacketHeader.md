...
|---|---|---|---|---|---|
| guild | DIFF | `0x80726ba` | `0x2dd` | `0x8068ce6` | `0x2d9` |
...
-mov    -0x18(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x153>
+mov    0x8(%ebp),%eax
 lea    0xd0(%eax),%ebx
-mov    -0x18(%ebp),%eax
-lea    0x13(%eax),%ecx
...
+mov    %eax,-0x18(%ebp)
+cmpl   $0x1,-0x18(%ebp)
+je     <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x97>
+mov    0x8(%ebp),%eax
 mov    0xb(%eax),%ebx
 movl   $0x202,0x8(%esp)
...
-mov    -0x18(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2d2>
+mov    0x8(%ebp),%eax
 mov    0xb(%eax),%eax
 mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
 add    $0x290,%edx
...
-mov    -0x18(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2d2>
+mov    0x8(%ebp),%eax
 mov    0xb(%eax),%eax
 mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
 add    $0x290,%edx
...
+jne    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x26c>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x265>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2cd>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1205 行）：
