...
|---|---|---|---|---|---|
| guild | DIFF | `0x80726ba` | `0x2dd` | `0x8068ad8` | `0x2f4` |
...
-mov    -0x18(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x168>
+mov    -0x1c(%ebp),%eax
 lea    0xd0(%eax),%ebx
-mov    -0x18(%ebp),%eax
+mov    -0x1c(%ebp),%eax
...
+mov    %eax,-0x18(%ebp)
+cmpl   $0x1,-0x18(%ebp)
+je     <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0xa1>
+mov    -0x1c(%ebp),%eax
+add    $0xb,%eax
+mov    (%eax),%ebx
 movl   $0x202,0x8(%esp)
...
-mov    -0x18(%ebp),%eax
-mov    0xb(%eax),%eax
+je     <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2ed>
+mov    -0x1c(%ebp),%eax
+add    $0xb,%eax
+mov    (%eax),%eax
 mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
...
-mov    -0x18(%ebp),%eax
-mov    0xb(%eax),%eax
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2ed>
+mov    -0x1c(%ebp),%eax
+add    $0xb,%eax
+mov    (%eax),%eax
 mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
...
+jne    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x287>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x280>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater17OnReplyQueryGuildEP12PacketHeader+0x2e8>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1092 行）：
