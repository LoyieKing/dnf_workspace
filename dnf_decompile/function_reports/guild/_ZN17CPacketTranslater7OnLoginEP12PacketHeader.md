...
|---|---|---|---|---|---|
| guild | DIFF | `0x80711a2` | `0x3b2` | `0x8067830` | `0x3b4` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 352 行）：
