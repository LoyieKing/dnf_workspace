...
|---|---|---|---|---|---|
| guild | NEAR | `0x80711a2` | `0x3b2` | `0x80676e8` | `0x3b2` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 167 行）：
