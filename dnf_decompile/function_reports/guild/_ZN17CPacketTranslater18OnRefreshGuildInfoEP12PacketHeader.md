...
|---|---|---|---|---|---|
| guild | DIFF | `0x80886da` | `0x21f` | `0x807d974` | `0x12d` |
...
+jne    <T> <_ZN17CPacketTranslater18OnRefreshGuildInfoEP12PacketHeader+0x51>
 movl   $0x1f4b,0x8(%esp)
 movl   $"OnRefreshGuildInfo",0x4(%esp)
-lea    -0x40(%ebp),%eax
+lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    %eax,0x4(%esp)
-mov    %edx,(%esp)
+jmp    <T> <_ZN17CPacketTranslater18OnRefreshGuildInfoEP12PacketHeader+0x127>
+mov    -0x14(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%ebx
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+jne    <T> <_ZN17CPacketTranslater18OnRefreshGuildInfoEP12PacketHeader+0xb3>
 movl   $0x1f51,0x8(%esp)
 movl   $"OnRefreshGuildInfo",0x4(%esp)
-lea    -0x38(%ebp),%eax
+lea    -0x24(%ebp),%eax
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0xc(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnRefreshGuildInfoEP12PacketHeader+0x115>
 movl   $0x1f57,0x8(%esp)
 movl   $"OnRefreshGuildInfo",0x4(%esp)
-lea    -0x30(%ebp),%eax
+lea    -0x2c(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5345 行）：
