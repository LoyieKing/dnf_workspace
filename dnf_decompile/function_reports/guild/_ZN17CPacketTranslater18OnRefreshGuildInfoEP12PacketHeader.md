...
|---|---|---|---|---|---|
| guild | NEAR | `0x80886da` | `0x21f` | `0x807e64e` | `0x21f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5576 行）：
