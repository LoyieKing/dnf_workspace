...
|---|---|---|---|---|---|
| guild | DIFF | `0x80886da` | `0x21f` | `0x807e4fc` | `0x206` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 6385 行）：
