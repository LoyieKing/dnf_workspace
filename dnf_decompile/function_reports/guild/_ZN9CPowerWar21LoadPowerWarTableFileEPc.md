...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a6f50` | `0x144` | `0x809d316` | `0x180` |
...
+sub    $0x40,%esp
 movl   $0x9e,0x8(%esp)
 movl   $"LoadPowerWarTableFile",0x4(%esp)
-lea    -0x24(%ebp),%eax
+lea    -0x2c(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/PowerWar.cpp](source/DNFServer/GameServer/Guild/PowerWar.cpp)（约第 182 行）：
