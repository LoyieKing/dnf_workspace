...
|---|---|---|---|---|---|
| guild | DIFF | `0x8053a94` | `0xde` | `0x80a7f98` | `0xd8` |
...
+jmp    <T> <_ZN13CTcpNetSystem10CleanPeersEv+0x94>
 mov    0x8(%ebp),%eax
 add    $0x78,%eax
 mov    %eax,0x4(%esp)
-lea    -0x14(%ebp),%eax
...
+je     <T> <_ZN13CTcpNetSystem10CleanPeersEv+0x7e>
 mov    %ebx,(%esp)
...
+jmp    <T> <_ZN13CTcpNetSystem10CleanPeersEv+0x7e>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x14(%ebp),%eax
+lea    -0x18(%ebp),%eax
...
-mov    0x8(%ebp),%eax
-add    $0x144,%eax
+jne    <T> <_ZN13CTcpNetSystem10CleanPeersEv+0x2a>
+mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
...

{
  ...
  while( true ) {
    ...
    if (this_00 != (CPeer *)0x0) {
                    /* try { // try from 08053ae3 to 08053afa has its CatchHandler @ 08053afd */
      CPeer::~CPeer(this_00);
...
定义于 [source/DNFServer/GameServer/Guild/TcpNetSystem.cpp](source/DNFServer/GameServer/Guild/TcpNetSystem.cpp)（约第 485 行）：
