...
|---|---|---|---|---|---|
| guild | DIFF | `0x8068cc2` | `0x2af` | `0x808b2a0` | `0x2a2` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFUserManager.cpp](source/DNFServer/GameServer/Guild/DNFUserManager.cpp)（约第 170 行）：
