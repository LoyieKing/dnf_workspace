# _ZN35Packet_Guild_Cargo_History_ResponseC1Ev

`Packet_Guild_Cargo_History_Response::Packet_Guild_Cargo_History_Response()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x808a5b6` | `0x83` | `0x807f01e` | `0xd1` |
...
void __thiscall
Packet_Guild_Cargo_History_Response::_ZN35Packet_Guild_Cargo_History_ResponseC1Ev
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5965 行）：
