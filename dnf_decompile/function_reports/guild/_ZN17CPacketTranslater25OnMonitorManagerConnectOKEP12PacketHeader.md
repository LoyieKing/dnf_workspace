...
|---|---|---|---|---|---|
| guild | DIFF | `0x807d37a` | `0x21c` | `0x80737e0` | `0x154` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2771 行）：
