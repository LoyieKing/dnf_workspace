...
|---|---|---|---|---|---|
| guild | NEAR | `0x807d37a` | `0x21c` | `0x80736ea` | `0x21c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2753 行）：
