...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076c9a` | `0x51c` | `0x806d69c` | `0x51d` |
...
+mov    %eax,-0x24(%ebp)
+cmpl   $0x0,-0x24(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2e8>
+lea    -0x31(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x45(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x28e>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2ad>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2ad>
+lea    -0x38(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2c5>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2ad>
