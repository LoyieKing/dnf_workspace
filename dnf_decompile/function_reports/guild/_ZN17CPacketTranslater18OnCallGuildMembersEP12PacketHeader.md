...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076c9a` | `0x51c` | `0x806d02c` | `0x51d` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1619 行）：
