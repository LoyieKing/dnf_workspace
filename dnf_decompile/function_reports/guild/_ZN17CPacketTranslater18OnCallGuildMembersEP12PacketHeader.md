...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076c9a` | `0x51c` | `0x806d102` | `0x514` |
...
-lea    -0x55(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0xf5>
+lea    -0x45(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x55(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x9b>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0xba>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0xba>
+lea    -0x4c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0xd2>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0xba>
...
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x3fe>
+lea    -0x45(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+mov    %eax,-0x28(%ebp)
+cmpl   $0x0,-0x28(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x1e1>
+lea    -0x3d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x4d(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x187>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x181>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x1a6>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x1a6>
+lea    -0x44(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x1be>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x1a6>
...
+mov    %eax,-0x24(%ebp)
+cmpl   $0x0,-0x24(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2e2>
+lea    -0x35(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSaIcEC1Ev>
+lea    -0x35(%ebp),%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN13CDNFExceptionC1ERKSs>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x288>
+mov    %eax,%ecx
+mov    %edx,%eax
+mov    %eax,%esi
+mov    %ecx,%edi
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x282>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2a7>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2a7>
+lea    -0x3c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2bf>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x2a7>
...
+mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x3e3>
+lea    -0x2d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x45(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x38c>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x386>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x3ab>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x3ab>
+lea    -0x34(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x3c0>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x3ab>
...
+mov    %eax,(%esp)
+call   <T> <_ZN6CGuild17ReplyGuildMembersEP5CUser>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x50c>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0x2,%eax
-jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x4aa>
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x4a2>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x49b>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildMembersEP12PacketHeader+0x507>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1452 行）：
