...
|---|---|---|---|---|---|
| guild | DIFF | `0x8067050` | `0x93` | `0x8089246` | `0xcd` |
...
+mov    $0x0,%eax
+jmp    <T> <_ZN5CUser19RegisterToBlackListEjPcj+0xc2>
 movl   $0x28,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFUser.cpp](source/DNFServer/GameServer/Guild/DNFUser.cpp)（约第 361 行）：
