...
|---|---|---|---|---|---|
| guild | DIFF | `0x8065374` | `0x9d` | `0x80807d2` | `0x142` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFServerConfig.cpp](source/DNFServer/GameServer/Guild/DNFServerConfig.cpp)（约第 122 行）：
