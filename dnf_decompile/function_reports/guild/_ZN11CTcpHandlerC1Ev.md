...
|---|---|---|---|---|---|
| guild | DIFF | `0x804ee26` | `0x4c` | `0x8085d7a` | `0x4a` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFTcpHandler.cpp](source/DNFServer/GameServer/Guild/DNFTcpHandler.cpp)（约第 163 行）：
