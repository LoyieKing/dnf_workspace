...
|---|---|---|---|---|---|
| guild | DIFF | `0x80755fc` | `0x7c3` | `0x806bb5e` | `0x7bd` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1029 行）：
