...
|---|---|---|---|---|---|
| guild | DIFF | `0x80755fc` | `0x7c3` | `0x806b9b6` | `0x7c4` |
...
-lea    -0x4d(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6e3>
+lea    -0x59(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
-mov    -0x28(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x7b9>
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+movl   $0x0,-0x2c(%ebp)
+cmpl   $0x0,-0x30(%ebp)
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x1f9>
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+lea    0x290(%eax),%edx
+mov    -0x30(%ebp),%eax
 mov    %eax,0x4(%esp)
...
+mov    %eax,-0x2c(%ebp)
+cmpl   $0x0,-0x2c(%ebp)
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x200>
 mov    $0x1,%eax
-jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x1fd>
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x205>
 mov    $0x0,%eax
 test   %al,%al
-je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x22d>
-movl   $0x64,-0xca(%ebp)
-lea    -0xd4(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x235>
+movl   $0x64,-0xd6(%ebp)
+lea    -0xe0(%ebp),%eax
 movl   $0x3a,0x8(%esp)
 mov    %eax,0x4(%esp)
...
+test   %al,%al
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x25d>
+mov    -0x34(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser16IsSubGuildMasterEv>
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x264>
+mov    $0x1,%eax
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x269>
+mov    $0x0,%eax
+mov    %al,-0x25(%ebp)
+movzbl -0x25(%ebp),%eax
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x281>
+movl   $0x56,-0xd6(%ebp)
+mov    -0x38(%ebp),%eax
+movzbl 0x30(%eax),%eax
+cmp    $0x1,%al
...
+movzbl 0x30(%eax),%eax
+cmp    $0x2,%al
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x2e7>
+mov    -0x2c(%ebp),%eax
+mov    %eax,(%esp)
...
+setbe  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x2dd>
+mov    -0x38(%ebp),%eax
+mov    0xa(%eax),%eax
+mov    %eax,0x4(%esp)
+mov    -0x2c(%ebp),%eax
...
-movl   $0x66,-0xca(%ebp)
-lea    -0x3d(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x2e7>
+movl   $0x66,-0xd6(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x2e7>
+movl   $0x59,-0xd6(%ebp)
+lea    -0x49(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
...
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x362>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x44(%ebp),%eax
+lea    -0x50(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x34a>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x3d(%ebp),%eax
+lea    -0x49(%ebp),%eax
...
-mov    -0xca(%ebp),%eax
+cmpl   $0x0,-0x24(%ebp)
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x446>
+mov    -0xd6(%ebp),%eax
 test   %eax,%eax
-jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6c0>
-lea    -0x9a(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6c1>
+lea    -0xa6(%ebp),%eax
 mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x3c1>
+mov    -0x34(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13GetGameServerEv>
 mov    %eax,(%esp)
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6b7>
+mov    -0x24(%ebp),%eax
+cmp    -0x34(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x490>
+movl   $0x55,-0xd6(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6c1>
+mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser17GetGuildMemDBInfoEv>
 movzbl 0x15(%eax),%eax
...
-jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6c0>
-mov    -0x20(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x4c4>
+movl   $0x65,-0xd6(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6c1>
+mov    -0x38(%ebp),%eax
 movzbl 0x30(%eax),%eax
...
-mov    -0x28(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x562>
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser17GetGuildMemDBInfoEv>
 movzbl 0x15(%eax),%eax
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x556>
+mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser13GetUniqCharNoEv>
 movl   $0x1,0x8(%esp)
...
-mov    %eax,0x4(%esp)
-mov    -0x24(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x5d9>
+movl   $0x66,-0xd6(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x5d9>
+mov    -0x24(%ebp),%eax
+mov    %eax,(%esp)
...
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x5d9>
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser17GetGuildMemDBInfoEv>
 movzbl 0x15(%eax),%eax
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x5cf>
+mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser13GetUniqCharNoEv>
 movl   $0x0,0x8(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x66e>
+movl   $0x3,-0xd6(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6c1>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x75f>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x758>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x7b4>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1003 行）：
