...
|---|---|---|---|---|---|
| guild | DIFF | `0x80755fc` | `0x7c3` | `0x806b9de` | `0x76a` |
...
-lea    -0x4d(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x689>
+lea    -0x5d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
-mov    -0x28(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x75f>
+lea    -0xe4(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN41Packet_Monitor_Set_Sub_Guild_Master_ReplyC1Ev>
+mov    -0x3c(%ebp),%eax
...
-mov    -0xca(%ebp),%eax
+cmpl   $0x0,-0x24(%ebp)
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x41d>
+cmpl   $0x0,-0x38(%ebp)
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x65e>
+lea    -0xaa(%ebp),%eax
+mov    %eax,(%esp)
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x657>
+mov    -0x24(%ebp),%eax
+cmp    -0x3c(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x460>
+movl   $0x55,-0x38(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x65e>
+mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser17GetGuildMemDBInfoEv>
 movzbl 0x15(%eax),%eax
...
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x485>
+movl   $0x65,-0x38(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x65e>
+cmpb   $0x2,-0x31(%ebp)
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x518>
+mov    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser17GetGuildMemDBInfoEv>
 movzbl 0x15(%eax),%eax
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x50f>
+mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser13GetUniqCharNoEv>
 movl   $0x1,0x8(%esp)
...
-mov    %eax,0x4(%esp)
-mov    -0x24(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x58c>
+movl   $0x66,-0x38(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x58c>
+mov    -0x24(%ebp),%eax
+mov    %eax,(%esp)
...
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x58c>
+mov    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser17GetGuildMemDBInfoEv>
 movzbl 0x15(%eax),%eax
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x585>
+mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser13GetUniqCharNoEv>
 movl   $0x0,0x8(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x60e>
+movl   $0x3,-0x38(%ebp)
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x65e>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x705>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x6fe>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater21OnSetGuildMemberGradeEP12PacketHeader+0x75a>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
