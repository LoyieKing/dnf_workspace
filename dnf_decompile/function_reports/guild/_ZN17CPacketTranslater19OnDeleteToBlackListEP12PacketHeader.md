...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dd42` | `0x297` | `0x80741bc` | `0x287` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3565 行）：
