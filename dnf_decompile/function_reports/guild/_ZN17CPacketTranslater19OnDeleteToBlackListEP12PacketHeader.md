...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dd42` | `0x297` | `0x80744bc` | `0x28c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3042 行）：
