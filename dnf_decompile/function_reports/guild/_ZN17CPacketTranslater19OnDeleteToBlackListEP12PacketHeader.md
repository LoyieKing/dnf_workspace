...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dd42` | `0x297` | `0x8074170` | `0x296` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2877 行）：
