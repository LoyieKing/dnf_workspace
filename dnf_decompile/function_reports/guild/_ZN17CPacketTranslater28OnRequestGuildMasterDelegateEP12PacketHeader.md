...
|---|---|---|---|---|---|
| guild | DIFF | `0x807af52` | `0x6b5` | `0x807182a` | `0x6e4` |
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x5f9>
+lea    -0x69(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+mov    %eax,-0x2c(%ebp)
+cmpl   $0x0,-0x30(%ebp)
+je     <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x533>
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x17c>
+movl   $0xc23,0x8(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x6d9>
+lea    -0x86(%ebp),%eax
+lea    0xa(%eax),%edx
+mov    -0x2c(%ebp),%eax
+mov    %eax,(%edx)
...
+mov    %eax,-0x24(%ebp)
+cmpl   $0x0,-0x24(%ebp)
+jne    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x233>
+movl   $0xc2c,0x8(%esp)
+movl   $&_ZZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
+lea    -0x60(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x4c5>
+mov    -0x2c(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    -0x24(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x450>
+lea    -0x51(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSaIcEC1Ev>
+mov    0x8(%ebp),%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x2e8>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x58(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x2d0>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x51(%ebp),%eax
+mov    %eax,(%esp)
...
+call   <T> <_ZNSaIcED1Ev>
+cmpl   $0x0,-0x20(%ebp)
+je     <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x321>
+mov    -0x20(%ebp),%eax
+mov    %eax,(%esp)
...
+je     <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x321>
+mov    $0x1,%eax
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x326>
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x3a9>
+mov    -0x20(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13GetUniqCharNoEv>
+mov    %eax,%ebx
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x6d9>
+lea    -0xc9(%ebp),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x5aa>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 call   <T> <__cxa_free_exception>
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x5a4>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x192>
+jne    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x5c1>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%eax
 mov    %ebx,%edx
...
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x5c1>
+lea    -0x38(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x5d6>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x192>
+jne    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x5c1>
 call   <T> <_ZSt9terminatev>
...
+jne    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x679>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x672>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater28OnRequestGuildMasterDelegateEP12PacketHeader+0x6d4>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
