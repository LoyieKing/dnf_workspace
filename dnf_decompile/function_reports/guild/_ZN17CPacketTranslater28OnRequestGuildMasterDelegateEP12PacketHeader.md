...
|---|---|---|---|---|---|
| guild | DIFF | `0x807af52` | `0x6b5` | `0x80717fe` | `0x6d3` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2484 行）：
