# _ZN7MemPoolI6CGuildE5allocEv

`MemPool<CGuild>::alloc()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x809344c` | `0x150` | `0x8095914` | `0x193` |
...
+sub    $0x44,%esp
 ...
 mov    (%eax),%eax
 cmp    $0x6718,%eax
-je     <T> <_ZN7MemPoolI6CGuildE5allocEv+0x25>
-movl   $0x6718,(%esp)
-call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x149>
+jne    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x17a>
 mov    &_ZN7MemPoolI6CGuildE15headOfFreeList_E,%eax
-mov    %eax,-0x14(%ebp)
-cmpl   $0x0,-0x14(%ebp)
-je     <T> <_ZN7MemPoolI6CGuildE5allocEv+0x46>
-mov    -0x14(%ebp),%eax
-mov    0x6714(%eax),%eax
-mov    %eax,&_ZN7MemPoolI6CGuildE15headOfFreeList_E
-jmp    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x146>
-mov    0x8(%ebp),%eax
-mov    0x4(%eax),%edx
+test   %eax,%eax
+jne    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x157>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
...
+mov    %eax,-0x18(%ebp)
 movl   $0x0,-0xc(%ebp)
-jmp    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x8d>
+jmp    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x7f>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
...
+mov    %eax,(%edx)
 ...
 seta   %al
 test   %al,%al
-jne    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x68>
+jne    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x48>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
...
-mov    -0x14(%ebp),%eax
-add    $0x40,%esp
+jmp    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x18a>
+mov    &_ZN7MemPoolI6CGuildE15headOfFreeList_E,%eax
+mov    %eax,-0x10(%ebp)
+mov    &_ZN7MemPoolI6CGuildE15headOfFreeList_E,%eax
+mov    %eax,%edx
...
void * __thiscall MemPool<CGuild>::_ZN7MemPoolI6CGuildE5allocEv(MemPool<CGuild> *this)
  ...
  if (*(int *)this == 0x6718) {
    ...
    if (headOfFreeList_ == (void *)0x0) {
      ...
      for (local_10 = 0; local_10 < *(int *)(this + 4) - 1U; local_10 = local_10 + 1) {
        *(void **)((int)local_24 + local_10 * 0x6718 + 0x6714) =
             (void *)((local_10 + 1) * 0x6718 + (int)local_24);
      }
      *(undefined4 *)((int)local_24 + (*(int *)(this + 4) + -1) * 0x6718 + 0x6714) = 0;
      headOfFreeList_ = (void *)((int)local_24 + 0x6718);
      local_18 = local_24;
      local_14 = local_24;
      ...
      headOfFreeList_ = *(void **)((int)headOfFreeList_ + 0x6714);
    }
  }
  else {
    local_18 = operator_new(0x6718);
  }
  return local_18;
}
```
