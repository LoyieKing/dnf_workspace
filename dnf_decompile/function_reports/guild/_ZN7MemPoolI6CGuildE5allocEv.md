...
|---|---|---|---|---|---|
| guild | DIFF | `0x809344c` | `0x150` | `0x8095524` | `0x15b` |
...
+jmp    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x154>
...
+jmp    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x151>
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
...
+jmp    <T> <_ZN7MemPoolI6CGuildE5allocEv+0x93>
 mov    -0xc(%ebp),%eax
-imul   $0x6718,%eax,%eax
-add    -0x10(%ebp),%eax
+imul   $0x6718,%eax,%edx
...
+sub    $0x6718,%eax
 ...
 mov    (%eax),%ebx
 movl   $0x7d,0x8(%esp)
 movl   $&_ZZN7MemPoolI6CGuildE5allocEvE12__FUNCTION__,0x4(%esp)
 lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
