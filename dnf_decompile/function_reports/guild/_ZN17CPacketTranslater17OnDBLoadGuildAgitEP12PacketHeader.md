...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082fac` | `0x1d7` | `0x807943c` | `0x1c1` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4361 行）：
