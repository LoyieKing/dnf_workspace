...
|---|---|---|---|---|---|
| guild | DIFF | `0x8051c06` | `0xea` | `0x8098504` | `0xed` |
...
+jmp    <T> <_ZN5CPeer7ConnSigEv+0xdb>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/Peer.cpp](source/DNFServer/GameServer/Guild/Peer.cpp)（约第 395 行）：
