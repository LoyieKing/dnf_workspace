# _ZN13CTcpNetSystem7GetPeerEj

`CTcpNetSystem::GetPeer(unsigned int)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x8053c8e` | `0x70` | `0x80a8188` | `0x6f` |
...
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjP5CPeerEEeqERKS5_>
 test   %al,%al
-je     <T> <_ZN13CTcpNetSystem7GetPeerEj+0x69>
-lea    -0x10(%ebp),%eax
+je     <T> <_ZN13CTcpNetSystem7GetPeerEj+0x5f>
+mov    $0x0,%eax
+jmp    <T> <_ZN13CTcpNetSystem7GetPeerEj+0x6d>
+lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjP5CPeerEEptEv>
 mov    0x4(%eax),%eax
-jmp    <T> <_ZN13CTcpNetSystem7GetPeerEj+0x6e>
-mov    $0x0,%eax
 leave
 ret
```
...
undefined4 CTcpNetSystem::_ZN13CTcpNetSystem7GetPeerEj(uint param_1)

{
  char cVar1;
  int iVar2;
  undefined4 uVar3;
  _Rb_tree_iterator<std::pair<unsigned_int_const,CPeer*>> local_14 [4];
  ...
  if (cVar1 == '\0') {
    ...
    iVar2 = std::_Rb_tree_iterator<std::pair<unsigned_int_const,CPeer*>>::operator->(local_14);
