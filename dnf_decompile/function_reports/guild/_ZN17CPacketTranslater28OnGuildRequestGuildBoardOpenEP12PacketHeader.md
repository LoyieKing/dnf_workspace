...
|---|---|---|---|---|---|
| guild | DIFF | `0x808641a` | `0x41b` | `0x807c02c` | `0x313` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5166 行）：
