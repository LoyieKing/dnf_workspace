...
|---|---|---|---|---|---|
| guild | DIFF | `0x8084102` | `0x342` | `0x807a1fa` | `0x339` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4527 行）：
