...
|---|---|---|---|---|---|
| guild | DIFF | `0x8084102` | `0x342` | `0x8079b46` | `0x2a4` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4455 行）：
