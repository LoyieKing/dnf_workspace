...
|---|---|---|---|---|---|
| guild | DIFF | `0x8084102` | `0x342` | `0x807a0d6` | `0x270` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4633 行）：
