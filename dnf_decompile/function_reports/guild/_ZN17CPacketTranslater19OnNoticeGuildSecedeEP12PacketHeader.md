...
|---|---|---|---|---|---|
| guild | DIFF | `0x8072f1e` | `0x39a` | `0x8069b0a` | `0x3b9` |
...
+mov    %eax,-0x24(%ebp)
+cmpl   $0x0,-0x24(%ebp)
+je     <T> <_ZN17CPacketTranslater19OnNoticeGuildSecedeEP12PacketHeader+0x182>
+lea    -0x4a(%ebp),%eax
 mov    %eax,(%esp)
...
-lea    -0x70(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater19OnNoticeGuildSecedeEP12PacketHeader+0x275>
+lea    -0x60(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+je     <T> <_ZN17CPacketTranslater19OnNoticeGuildSecedeEP12PacketHeader+0x3ae>
+mov    -0x28(%ebp),%eax
 add    $0xa,%eax
 mov    %eax,0x4(%esp)
-mov    -0x28(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater19OnNoticeGuildSecedeEP12PacketHeader+0x3ae>
 cmp    $0x2,%edx
-jne    <T> <_ZN17CPacketTranslater19OnNoticeGuildSecedeEP12PacketHeader+0x335>
+jne    <T> <_ZN17CPacketTranslater19OnNoticeGuildSecedeEP12PacketHeader+0x354>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater19OnNoticeGuildSecedeEP12PacketHeader+0x34d>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater19OnNoticeGuildSecedeEP12PacketHeader+0x3a9>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 544 行）：
