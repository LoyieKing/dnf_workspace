...
|---|---|---|---|---|---|
| guild | DIFF | `0x807d15a` | `0x21f` | `0x807344a` | `0x251` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2719 行）：
