...
|---|---|---|---|---|---|
| guild | DIFF | `0x807d15a` | `0x21f` | `0x8073776` | `0x254` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2600 行）：
