...
|---|---|---|---|---|---|
| guild | DIFF | `0x8096a74` | `0x159` | `0x805ca62` | `0x14f` |
...
+je     <T> <_ZN13CGuildManager14DBGuildProcessEP14CServerHandlerb+0x149>
 movl   $0x0,(%esp)
 call   <T> <time>
-mov    %eax,-0x20(%ebp)
-lea    -0x20(%ebp),%eax
...
-lea    -0x24(%ebp),%eax
+jmp    <T> <_ZN13CGuildManager14DBGuildProcessEP14CServerHandlerb+0xf4>
+lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN13CGuildManager14DBGuildProcessEP14CServerHandlerb+0xe9>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    &g_guildDBProcessDay,%eax
+cmp    %eax,%edx
+jne    <T> <_ZN13CGuildManager14DBGuildProcessEP14CServerHandlerb+0xe9>
 mov    0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
-mov    -0x18(%ebp),%eax
+mov    -0x10(%ebp),%eax
...
+jle    <T> <_ZN13CGuildManager14DBGuildProcessEP14CServerHandlerb+0x14a>
+movl   $0x0,&g_guildDBProcessDay
+jmp    <T> <_ZN13CGuildManager14DBGuildProcessEP14CServerHandlerb+0x14a>
 nop
 mov    -0x4(%ebp),%ebx
 leave
 ret
