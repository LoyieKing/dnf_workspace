...
|---|---|---|---|---|---|
| guild | DIFF | `0x8096a74` | `0x159` | `0x805c7fe` | `0x151` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 530 行）：
