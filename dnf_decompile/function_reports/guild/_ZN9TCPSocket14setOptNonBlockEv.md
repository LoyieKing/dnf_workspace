...
|---|---|---|---|---|---|
| guild | DIFF | `0x804f590` | `0x5e` | `0x8086798` | `0x54` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFTcpSocket.cpp](source/DNFServer/GameServer/Guild/DNFTcpSocket.cpp)（约第 208 行）：
