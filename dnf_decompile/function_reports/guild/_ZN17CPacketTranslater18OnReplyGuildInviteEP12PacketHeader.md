...
|---|---|---|---|---|---|
| guild | DIFF | `0x8078908` | `0x71d` | `0x806f184` | `0x826` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1781 行）：
