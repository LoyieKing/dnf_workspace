...
|---|---|---|---|---|---|
| guild | DIFF | `0x8078908` | `0x71d` | `0x806f2e2` | `0x81f` |
...
-lea    -0x61(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x731>
+lea    -0x45(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
+mov    %eax,-0x40(%ebp)
+cmpl   $0x0,-0x40(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x154>
 movl   $0x94d,0x8(%esp)
...
-lea    -0x7e(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x814>
+lea    -0x62(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x34(%ebp)
+cmpl   $0x0,-0x34(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x32e>
 movl   $0x962,0x8(%esp)
 movl   $"OnReplyGuildInvite",0x4(%esp)
-lea    -0x58(%ebp),%eax
+lea    -0x74(%ebp),%eax
...
+mov    %eax,-0x30(%ebp)
+cmpl   $0x0,-0x30(%ebp)
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x813>
+lea    -0xcc(%ebp),%eax
+mov    %eax,(%esp)
...
-mov    %eax,0x4(%esp)
-mov    -0x34(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x60d>
+mov    0x8(%ebp),%eax
+add    $0xe,%eax
+movzbl (%eax),%eax
+cmp    $0x1,%al
+jne    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x52e>
+lea    -0xcc(%ebp),%eax
+mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x3aa>
+mov    -0x40(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13GetGameServerEv>
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x5e5>
+mov    -0x3c(%ebp),%ebx
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN12CApplication15Get_UserManagerEv>
...
+mov    %eax,-0x24(%ebp)
+cmpl   $0x0,-0x24(%ebp)
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x5e5>
+lea    -0xcc(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN41Packet_Guild_Reply_Guild_Invite_To_CallerC1Ev>
+lea    -0xcc(%ebp),%eax
...
+mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x814>
+lea    -0xcc(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN41Packet_Guild_Reply_Guild_Invite_To_CallerC1Ev>
+lea    -0xcc(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x7b1>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x7aa>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x80c>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
