...
|---|---|---|---|---|---|
| guild | DIFF | `0x8078908` | `0x71d` | `0x806f04a` | `0x838` |
...
-lea    -0x61(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x74a>
+lea    -0x5d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
-mov    -0x2c(%ebp),%eax
-mov    0xa(%eax),%ebx
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x159>
 movl   $0x94d,0x8(%esp)
...
-lea    -0x7e(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x82d>
+lea    -0x7a(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x38(%ebp)
+cmpl   $0x0,-0x3c(%ebp)
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x1aa>
+cmpl   $0x0,-0x38(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x1f8>
+lea    -0x7a(%ebp),%eax
+add    $0x12,%eax
+movl   $0x67,(%eax)
+lea    -0x7a(%ebp),%eax
...
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x33d>
 movl   $0x962,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x58(%ebp),%eax
+lea    -0x54(%ebp),%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x82c>
+lea    -0xcc(%ebp),%eax
+mov    %eax,(%esp)
...
+setle  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x621>
+mov    0x8(%ebp),%eax
+add    $0xe,%eax
+movzbl (%eax),%eax
+cmp    $0x1,%al
+jne    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x53d>
+lea    -0xcc(%ebp),%eax
+mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x3b9>
+mov    -0x40(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN5CUser13GetGameServerEv>
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x5f9>
+mov    -0x3c(%ebp),%ebx
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN12CApplication15Get_UserManagerEv>
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x5f9>
+lea    -0xcc(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN41Packet_Guild_Reply_Guild_Invite_To_CallerC1Ev>
+lea    -0xcc(%ebp),%eax
...
-lea    -0xbe(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x82d>
+lea    -0xcc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN41Packet_Guild_Reply_Guild_Invite_To_CallerC1Ev>
-mov    -0x24(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x7ca>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x7c3>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnReplyGuildInviteEP12PacketHeader+0x825>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1611 行）：
