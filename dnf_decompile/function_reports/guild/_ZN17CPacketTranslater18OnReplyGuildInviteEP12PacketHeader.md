...
|---|---|---|---|---|---|
| guild | DIFF | `0x8078908` | `0x71d` | `0x806ec80` | `0x796` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1714 行）：
