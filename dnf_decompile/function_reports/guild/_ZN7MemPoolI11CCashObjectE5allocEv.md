...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a193c` | `0x151` | `0x8094186` | `0x191` |
...
+sub    $0x44,%esp
 ...
 mov    (%eax),%eax
 cmp    $0x24,%eax
-je     <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x23>
-movl   $0x24,(%esp)
-call   <T> <_Znwj>
-jmp    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x14a>
+jne    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x178>
 mov    &_ZN7MemPoolI11CCashObjectE15headOfFreeList_E,%eax
-mov    %eax,-0x14(%ebp)
-cmpl   $0x0,-0x14(%ebp)
-je     <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x41>
-mov    -0x14(%ebp),%eax
-mov    0x20(%eax),%eax
-mov    %eax,&_ZN7MemPoolI11CCashObjectE15headOfFreeList_E
-jmp    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x147>
-mov    0x8(%ebp),%eax
-mov    0x4(%eax),%edx
+test   %eax,%eax
+jne    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x155>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
...
+mov    %eax,-0x18(%ebp)
 movl   $0x0,-0xc(%ebp)
-jmp    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x8f>
-mov    -0xc(%ebp),%edx
-mov    %edx,%eax
-shl    $0x3,%eax
-add    %edx,%eax
-shl    $0x2,%eax
+jmp    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x7d>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
+mov    0x8(%ebp),%eax
+mov    (%eax),%eax
...
+mov    %eax,(%edx)
 ...
 seta   %al
 test   %al,%al
-jne    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x63>
+jne    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x46>
+mov    -0x18(%ebp),%eax
+mov    %eax,%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
...
-mov    -0x14(%ebp),%eax
-add    $0x40,%esp
+jmp    <T> <_ZN7MemPoolI11CCashObjectE5allocEv+0x188>
+mov    &_ZN7MemPoolI11CCashObjectE15headOfFreeList_E,%eax
+mov    %eax,-0x10(%ebp)
+mov    &_ZN7MemPoolI11CCashObjectE15headOfFreeList_E,%eax
+mov    %eax,%edx
  ...
  if (*(int *)this == 0x24) {
    ...
    if (headOfFreeList_ == (void *)0x0) {
      ...
      for (local_10 = 0; local_10 < *(int *)(this + 4) - 1U; local_10 = local_10 + 1) {
        *(void **)((int)local_24 + local_10 * 0x24 + 0x20) =
             (void *)((local_10 + 1) * 0x24 + (int)local_24);
      }
      *(undefined4 *)((int)local_24 + (*(int *)(this + 4) + -1) * 0x24 + 0x20) = 0;
      headOfFreeList_ = (void *)((int)local_24 + 0x24);
      local_18 = local_24;
      local_14 = local_24;
      ...
      headOfFreeList_ = *(void **)((int)headOfFreeList_ + 0x20);
    }
  }
  else {
