...
|---|---|---|---|---|---|
| guild | DIFF | `0x8057338` | `0x111` | `0x80a4e16` | `0x19a` |
...
+mov    %ebx,%eax
+test   %eax,%eax
+je     <T> <_ZN13np_server_xml10CServerXmlC1Ev+0xb4>
+mov    %ebx,%eax
+mov    %eax,(%esp)
+call   <T> <_ZN13TiXmlDocumentC1Ev>
+jmp    <T> <_ZN13np_server_xml10CServerXmlC1Ev+0xb4>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    0x8(%ebp),%eax
+add    $0x5,%eax
...
+mov    %edi,%eax
+mov    %esi,%edx
+jmp    <T> <_ZN13np_server_xml10CServerXmlC1Ev+0x110>
+mov    0x8(%ebp),%eax
+movl   $0x0,0x50(%eax)
+lea    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN13np_server_xml10CServerXmlC1Ev+0x192>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xa0,%eax
...
+jmp    <T> <_ZN13np_server_xml10CServerXmlC1Ev+0x12a>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x88,%eax
...
+jmp    <T> <_ZN13np_server_xml10CServerXmlC1Ev+0x144>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x70,%eax
...
+jmp    <T> <_ZN13np_server_xml10CServerXmlC1Ev+0x15c>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x58,%eax
...
+jmp    <T> <_ZN13np_server_xml10CServerXmlC1Ev+0x174>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x54,%eax
...
void __thiscall np_server_xml::CServerXml::_ZN13np_server_xml10CServerXmlC1Ev(CServerXml *this)
...
定义于 [source/DNFServer/GameServer/DBMW/ServerXml.cpp](source/DNFServer/GameServer/DBMW/ServerXml.cpp)（约第 36 行）：
