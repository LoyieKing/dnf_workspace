...
|---|---|---|---|---|---|
| guild | NEAR | `0x80892b2` | `0x260` | `0x807f168` | `0x260` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5741 行）：
