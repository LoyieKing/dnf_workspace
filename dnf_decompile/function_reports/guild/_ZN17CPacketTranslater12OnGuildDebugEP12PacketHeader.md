...
|---|---|---|---|---|---|
| guild | DIFF | `0x80892b2` | `0x260` | `0x807dee6` | `0x178` |
...
+jne    <T> <_ZN17CPacketTranslater12OnGuildDebugEP12PacketHeader+0x50>
 movl   $0x2040,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater12OnGuildDebugEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x40(%ebp),%eax
+lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater12OnGuildDebugEP12PacketHeader+0x176>
+mov    -0x1c(%ebp),%eax
+add    $0xa,%eax
+mov    (%eax),%eax
+mov    %eax,-0x18(%ebp)
...
+je     <T> <_ZN17CPacketTranslater12OnGuildDebugEP12PacketHeader+0xbe>
 movl   $0x2046,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater12OnGuildDebugEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x38(%ebp),%eax
+lea    -0x2c(%ebp),%eax
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x0,-0xc(%ebp)
+jne    <T> <_ZN17CPacketTranslater12OnGuildDebugEP12PacketHeader+0x121>
 movl   $0x204c,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater12OnGuildDebugEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x30(%ebp),%eax
+lea    -0x24(%ebp),%eax
...
-jmp    <T> <_ZN17CPacketTranslater12OnGuildDebugEP12PacketHeader+0x259>
+jne    <T> <_ZN17CPacketTranslater12OnGuildDebugEP12PacketHeader+0x14c>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    %eax,(%esp)
...
+mov    (%eax),%eax
+cmp    $0x1,%eax
+jne    <T> <_ZN17CPacketTranslater12OnGuildDebugEP12PacketHeader+0x176>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
 mov    %eax,(%esp)
 call   <T> <_ZN12CApplication16Get_GuildManagerEv>
 movl   $0x1,0x4(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5511 行）：
