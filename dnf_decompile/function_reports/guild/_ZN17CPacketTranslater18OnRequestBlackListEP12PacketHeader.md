...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dfda` | `0x207` | `0x80744d8` | `0x20e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2930 行）：
