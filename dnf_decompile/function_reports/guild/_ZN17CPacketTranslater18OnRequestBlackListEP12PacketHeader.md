...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dfda` | `0x207` | `0x8074842` | `0x20d` |
...
-lea    -0x1d3(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0x203>
+lea    -0x1d7(%ebp),%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0xdb>
 movl   $0xf39,0x8(%esp)
 movl   $"OnRequestBlackList",0x4(%esp)
-lea    -0x2c(%ebp),%eax
+lea    -0x28(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0x1a9>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0x1a2>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0x1fe>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
