...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dfda` | `0x207` | `0x8074912` | `0x20e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2962 行）：
