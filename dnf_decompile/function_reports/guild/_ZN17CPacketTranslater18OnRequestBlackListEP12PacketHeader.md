...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dfda` | `0x207` | `0x8074326` | `0x200` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2896 行）：
