...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dfda` | `0x207` | `0x80742d8` | `0x200` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2889 行）：
