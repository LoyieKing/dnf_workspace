...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dfda` | `0x207` | `0x80748a4` | `0x20a` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3097 行）：
