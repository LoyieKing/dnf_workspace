...
|---|---|---|---|---|---|
| guild | DIFF | `0x807dfda` | `0x207` | `0x807464c` | `0x212` |
...
-lea    -0x1d3(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0x208>
+lea    -0x1d7(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0xe0>
 movl   $0xf39,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater18OnRequestBlackListEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x2c(%ebp),%eax
+lea    -0x1c(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0x1ae>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnRequestBlackListEP12PacketHeader+0x1a7>
 mov    %edx,%ebx
 mov    %eax,%esi
