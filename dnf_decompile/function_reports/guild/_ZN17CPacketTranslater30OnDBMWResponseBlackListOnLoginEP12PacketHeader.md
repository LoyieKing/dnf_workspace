...
|---|---|---|---|---|---|
| guild | DIFF | `0x807e828` | `0x262` | `0x8074dd4` | `0x261` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3102 行）：
