...
|---|---|---|---|---|---|
| guild | DIFF | `0x807e828` | `0x262` | `0x8074a44` | `0x263` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3669 行）：
