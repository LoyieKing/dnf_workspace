...
|---|---|---|---|---|---|
| guild | DIFF | `0x807ff8a` | `0x3d5` | `0x8076356` | `0x3b3` |
...
+jne    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x74>
 movl   $0x1237,0x8(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x3a9>
+mov    0x8(%ebp),%eax
 mov    0xa(%eax),%eax
...
+mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+jne    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0xd8>
 movl   $0x123d,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x44(%ebp),%eax
+lea    -0x3c(%ebp),%eax
...
+je     <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x118>
+cmpl   $0x0,-0x18(%ebp)
+jne    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x174>
+movl   $0x1244,0x8(%esp)
+movl   $&_ZZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
+lea    -0x34(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+jne    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x1a0>
+mov    -0x24(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    -0x18(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x1a7>
 mov    $0x1,%eax
-jmp    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x126>
+jmp    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x1ac>
 mov    $0x0,%eax
 test   %al,%al
...
-jmp    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x3ce>
-mov    -0x14(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x26b>
+mov    0x8(%ebp),%eax
 movzbl 0x12(%eax),%eax
-mov    %al,-0xd(%ebp)
-cmpb   $0x1,-0xd(%ebp)
...
-mov    -0x1c(%ebp),%eax
+cmp    $0x1,%al
+jne    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x1c6>
+mov    $0x3,%eax
+jmp    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x1cb>
+mov    $0x4,%eax
+mov    %al,-0x11(%ebp)
+movzbl -0x11(%ebp),%eax
+mov    %eax,0x4(%esp)
...
+jne    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x34f>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x348>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater17OnPacketJoinPowerEP12PacketHeader+0x3a4>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4201 行）：
