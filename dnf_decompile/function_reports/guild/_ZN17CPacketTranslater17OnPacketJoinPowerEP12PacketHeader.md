...
|---|---|---|---|---|---|
| guild | DIFF | `0x807ff8a` | `0x3d5` | `0x80762f0` | `0x3e6` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3440 行）：
