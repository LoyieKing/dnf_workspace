...
|---|---|---|---|---|---|
| guild | NEAR | `0x8096fa8` | `0xa5` | `0x805cd32` | `0xa5` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 692 行）：
