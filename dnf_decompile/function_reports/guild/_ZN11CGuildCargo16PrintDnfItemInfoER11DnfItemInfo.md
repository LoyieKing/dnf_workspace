...
|---|---|---|---|---|---|
| guild | DIFF | `0x809ff8c` | `0xea` | `0x8092254` | `0x102` |
...
定义于 [source/DNFServer/GameServer/Guild/GuildCargo.cpp](source/DNFServer/GameServer/Guild/GuildCargo.cpp)（约第 361 行）：
