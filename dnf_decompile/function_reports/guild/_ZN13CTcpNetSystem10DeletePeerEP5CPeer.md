...
|---|---|---|---|---|---|
| guild | DIFF | `0x80536c4` | `0xe7` | `0x80a7c04` | `0xf2` |
...
-lea    0x144(%eax),%edx
-mov    -0x14(%ebp),%eax
+je     <T> <_ZN13CTcpNetSystem10DeletePeerEP5CPeer+0x8e>
+mov    -0x20(%ebp),%eax
 mov    %eax,0x4(%esp)
-mov    %edx,(%esp)
+mov    -0xc(%ebp),%eax
...
+cmpl   $0x0,0xc(%ebp)
+je     <T> <_ZN13CTcpNetSystem10DeletePeerEP5CPeer+0xdd>
 mov    0xc(%ebp),%ebx
 test   %ebx,%ebx
...
+jmp    <T> <_ZN13CTcpNetSystem10DeletePeerEP5CPeer+0xdd>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x18(%ebp),%eax
+lea    -0x24(%ebp),%eax
...

{
  ...
  if (param_1 != (CPeer *)0x0) {
                    /* try { // try from 0805376c to 08053778 has its CatchHandler @ 0805377b */
    CPeer::~CPeer(param_1);
