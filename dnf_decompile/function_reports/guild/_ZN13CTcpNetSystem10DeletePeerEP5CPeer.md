...
|---|---|---|---|---|---|
| guild | DIFF | `0x80536c4` | `0xe7` | `0x80a7f96` | `0xf3` |
...
定义于 [source/DNFServer/GameServer/Guild/TcpNetSystem.cpp](source/DNFServer/GameServer/Guild/TcpNetSystem.cpp)（约第 390 行）：
