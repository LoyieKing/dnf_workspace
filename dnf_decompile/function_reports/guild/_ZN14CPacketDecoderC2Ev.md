...
|---|---|---|---|---|---|
| guild | DIFF | `0x806f934` | `0x60f` | `0x8066b00` | `0x58` |
...
+call   <T> <memset>
+movl   $0x0,-0xc(%ebp)
+jmp    <T> <_ZN14CPacketDecoderC1Ev+0x4b>
 mov    0x8(%ebp),%eax
-movl   $0x0,0x4(%eax)
-mov    0x8(%ebp),%eax
-movl   $0x0,0x8(%eax)
...
+mov    %eax,%edx
+mov    -0xc(%ebp),%eax
+mov    &_ZZN14CPacketDecoderC1EvE3tbl(,%eax,8),%eax
+add    %eax,%edx
+mov    -0xc(%ebp),%eax
+mov    &_ZZN14CPacketDecoderC1EvE3tbl+0x4(,%eax,8),%eax
+mov    %eax,(%edx)
+addl   $0x1,-0xc(%ebp)
+cmpl   $0x6c,-0xc(%ebp)
+setbe  %al
...
+jne    <T> <_ZN14CPacketDecoderC1Ev+0x2a>
 leave
 ret
```
## 2. Ghidra 反编译 C
