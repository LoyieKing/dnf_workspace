...
|---|---|---|---|---|---|
| guild | DIFF | `0x806f934` | `0x60f` | `0x8065f8e` | `0x60f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Guild/DNFPacketDecoder.cpp)（约第 77 行）：
