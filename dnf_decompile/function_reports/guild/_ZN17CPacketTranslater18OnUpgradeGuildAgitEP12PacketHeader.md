...
|---|---|---|---|---|---|
| guild | DIFF | `0x8083184` | `0x32a` | `0x8078f88` | `0x22e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4207 行）：
