...
|---|---|---|---|---|---|
| guild | DIFF | `0x8083184` | `0x32a` | `0x80792fc` | `0x22e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4376 行）：
