...
|---|---|---|---|---|---|
| guild | DIFF | `0x8083184` | `0x32a` | `0x8079320` | `0x31c` |
...
+jmp    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x311>
 mov    0x8(%ebp),%eax
 mov    %eax,-0x20(%ebp)
 mov    -0x20(%ebp),%eax
 mov    0xa(%eax),%eax
...
+je     <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x88>
 mov    -0x20(%ebp),%eax
 mov    0xa(%eax),%eax
...
+jne    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0xc9>
 movl   $0x1770,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
 lea    -0x54(%ebp),%eax
 mov    %eax,(%esp)
...
-call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x31f>
+je     <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x1ec>
 mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
-call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x31f>
+je     <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x1a7>
 mov    -0x20(%ebp),%eax
 mov    0x16(%eax),%ebx
 mov    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x158>
 mov    -0x20(%ebp),%eax
 mov    0xa(%eax),%ebx
 movl   $0x1783,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
...
+jne    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x2b7>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x2b0>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnUpgradeGuildAgitEP12PacketHeader+0x30c>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4202 行）：
