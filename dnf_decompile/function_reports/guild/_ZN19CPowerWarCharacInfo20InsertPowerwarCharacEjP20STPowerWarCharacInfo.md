...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a78dc` | `0x6a` | `0x809d8b0` | `0x6f` |
...
定义于 [source/DNFServer/GameServer/Guild/PowerWarCharacInfo.cpp](source/DNFServer/GameServer/Guild/PowerWarCharacInfo.cpp)（约第 149 行）：
