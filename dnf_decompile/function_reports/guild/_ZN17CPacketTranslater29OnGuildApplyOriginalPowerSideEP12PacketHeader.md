...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087c5c` | `0x374` | `0x807d390` | `0x29c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5402 行）：
