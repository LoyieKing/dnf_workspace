...
|---|---|---|---|---|---|
| guild | DIFF | `0x80793b0` | `0x235` | `0x806f7ca` | `0x24c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2074 行）：
