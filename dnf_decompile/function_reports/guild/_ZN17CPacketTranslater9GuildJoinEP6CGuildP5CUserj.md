...
|---|---|---|---|---|---|
| guild | DIFF | `0x80793b0` | `0x235` | `0x806f96a` | `0x252` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1920 行）：
