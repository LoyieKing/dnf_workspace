...
|---|---|---|---|---|---|
| guild | DIFF | `0x80793b0` | `0x235` | `0x806feb0` | `0x252` |
...
+je     <T> <_ZN17CPacketTranslater9GuildJoinEP6CGuildP5CUserj+0x249>
 cmpl   $0x0,0xc(%ebp)
...
+je     <T> <_ZN17CPacketTranslater9GuildJoinEP6CGuildP5CUserj+0x21c>
 mov    0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1786 行）：
