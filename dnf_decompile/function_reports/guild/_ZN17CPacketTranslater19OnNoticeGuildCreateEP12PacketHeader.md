...
|---|---|---|---|---|---|
| guild | DIFF | `0x8073574` | `0x3d4` | `0x8069c38` | `0x3de` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 899 行）：
