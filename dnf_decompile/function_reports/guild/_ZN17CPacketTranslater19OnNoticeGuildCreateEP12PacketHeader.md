...
|---|---|---|---|---|---|
| guild | DIFF | `0x8073574` | `0x3d4` | `0x8069a86` | `0x3db` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 746 行）：
