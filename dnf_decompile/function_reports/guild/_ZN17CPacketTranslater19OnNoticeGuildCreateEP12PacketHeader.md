...
|---|---|---|---|---|---|
| guild | DIFF | `0x8073574` | `0x3d4` | `0x8069992` | `0x3d9` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1308 行）：
