...
|---|---|---|---|---|---|
| guild | DIFF | `0x80875e2` | `0x233` | `0x807d4a0` | `0x230` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 6074 行）：
