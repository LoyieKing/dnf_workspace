...
|---|---|---|---|---|---|
| guild | DIFF | `0x80875e2` | `0x233` | `0x807ccc6` | `0x166` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5304 行）：
