# _ZN19CPowerWarCharacInfo10InitializeEv

`CPowerWarCharacInfo::Initialize()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| guild | DIFF | `0x80a7766` | `0x32` | `0x809dc16` | `0x38` |
...
+add    $0x24,%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSt4listI11STUserPointSaIS0_EE5clearEv>
 leave
 ret
```
## 2. Ghidra 反编译 C
...
void __thiscall
CPowerWarCharacInfo::_ZN19CPowerWarCharacInfo10InitializeEv(CPowerWarCharacInfo *this)

{
  ...
  std::list<STUserPoint,std::allocator<STUserPoint>>::clear
...
定义于 [source/DNFServer/GameServer/Guild/PowerWarCharacInfo.cpp](source/DNFServer/GameServer/Guild/PowerWarCharacInfo.cpp)（约第 115 行）：
