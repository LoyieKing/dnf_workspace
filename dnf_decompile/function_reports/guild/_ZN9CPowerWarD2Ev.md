...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a6d12` | `0xbe` | `0x809d0ee` | `0x8d` |
...
void __thiscall CPowerWar::_ZN9CPowerWarD2Ev(CPowerWar *this)

{
  *(undefined ***)this = &PTR__ZN9CPowerWarD2Ev_081372e0;
  if (*(int *)(this + 0x10) != 0) {
    if (*(int *)(this + 0x10) != 0) {
...
定义于 [source/DNFServer/GameServer/Guild/PowerWar.cpp](source/DNFServer/GameServer/Guild/PowerWar.cpp)（约第 116 行）：
