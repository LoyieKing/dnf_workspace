...
|---|---|---|---|---|---|
| guild | DIFF | `0x8088d58` | `0x2d2` | `0x807dc14` | `0x1f9` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5607 行）：
