...
|---|---|---|---|---|---|
| guild | DIFF | `0x8088d58` | `0x2d2` | `0x807ec52` | `0x2b4` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5653 行）：
