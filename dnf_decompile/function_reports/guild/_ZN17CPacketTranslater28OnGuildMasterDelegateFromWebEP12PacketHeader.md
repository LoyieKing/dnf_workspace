...
|---|---|---|---|---|---|
| guild | DIFF | `0x807bc44` | `0x645` | `0x8071efc` | `0x620` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3072 行）：
