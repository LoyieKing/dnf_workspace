...
|---|---|---|---|---|---|
| guild | DIFF | `0x807bc44` | `0x645` | `0x80723ba` | `0x639` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2353 行）：
