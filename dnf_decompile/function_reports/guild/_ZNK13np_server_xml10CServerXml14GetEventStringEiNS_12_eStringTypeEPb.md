...
|---|---|---|---|---|---|
| guild | DIFF | `0x8058146` | `0x20a` | `0x80a54ba` | `0x10f` |
...
+mov    %eax,-0xc(%ebp)
+cmpl   $0x1,0x14(%ebp)
+jne    <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0x25>
+mov    0xc(%ebp),%eax
+add    $0x70,%eax
+mov    %eax,-0xc(%ebp)
+jmp    <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0x36>
+cmpl   $0x2,0x14(%ebp)
+jne    <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0x36>
+mov    0xc(%ebp),%eax
+add    $0x88,%eax
+mov    %eax,-0xc(%ebp)
+lea    -0x18(%ebp),%eax
...
+test   %al,%al
+je     <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0xd7>
+cmpl   $0x0,0x18(%ebp)
+je     <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0x89>
+mov    0x18(%ebp),%eax
+movb   $0x0,(%eax)
+mov    %ebx,%esi
+lea    -0xd(%ebp),%eax
...
+jmp    <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0xca>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x11(%ebp),%eax
+lea    -0xd(%ebp),%eax
...
+jmp    <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0xff>
 cmpl   $0x0,0x18(%ebp)
-je     <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0xfc>
+je     <T> <_ZNK13np_server_xml10CServerXml14GetEventStringEiNS_12_eStringTypeEPb+0xe3>
 mov    0x18(%ebp),%eax
 movb   $0x1,(%eax)
...

{
  ...
  std::allocator<char>::allocator();
                    /* try { // try from 08058171 to 08058175 has its CatchHandler @ 08058178 */
  ...
  if (param_4 == 1) {
                    /* try { // try from 080581d6 to 08058317 has its CatchHandler @ 0805831a */
