...
|---|---|---|---|---|---|
| guild | NEAR | `0x807d596` | `0x26d` | `0x8073906` | `0x26d` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2767 行）：
