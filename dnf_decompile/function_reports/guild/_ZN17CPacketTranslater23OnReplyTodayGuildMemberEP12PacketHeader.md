...
|---|---|---|---|---|---|
| guild | NEAR | `0x80888fa` | `0x1eb` | `0x807e7fa` | `0x1eb` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5593 行）：
