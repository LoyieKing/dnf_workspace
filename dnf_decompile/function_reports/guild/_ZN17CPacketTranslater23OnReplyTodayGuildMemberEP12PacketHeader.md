...
|---|---|---|---|---|---|
| guild | DIFF | `0x80888fa` | `0x1eb` | `0x807d7ca` | `0x1e4` |
...
+jmp    <T> <_ZN17CPacketTranslater23OnReplyTodayGuildMemberEP12PacketHeader+0x1dd>
 mov    -0x14(%ebp),%eax
 mov    0xa(%eax),%eax
...
+je     <T> <_ZN17CPacketTranslater23OnReplyTodayGuildMemberEP12PacketHeader+0xb9>
 movl   $0x1f7b,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater23OnReplyTodayGuildMemberEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
 lea    -0x2c(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater23OnReplyTodayGuildMemberEP12PacketHeader+0x183>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater23OnReplyTodayGuildMemberEP12PacketHeader+0x17c>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater23OnReplyTodayGuildMemberEP12PacketHeader+0x1d8>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5544 行）：
