...
|---|---|---|---|---|---|
| guild | DIFF | `0x805f992` | `0xa4` | `0x8063d42` | `0x93` |
...
+je     <T> <_ZN14CKillUSRConfig11Clear_TableEv+0x91>
 mov    0x8(%ebp),%eax
 lea    0x4(%eax),%edx
 lea    -0x10(%ebp),%eax
 mov    %edx,0x4(%esp)
...
+call   <T> <_ZNSt6vectorIP16ST_KillUSRConfigSaIS1_EE5beginEv>
+sub    $0x4,%esp
+jmp    <T> <_ZN14CKillUSRConfig11Clear_TableEv+0x55>
+lea    -0x10(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNK9__gnu_cxx17__normal_iteratorIPP16ST_KillUSRConfigSt6vectorIS2_SaIS2_EEEdeEv>
+mov    (%eax),%eax
...
+jne    <T> <_ZN14CKillUSRConfig11Clear_TableEv+0x35>
 mov    0x8(%ebp),%eax
 add    $0x4,%eax
 mov    %eax,(%esp)
