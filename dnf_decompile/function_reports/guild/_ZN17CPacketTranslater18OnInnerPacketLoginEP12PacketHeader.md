...
|---|---|---|---|---|---|
| guild | DIFF | `0x808109c` | `0x25a` | `0x80774ac` | `0x23b` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3524 行）：
