...
|---|---|---|---|---|---|
| guild | DIFF | `0x808109c` | `0x25a` | `0x80773e0` | `0x247` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3861 行）：
