...
|---|---|---|---|---|---|
| guild | DIFF | `0x808109c` | `0x25a` | `0x8077432` | `0x241` |
...
+jmp    <T> <_ZN17CPacketTranslater18OnInnerPacketLoginEP12PacketHeader+0x23a>
 mov    0x8(%ebp),%eax
-mov    %eax,-0x20(%ebp)
+mov    %eax,-0x1c(%ebp)
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+mov    %eax,-0x18(%ebp)
+cmpl   $0x0,-0x18(%ebp)
+je     <T> <_ZN17CPacketTranslater18OnInnerPacketLoginEP12PacketHeader+0x23a>
 movl   $0xc,0x8(%esp)
 movl   $0x1f40,0x4(%esp)
-mov    -0x24(%ebp),%eax
+mov    -0x18(%ebp),%eax
...
+jne    <T> <_ZN17CPacketTranslater18OnInnerPacketLoginEP12PacketHeader+0x1e0>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater18OnInnerPacketLoginEP12PacketHeader+0x1d9>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater18OnInnerPacketLoginEP12PacketHeader+0x235>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3720 行）：
