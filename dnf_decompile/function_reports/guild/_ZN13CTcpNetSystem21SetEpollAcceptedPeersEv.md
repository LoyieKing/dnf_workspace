...
|---|---|---|---|---|---|
| guild | DIFF | `0x8052fb8` | `0x19c` | `0x80a771a` | `0x199` |
...
+je     <T> <_ZN13CTcpNetSystem21SetEpollAcceptedPeersEv+0x184>
+jmp    <T> <_ZN13CTcpNetSystem21SetEpollAcceptedPeersEv+0x14c>
 mov    0x8(%ebp),%eax
 add    $0x11c,%eax
 mov    %eax,(%esp)
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+je     <T> <_ZN13CTcpNetSystem21SetEpollAcceptedPeersEv+0xd6>
+mov    -0x10(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <strerror>
 mov    %eax,%ebx
...
+jne    <T> <_ZN13CTcpNetSystem21SetEpollAcceptedPeersEv+0x3d>
+jmp    <T> <_ZN13CTcpNetSystem21SetEpollAcceptedPeersEv+0x184>
 mov    %edx,%ebx
 mov    %eax,%esi
-lea    -0x2c(%ebp),%eax
+lea    -0x30(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Guild/TcpNetSystem.cpp](source/DNFServer/GameServer/Guild/TcpNetSystem.cpp)（约第 252 行）：
