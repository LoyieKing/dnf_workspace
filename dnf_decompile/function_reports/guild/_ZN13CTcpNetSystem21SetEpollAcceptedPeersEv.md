...
|---|---|---|---|---|---|
| guild | DIFF | `0x8052fb8` | `0x19c` | `0x80a76da` | `0x199` |
...
定义于 [source/DNFServer/GameServer/Guild/TcpNetSystem.cpp](source/DNFServer/GameServer/Guild/TcpNetSystem.cpp)（约第 267 行）：
