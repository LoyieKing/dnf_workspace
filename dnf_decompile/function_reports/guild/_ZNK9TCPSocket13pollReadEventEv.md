...
|---|---|---|---|---|---|
| guild | DIFF | `0x804f79e` | `0x117` | `0x8086cac` | `0x10a` |
...
+sub    $0xc0,%esp
+movl   $0x0,-0xc(%ebp)
+jmp    <T> <_ZNK9TCPSocket13pollReadEventEv+0x26>
+mov    -0xc(%ebp),%eax
...
+jne    <T> <_ZNK9TCPSocket13pollReadEventEv+0x14>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 mov    %eax,%edx
 shr    $0x5,%edx
...
+mov    %eax,-0x10(%ebp)
+cmpl   $0x0,-0x10(%ebp)
+jns    <T> <_ZNK9TCPSocket13pollReadEventEv+0xde>
...
+jmp    <T> <_ZNK9TCPSocket13pollReadEventEv+0x100>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 shr    $0x5,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFTcpSocket.cpp](source/DNFServer/GameServer/Guild/DNFTcpSocket.cpp)（约第 258 行）：
