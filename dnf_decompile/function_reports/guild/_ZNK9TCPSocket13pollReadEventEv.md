...
|---|---|---|---|---|---|
| guild | DIFF | `0x804f79e` | `0x117` | `0x808698a` | `0x10a` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFTcpSocket.cpp](source/DNFServer/GameServer/Guild/DNFTcpSocket.cpp)（约第 259 行）：
