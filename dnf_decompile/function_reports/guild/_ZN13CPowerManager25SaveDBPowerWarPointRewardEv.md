...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a4b16` | `0x124` | `0x809ae26` | `0x125` |
...
+jle    <T> <_ZN13CPowerManager25SaveDBPowerWarPointRewardEv+0x67>
 movl   $0x357,0x8(%esp)
 movl   $"SaveDBPowerWarPointReward",0x4(%esp)
-lea    -0x1c(%ebp),%eax
+lea    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/PowerManager.cpp](source/DNFServer/GameServer/Guild/PowerManager.cpp)（约第 459 行）：
