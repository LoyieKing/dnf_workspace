...
|---|---|---|---|---|---|
| guild | DIFF | `0x809720a` | `0x246` | `0x805d716` | `0x24c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 641 行）：
