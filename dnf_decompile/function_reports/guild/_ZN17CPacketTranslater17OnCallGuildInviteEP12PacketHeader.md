...
|---|---|---|---|---|---|
| guild | DIFF | `0x8077fde` | `0x92a` | `0x806e354` | `0x929` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1598 行）：
