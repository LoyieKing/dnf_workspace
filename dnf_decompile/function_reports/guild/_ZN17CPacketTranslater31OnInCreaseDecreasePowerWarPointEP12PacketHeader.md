...
|---|---|---|---|---|---|
| guild | DIFF | `0x8081faa` | `0x25b` | `0x80787b8` | `0x170` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3982 行）：
