...
|---|---|---|---|---|---|
| guild | DIFF | `0x8081faa` | `0x25b` | `0x80785d0` | `0x170` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4104 行）：
