...
|---|---|---|---|---|---|
| guild | DIFF | `0x80870e6` | `0x241` | `0x807cf5a` | `0x236` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 6028 行）：
