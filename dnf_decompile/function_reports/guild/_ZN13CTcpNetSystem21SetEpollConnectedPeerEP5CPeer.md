...
|---|---|---|---|---|---|
| guild | DIFF | `0x805395e` | `0x136` | `0x80a82ac` | `0xf1` |
...
+je     <T> <_ZN13CTcpNetSystem21SetEpollConnectedPeerEP5CPeer+0x72>
+movl   $0x0,0xc(%esp)
+mov    -0x14(%ebp),%eax
+mov    %eax,0x8(%esp)
+mov    0xc(%ebp),%eax
...

{
  ...
  pTVar1 = (TCPSocket *)CPeer::GetTcpSocket(param_1);
                    /* try { // try from 08053990 to 08053a60 has its CatchHandler @ 08053a79 */
...
定义于 [source/DNFServer/GameServer/Guild/TcpNetSystem.cpp](source/DNFServer/GameServer/Guild/TcpNetSystem.cpp)（约第 467 行）：
