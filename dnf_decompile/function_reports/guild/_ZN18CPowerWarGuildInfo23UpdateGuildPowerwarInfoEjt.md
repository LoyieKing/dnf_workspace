...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a9f6c` | `0x77` | `0x80a015c` | `0x7e` |
...
定义于 [source/DNFServer/GameServer/Guild/PowerWarGuildInfo.cpp](source/DNFServer/GameServer/Guild/PowerWarGuildInfo.cpp)（约第 163 行）：
