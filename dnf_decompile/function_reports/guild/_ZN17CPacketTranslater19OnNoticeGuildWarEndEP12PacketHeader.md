...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076258` | `0x4a8` | `0x806c5b2` | `0x4a5` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1926 行）：
