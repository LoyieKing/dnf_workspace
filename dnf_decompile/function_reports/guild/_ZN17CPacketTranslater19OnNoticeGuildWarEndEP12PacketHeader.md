...
|---|---|---|---|---|---|
| guild | DIFF | `0x8076258` | `0x4a8` | `0x806c6c8` | `0x49f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1353 行）：
