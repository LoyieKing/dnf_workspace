...
|---|---|---|---|---|---|
| guild | DIFF | `0x806230c` | `0x77a` | `0x804dd7c` | `0x849` |
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x3e>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 call   <T> <_ZdlPv>
...
+mov    0x5c(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x12e>
 mov    0x8(%ebp),%eax
 mov    0x5c(%eax),%eax
 mov    (%eax),%eax
 add    $0x8,%eax
...
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x700>
-lea    -0x51(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0xfb>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x60(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x108>
+lea    -0x60(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x123>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x59(%ebp),%eax
+mov    %eax,(%esp)
...
+lea    -0x59(%ebp),%eax
 ...
 mov    0x5c(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x189>
+mov    0x8(%ebp),%eax
+mov    0x5c(%eax),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x1bb>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 call   <T> <_ZdlPv>
...
+call   <T> <_Unwind_Resume>
 ...
 mov    0x5c(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x2d9>
+mov    0x8(%ebp),%eax
+mov    0x5c(%eax),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x284>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x27e>
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN12CApplication4LoadEiPPc+0x29b>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x29b>
+lea    -0x58(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x2b6>
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN12CApplication4LoadEiPPc+0x29b>
+call   <T> <_ZSt9terminatev>
+mov    %edx,%ebx
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x30b>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+mov    0x5c(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x352>
+mov    0x8(%ebp),%eax
+mov    0x5c(%eax),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x38f>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x3e0>
+mov    %edx,%esi
+mov    %eax,%edi
+mov    %ebx,(%esp)
+call   <T> <_ZdlPv>
...
+sete   %al
+test   %al,%al
+je     <T> <_ZN12CApplication4LoadEiPPc+0x4ed>
 lea    -0x49(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
 lea    -0x49(%ebp),%eax
 mov    %eax,0x8(%esp)
-movl   $"CApplication::Load() Init UDP Server Socket Exception Break!",0x4(%esp)
+movl   $"CApplication::Load() UdpThread begin Fail!",0x4(%esp)
 lea    -0x50(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsC1EPKcRKSaIcE>
 lea    -0x50(%ebp),%esi
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x498>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 call   <T> <__cxa_free_exception>
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x492>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN12CApplication4LoadEiPPc+0x265>
+jne    <T> <_ZN12CApplication4LoadEiPPc+0x4af>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%eax
 mov    %ebx,%edx
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x265>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x4af>
 lea    -0x50(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN12CApplication4LoadEiPPc+0x27d>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x4ca>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN12CApplication4LoadEiPPc+0x265>
+jne    <T> <_ZN12CApplication4LoadEiPPc+0x4af>
 call   <T> <_ZSt9terminatev>
...
+mov    0x5c(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x51d>
 mov    0x8(%ebp),%eax
 mov    0x5c(%eax),%eax
 mov    %eax,(%esp)
 ...
 mov    0x5c(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x797>
+mov    0x8(%ebp),%eax
+mov    0x5c(%eax),%eax
 mov    %eax,(%esp)
...
-cmpw   $0x0,-0x22(%ebp)
-je     <T> <_ZN12CApplication4LoadEiPPc+0x614>
+je     <T> <_ZN12CApplication4LoadEiPPc+0x570>
+cmpw   $0x0,-0x1e(%ebp)
+jne    <T> <_ZN12CApplication4LoadEiPPc+0x5b7>
...
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x797>
 mov    0x8(%ebp),%eax
 lea    0x290(%eax),%edx
 mov    0x8(%ebp),%eax
 add    $0x130,%eax
...
-mov    %eax,0x4(%esp)
-mov    -0x20(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x628>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x40(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x635>
+lea    -0x40(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x650>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x39(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+je     <T> <_ZN12CApplication4LoadEiPPc+0x726>
+movzwl -0x1e(%ebp),%ebx
+mov    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFApplication.cpp](source/DNFServer/GameServer/Guild/DNFApplication.cpp)（约第 143 行）：
