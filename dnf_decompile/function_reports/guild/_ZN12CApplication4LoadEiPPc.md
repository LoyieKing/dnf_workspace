...
|---|---|---|---|---|---|
| guild | DIFF | `0x806230c` | `0x77a` | `0x804dd28` | `0x845` |
...
+je     <T> <_ZN12CApplication4LoadEiPPc+0x51d>
 ...
 mov    0x5c(%eax),%eax
+test   %eax,%eax
+je     <T> <_ZN12CApplication4LoadEiPPc+0x793>
+mov    0x8(%ebp),%eax
+mov    0x5c(%eax),%eax
 mov    %eax,(%esp)
...
+lea    -0x58(%ebp),%eax
 ...
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-lea    -0x63(%ebp),%eax
+jmp    <T> <_ZN12CApplication4LoadEiPPc+0x793>
+mov    0x8(%ebp),%eax
+lea    0x290(%eax),%edx
+mov    0x8(%ebp),%eax
+add    $0x130,%eax
...
+call   <T> <_ZN13CTcpNetSystem14OpenTcpServiceERiPKct>
+test   %al,%al
+je     <T> <_ZN12CApplication4LoadEiPPc+0x724>
+movzwl -0x1e(%ebp),%ebx
+mov    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN12CTcpDBServer7GetSockEv>
