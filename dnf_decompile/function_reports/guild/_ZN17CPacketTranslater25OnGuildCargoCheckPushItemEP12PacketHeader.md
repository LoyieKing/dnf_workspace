...
|---|---|---|---|---|---|
| guild | DIFF | `0x8084444` | `0x518` | `0x8079e7c` | `0x558` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4509 行）：
