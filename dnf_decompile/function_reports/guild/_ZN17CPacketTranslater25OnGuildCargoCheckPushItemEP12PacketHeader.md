...
|---|---|---|---|---|---|
| guild | DIFF | `0x8084444` | `0x518` | `0x807a534` | `0x505` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4578 行）：
