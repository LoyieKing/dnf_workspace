...
|---|---|---|---|---|---|
| guild | DIFF | `0x8084444` | `0x518` | `0x807a5f6` | `0x578` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4707 行）：
