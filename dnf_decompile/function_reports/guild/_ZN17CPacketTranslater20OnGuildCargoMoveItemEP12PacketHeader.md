...
|---|---|---|---|---|---|
| guild | DIFF | `0x80858aa` | `0x5e8` | `0x807b8e8` | `0x619` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4999 行）：
