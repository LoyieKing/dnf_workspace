...
|---|---|---|---|---|---|
| guild | DIFF | `0x80858aa` | `0x5e8` | `0x807b84c` | `0x5ba` |
...
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0xe6>
 movl   $0x1b21,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x7c(%ebp),%eax
+lea    -0x74(%ebp),%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x5af>
 mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
-add    $0x10,%eax
+lea    0x10(%eax),%edx
+mov    -0x3c(%ebp),%eax
...
+cmpl   $0x0,-0x30(%ebp)
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x141>
 movl   $0x1b2b,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x74(%ebp),%eax
+lea    -0x6c(%ebp),%eax
...
+mov    %eax,-0x2c(%ebp)
+cmpl   $0x0,-0x2c(%ebp)
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x1d0>
 movl   $0x1b35,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x6c(%ebp),%eax
+lea    -0x64(%ebp),%eax
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x256>
+mov    0x8(%ebp),%eax
 mov    0xa(%eax),%esi
-mov    -0x34(%ebp),%eax
+mov    0x8(%ebp),%eax
...
-mov    -0x34(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x2d3>
+mov    0x8(%ebp),%eax
 mov    0xa(%eax),%esi
-mov    -0x34(%ebp),%eax
+mov    0x8(%ebp),%eax
...
-mov    -0x34(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x360>
+mov    0x8(%ebp),%eax
 mov    0xa(%eax),%esi
-mov    -0x34(%ebp),%eax
+mov    0x8(%ebp),%eax
...
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x388>
 cmpb   $0x1,-0x21(%ebp)
-je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x405>
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x388>
 cmpb   $0x2,-0x21(%ebp)
...
-jmp    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x5dd>
-lea    -0xd4(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x45c>
+lea    -0xdd(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x34(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x442>
+mov    0x8(%ebp),%eax
 mov    0xe(%eax),%eax
-mov    %eax,%esi
+mov    %eax,%edx
...
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x54f>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x548>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x5aa>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4871 行）：
