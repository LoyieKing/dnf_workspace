...
|---|---|---|---|---|---|
| guild | DIFF | `0x80858aa` | `0x5e8` | `0x807b3f0` | `0x5f7` |
...
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0xf9>
 movl   $0x1b21,0x8(%esp)
 movl   $"OnGuildCargoMoveItem",0x4(%esp)
-lea    -0x7c(%ebp),%eax
+lea    -0x5c(%ebp),%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x5ed>
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+mov    %eax,(%esp)
...
+mov    %eax,-0x20(%ebp)
+cmpl   $0x0,-0x20(%ebp)
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x159>
 movl   $0x1b2b,0x8(%esp)
 movl   $"OnGuildCargoMoveItem",0x4(%esp)
-lea    -0x74(%ebp),%eax
+lea    -0x64(%ebp),%eax
...
+mov    %eax,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x1ec>
 movl   $0x1b35,0x8(%esp)
 movl   $"OnGuildCargoMoveItem",0x4(%esp)
 lea    -0x6c(%ebp),%eax
 mov    %eax,(%esp)
...
-mov    -0x34(%ebp),%eax
-mov    0xe(%eax),%ebx
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x273>
 movl   $0x1b40,0x8(%esp)
 movl   $"OnGuildCargoMoveItem",0x4(%esp)
-lea    -0x64(%ebp),%eax
-mov    %eax,(%esp)
...
-mov    -0x34(%ebp),%eax
-mov    0xe(%eax),%ebx
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x2f3>
 movl   $0x1b4b,0x8(%esp)
 movl   $"OnGuildCargoMoveItem",0x4(%esp)
-lea    -0x5c(%ebp),%eax
-mov    %eax,(%esp)
...
-mov    -0x34(%ebp),%eax
-mov    0xe(%eax),%ebx
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x387>
 movl   $0x1b55,0x8(%esp)
 movl   $"OnGuildCargoMoveItem",0x4(%esp)
-lea    -0x54(%ebp),%eax
-mov    %eax,(%esp)
...
+mov    %al,-0x11(%ebp)
+cmpb   $0x3,-0x11(%ebp)
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x3b1>
+cmpb   $0x1,-0x11(%ebp)
+je     <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x3b1>
+cmpb   $0x2,-0x11(%ebp)
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x491>
+lea    -0xd1(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %al,(%edx)
+cmpl   $0xc1,-0x10(%ebp)
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x47a>
+mov    -0x30(%ebp),%eax
+add    $0xe,%eax
+mov    (%eax),%ebx
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+jne    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x58d>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x586>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater20OnGuildCargoMoveItemEP12PacketHeader+0x5e8>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4627 行）：
