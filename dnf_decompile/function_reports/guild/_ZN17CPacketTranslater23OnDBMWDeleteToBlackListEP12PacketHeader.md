...
|---|---|---|---|---|---|
| guild | NEAR | `0x807e4a8` | `0x269` | `0x807487a` | `0x269` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3017 行）：
