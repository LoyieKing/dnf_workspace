...
|---|---|---|---|---|---|
| guild | DIFF | `0x807e4a8` | `0x269` | `0x8074e0a` | `0x282` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3057 行）：
