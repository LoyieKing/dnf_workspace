...
|---|---|---|---|---|---|
| guild | DIFF | `0x807e4a8` | `0x269` | `0x80748ba` | `0x25e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3702 行）：
