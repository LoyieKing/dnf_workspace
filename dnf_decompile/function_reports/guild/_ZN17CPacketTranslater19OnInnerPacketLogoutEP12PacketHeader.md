...
|---|---|---|---|---|---|
| guild | NEAR | `0x80812f6` | `0x202` | `0x80775be` | `0x202` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3706 行）：
