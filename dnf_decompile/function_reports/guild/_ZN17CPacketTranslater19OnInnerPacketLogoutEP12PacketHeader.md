...
|---|---|---|---|---|---|
| guild | DIFF | `0x80812f6` | `0x202` | `0x80775d0` | `0x203` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3715 行）：
