...
|---|---|---|---|---|---|
| guild | DIFF | `0x80812f6` | `0x202` | `0x807791e` | `0x203` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3562 行）：
