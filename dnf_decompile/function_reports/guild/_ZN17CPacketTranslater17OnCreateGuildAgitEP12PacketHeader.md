...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082206` | `0x327` | `0x807874e` | `0x231` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4012 行）：
