...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082206` | `0x327` | `0x8078170` | `0x223` |
...
-mov    0x8(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x21b>
+mov    -0x24(%ebp),%eax
+mov    0xa(%eax),%eax
 mov    %eax,-0x20(%ebp)
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+call   <T> <_ZN6CGuild13IsGuildMasterEj>
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x1d4>
+mov    -0x1c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CGuild16IsExistGuildAgitEv>
+xor    $0x1,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4565 行）：
