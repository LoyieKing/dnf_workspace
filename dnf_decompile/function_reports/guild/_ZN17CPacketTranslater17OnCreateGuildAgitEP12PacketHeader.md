...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082206` | `0x327` | `0x80783c0` | `0x31f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3938 行）：
