...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082206` | `0x327` | `0x807849a` | `0x301` |
...
-mov    %eax,-0x20(%ebp)
-mov    -0x20(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x2f9>
+mov    -0x28(%ebp),%eax
 mov    0xa(%eax),%eax
-test   %eax,%eax
...
+je     <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x85>
+cmpl   $0x0,-0x20(%ebp)
+jne    <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0xc0>
 movl   $0x1610,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
-lea    -0x54(%ebp),%eax
+lea    -0x58(%ebp),%eax
...
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x1d7>
+mov    -0x20(%ebp),%eax
+mov    %eax,(%esp)
...
+je     <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x195>
 mov    -0x20(%ebp),%eax
-mov    0xa(%eax),%esi
+mov    %eax,(%esp)
...
+setb   %al
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x14f>
+movl   $0x1623,0x8(%esp)
+movl   $&_ZZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
+lea    -0x50(%ebp),%eax
+mov    %eax,(%esp)
...
+jne    <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x29f>
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x298>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN17CPacketTranslater17OnCreateGuildAgitEP12PacketHeader+0x2f4>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4699 行）：
