...
|---|---|---|---|---|---|
| guild | DIFF | `0x80797ec` | `0x5d7` | `0x806ff28` | `0x5ce` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2145 行）：
