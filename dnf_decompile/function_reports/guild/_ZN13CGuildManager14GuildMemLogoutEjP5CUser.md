...
|---|---|---|---|---|---|
| guild | DIFF | `0x8095a22` | `0x349` | `0x805bf92` | `0x33c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 280 行）：
