...
|---|---|---|---|---|---|
| guild | DIFF | `0x807f494` | `0x44d` | `0x8075b9e` | `0x481` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3470 行）：
