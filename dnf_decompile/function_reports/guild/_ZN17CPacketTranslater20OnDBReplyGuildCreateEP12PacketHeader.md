...
|---|---|---|---|---|---|
| guild | DIFF | `0x807f494` | `0x44d` | `0x80756f4` | `0x487` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3287 行）：
