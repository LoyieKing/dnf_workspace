...
|---|---|---|---|---|---|
| guild | DIFF | `0x80814f8` | `0x44a` | `0x80777c0` | `0x419` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3735 行）：
