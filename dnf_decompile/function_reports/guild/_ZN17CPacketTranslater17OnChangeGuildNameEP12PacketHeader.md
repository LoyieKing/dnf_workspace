...
|---|---|---|---|---|---|
| guild | DIFF | `0x80814f8` | `0x44a` | `0x8077c5e` | `0x43c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3926 行）：
