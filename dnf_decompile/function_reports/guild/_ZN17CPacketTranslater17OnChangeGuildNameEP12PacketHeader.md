...
|---|---|---|---|---|---|
| guild | DIFF | `0x80814f8` | `0x44a` | `0x8077876` | `0x413` |
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater17OnChangeGuildNameEP12PacketHeader+0x409>
+lea    -0x76(%ebp),%eax
+mov    %eax,(%esp)
...
-mov    -0x20(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater17OnChangeGuildNameEP12PacketHeader+0x2ce>
+mov    -0x18(%ebp),%eax
+add    $0x12,%eax
+movl   $0x1,0x8(%esp)
+mov    %eax,0x4(%esp)
...
+jne    <T> <_ZN17CPacketTranslater17OnChangeGuildNameEP12PacketHeader+0x3af>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater17OnChangeGuildNameEP12PacketHeader+0x3a8>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater17OnChangeGuildNameEP12PacketHeader+0x404>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3785 行）：
