...
|---|---|---|---|---|---|
| guild | DIFF | `0x80814f8` | `0x44a` | `0x8077926` | `0x43c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3763 行）：
