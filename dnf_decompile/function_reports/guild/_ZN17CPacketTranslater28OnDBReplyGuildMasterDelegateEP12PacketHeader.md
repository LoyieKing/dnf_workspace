...
|---|---|---|---|---|---|
| guild | DIFF | `0x807b608` | `0x63c` | `0x8071e50` | `0x647` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2567 行）：
