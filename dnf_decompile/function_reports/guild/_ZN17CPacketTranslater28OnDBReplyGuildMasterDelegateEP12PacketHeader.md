...
|---|---|---|---|---|---|
| guild | DIFF | `0x807b608` | `0x63c` | `0x80718ba` | `0x61d` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3071 行）：
