...
|---|---|---|---|---|---|
| guild | DIFF | `0x806d5cc` | `0xa9` | `0x8081b84` | `0x8e` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFServerHandler.cpp](source/DNFServer/GameServer/Guild/DNFServerHandler.cpp)（约第 299 行）：
