...
|---|---|---|---|---|---|
| guild | DIFF | `0x809519c` | `0x1a6` | `0x805b786` | `0x18e` |
...
+jne    <T> <_ZN13CGuildManager11DeleteGuildEj+0x183>
 mov    0x8(%ebp),%eax
 lea    0x4(%eax),%ecx
-lea    -0x30(%ebp),%eax
+lea    -0x10(%ebp),%eax
...
+je     <T> <_ZN13CGuildManager11DeleteGuildEj+0xc1>
+movl   $0xcd,0x8(%esp)
...
+jmp    <T> <_ZN13CGuildManager11DeleteGuildEj+0x184>
+movl   $0xc4,0x8(%esp)
+movl   $"DeleteGuild",0x4(%esp)
+lea    -0x18(%ebp),%eax
+mov    %eax,(%esp)
...
+je     <T> <_ZN13CGuildManager11DeleteGuildEj+0x16c>
 mov    %ebx,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 165 行）：
