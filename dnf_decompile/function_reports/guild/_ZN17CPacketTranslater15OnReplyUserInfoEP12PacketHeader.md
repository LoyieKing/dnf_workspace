...
|---|---|---|---|---|---|
| guild | DIFF | `0x8071c7a` | `0x554` | `0x806829a` | `0x55f` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1071 行）：
