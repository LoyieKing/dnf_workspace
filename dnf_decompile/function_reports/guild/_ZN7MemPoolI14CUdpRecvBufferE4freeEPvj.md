...
|---|---|---|---|---|---|
| guild | DIFF | `0x804d52c` | `0x45` | `0x8093d5c` | `0x43` |
...
+je     <T> <_ZN7MemPoolI14CUdpRecvBufferE4freeEPvj+0x41>
+mov    0x8(%ebp),%eax
+mov    (%eax),%edx
+mov    0x10(%ebp),%eax
+cmp    %eax,%edx
+jne    <T> <_ZN7MemPoolI14CUdpRecvBufferE4freeEPvj+0x36>
+mov    0xc(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
-cmp    0x10(%ebp),%eax
...
+jmp    <T> <_ZN7MemPoolI14CUdpRecvBufferE4freeEPvj+0x41>
 mov    0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZdlPv>
