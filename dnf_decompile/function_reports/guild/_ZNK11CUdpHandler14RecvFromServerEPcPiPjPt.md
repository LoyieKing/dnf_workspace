...
|---|---|---|---|---|---|
| guild | DIFF | `0x80507e8` | `0x25d` | `0x808870c` | `0x255` |
...
+jne    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x1b>
 mov    $0x0,%eax
-jmp    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x255>
-movl   $0x10,-0x58(%ebp)
-lea    -0x58(%ebp),%ebx
-lea    -0x54(%ebp),%ecx
+jmp    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x253>
+movl   $0x10,-0x1c(%ebp)
 mov    0x10(%ebp),%eax
 mov    (%eax),%eax
 mov    %eax,%edx
...
+jmp    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x253>
+cmpl   $0x0,-0x18(%ebp)
+jg     <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x186>
+mov    -0x18(%ebp),%eax
 mov    %eax,0x4(%esp)
...
+mov    %ax,-0xe(%ebp)
+cmpw   $0x4c8,-0xe(%ebp)
+je     <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x1e8>
+cmpw   $0x4c9,-0xe(%ebp)
+jne    <T> <_ZNK11CUdpHandler14RecvFromServerEPcPiPjPt+0x243>
+movl   $0x179,0x8(%esp)
+movl   $"RecvFromServer",0x4(%esp)
+lea    -0x4c(%ebp),%eax
+mov    %eax,(%esp)
