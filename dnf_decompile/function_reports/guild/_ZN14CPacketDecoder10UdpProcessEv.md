...
|---|---|---|---|---|---|
| guild | DIFF | `0x807013c` | `0x32e` | `0x8066d2e` | `0x33b` |
...
-mov    0x8(%ebp),%eax
-mov    0x4(%eax),%eax
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x22>
+mov    0x8(%ebp),%eax
+add    $0x4,%eax
+mov    (%eax),%eax
 test   %eax,%eax
...
-lea    -0x2d(%ebp),%eax
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0xee>
+lea    -0x3d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x2d(%ebp),%eax
...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x99>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x93>
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0xb0>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0xb0>
+lea    -0x44(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0xcb>
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0xb0>
+call   <T> <_ZSt9terminatev>
+mov    %edx,%ebx
...
+test   %al,%al
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x332>
+mov    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+sete   %al
+test   %al,%al
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0xf6>
+mov    -0x34(%ebp),%eax
+mov    %eax,(%esp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x194>
+mov    0x8(%ebp),%eax
+add    $0x18,%eax
+mov    (%eax),%eax
 mov    %eax,-0x20(%ebp)
...
+setne  %al
+test   %al,%al
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x2dd>
+mov    0x8(%ebp),%eax
+add    $0x8,%eax
+mov    (%eax),%eax
 mov    %eax,-0x1c(%ebp)
...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x273>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 call   <T> <__cxa_free_exception>
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x26d>
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x28a>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x28a>
+lea    -0x3c(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x29f>
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x28a>
+call   <T> <_ZSt9terminatev>
+mov    %edx,%ebx
...
+mov    %esi,%eax
+mov    %ebx,%edx
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x2c2>
+lea    -0x35(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
 movl   $&_ZN13CDNFExceptionD2Ev,0x8(%esp)
...
-mov    %eax,%esi
-lea    -0x3c(%ebp),%eax
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x322>
+mov    %edx,%ebx
+mov    %eax,%esi
+lea    -0x48(%ebp),%eax
 mov    %eax,(%esp)
...
-add    $0x4c,%esp
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0xf6>
+nop
+add    $0x5c,%esp
 pop    %ebx
 pop    %esi
