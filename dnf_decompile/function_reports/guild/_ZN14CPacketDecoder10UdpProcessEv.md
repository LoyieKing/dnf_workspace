...
|---|---|---|---|---|---|
| guild | DIFF | `0x807013c` | `0x32e` | `0x8066796` | `0x333` |
...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x313>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x312>
 mov    -0x24(%ebp),%eax
 mov    %eax,-0x20(%ebp)
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
...
-mov    0x8(%ebp),%eax
-mov    0x18(%eax),%ebx
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x177>
+mov    0x8(%ebp),%eax
+mov    0x18(%eax),%eax
+mov    %eax,%ebx
 call   <T> <_Z23CAppLoadCheckerInstancev>
...
+je     <T> <_ZN14CPacketDecoder10UdpProcessEv+0x2c8>
 mov    0x8(%ebp),%eax
 mov    0x8(%eax),%eax
 mov    %eax,0x4(%esp)
 lea    -0x38(%ebp),%eax
...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x1d1>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x38(%ebp),%eax
 mov    %eax,(%esp)
...
-cmp    $0xffffffff,%edx
-jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x288>
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x2a5>
+cmp    $0xffffffff,%edx
+jne    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x28a>
 call   <T> <_ZSt9terminatev>
 mov    %edx,%ebx
...
+jmp    <T> <_ZN14CPacketDecoder10UdpProcessEv+0x305>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Guild/DNFPacketDecoder.cpp)（约第 234 行）：
