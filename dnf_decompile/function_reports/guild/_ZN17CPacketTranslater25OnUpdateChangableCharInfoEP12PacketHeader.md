...
|---|---|---|---|---|---|
| guild | DIFF | `0x8075dc0` | `0x24c` | `0x806c430` | `0x242` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1447 行）：
