...
|---|---|---|---|---|---|
| guild | DIFF | `0x8075dc0` | `0x24c` | `0x806c150` | `0x244` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1272 行）：
