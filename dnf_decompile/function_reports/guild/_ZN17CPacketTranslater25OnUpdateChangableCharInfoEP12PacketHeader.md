...
|---|---|---|---|---|---|
| guild | DIFF | `0x8075dc0` | `0x24c` | `0x806c236` | `0x242` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1259 行）：
