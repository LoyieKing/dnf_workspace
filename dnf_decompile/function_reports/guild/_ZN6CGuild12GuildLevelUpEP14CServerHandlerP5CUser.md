...
|---|---|---|---|---|---|
| guild | DIFF | `0x808e73e` | `0x287` | `0x80546e6` | `0x292` |
...
+je     <T> <_ZN6CGuild12GuildLevelUpEP14CServerHandlerP5CUser+0x77>
 mov    0x10(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN5CUser13GetUniqCharNoEv>
 mov    %eax,0x4(%esp)
...
+jmp    <T> <_ZN6CGuild12GuildLevelUpEP14CServerHandlerP5CUser+0x7c>
 mov    $0x0,%eax
 test   %al,%al
-je     <T> <_ZN6CGuild12GuildLevelUpEP14CServerHandlerP5CUser+0x27a>
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 1073 行）：
