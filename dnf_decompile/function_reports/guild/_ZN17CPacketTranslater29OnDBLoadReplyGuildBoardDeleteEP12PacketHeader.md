...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087328` | `0x2ba` | `0x807c63c` | `0x1f3` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5043 行）：
