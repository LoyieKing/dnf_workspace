...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087328` | `0x2ba` | `0x807ccc6` | `0x1f3` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5265 行）：
