...
|---|---|---|---|---|---|
| guild | DIFF | `0x8087328` | `0x2ba` | `0x807d190` | `0x2b3` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 6063 行）：
