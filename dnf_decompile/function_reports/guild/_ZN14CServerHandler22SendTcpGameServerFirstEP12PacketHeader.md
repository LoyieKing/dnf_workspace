...
|---|---|---|---|---|---|
| guild | DIFF | `0x806d76c` | `0xce` | `0x8081cfc` | `0xc1` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFServerHandler.cpp](source/DNFServer/GameServer/Guild/DNFServerHandler.cpp)（约第 328 行）：
