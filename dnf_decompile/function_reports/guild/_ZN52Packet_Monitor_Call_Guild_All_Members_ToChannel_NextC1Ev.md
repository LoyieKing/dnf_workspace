...
+movb   $0x0,(%eax)
+movl   $0x0,-0xc(%ebp)
+jmp    <T> <_ZN52Packet_Monitor_Call_Guild_All_Members_ToChannel_NextC1Ev+0x91>
+mov    0x8(%ebp),%edx
+mov    -0xc(%ebp),%eax
+mov    %eax,%ecx
+shl    $0x6,%ecx
...
+mov    %eax,%edx
+test   %edx,%edx
+je     <T> <_ZN52Packet_Monitor_Call_Guild_All_Members_ToChannel_NextC1Ev+0x8d>
+mov    %eax,(%esp)
...
-add    $0x10,%esp
+jne    <T> <_ZN52Packet_Monitor_Call_Guild_All_Members_ToChannel_NextC1Ev+0x58>
+add    $0x24,%esp
 pop    %ebx
-pop    %esi
 pop    %ebp
