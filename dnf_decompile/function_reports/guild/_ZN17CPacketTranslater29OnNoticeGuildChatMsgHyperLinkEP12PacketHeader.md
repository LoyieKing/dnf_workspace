...
|---|---|---|---|---|---|
| guild | DIFF | `0x807401a` | `0x3ce` | `0x806a42e` | `0x3ca` |
...
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x2b4>
+lea    -0x35(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
-mov    -0x20(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x1da>
+mov    -0x2c(%ebp),%eax
 mov    0xa(%eax),%eax
 test   %eax,%eax
-je     <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x1dc>
...
-mov    -0x20(%ebp),%eax
-mov    0xa(%eax),%eax
+je     <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x1d4>
+mov    -0x2c(%ebp),%eax
+mov    0xe(%eax),%eax
 mov    &_ZN17CPacketTranslater8m_pclAppE,%edx
 add    $0x290,%edx
...
-lea    -0x39(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x3c2>
+lea    -0x2d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x39(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x259>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x253>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x278>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x278>
+lea    -0x34(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNSsD1Ev>
+jmp    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x28d>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x278>
...
+jne    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x358>
 mov    %ecx,(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x351>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+jmp    <T> <_ZN17CPacketTranslater29OnNoticeGuildChatMsgHyperLinkEP12PacketHeader+0x3bd>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1418 行）：
