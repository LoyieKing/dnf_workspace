...
|---|---|---|---|---|---|
| guild | DIFF | `0x808252e` | `0x3d3` | `0x80786e0` | `0x3b9` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 3990 行）：
