...
|---|---|---|---|---|---|
| guild | DIFF | `0x808e42e` | `0x30f` | `0x80543ee` | `0x310` |
...
+mov    $0x0,%eax
+jmp    <T> <_ZN6CGuild13BuyGuildSkillEiisj+0x30a>
+mov    0x8(%ebp),%eax
+add    $0x62,%eax
+movzwl (%eax),%eax
 movzwl %ax,%edx
...
+jmp    <T> <_ZN6CGuild13BuyGuildSkillEiisj+0x16e>
+mov    0x8(%ebp),%ecx
 mov    -0x10(%ebp),%edx
-mov    0x8(%ebp),%ecx
-mov    %edx,%eax
...
+mov    0xc(%ebp),%eax
+cmp    %eax,%edx
+jne    <T> <_ZN6CGuild13BuyGuildSkillEiisj+0x16a>
 mov    -0x10(%ebp),%eax
 mov    %eax,-0x14(%ebp)
...
+jne    <T> <_ZN6CGuild13BuyGuildSkillEiisj+0x146>
 cmpl   $0xffffffff,-0x14(%ebp)
-jne    <T> <_ZN6CGuild13BuyGuildSkillEiisj+0x242>
+jne    <T> <_ZN6CGuild13BuyGuildSkillEiisj+0x244>
 mov    0x8(%ebp),%eax
 add    $0x64,%eax
 mov    %eax,-0xc(%ebp)
 mov    -0xc(%ebp),%eax
...
-movw   $0x0,0x62(%eax)
+cmp    %ax,%dx
+jb     <T> <_ZN6CGuild13BuyGuildSkillEiisj+0x28d>
+mov    0x8(%ebp),%eax
+add    $0x62,%eax
+mov    0x8(%ebp),%edx
+add    $0x62,%edx
...
+mov    %ebx,%edx
+mov    %dx,(%eax)
+jmp    <T> <_ZN6CGuild13BuyGuildSkillEiisj+0x298>
+mov    0x8(%ebp),%eax
+add    $0x62,%eax
+movw   $0x0,(%eax)
 mov    0x8(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuild.cpp](source/DNFServer/GameServer/Guild/DNFGuild.cpp)（约第 970 行）：
