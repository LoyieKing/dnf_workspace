...
|---|---|---|---|---|---|
| guild | DIFF | `0x8079ed6` | `0x384` | `0x8070530` | `0x391` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2093 行）：
