...
|---|---|---|---|---|---|
| guild | DIFF | `0x8062a86` | `0x28c` | `0x804e5ca` | `0x29c` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFApplication.cpp](source/DNFServer/GameServer/Guild/DNFApplication.cpp)（约第 232 行）：
