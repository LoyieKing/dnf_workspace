...
|---|---|---|---|---|---|
| guild | DIFF | `0x807c8a8` | `0x4b0` | `0x8072de8` | `0x4ba` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2641 行）：
