...
|---|---|---|---|---|---|
| guild | DIFF | `0x807c8a8` | `0x4b0` | `0x8072ba4` | `0x4a6` |
...
-lea    -0x69(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0xf8>
+lea    -0x65(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
-lea    -0x69(%ebp),%eax
...
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x9e>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0xbd>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%ecx
 mov    %ebx,%eax
-jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0xb7>
-lea    -0x70(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0xbd>
+lea    -0x6c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0xcf>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0xd5>
 mov    %eax,%ecx
 mov    %edx,%eax
 cmp    $0xffffffff,%eax
-jne    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0xb7>
...
-lea    -0x69(%ebp),%eax
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x3bd>
+lea    -0x65(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcED1Ev>
...
-mov    -0x28(%ebp),%eax
+je     <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x248>
+mov    -0x2c(%ebp),%eax
 mov    0xe(%eax),%ebx
 movl   $0xd90,0x8(%esp)
...
+mov    %eax,-0x24(%ebp)
+cmpl   $0x0,-0x24(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x2b4>
+mov    -0x2c(%ebp),%eax
 mov    0x12(%eax),%ebx
 movl   $0xd94,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x49b>
+mov    -0x2c(%ebp),%eax
 mov    0x17(%eax),%ebx
-mov    -0x2c(%ebp),%eax
+mov    -0x24(%ebp),%eax
...
+je     <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x49b>
 movzbl -0x1d(%ebp),%edi
-mov    -0x28(%ebp),%eax
+mov    -0x2c(%ebp),%eax
 mov    0xe(%eax),%esi
...
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x43d>
 mov    %ecx,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x436>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x496>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%ebx
 mov    %ecx,%esi
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2606 行）：
