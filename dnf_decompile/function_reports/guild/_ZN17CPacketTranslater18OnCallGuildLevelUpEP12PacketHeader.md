...
|---|---|---|---|---|---|
| guild | DIFF | `0x807c8a8` | `0x4b0` | `0x8073272` | `0x4ba` |
...
+mov    %eax,-0x28(%ebp)
+cmpl   $0x0,-0x28(%ebp)
+jne    <T> <_ZN17CPacketTranslater18OnCallGuildLevelUpEP12PacketHeader+0x24d>
 movl   $0xd90,0x8(%esp)
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2488 行）：
