...
|---|---|---|---|---|---|
| guild | DIFF | `0x808495c` | `0x7b5` | `0x807aad2` | `0x698` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5372 行）：
