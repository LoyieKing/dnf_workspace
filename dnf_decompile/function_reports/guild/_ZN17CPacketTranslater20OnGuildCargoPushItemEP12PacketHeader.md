...
|---|---|---|---|---|---|
| guild | DIFF | `0x808495c` | `0x7b5` | `0x807a8be` | `0x6d4` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4775 行）：
