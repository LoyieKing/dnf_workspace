...
|---|---|---|---|---|---|
| guild | DIFF | `0x808ea5a` | `0x120` | `0x8054a54` | `0x129` |
...
+mov    $0x0,%eax
+test   %al,%al
+je     <T> <_ZN6CGuild24NoticeEnterToGuildMemberEPc+0x127>
 lea    -0x6e(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN6CGuild24NoticeEnterToGuildMemberEPc+0xf8>
 lea    -0x14(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN6CGuild24NoticeEnterToGuildMemberEPc+0xed>
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
