...
|---|---|---|---|---|---|
| guild | DIFF | `0x8079026` | `0x389` | `0x806f516` | `0x3af` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1860 行）：
