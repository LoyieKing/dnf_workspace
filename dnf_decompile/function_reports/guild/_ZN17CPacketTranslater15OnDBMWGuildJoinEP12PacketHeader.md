...
|---|---|---|---|---|---|
| guild | DIFF | `0x8079026` | `0x389` | `0x806f414` | `0x381` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1830 行）：
