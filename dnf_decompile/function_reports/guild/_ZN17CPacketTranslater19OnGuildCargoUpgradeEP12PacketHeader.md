...
|---|---|---|---|---|---|
| guild | DIFF | `0x8085e92` | `0x588` | `0x807c108` | `0x4ed` |
...
+test   %eax,%eax
+jne    <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x61>
+movl   $0x1bd1,0x8(%esp)
...
+jmp    <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x500>
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
+add    $0x10,%eax
+mov    %eax,-0x38(%ebp)
+mov    &_ZN17CPacketTranslater8m_pclAppE,%eax
...
+mov    %eax,-0x2c(%ebp)
+cmpl   $0x0,-0x2c(%ebp)
+jne    <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0xd3>
+movl   $0x1bdb,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
 lea    -0x80(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x13f>
 movl   $0x1be2,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
+lea    -0x78(%ebp),%eax
+mov    %eax,(%esp)
...
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x3e1>
+mov    -0x24(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZN6CGuild16IsExistGuildAgitEv>
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x39f>
+mov    -0x24(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    0x12(%eax),%eax
+cmp    -0x20(%ebp),%eax
+jne    <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x33b>
+mov    -0x40(%ebp),%eax
+mov    0x1a(%eax),%eax
+mov    %eax,-0x1c(%ebp)
+mov    -0x24(%ebp),%eax
...
+mov    -0x18(%ebp),%eax
+cmp    -0x1c(%ebp),%eax
+jae    <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x222>
+mov    -0x40(%ebp),%eax
+mov    0x16(%eax),%esi
+mov    -0x40(%ebp),%eax
+mov    0x12(%eax),%ebx
...
+jne    <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x4a6>
 mov    %eax,(%esp)
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x49f>
 mov    %edx,%ebx
 mov    %eax,%esi
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater19OnGuildCargoUpgradeEP12PacketHeader+0x4fb>
 mov    %edx,%ebx
 mov    %eax,%esi
 call   <T> <__cxa_end_catch>
 mov    %esi,%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4988 行）：
