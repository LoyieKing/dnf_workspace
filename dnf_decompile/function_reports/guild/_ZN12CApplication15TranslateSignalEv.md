...
|---|---|---|---|---|---|
| guild | DIFF | `0x8063640` | `0x44d` | `0x804f050` | `0x433` |
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN12CApplication15TranslateSignalEv+0x429>
+lea    -0x20(%ebp),%eax
+mov    -0x10(%ebp),%edx
+mov    %edx,0x4(%esp)
+mov    %eax,(%esp)
...
+sub    $0x4,%esp
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x3fa>
+lea    -0x20(%ebp),%eax
+mov    %eax,(%esp)
...
+ja     <T> <_ZN12CApplication15TranslateSignalEv+0x3ef>
+mov    &data#f3f3eebf(.rodata)(,%eax,4),%eax
 jmp    *%eax
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x3ef>
+lea    -0x169(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %eax,(%edx)
+movl   $0x17,0x8(%esp)
+movl   $&data#77a523b4(.rodata),0x4(%esp)
+lea    -0x169(%ebp),%eax
+add    $0x12,%eax
+mov    %eax,(%esp)
+call   <T> <memcpy>
...
-mov    %eax,-0x157(%ebp)
-movl   $0x17,0x8(%esp)
-movl   $&data#2140350f(.rodata),0x4(%esp)
-lea    -0x165(%ebp),%eax
+jmp    <T> <_ZN12CApplication15TranslateSignalEv+0x3ef>
+lea    -0x169(%ebp),%eax
+mov    %eax,(%esp)
...
+mov    %eax,(%edx)
+movl   $0x16,0x8(%esp)
+movl   $&data#722c870f(.rodata),0x4(%esp)
+lea    -0x169(%ebp),%eax
+add    $0x16,%eax
+mov    %eax,(%esp)
+call   <T> <memcpy>
...
+mov    %eax,(%edx)
+movl   $0x4,0x8(%esp)
+movl   $&data#e3f060d6(.rodata),0x4(%esp)
+lea    -0x169(%ebp),%eax
+add    $0x16,%eax
 mov    %eax,(%esp)
 call   <T> <memcpy>
...
-mov    %eax,-0x153(%ebp)
-movl   $0x16,0x8(%esp)
-movl   $&data#bcdc977a(.rodata),0x4(%esp)
-lea    -0x165(%ebp),%eax
-add    $0x16,%eax
-mov    %eax,(%esp)
-call   <T> <memcpy>
...
-mov    %eax,-0x153(%ebp)
-movl   $0x4,0x8(%esp)
-movl   $&data#fc911c56(.rodata),0x4(%esp)
-lea    -0x165(%ebp),%eax
-add    $0x16,%eax
-mov    %eax,(%esp)
-call   <T> <memcpy>
...
-nop
+jne    <T> <_ZN12CApplication15TranslateSignalEv+0xe8>
 lea    -0x8(%ebp),%esp
 add    $0x0,%esp
 pop    %ebx
 pop    %esi
