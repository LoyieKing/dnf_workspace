...
|---|---|---|---|---|---|
| guild | DIFF | `0x8077bca` | `0x414` | `0x806dfa2` | `0x410` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 1593 行）：
