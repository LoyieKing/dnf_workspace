...
|---|---|---|---|---|---|
| guild | DIFF | `0x8077bca` | `0x414` | `0x806e0e2` | `0x410` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 2285 行）：
