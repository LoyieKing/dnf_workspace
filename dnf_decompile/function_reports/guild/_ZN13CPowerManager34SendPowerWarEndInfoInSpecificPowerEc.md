...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a5148` | `0x389` | `0x809acde` | `0x395` |
...
定义于 [source/DNFServer/GameServer/Guild/PowerManager.cpp](source/DNFServer/GameServer/Guild/PowerManager.cpp)（约第 615 行）：
