...
|---|---|---|---|---|---|
| guild | DIFF | `0x80a5148` | `0x389` | `0x809c616` | `0x391` |
...
定义于 [source/DNFServer/GameServer/Guild/PowerManager.cpp](source/DNFServer/GameServer/Guild/PowerManager.cpp)（约第 593 行）：
