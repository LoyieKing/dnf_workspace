...
|---|---|---|---|---|---|
| guild | DIFF | `0x80955e4` | `0x43d` | `0x805bb7c` | `0x416` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 236 行）：
