...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082902` | `0x2e3` | `0x8078850` | `0x203` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4082 行）：
