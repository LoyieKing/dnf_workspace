...
|---|---|---|---|---|---|
| guild | DIFF | `0x8082902` | `0x2e3` | `0x80787b6` | `0x203` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 4076 行）：
