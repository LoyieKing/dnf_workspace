...
|---|---|---|---|---|---|
| guild | DIFF | `0x80aa89a` | `0x21` | `0x80a0a32` | `0x1a` |
...
定义于 [source/DNFServer/GameServer/Guild/PowerWarGuildInfo.cpp](source/DNFServer/GameServer/Guild/PowerWarGuildInfo.cpp)（约第 368 行）：
