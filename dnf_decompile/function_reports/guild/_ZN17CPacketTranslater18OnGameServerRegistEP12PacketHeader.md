...
|---|---|---|---|---|---|
| guild | DIFF | `0x8088152` | `0x25f` | `0x807d21e` | `0x250` |
...
+mov    %eax,-0x14(%ebp)
+cmpl   $0x0,-0x14(%ebp)
+je     <T> <_ZN17CPacketTranslater18OnGameServerRegistEP12PacketHeader+0x24a>
+movzbl -0x49(%ebp),%eax
 movzbl %al,%ebx
 movl   $0x1ec6,0x8(%esp)
...
+test   %al,%al
+je     <T> <_ZN17CPacketTranslater18OnGameServerRegistEP12PacketHeader+0x1e5>
+mov    -0x1c(%ebp),%eax
+add    $0xc,%eax
+movzbl (%eax),%eax
+movzbl %al,%eax
...
+mov    %eax,(%esp)
+call   <T> <_ZN10CMyFileLogclEPKcS1_z>
+jmp    <T> <_ZN17CPacketTranslater18OnGameServerRegistEP12PacketHeader+0x22f>
+mov    -0x10(%ebp),%eax
+add    $0xb,%eax
+movb   $0x1,(%eax)
+movzbl -0x49(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Guild/DNFPacketTranslater.cpp)（约第 5428 行）：
