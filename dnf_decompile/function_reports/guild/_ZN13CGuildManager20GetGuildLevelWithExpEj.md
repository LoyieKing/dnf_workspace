...
|---|---|---|---|---|---|
| guild | DIFF | `0x8096f56` | `0x52` | `0x805d4ba` | `0x43` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 582 行）：
