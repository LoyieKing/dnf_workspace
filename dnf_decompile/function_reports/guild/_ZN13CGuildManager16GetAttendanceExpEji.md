...
|---|---|---|---|---|---|
| guild | DIFF | `0x80975a0` | `0xc5` | `0x805da84` | `0xab` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFGuildManager.cpp](source/DNFServer/GameServer/Guild/DNFGuildManager.cpp)（约第 700 行）：
