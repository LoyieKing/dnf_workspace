...
|---|---|---|---|---|---|
| guild | DIFF | `0x8064f60` | `0x110` | `0x804d242` | `0x11d` |
...
定义于 [source/DNFServer/GameServer/Guild/DNFAppStartInit.cpp](source/DNFServer/GameServer/Guild/DNFAppStartInit.cpp)（约第 109 行）：
