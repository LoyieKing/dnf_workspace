...
|---|---|---|---|---|---|
| guild | DIFF | `0x8068ab8` | `0x120` | `0x808b1ce` | `0x143` |
...
-mov    0xc(%ebp),%eax
+jne    <T> <_ZN12CUserManager10DeleteUserEj+0x13a>
+mov    0x8(%ebp),%edx
+lea    -0x18(%ebp),%eax
+lea    0xc(%ebp),%ecx
+mov    %ecx,0x8(%esp)
...
-mov    -0x1c(%ebp),%eax
+je     <T> <_ZN12CUserManager10DeleteUserEj+0x13e>
+lea    -0x18(%ebp),%eax
+mov    %eax,(%esp)
...
-pop    %edi
-pop    %ebp
+jmp    <T> <_ZN12CUserManager10DeleteUserEj+0x13e>
+nop
+jmp    <T> <_ZN12CUserManager10DeleteUserEj+0x13e>
+nop
+mov    -0x4(%ebp),%ebx
