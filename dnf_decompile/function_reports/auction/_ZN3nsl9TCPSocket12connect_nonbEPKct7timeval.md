...
|---|---|---|---|---|---|
| auction | DIFF | `0x80ad270` | `0x230` | `0x809f5a4` | `0x23b` |
...
+cmpl   $0x0,-0x28(%ebp)
+jns    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0xcf>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0x73,%eax
-je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0xd3>
+je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0xcf>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0x4,%eax
-je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0xd3>
...
+jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x230>
 cmpl   $0x0,-0x28(%ebp)
-je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x1f5>
-lea    -0xc4(%ebp),%eax
-mov    %eax,-0x1c(%ebp)
+je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x200>
+lea    -0xc8(%ebp),%eax
+mov    %eax,-0x24(%ebp)
 movl   $0x0,-0x20(%ebp)
-jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x100>
+jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0xfc>
 mov    -0x20(%ebp),%edx
-mov    -0x1c(%ebp),%eax
+mov    -0x24(%ebp),%eax
 movl   $0x0,(%eax,%edx,4)
...
+jne    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0xeb>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 shr    $0x5,%eax
 mov    %eax,%edx
-mov    -0xc4(%ebp,%eax,4),%ebx
+mov    -0xc8(%ebp,%eax,4),%ebx
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
 and    $0x1f,%eax
 mov    $0x1,%esi
...
+jns    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x18e>
 call   <T> <__errno_location>
 mov    (%eax),%eax
 cmp    $0x4,%eax
...
+je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x185>
+movl   $0x1,-0x1c(%ebp)
+jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x195>
+movl   $0x0,-0x1c(%ebp)
+jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x195>
+movl   $0x0,-0x1c(%ebp)
+cmpl   $0x0,-0x1c(%ebp)
+je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x1a5>
 mov    $0x0,%eax
-test   %al,%al
-je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x19a>
+jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x230>
+cmpl   $0x0,-0x28(%ebp)
+jg     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x1b2>
 mov    $0x0,%eax
-jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x225>
-cmpl   $0x0,-0x28(%ebp)
...
+je     <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x1f2>
 mov    $0x0,%eax
-jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x225>
-mov    -0x44(%ebp),%eax
+jmp    <T> <_ZN3nsl9TCPSocket12connect_nonbEPKct7timeval+0x230>
