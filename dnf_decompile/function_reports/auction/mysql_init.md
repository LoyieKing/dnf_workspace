...
|---|---|---|---|---|---|
| auction | DIFF | `0x80c1120` | `0x108` | `0x80b9251` | `0xa` |
...

{
  ...
  if (param_1 == (undefined4 *)0x0) {
    ...
    if (param_1 == (undefined4 *)0x0) {
      set_mysql_error(0,0x7d8,*(undefined4 *)PTR_unknown_sqlstate_0828271c);
      return (undefined4 *)0x0;
    }
  ...
  puVar1 = PTR_default_client_charset_info_082825f4;
  param_1[0xbe] = 0;
  param_1[0xa4] = *(undefined4 *)puVar1;
  strcpy((char *)((int)param_1 + 0x25f),*(char **)PTR_not_error_sqlstate_08282680);
  param_1[0xd7] = 0x10;
...
定义于 [source/DNFServer/GameServer/ServerLab/ServerLib/common_source/mysql_stubs.cpp](source/DNFServer/GameServer/ServerLab/ServerLib/common_source/mysql_stubs.cpp)（约第 8 行）：
