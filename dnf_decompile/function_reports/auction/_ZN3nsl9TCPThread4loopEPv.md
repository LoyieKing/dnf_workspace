...
|---|---|---|---|---|---|
| auction | DIFF | `0x80afc5c` | `0x64a` | `0x80ae5f6` | `0x648` |
...
-movl   $0x0,-0x3c(%ebp)
+movl   $0x7530,-0x30(%ebp)
+movl   $0x0,-0x2c(%ebp)
+movl   $0x7530,-0x28(%ebp)
+movl   $0x0,-0x24(%ebp)
 mov    &_ZN3nsl4pAppE,%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN3nsl9TCPThread4loopEPv+0x608>
...
-mov    %eax,0x4(%esp)
-mov    -0x50(%ebp),%eax
+je     <T> <_ZN3nsl9TCPThread4loopEPv+0x2df>
+mov    -0x1c(%ebp),%eax
+mov    %eax,0x4(%esp)
+mov    -0x40(%ebp),%eax
 mov    %eax,(%esp)
...
-movl   $0x0,-0x78(%ebp)
+je     <T> <_ZN3nsl9TCPThread4loopEPv+0x37c>
+movl   $0x0,-0x68(%ebp)
 mov    &_ZN3nsl4pAppE,%eax
 add    $0xb8,%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN3nsl9TCPThread4loopEPv+0x3ef>
 call   <T> <_ZN3nsl8G_ScriptEv>
...
+xor    $0x1,%eax
+test   %al,%al
+je     <T> <_ZN3nsl9TCPThread4loopEPv+0x3c0>
 movl   $&_ZN3nsl10configpathE,0x4(%esp)
 movl   $"Can't open script file : %s\n",(%esp)
 call   <T> <printf>
-jmp    <T> <_ZN3nsl9TCPThread4loopEPv+0x3d8>
+jmp    <T> <_ZN3nsl9TCPThread4loopEPv+0x3d4>
 movl   $&_ZN3nsl10configpathE,0x4(%esp)
...
-movl   $0x0,-0x80(%ebp)
+je     <T> <_ZN3nsl9TCPThread4loopEPv+0x466>
+movl   $0x0,-0x70(%ebp)
 call   <T> <_ZN3nsl16G_ActiveNetCloseEv>
-lea    -0x80(%ebp),%edx
+lea    -0x70(%ebp),%edx
...
+mov    $0x1,%ecx
+test   %edx,%edx
+js     <T> <_ZN3nsl9TCPThread4loopEPv+0x4a2>
+test   %edx,%edx
+jg     <T> <_ZN3nsl9TCPThread4loopEPv+0x49d>
+cmp    $0x7530,%eax
+jbe    <T> <_ZN3nsl9TCPThread4loopEPv+0x4a2>
+mov    $0x0,%ecx
+test   %cl,%cl
+jne    <T> <_ZN3nsl9TCPThread4loopEPv+0x2df>
+mov    -0x38(%ebp),%eax
+mov    -0x34(%ebp),%edx
 mov    %eax,-0x28(%ebp)
 mov    %edx,-0x24(%ebp)
...
+mov    -0x5c(%ebp),%eax
+mov    %eax,-0x64(%ebp)
+jmp    <T> <_ZN3nsl9TCPThread4loopEPv+0x5e9>
+cmpl   $0x0,-0x3c(%ebp)
+je     <T> <_ZN3nsl9TCPThread4loopEPv+0x50c>
+lea    -0x64(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN3nsl9TCPThread4loopEPv+0x511>
 mov    $0x0,%eax
 test   %al,%al
-je     <T> <_ZN3nsl9TCPThread4loopEPv+0x5e0>
-lea    -0x74(%ebp),%eax
+je     <T> <_ZN3nsl9TCPThread4loopEPv+0x5de>
+lea    -0x64(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKjPN3nsl7TCPUserEEEptEv>
 mov    0x4(%eax),%ebx
...
-jmp    <T> <_ZN3nsl9TCPThread4loopEPv+0x2e3>
-mov    -0x50(%ebp),%eax
+jne    <T> <_ZN3nsl9TCPThread4loopEPv+0x4e2>
+jmp    <T> <_ZN3nsl9TCPThread4loopEPv+0x2df>
+mov    -0x40(%ebp),%eax
 mov    %eax,(%esp)
