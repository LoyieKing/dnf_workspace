# _Z6insertRK10CharStringiPKci

`insert(CharString const&, int, char const*, int)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| auction | NEAR | `0x809887e` | `0x164` | `0x80a65d1` | `0x164` |
...
@@ -1,106 +1,106 @@
 ...
 mov    0x8(%ebp),%ebx
 cmpl   $0x0,0x10(%ebp)
 js     <T> <_Z6insertRK10CharStringiPKci+0x22>
 mov    0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNK10CharString6lengthEv>
 cmp    0x10(%ebp),%eax
 jge    <T> <_Z6insertRK10CharStringiPKci+0x46>
 movl   $"CharString insert(const CharString&, int32, const char*, int32)",0xc(%esp)
 movl $L,0x8(%esp)
 ...
 sete   %al
 test   %al,%al
 je     <T> <_Z6insertRK10CharStringiPKci+0x77>
 mov    %ebx,%eax
 mov    0x18(%ebp),%edx
 mov    %edx,0x8(%esp)
 mov    0x14(%ebp),%edx
 mov    %edx,0x4(%esp)
 mov    %eax,(%esp)
 call   <T> <_ZN10CharStringC1EPKci>
 jmp    <T> <_Z6insertRK10CharStringiPKci+0x156>
 cmpl   $0x0,0x18(%ebp)
 jne    <T> <_Z6insertRK10CharStringiPKci+0x93>
 mov    %ebx,%eax
 mov    0xc(%ebp),%edx
 mov    %edx,0x4(%esp)
 mov    %eax,(%esp)
...
CharString *
insert(CharString *__return_storage_ptr__,CharString *str,int32 pos,char *src,int32 srcLength)

{
  ...
  if (-1 < pos) {
    ...
    if (pos <= iVar1) {
      iVar1 = CharString::length(str);
      if (iVar1 == 0) {
        CharString::CharString(__return_storage_ptr__,src,srcLength);
      }
      else if (srcLength == 0) {
        ...
        iVar1 = CharString::length(str);
        this = CharStringData::createTerminated(iVar1 + srcLength);
        ...
        memcpy(pcVar2 + pos,src,srcLength);
        iVar1 = CharString::length(str);
        pcVar2 = CharString::c_str(str);
        pcVar3 = CharStringData::getBuffer(this);
        memcpy(pcVar3 + pos + srcLength,pcVar2 + pos,iVar1 - pos);
