...
|---|---|---|---|---|---|
| auction | NEAR | `0x806934a` | `0x14` | `0x806339e` | `0x14` |
...
@@ -1,7 +1,7 @@
 ...
 mov    %esp,%ebp
 sub    $0x18,%esp
-movl   $&data#406cd706(.rodata),(%esp)
+movl   $&data#47c88526(.rodata),(%esp)
 call   <T> <puts>
 leave
 ret
```
...
/* DWARF original prototype: void exit(Attack * this) */

void __thiscall Attack::_ZN6Attack4exitEv(Attack *this)
