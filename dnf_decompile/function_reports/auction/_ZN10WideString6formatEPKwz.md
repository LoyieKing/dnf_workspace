...
|---|---|---|---|---|---|
| auction | DIFF | `0x809d240` | `0xa3` | `0x80a4c2a` | `0xa3` |
...
-mov    %eax,-0x20(%ebp)
-cmpl   $0x0,-0x20(%ebp)
-jne    <T> <_ZN10WideString6formatEPKwz+0x49>
+mov    %eax,-0x14(%ebp)
+cmpl   $0x0,-0x14(%ebp)
+jne    <T> <_ZN10WideString6formatEPKwz+0x47>
 mov    %ebx,%eax
 mov    %eax,(%esp)
 call   <T> <_ZN10WideStringC1Ev>
-jmp    <T> <_ZN10WideString6formatEPKwz+0x95>
-mov    -0x20(%ebp),%eax
+jmp    <T> <_ZN10WideString6formatEPKwz+0x97>
+mov    -0x14(%ebp),%eax
 mov    %eax,(%esp)
...
WideString *
WideString::_ZN10WideString6formatEPKwz(WideString *__return_storage_ptr__,wchar *formatStr,...)
