...
|---|---|---|---|---|---|
| auction | NEAR | `0x807cb52` | `0x24b` | `0x80804ad` | `0x24b` |
...
*未能在以下候选源文件中定位定义：mnt/d/Docs/my_sources/dnf_workspace/dnf_decompile/source/DNFShared/GameScript/RDARScriptItemInfo.cpp, source/DNFShared/GameScript/RDARScriptItemInfo.cpp, source/DNFShared/GameScript/RDARScriptItemInfo.h, source/DNFServer/GameServer/ServerLab/ServerLib/basic_source/stdafx.h, source/DNFServer/ServerCommon/DNFFunctionLib.h, source/Library/Include/Core/SecureStdio.h, source/Library/Include/Core/Strings.h, source/Library/Include/Core/UnicodeConvert.h 等 223 个文件*
