...
|---|---|---|---|---|---|
| auction | NEAR | `0x806b774` | `0x44` | `0x806902e` | `0x44` |
...
定义于 [source/DNFServer/ServerCommon/DNFFunctionLib.cpp](source/DNFServer/ServerCommon/DNFFunctionLib.cpp)（约第 380 行）：
