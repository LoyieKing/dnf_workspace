...
|---|---|---|---|---|---|
| statics | NEAR | `0x8073e66` | `0x15c` | `0x8074006` | `0x15c` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1540 行）：
