...
|---|---|---|---|---|---|
| statics | NEAR | `0x805c916` | `0x1e7` | `0x8057338` | `0x1e7` |
...
+call   *%eax
 mov    %eax,%ebx
 movl   $0x2f8,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater32OnDeathTowerStatisticPlayDataJobEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
 lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 479 行）：
