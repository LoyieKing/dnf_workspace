...
|---|---|---|---|---|---|
| statics | DIFF | `0x807268a` | `0xf6` | `0x807271c` | `0x102` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1173 行）：
