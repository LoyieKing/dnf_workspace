...
|---|---|---|---|---|---|
| statics | NEAR | `0x805630a` | `0x108` | `0x804d424` | `0x108` |
...

{
  CSignalTranslator *this_00;
                    ...
                    /* try { // try from 08056312 to 0805638e has its CatchHandler @ 08056391 */
  ShowLogo();
...
定义于 [source/DNFServer/GameServer/Statics/DNFApplication.cpp](source/DNFServer/GameServer/Statics/DNFApplication.cpp)（约第 67 行）：
