...
|---|---|---|---|---|---|
| statics | NEAR | `0x8050ad2` | `0x48` | `0x804cee4` | `0x48` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFApplication.cpp](source/DNFServer/GameServer/Statics/DNFApplication.cpp)（约第 29 行）：
