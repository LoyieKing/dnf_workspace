...
|---|---|---|---|---|---|
| statics | DIFF | `0x807499a` | `0x96` | `0x8074942` | `0x8c` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1639 行）：
