# _ZN16StatisticManagerC2Ev

`StatisticManager::StatisticManager()`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| statics | DIFF | `0x806d55c` | `0x558` | `0x806d8cc` | `0x529` |
...
+mov    %esi,%edi
+mov    $0x7,%ebx
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x14a>
+mov    %edi,(%esp)
...
+jne    <T> <_ZN16StatisticManagerC1Ev+0x13c>
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x187>
+mov    %edx,%edi
+mov    %eax,-0x20(%ebp)
+test   %esi,%esi
+je     <T> <_ZN16StatisticManagerC1Ev+0x17d>
+mov    $0x7,%eax
+sub    %ebx,%eax
+shl    $0x4,%eax
+lea    (%esi,%eax,1),%ebx
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x16c>
+mov    -0x20(%ebp),%eax
+mov    %edi,%edx
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x356>
 mov    0x8(%ebp),%eax
 add    $0x3f0,%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x1d7>
 mov    %edi,(%esp)
...
+jne    <T> <_ZN16StatisticManagerC1Ev+0x1c9>
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x21c>
 mov    %edx,%edi
-mov    %eax,-0x2c(%ebp)
+mov    %eax,-0x1c(%ebp)
 test   %esi,%esi
-je     <T> <_ZN16StatisticManagerC1Ev+0x1ef>
+je     <T> <_ZN16StatisticManagerC1Ev+0x212>
 mov    $0x2,%eax
 sub    %ebx,%eax
 mov    %eax,%edx
 mov    %edx,%eax
...
-mov    -0x2c(%ebp),%eax
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x201>
+mov    -0x1c(%ebp),%eax
 mov    %edi,%edx
-jmp    <T> <_ZN16StatisticManagerC1Ev+0x2fe>
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x2cb>
 mov    0x8(%ebp),%eax
 add    $0x48c,%eax
 mov    %eax,%ebx
 mov    $0x62,%esi
-jmp    <T> <_ZN16StatisticManagerC1Ev+0x218>
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x23b>
 mov    %ebx,(%esp)
...
-mov    0x8(%ebp),%eax
-add    $0x807,%eax
+jne    <T> <_ZN16StatisticManagerC1Ev+0x22d>
+mov    0x8(%ebp),%eax
+add    $0x808,%eax
 mov    %eax,%ebx
 mov    $0x64,%esi
-jmp    <T> <_ZN16StatisticManagerC1Ev+0x241>
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x264>
 mov    %ebx,(%esp)
...
+jne    <T> <_ZN16StatisticManagerC1Ev+0x256>
 mov    0x8(%ebp),%eax
 add    $0xb30,%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x521>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    0x8(%ebp),%eax
 add    $0x444,%eax
...
+je     <T> <_ZN16StatisticManagerC1Ev+0x2c7>
 mov    0x8(%ebp),%eax
 add    $0x444,%eax
 lea    0x48(%eax),%ebx
 mov    0x8(%ebp),%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x2ae>
 mov    %edi,%eax
 mov    %esi,%edx
 mov    %edx,%ebx
 mov    %eax,%esi
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x2e5>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x408,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x2ff>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x3f0,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x319>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    0x8(%ebp),%eax
 add    $0x370,%eax
...
+je     <T> <_ZN16StatisticManagerC1Ev+0x350>
 mov    0x8(%ebp),%eax
 add    $0x370,%eax
 lea    0x80(%eax),%ebx
 mov    0x8(%ebp),%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x337>
 mov    %edi,%eax
 mov    %esi,%edx
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x356>
 mov    %edx,%ebx
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x370>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x1b8,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x38a>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x1a0,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x3a4>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x188,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x3be>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x140,%eax
 ...
 mov    %esi,%eax
 mov    %ebx,%edx
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x3d8>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x128,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x3f2>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x110,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x40c>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xf8,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x426>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xe0,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x440>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xc8,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x45a>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0xb0,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x474>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x98,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x48e>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 sub    $0xffffff80,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x4a6>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x68,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x4be>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x50,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x4d6>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x38,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x4ee>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 add    $0x18,%eax
...
+jmp    <T> <_ZN16StatisticManagerC1Ev+0x506>
 mov    %edx,%ebx
 mov    %eax,%esi
 mov    0x8(%ebp),%eax
 mov    %eax,(%esp)
...
void __thiscall StatisticManager::_ZN16StatisticManagerC2Ev(StatisticManager *this)
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 38 行）：
