...
|---|---|---|---|---|---|
| statics | DIFF | `0x806d55c` | `0x558` | `0x806d762` | `0x53a` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 39 行）：
