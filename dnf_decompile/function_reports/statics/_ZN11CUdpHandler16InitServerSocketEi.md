...
|---|---|---|---|---|---|
| statics | DIFF | `0x80600a8` | `0x1c5` | `0x805da8e` | `0x1b4` |
...
+jne    <T> <_ZN11CUdpHandler16InitServerSocketEi+0x50>
 call   <T> <_Z8getErrnov>
-mov    %eax,-0xc(%ebp)
-mov    -0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
 ...
 call   <T> <printf>
 mov    $0xffffffff,%eax
-jmp    <T> <_ZN11CUdpHandler16InitServerSocketEi+0x1be>
-lea    -0x24(%ebp),%eax
+jmp    <T> <_ZN11CUdpHandler16InitServerSocketEi+0x1b2>
 movl   $0x10,0x8(%esp)
 movl   $0x0,0x4(%esp)
+lea    -0x1c(%ebp),%eax
 mov    %eax,(%esp)
...
+cmpl   $0x62,-0xc(%ebp)
+jne    <T> <_ZN11CUdpHandler16InitServerSocketEi+0xda>
 mov    0xc(%ebp),%eax
 mov    %eax,0x4(%esp)
 movl   $"Port %d for receiving UDP is in use\n",(%esp)
 call   <T> <printf>
-jmp    <T> <_ZN11CUdpHandler16InitServerSocketEi+0x122>
+jmp    <T> <_ZN11CUdpHandler16InitServerSocketEi+0x116>
+cmpl   $0x63,-0xc(%ebp)
+jne    <T> <_ZN11CUdpHandler16InitServerSocketEi+0xee>
 movl   $"Cannot assign requested address",(%esp)
 call   <T> <puts>
-jmp    <T> <_ZN11CUdpHandler16InitServerSocketEi+0x122>
+jmp    <T> <_ZN11CUdpHandler16InitServerSocketEi+0x116>
+cmpl   $0x0,-0xc(%ebp)
+je     <T> <_ZN11CUdpHandler16InitServerSocketEi+0x116>
 mov    -0xc(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <strerror>
 mov    %eax,0x8(%esp)
...

{
  ...
  *(int *)this = iVar2;
  if (*(int *)this == -1) {
    ...
    CMyFileLog::CMyFileLog(local_18,"InitServerSocket",0x80);
    CMyFileLog::_ZN10CMyFileLogclEPKcS1_z
              (local_18,"./log/Udp.log","Opened port %d with fd %d, recv buf size %d\n",param_1,
               uVar3,uVar1);
    SetNonBlock(*(int *)this);
    uVar3 = *(undefined4 *)this;
  }
  return uVar3;
}
