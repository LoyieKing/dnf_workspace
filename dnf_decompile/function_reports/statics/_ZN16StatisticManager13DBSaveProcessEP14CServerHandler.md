...
|---|---|---|---|---|---|
| statics | DIFF | `0x8071ffc` | `0x569` | `0x8071e46` | `0x52b` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1011 行）：
