...
|---|---|---|---|---|---|
| statics | DIFF | `0x806fd9c` | `0x3c0` | `0x806ff76` | `0x216` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 507 行）：
