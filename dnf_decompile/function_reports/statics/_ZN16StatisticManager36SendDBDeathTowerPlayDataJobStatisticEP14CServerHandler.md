...
|---|---|---|---|---|---|
| statics | DIFF | `0x806fd9c` | `0x3c0` | `0x806fdf6` | `0x356` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 544 行）：
