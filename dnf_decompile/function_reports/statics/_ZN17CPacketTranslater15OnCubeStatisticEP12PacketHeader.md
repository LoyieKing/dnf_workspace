...
|---|---|---|---|---|---|
| statics | NEAR | `0x805da3e` | `0x1ef` | `0x8058460` | `0x1ef` |
...
+call   *%eax
 mov    %eax,%ebx
 movl   $0x3f9,0x8(%esp)
 movl   $&_ZZN17CPacketTranslater15OnCubeStatisticEP12PacketHeaderE12__FUNCTION__,0x4(%esp)
 lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 650 行）：
