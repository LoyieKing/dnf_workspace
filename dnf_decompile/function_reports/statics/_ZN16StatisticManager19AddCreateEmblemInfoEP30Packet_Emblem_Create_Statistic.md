...
|---|---|---|---|---|---|
| statics | NEAR | `0x8072c3e` | `0x68` | `0x8072d92` | `0x68` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1290 行）：
