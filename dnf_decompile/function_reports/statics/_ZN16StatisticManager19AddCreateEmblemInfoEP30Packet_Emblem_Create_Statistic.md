...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072c3e` | `0x68` | `0x80729bc` | `0x77` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1122 行）：
