...
|---|---|---|---|---|---|
| statics | DIFF | `0x80739a4` | `0x15c` | `0x8073a80` | `0x159` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1455 行）：
