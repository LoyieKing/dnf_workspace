...
|---|---|---|---|---|---|
| statics | DIFF | `0x80584de` | `0x1fe` | `0x804c6f6` | `0x214` |
...
+mov    %ebx,%edx
 ...
 sete   %al
 test   %al,%al
-je     <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1f6>
+je     <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x20c>
 lea    -0x19(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
 lea    -0x19(%ebp),%eax
...
-jmp    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1a1>
+jmp    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1b7>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 ...
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x19b>
+jmp    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1b1>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1b8>
+jne    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1ce>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%eax
 mov    %ebx,%edx
-jmp    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1b8>
+jmp    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1ce>
 lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1d3>
+jmp    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1e9>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1b8>
+jne    <T> <_ZN13CAppStartInit4InitEP12CApplicationiPPc+0x1ce>
 call   <T> <_ZSt9terminatev>
...

{
  ...
  *(CAppConfig **)(param_1 + 0x10) = this_00;
  std::allocator<char>::allocator();
                    /* try { // try from 08058541 to 08058545 has its CatchHandler @ 0805857f */
  std::string::string(local_2c,param_3[1],&local_25);
                    /* try { // try from 08058556 to 0805855a has its CatchHandler @ 0805855d */
  CAppConfig::Check_FileName(*(string **)(param_1 + 0x10));
                    /* try { // try from 08058578 to 0805857c has its CatchHandler @ 0805857f */
  std::string::~string(local_2c);
  std::allocator<char>::~allocator((allocator<char> *)&local_25);
  this_01 = operator_new(0xbf8);
                    /* try { // try from 080585b8 to 080585bc has its CatchHandler @ 080585bf */
  ...
  *(CServerConfig **)(param_1 + 0x14) = this_01;
  ...
  if (iVar1 == -1) {
    std::allocator<char>::allocator();
                    /* try { // try from 08058628 to 0805862c has its CatchHandler @ 08058696 */
    ...
    this_02 = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 08058647 to 0805864b has its CatchHandler @ 0805864e */
    CDNFException::CDNFException(this_02,local_24);
                    /* try { // try from 08058685 to 08058689 has its CatchHandler @ 0805868c */
