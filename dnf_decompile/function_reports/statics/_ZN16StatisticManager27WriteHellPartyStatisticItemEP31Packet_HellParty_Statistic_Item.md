...
+je     <T> <_ZN16StatisticManager27WriteHellPartyStatisticItemEP31Packet_HellParty_Statistic_Item+0x18e>
 lea    -0x34(%ebp),%eax
 lea    -0x90(%ebp),%edx
 mov    %edx,0x8(%esp)
 lea    -0x74(%ebp),%edx
...
+jmp    <T> <_ZN16StatisticManager27WriteHellPartyStatisticItemEP31Packet_HellParty_Statistic_Item+0x1d1>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x5c(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN16StatisticManager27WriteHellPartyStatisticItemEP31Packet_HellParty_Statistic_Item+0x179>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN16StatisticManager27WriteHellPartyStatisticItemEP31Packet_HellParty_Statistic_Item+0x1b9>
 lea    -0x94(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN16StatisticManager27WriteHellPartyStatisticItemEP31Packet_HellParty_Statistic_Item+0x1f4>
 lea    -0x90(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZN18HellPartyItenmDataD1Ev>
 lea    -0x74(%ebp),%eax
