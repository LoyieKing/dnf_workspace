...
|---|---|---|---|---|---|
| statics | DIFF | `0x8071138` | `0x210` | `0x8070eba` | `0x20d` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 774 行）：
