...
|---|---|---|---|---|---|
| statics | DIFF | `0x8071348` | `0x2aa` | `0x8071026` | `0x253` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 813 行）：
