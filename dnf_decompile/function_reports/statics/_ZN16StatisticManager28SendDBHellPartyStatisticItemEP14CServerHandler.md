...
|---|---|---|---|---|---|
| statics | DIFF | `0x8071348` | `0x2aa` | `0x80714a8` | `0x2a4` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 868 行）：
