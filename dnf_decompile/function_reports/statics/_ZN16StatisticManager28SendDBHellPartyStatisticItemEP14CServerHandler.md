...
|---|---|---|---|---|---|
| statics | DIFF | `0x8071348` | `0x2aa` | `0x8070f70` | `0x253` |
...
+lea    -0x17da(%ebp),%eax
 ...
 movl   $0x391,0x8(%esp)
 movl   $"SendDBHellPartyStatisticItem",0x4(%esp)
-lea    -0x1c(%ebp),%eax
+lea    -0x24(%ebp),%eax
 mov    %eax,(%esp)
...
+movl   $"HellParty DB Sent %d",0x8(%esp)
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 679 行）：
