...
+jg     <T> <_ZN14CPacketCounterILi1000ELi10240EE20IncrementPacketCountEi+0x65>
 cmpl   $0x3e7,0xc(%ebp)
-jle    <T> <_ZN14CPacketCounterILi1000ELi10240EE20IncrementPacketCountEi+0x59>
+jle    <T> <_ZN14CPacketCounterILi1000ELi10240EE20IncrementPacketCountEi+0x65>
 mov    0x8(%ebp),%eax
...
+movzbl (%eax),%eax
+cmp    $0x1,%al
+je     <T> <_ZN14CPacketCounterILi1000ELi10240EE20IncrementPacketCountEi+0x3c>
 mov    0x8(%ebp),%eax
...
-mov    0xc(%ebp),%eax
-sub    $0x3e8,%eax
+ja     <T> <_ZN14CPacketCounterILi1000ELi10240EE20IncrementPacketCountEi+0x65>
+mov    0x8(%ebp),%eax
+mov    0xc(%ebp),%edx
+sub    $0x3e6,%edx
+shl    $0x2,%edx
