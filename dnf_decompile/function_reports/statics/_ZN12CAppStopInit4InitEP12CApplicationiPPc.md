...
|---|---|---|---|---|---|
| statics | DIFF | `0x8058b72` | `0x248` | `0x804cc8c` | `0x249` |
...
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x9e>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x83>
 mov    %edx,%ebx
 mov    %eax,%esi
 lea    -0x29(%ebp),%eax
 mov    %eax,(%esp)
...
+je     <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x17d>
 lea    -0x21(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
 lea    -0x21(%ebp),%eax
...
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x128>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
...
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x122>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x13e>
+jne    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x13f>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%eax
 mov    %ebx,%edx
-jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x13e>
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x13f>
 lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x159>
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x15a>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x13e>
+jne    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x13f>
 call   <T> <_ZSt9terminatev>
...
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x1f4>
 mov    %edx,%esi
 mov    %eax,%edi
 mov    %ebx,(%esp)
 call   <T> <__cxa_free_exception>
...
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x1ee>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x20a>
+jne    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x20b>
 call   <T> <_ZSt9terminatev>
 mov    %esi,%eax
 mov    %ebx,%edx
-jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x20a>
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x20b>
 lea    -0x20(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
-jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x225>
+jmp    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x226>
 cmp    $0xffffffff,%edx
-jne    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x20a>
+jne    <T> <_ZN12CAppStopInit4InitEP12CApplicationiPPc+0x20b>
 call   <T> <_ZSt9terminatev>
...

{
  ...
  std::allocator<char>::allocator();
                    /* try { // try from 08058bb6 to 08058bba has its CatchHandler @ 08058bf4 */
  std::string::string(local_34,param_3[1],&local_2d);
                    /* try { // try from 08058bc8 to 08058bcc has its CatchHandler @ 08058bdf */
  cVar1 = CApplication::Send_Term_Signal((string *)param_1);
                    /* try { // try from 08058bd8 to 08058bdc has its CatchHandler @ 08058bf4 */
  std::string::~string(local_34);
  std::allocator<char>::~allocator((allocator<char> *)&local_2d);
  if (cVar1 != '\x01') {
    std::allocator<char>::allocator();
                    /* try { // try from 08058c42 to 08058c46 has its CatchHandler @ 08058cb0 */
    std::string::string(local_2c,&DAT_080e6f84,&local_25);
    pCVar2 = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 08058c61 to 08058c65 has its CatchHandler @ 08058c68 */
    CDNFException::CDNFException(pCVar2,local_2c);
                    /* try { // try from 08058c9f to 08058ca3 has its CatchHandler @ 08058ca6 */
  ...
  std::allocator<char>::allocator();
                    /* try { // try from 08058d0e to 08058d12 has its CatchHandler @ 08058d7c */
  std::string::string(local_24,&DAT_080e6fb4,local_1d);
  pCVar2 = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 08058d2d to 08058d31 has its CatchHandler @ 08058d34 */
  CDNFException::CDNFException(pCVar2,local_24);
                    /* try { // try from 08058d6b to 08058d6f has its CatchHandler @ 08058d72 */
