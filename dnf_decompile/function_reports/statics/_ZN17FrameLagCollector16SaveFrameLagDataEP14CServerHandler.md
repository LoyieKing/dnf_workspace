...
|---|---|---|---|---|---|
| statics | DIFF | `0x80675dc` | `0x63e` | `0x8060868` | `0x5af` |
...
定义于 [source/DNFServer/GameServer/Statics/FrameLagCollector.cpp](source/DNFServer/GameServer/Statics/FrameLagCollector.cpp)（约第 365 行）：
