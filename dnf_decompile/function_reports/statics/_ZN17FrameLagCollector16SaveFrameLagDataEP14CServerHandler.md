...
|---|---|---|---|---|---|
| statics | DIFF | `0x80675dc` | `0x63e` | `0x806087a` | `0x5af` |
...
定义于 [source/DNFServer/GameServer/Statics/FrameLagCollector.cpp](source/DNFServer/GameServer/Statics/FrameLagCollector.cpp)（约第 377 行）：
