...
|---|---|---|---|---|---|
| statics | DIFF | `0x80728a2` | `0x134` | `0x80729f4` | `0x131` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1213 行）：
