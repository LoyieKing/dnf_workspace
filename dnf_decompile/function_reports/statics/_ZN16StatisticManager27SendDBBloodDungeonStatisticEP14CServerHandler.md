...
|---|---|---|---|---|---|
| statics | DIFF | `0x80728a2` | `0x134` | `0x807282c` | `0x139` |
...
+je     <T> <_ZN16StatisticManager27SendDBBloodDungeonStatisticEP14CServerHandler+0x12f>
 lea    -0x101f(%ebp),%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN16StatisticManager27SendDBBloodDungeonStatisticEP14CServerHandler+0xfa>
 movl   $0x1001,0x8(%esp)
 movl   $0x0,0x4(%esp)
 lea    -0x101f(%ebp),%eax
 add    $0xe,%eax
...
-nop
+jne    <T> <_ZN16StatisticManager27SendDBBloodDungeonStatisticEP14CServerHandler+0x63>
 lea    -0x8(%ebp),%esp
 add    $0x0,%esp
 pop    %ebx
 pop    %esi
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1200 行）：
