...
|---|---|---|---|---|---|
| statics | DIFF | `0x8067164` | `0x41a` | `0x80603a8` | `0x473` |
...
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x468>
 mov    0x8(%ebp),%eax
 movzbl 0x19(%eax),%edx
 mov    0xc(%ebp),%eax
-movzbl 0xa(%eax),%eax
...
+movl   $0x0,-0x20(%ebp)
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x408>
+mov    0xc(%ebp),%eax
+mov    -0x20(%ebp),%edx
+add    $0x4,%edx
+shl    $0x2,%edx
...
+mov    -0x34(%ebp),%eax
+cmp    $0xffffffff,%eax
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x419>
+mov    0xc(%ebp),%eax
+mov    -0x20(%ebp),%edx
+add    $0x8,%edx
+shl    $0x2,%edx
...
-mov    -0x1c(%ebp),%edx
-mov    0xc(%ebp),%eax
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x27d>
+mov    0xc(%ebp),%eax
+mov    -0x20(%ebp),%edx
 add    $0x10,%edx
-mov    0x3(%eax,%edx,4),%eax
...
+mov    -0x3c(%ebp),%edx
+mov    %edx,0x1c(%eax)
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3bd>
+lea    -0x38(%ebp),%eax
+mov    %eax,(%esp)
...
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x41a>
 nop
 mov    0x8(%ebp),%eax
 add    $0x34,%eax
 mov    %eax,(%esp)
...
-mov    0x8(%ebp),%eax
-mov    0x4c(%eax),%eax
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x463>
+mov    0x8(%ebp),%eax
+mov    0x4c(%eax),%edx
+mov    0x8(%ebp),%eax
+mov    0x50(%eax),%eax
...
+jge    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x457>
 mov    0x8(%ebp),%eax
 mov    0x50(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0x4c(%eax)
...
定义于 [source/DNFServer/GameServer/Statics/FrameLagCollector.cpp](source/DNFServer/GameServer/Statics/FrameLagCollector.cpp)（约第 290 行）：
