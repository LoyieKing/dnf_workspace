...
|---|---|---|---|---|---|
| statics | DIFF | `0x8067164` | `0x41a` | `0x8060354` | `0x3fe` |
...
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3f3>
 mov    0x8(%ebp),%eax
 movzbl 0x19(%eax),%edx
 mov    0xc(%ebp),%eax
 movzbl 0xa(%eax),%eax
...
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3d>
+mov    $0x0,%eax
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3f3>
+mov    0xc(%ebp),%eax
+mov    0xb(%eax),%eax
...
-mov    %edx,0x4(%esp)
-mov    %eax,(%esp)
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x9d>
+mov    $0x0,%eax
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3f3>
+mov    0x8(%ebp),%eax
+lea    0x34(%eax),%edx
...
-mov    0xc(%ebp),%eax
+movl   $0x0,-0x20(%ebp)
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x395>
+mov    0xc(%ebp),%eax
+mov    -0x20(%ebp),%edx
 add    $0x4,%edx
...
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3a6>
+mov    0xc(%ebp),%eax
+mov    -0x20(%ebp),%edx
+add    $0x8,%edx
...
+mov    0x50(%eax),%eax
+cmp    -0x1c(%ebp),%eax
+jge    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x101>
+mov    0x8(%ebp),%eax
 mov    -0x1c(%ebp),%edx
-mov    0xc(%ebp),%eax
-add    $0x8,%edx
...
-mov    -0x1c(%ebp),%edx
-mov    0xc(%ebp),%eax
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x23c>
+mov    0xc(%ebp),%eax
+mov    -0x20(%ebp),%edx
 add    $0x10,%edx
 mov    0x3(%eax,%edx,4),%eax
...
-mov    -0x1c(%ebp),%ecx
-mov    0xc(%ebp),%edx
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x34b>
+lea    -0x38(%ebp),%eax
+mov    %eax,(%esp)
+call   <T> <_ZNKSt17_Rb_tree_iteratorISt4pairIKiN17FrameLagCollector18MonitoringSpecCaseEEEptEv>
+mov    0xc(%ebp),%edx
...
+jne    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0xc1>
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3a7>
 nop
 mov    0x8(%ebp),%eax
 add    $0x34,%eax
 mov    %eax,(%esp)
...
-mov    0x8(%ebp),%eax
-mov    0x4c(%eax),%eax
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3ee>
+mov    0x8(%ebp),%eax
+mov    0x4c(%eax),%edx
+mov    0x8(%ebp),%eax
+mov    0x50(%eax),%eax
...
+jge    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP45Packet_Frame_Lag_Statistic_Result_Reload_Spec+0x3e2>
 mov    0x8(%ebp),%eax
 mov    0x50(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0x4c(%eax)
...
定义于 [source/DNFServer/GameServer/Statics/FrameLagCollector.cpp](source/DNFServer/GameServer/Statics/FrameLagCollector.cpp)（约第 369 行）：
