...
|---|---|---|---|---|---|
| statics | DIFF | `0x8071b84` | `0xb3` | `0x80718a0` | `0xcf` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 791 行）：
