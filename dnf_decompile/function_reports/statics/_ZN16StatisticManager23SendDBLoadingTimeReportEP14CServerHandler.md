...
|---|---|---|---|---|---|
| statics | NEAR | `0x8071b84` | `0xb3` | `0x8071c50` | `0xb3` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 923 行）：
