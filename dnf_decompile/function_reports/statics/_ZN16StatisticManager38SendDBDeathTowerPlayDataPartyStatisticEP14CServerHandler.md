...
|---|---|---|---|---|---|
| statics | DIFF | `0x807015c` | `0x269` | `0x80701b0` | `0x1e8` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 543 行）：
