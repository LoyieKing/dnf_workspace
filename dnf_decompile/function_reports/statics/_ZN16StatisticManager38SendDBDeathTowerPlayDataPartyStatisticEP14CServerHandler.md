...
|---|---|---|---|---|---|
| statics | DIFF | `0x807015c` | `0x269` | `0x80702d8` | `0x263` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 603 行）：
