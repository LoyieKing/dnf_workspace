...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072cee` | `0x85` | `0x8072b94` | `0xa7` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1289 行）：
