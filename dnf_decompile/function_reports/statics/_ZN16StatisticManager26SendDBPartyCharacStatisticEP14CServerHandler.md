...
|---|---|---|---|---|---|
| statics | DIFF | `0x806f742` | `0x44c` | `0x806f7d2` | `0x43e` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 430 行）：
