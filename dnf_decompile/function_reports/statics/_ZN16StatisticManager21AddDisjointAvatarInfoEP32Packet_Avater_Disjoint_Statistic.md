...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072ad2` | `0xe1` | `0x8072b96` | `0xda` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1240 行）：
