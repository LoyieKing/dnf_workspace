...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072ad2` | `0xe1` | `0x80728de` | `0xda` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1245 行）：
