...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072566` | `0x10c` | `0x80724fc` | `0x117` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1147 行）：
