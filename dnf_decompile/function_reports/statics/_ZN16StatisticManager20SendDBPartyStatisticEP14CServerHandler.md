...
|---|---|---|---|---|---|
| statics | DIFF | `0x806eee4` | `0x4ba` | `0x806ef58` | `0x4b3` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 383 行）：
