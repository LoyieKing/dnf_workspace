...
|---|---|---|---|---|---|
| statics | DIFF | `0x8059d02` | `0x7e` | `0x805479e` | `0x87` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp)（约第 154 行）：
