# _ZN14CPacketCounterILi1000ELi10240EEC1EPcS1_

`CPacketCounter<1000, 10240>::CPacketCounter(char*, char*)`

| 服务 | 状态 | ORIG 地址 | ORIG 大小 | 重建地址 | 重建大小 |
|---|---|---|---|---|---|
| statics | DIFF | `0x8059d02` | `0x7e` | `0x80547fc` | `0x87` |
...
+jne    <T> <_ZN14CPacketCounterILi1000ELi10240EEC1EPcS1_+0x53>
+mov    0x8(%ebp),%eax
+lea    0x1d540(%eax),%edx
+mov    0x10(%ebp),%eax
+mov    %eax,0x8(%esp)
...
+mov    %edx,(%esp)
+call   <T> <sprintf>
+jmp    <T> <_ZN14CPacketCounterILi1000ELi10240EEC1EPcS1_+0x7a>
 mov    0x8(%ebp),%eax
 lea    0x1d540(%eax),%edx
 mov    0x10(%ebp),%eax
 mov    %eax,0xc(%esp)
...
void __thiscall
CPacketCounter<1000,10240>::_ZN14CPacketCounterILi1000ELi10240EEC1EPcS1_
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp)（约第 155 行）：
