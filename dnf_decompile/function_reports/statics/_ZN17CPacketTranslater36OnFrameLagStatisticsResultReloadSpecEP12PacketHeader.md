...
|---|---|---|---|---|---|
| statics | NEAR | `0x805b236` | `0x1e7` | `0x8055cde` | `0x1e7` |
...
+call   *%eax
 mov    %eax,%ebx
 movl   $0x18c,0x8(%esp)
 movl   $"OnFrameLagStatisticsResultReloadSpec",0x4(%esp)
 lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 221 行）：
