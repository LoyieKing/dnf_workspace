...
|---|---|---|---|---|---|
| statics | DIFF | `0x8074802` | `0x157` | `0x8074b56` | `0x19e` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1670 行）：
