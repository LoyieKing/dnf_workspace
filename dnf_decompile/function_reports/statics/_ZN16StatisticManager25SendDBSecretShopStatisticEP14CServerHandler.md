...
|---|---|---|---|---|---|
| statics | DIFF | `0x8074802` | `0x157` | `0x8074844` | `0x1b0` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1589 行）：
