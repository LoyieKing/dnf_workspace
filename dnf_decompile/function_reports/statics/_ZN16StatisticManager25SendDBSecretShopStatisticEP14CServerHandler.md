...
|---|---|---|---|---|---|
| statics | DIFF | `0x8074802` | `0x157` | `0x8074a26` | `0x1aa` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1644 行）：
