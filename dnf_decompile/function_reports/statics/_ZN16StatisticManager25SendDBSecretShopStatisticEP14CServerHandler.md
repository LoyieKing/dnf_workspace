...
|---|---|---|---|---|---|
| statics | DIFF | `0x8074802` | `0x157` | `0x80749d6` | `0x1aa` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1635 行）：
