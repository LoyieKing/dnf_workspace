...
|---|---|---|---|---|---|
| statics | DIFF | `0x806e5f0` | `0x2be` | `0x806e772` | `0x2bd` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 280 行）：
