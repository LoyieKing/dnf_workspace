...
|---|---|---|---|---|---|
| statics | DIFF | `0x806e5f0` | `0x2be` | `0x806e804` | `0x2cf` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 181 行）：
