...
|---|---|---|---|---|---|
| statics | DIFF | `0x80756a6` | `0x9e` | `0x8065422` | `0x94` |
...
定义于 [source/DNFServer/GameServer/Statics/GMAccounts.cpp](source/DNFServer/GameServer/Statics/GMAccounts.cpp)（约第 102 行）：
