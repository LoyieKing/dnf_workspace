...
|---|---|---|---|---|---|
| statics | DIFF | `0x8058f6a` | `0x34a` | `0x805d538` | `0x37a` |
...
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x14c>
 mov    0x8(%ebp),%eax
 movb   $0x1,(%eax)
 mov    0x8(%ebp),%eax
 movl   $0x0,0x14(%eax)
...
-sete   %al
-test   %al,%al
-je     <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x33f>
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x36f>
 lea    -0x35(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
 lea    -0x35(%ebp),%eax
...
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0xef>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x10e>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x10e>
 lea    -0x3c(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-cmp    $0xffffffff,%eax
-jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x10f>
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x129>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x10e>
...
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x24e>
 lea    -0x2d(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSaIcEC1Ev>
 lea    -0x2d(%ebp),%eax
...
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x1f1>
 mov    %eax,%ecx
 mov    %edx,%eax
 mov    %eax,%esi
 mov    %ecx,%edi
...
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x1eb>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x210>
+call   <T> <_ZSt9terminatev>
+mov    %esi,%ecx
+mov    %ebx,%eax
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x210>
 lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <_ZNSsD1Ev>
...
-cmp    $0xffffffff,%eax
-jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x212>
+jmp    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x22b>
+mov    %eax,%ecx
+mov    %edx,%eax
+cmp    $0xffffffff,%eax
+jne    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x210>
...
+jae    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x26a>
 mov    0x8(%ebp),%eax
 mov    0x10(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0xc(%eax)
...
+divl   -0x5c(%ebp)
+cmp    %eax,%ecx
+jae    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x36f>
+mov    0x8(%ebp),%eax
+mov    0x14(%eax),%eax
+lea    0x1(%eax),%edx
+mov    0x8(%ebp),%eax
...
-mov    0x14(%eax),%eax
-cmp    -0x20(%ebp),%eax
-jae    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x33f>
-mov    0x8(%ebp),%eax
-mov    0x14(%eax),%eax
-lea    0x1(%eax),%edx
-mov    0x8(%ebp),%eax
...
-mov    %eax,-0x28(%ebp)
-cmpl   $0x63,-0x28(%ebp)
-jbe    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x33f>
+cmp    $0x63,%eax
+jbe    <T> <_ZN18CFrameCountHandler17GetFrameCountInfoEv+0x36f>
 mov    0x8(%ebp),%eax
 mov    0x14(%eax),%edx
 mov    0x8(%ebp),%eax
 mov    %edx,0x18(%eax)
...

{
  ...
  if (*this == (CFrameCountHandler)0x0) {
    ...
    *(clock_t *)(this + 0xc) = cVar1;
    if (*(int *)(this + 0xc) == -1) {
      std::allocator<char>::allocator();
                    /* try { // try from 08058ffb to 08058fff has its CatchHandler @ 08059075 */
      ...
      pCVar2 = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 0805901a to 0805901e has its CatchHandler @ 08059021 */
      CDNFException::CDNFException(pCVar2,local_40);
                    /* try { // try from 08059060 to 08059064 has its CatchHandler @ 08059067 */
      std::string::~string(local_40);
    ...
    *(clock_t *)(this + 0x10) = cVar1;
    if (*(int *)(this + 0x10) == -1) {
      std::allocator<char>::allocator();
                    /* try { // try from 080590fe to 08059102 has its CatchHandler @ 08059178 */
      std::string::string(local_38,
                          "CFrameCountHandler::GetFrameCountInfo() times() Exception Break!",
                          &local_31);
      pCVar2 = (CDNFException *)__cxa_allocate_exception(8);
                    /* try { // try from 0805911d to 08059121 has its CatchHandler @ 08059124 */
      CDNFException::CDNFException(pCVar2,local_38);
                    /* try { // try from 08059163 to 08059167 has its CatchHandler @ 0805916a */
      std::string::~string(local_38);
