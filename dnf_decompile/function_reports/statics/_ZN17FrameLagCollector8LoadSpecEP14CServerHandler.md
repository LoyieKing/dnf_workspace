...
|---|---|---|---|---|---|
| statics | DIFF | `0x806677e` | `0xca` | `0x805fab4` | `0xcd` |
...
定义于 [source/DNFServer/GameServer/Statics/FrameLagCollector.cpp](source/DNFServer/GameServer/Statics/FrameLagCollector.cpp)（约第 80 行）：
