...
|---|---|---|---|---|---|
| statics | DIFF | `0x8074aac` | `0x9d` | `0x8074d22` | `0xc9` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1695 行）：
