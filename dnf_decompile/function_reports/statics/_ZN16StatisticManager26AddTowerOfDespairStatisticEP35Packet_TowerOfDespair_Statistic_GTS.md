...
|---|---|---|---|---|---|
| statics | DIFF | `0x8074aac` | `0x9d` | `0x8074d26` | `0xc9` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1679 行）：
