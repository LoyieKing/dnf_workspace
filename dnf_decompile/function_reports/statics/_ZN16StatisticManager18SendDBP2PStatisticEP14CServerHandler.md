...
|---|---|---|---|---|---|
| statics | DIFF | `0x80751c8` | `0x190` | `0x80751ca` | `0x243` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1623 行）：
