...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072d74` | `0x6e` | `0x8072e14` | `0x85` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1315 行）：
