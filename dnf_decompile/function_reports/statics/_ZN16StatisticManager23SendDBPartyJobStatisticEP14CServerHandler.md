...
|---|---|---|---|---|---|
| statics | DIFF | `0x806f39e` | `0x3a3` | `0x806f61e` | `0x288` |
...
+je     <T> <_ZN16StatisticManager23SendDBPartyJobStatisticEP14CServerHandler+0x283>
 mov    0x8(%ebp),%eax
 lea    0x50(%eax),%edx
-lea    -0x24(%ebp),%eax
+lea    -0x28(%ebp),%eax
...
+jmp    <T> <_ZN16StatisticManager23SendDBPartyJobStatisticEP14CServerHandler+0x1eb>
+lea    -0x17f1(%ebp),%ecx
+mov    -0x10(%ebp),%edx
+mov    %edx,%eax
+shl    $0x2,%eax
...
+addl   $0x1,-0x10(%ebp)
+cmpl   $0x63,-0x10(%ebp)
+jle    <T> <_ZN16StatisticManager23SendDBPartyJobStatisticEP14CServerHandler+0x1e0>
+lea    -0x17f1(%ebp),%eax
+add    $0xa,%eax
+movl   $0x64,(%eax)
+lea    -0x17f1(%ebp),%eax
