...
|---|---|---|---|---|---|
| statics | DIFF | `0x807350a` | `0x499` | `0x8073478` | `0x49e` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1514 行）：
