...
|---|---|---|---|---|---|
| statics | DIFF | `0x807350a` | `0x499` | `0x80735e8` | `0x40f` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1396 行）：
