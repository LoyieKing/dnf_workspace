...
|---|---|---|---|---|---|
| statics | DIFF | `0x8074fcc` | `0x1fc` | `0x8074f96` | `0x288` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1811 行）：
