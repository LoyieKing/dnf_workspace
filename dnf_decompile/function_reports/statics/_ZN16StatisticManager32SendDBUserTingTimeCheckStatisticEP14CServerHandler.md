...
|---|---|---|---|---|---|
| statics | DIFF | `0x8070f7a` | `0x1a5` | `0x8070dd0` | `0x1ba` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 750 行）：
