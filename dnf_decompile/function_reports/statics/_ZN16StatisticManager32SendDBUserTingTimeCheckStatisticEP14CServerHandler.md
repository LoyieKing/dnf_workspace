...
|---|---|---|---|---|---|
| statics | DIFF | `0x8070f7a` | `0x1a5` | `0x80710de` | `0x19f` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 806 行）：
