...
|---|---|---|---|---|---|
| statics | DIFF | `0x8060f3c` | `0x2e` | `0x805e856` | `0x23` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFUdpRecvBuffer.cpp](source/DNFServer/GameServer/Statics/DNFUdpRecvBuffer.cpp)（约第 61 行）：
