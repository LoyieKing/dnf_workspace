...
|---|---|---|---|---|---|
| statics | NEAR | `0x805f6cc` | `0x1f8` | `0x805a174` | `0x1f8` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 976 行）：
