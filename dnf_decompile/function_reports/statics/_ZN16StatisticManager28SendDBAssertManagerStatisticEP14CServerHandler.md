...
|---|---|---|---|---|---|
| statics | DIFF | `0x8070874` | `0x239` | `0x80709e6` | `0x231` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 704 行）：
