...
|---|---|---|---|---|---|
| statics | DIFF | `0x80715f2` | `0x592` | `0x80713d4` | `0x6db` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 842 行）：
