...
|---|---|---|---|---|---|
| statics | DIFF | `0x80715f2` | `0x592` | `0x80716e6` | `0x5b2` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 861 行）：
