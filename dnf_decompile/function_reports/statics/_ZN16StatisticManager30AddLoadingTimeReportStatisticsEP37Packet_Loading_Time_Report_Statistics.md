...
|---|---|---|---|---|---|
| statics | DIFF | `0x80715f2` | `0x592` | `0x8071436` | `0x6d7` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 850 行）：
