...
|---|---|---|---|---|---|
| statics | DIFF | `0x806e0a0` | `0x1c3` | `0x806e2b4` | `0x1c3` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 95 行）：
