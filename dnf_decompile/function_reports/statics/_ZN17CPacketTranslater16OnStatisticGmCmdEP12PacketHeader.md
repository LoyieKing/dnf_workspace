...
|---|---|---|---|---|---|
| statics | NEAR | `0x805f4fc` | `0x1cf` | `0x8059fa4` | `0x1cf` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 955 行）：
