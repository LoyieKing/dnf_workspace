...
|---|---|---|---|---|---|
| statics | DIFF | `0x805f8c4` | `0x8` | `0x805a36c` | `0x5` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 997 行）：
