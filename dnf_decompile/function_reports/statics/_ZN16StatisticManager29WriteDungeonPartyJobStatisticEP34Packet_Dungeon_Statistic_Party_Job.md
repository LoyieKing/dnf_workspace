...
|---|---|---|---|---|---|
| statics | DIFF | `0x806e8ae` | `0x1df` | `0x806ead4` | `0x211` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 228 行）：
