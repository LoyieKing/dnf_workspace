...
|---|---|---|---|---|---|
| statics | NEAR | `0x805cafe` | `0x1e7` | `0x80575a6` | `0x1e7` |
...
+call   *%eax
 mov    %eax,%ebx
 movl   $0x318,0x8(%esp)
 movl   $"OnDeathTowerStatisticPlayDataParty",0x4(%esp)
 lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 494 行）：
