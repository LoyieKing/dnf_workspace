...
|---|---|---|---|---|---|
| statics | DIFF | `0x8070dbc` | `0x1a5` | `0x8070d62` | `0x1ba` |
...
+je     <T> <_ZN16StatisticManager23SendDBTingUserTimeCheckEP14CServerHandler+0x1b5>
 mov    0x8(%ebp),%eax
 lea    0x110(%eax),%edx
 lea    -0x24(%ebp),%eax
 mov    %edx,0x4(%esp)
...
-mov    -0xc(%ebp),%ebx
+jmp    <T> <_ZN16StatisticManager23SendDBTingUserTimeCheckEP14CServerHandler+0x11a>
+lea    -0x1822(%ebp),%eax
+mov    -0xc(%ebp),%edx
+shl    $0x3,%edx
+add    $0xe,%edx
...
+cmpl   $0x63,-0xc(%ebp)
+jle    <T> <_ZN16StatisticManager23SendDBTingUserTimeCheckEP14CServerHandler+0x10f>
+lea    -0x1822(%ebp),%eax
+add    $0xa,%eax
+movl   $0x64,(%eax)
 lea    -0x1822(%ebp),%eax
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 717 行）：
