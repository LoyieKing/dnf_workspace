...
|---|---|---|---|---|---|
| statics | DIFF | `0x8070dbc` | `0x1a5` | `0x8070a74` | `0x1ba` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 718 行）：
