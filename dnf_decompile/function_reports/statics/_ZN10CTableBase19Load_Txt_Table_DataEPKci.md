...
|---|---|---|---|---|---|
| statics | DIFF | `0x8055ce0` | `0xda` | `0x805d226` | `0xd1` |
...
+jne    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x37>
 mov    $0xffffffff,%eax
-jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xd8>
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xcf>
+nop
 movzbl -0x410(%ebp),%eax
 cmp    $0x23,%al
-je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x85>
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x7c>
 mov    -0x10(%ebp),%eax
 cmp    0x10(%ebp),%eax
-jl     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x58>
+jl     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0x51>
 mov    $0xfffffffe,%eax
-jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xd8>
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xcf>
 mov    0x8(%ebp),%eax
...
+jne    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xb3>
 mov    -0xc(%ebp),%eax
 mov    %eax,0x8(%esp)
 movl   $0x400,0x4(%esp)
 lea    -0x410(%ebp),%eax
...
+je     <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xb3>
 mov    $0x1,%eax
-jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xc2>
+jmp    <T> <_ZN10CTableBase19Load_Txt_Table_DataEPKci+0xb8>
 mov    $0x0,%eax
 test   %al,%al
