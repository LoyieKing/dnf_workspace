...
|---|---|---|---|---|---|
| statics | NEAR | `0x805a43e` | `0x25d` | `0x8054e5e` | `0x25d` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 124 行）：
