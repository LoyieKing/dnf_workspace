...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072e44` | `0x6c5` | `0x8072fbe` | `0x6a1` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1383 行）：
