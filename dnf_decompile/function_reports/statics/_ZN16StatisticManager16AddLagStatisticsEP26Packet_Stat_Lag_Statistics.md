...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072e44` | `0x6c5` | `0x8072f9a` | `0x6a1` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1375 行）：
