...
|---|---|---|---|---|---|
| statics | NEAR | `0x805b7ee` | `0x1e7` | `0x8056296` | `0x1e7` |
...
+call   *%eax
 mov    %eax,%ebx
 movl   $0x1de,0x8(%esp)
 movl   $"OnPartyResultStatistic",0x4(%esp)
 lea    -0x34(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp](source/DNFServer/GameServer/Statics/DNFPacketTranslater.cpp)（约第 284 行）：
