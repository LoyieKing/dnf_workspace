...
|---|---|---|---|---|---|
| statics | DIFF | `0x8073fda` | `0x524` | `0x8074186` | `0x59c` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1561 行）：
