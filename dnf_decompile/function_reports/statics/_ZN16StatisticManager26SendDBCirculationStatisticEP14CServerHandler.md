...
|---|---|---|---|---|---|
| statics | DIFF | `0x8073fda` | `0x524` | `0x8073f9e` | `0x5a1` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1507 行）：
