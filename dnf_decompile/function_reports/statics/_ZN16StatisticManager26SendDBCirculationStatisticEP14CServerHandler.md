...
|---|---|---|---|---|---|
| statics | DIFF | `0x8073fda` | `0x524` | `0x80742b8` | `0x59c` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1583 行）：
