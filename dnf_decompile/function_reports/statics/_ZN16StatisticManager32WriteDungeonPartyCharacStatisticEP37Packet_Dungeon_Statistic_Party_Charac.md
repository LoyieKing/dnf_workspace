...
|---|---|---|---|---|---|
| statics | DIFF | `0x806ea8e` | `0x2c9` | `0x806ec06` | `0x2d0` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 307 行）：
