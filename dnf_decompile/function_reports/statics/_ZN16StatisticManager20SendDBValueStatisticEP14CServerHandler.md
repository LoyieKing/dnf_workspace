...
|---|---|---|---|---|---|
| statics | DIFF | `0x8073b18` | `0x34e` | `0x8073c82` | `0x393` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1482 行）：
