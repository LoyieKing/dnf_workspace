...
|---|---|---|---|---|---|
| statics | DIFF | `0x80609a6` | `0x27b` | `0x805e34c` | `0x26e` |
...
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x22>
 mov    $0x0,%eax
-jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x275>
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x26c>
 cmpw   $0x0,-0x4c(%ebp)
-jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x5d>
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x5c>
 cmpl   $0x0,0x18(%ebp)
-jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0xd2>
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0xd1>
 mov    0x10(%ebp),%edx
 mov    0x8(%ebp),%eax
 mov    0x4(%eax),%eax
 movl   $0x0,0xc(%esp)
...
-lea    -0x48(%ebp),%eax
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0xd1>
 movl   $0x10,0x8(%esp)
 movl   $0x0,0x4(%esp)
+lea    -0x28(%ebp),%eax
 mov    %eax,(%esp)
...
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x1d1>
 call   <T> <_Z8getErrnov>
 mov    %eax,-0xc(%ebp)
-mov    -0xc(%ebp),%eax
-cmp    $0x61,%eax
...
-movl   $0x1d1,0x8(%esp)
+cmpl   $0x61,-0xc(%ebp)
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x12b>
+movl   $0x1b8,0x8(%esp)
 movl   $"SendToServer",0x4(%esp)
 lea    -0x30(%ebp),%eax
 mov    %eax,(%esp)
 ...
 call   <T> <_ZN10CMyFileLogclEPKcS1_z>
-jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x1d0>
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x1c7>
+cmpl   $0x60,-0xc(%ebp)
+jle    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x13c>
+mov    -0xc(%ebp),%eax
+sub    $0x6f,%eax
+cmp    $0x2,%eax
+jbe    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x18a>
+movl   $0x1be,0x8(%esp)
+movl   $"SendToServer",0x4(%esp)
+lea    -0x38(%ebp),%eax
+mov    %eax,(%esp)
...
-movl   $0x1e0,0x8(%esp)
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x214>
+movl   $0x1c7,0x8(%esp)
 movl   $"SendToServer",0x4(%esp)
-lea    -0x20(%ebp),%eax
+lea    -0x48(%ebp),%eax
...
-movl   $0x1e7,0x8(%esp)
+jne    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x223>
+mov    $0x1,%eax
+jmp    <T> <_ZNK11CUdpHandler12SendToServerEPcitPKc+0x26c>
+movl   $0x1ce,0x8(%esp)
 movl   $"SendToServer",0x4(%esp)
