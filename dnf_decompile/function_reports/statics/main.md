...

{
  ...
  this = (CAppBase *)CApplicationInstance();
                    /* try { // try from 08050a11 to 08050a35 has its CatchHandler @ 08050a38 */
...
定义于 [source/DNFServer/GameServer/Statics/DNFStatisticServerMain.cpp](source/DNFServer/GameServer/Statics/DNFStatisticServerMain.cpp)（约第 6 行）：
