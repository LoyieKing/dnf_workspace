...
|---|---|---|---|---|---|
| statics | DIFF | `0x8071e1e` | `0x1de` | `0x8071cd4` | `0x213` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 970 行）：
