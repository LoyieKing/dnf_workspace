...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072780` | `0x109` | `0x8072516` | `0xf6` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1048 行）：
