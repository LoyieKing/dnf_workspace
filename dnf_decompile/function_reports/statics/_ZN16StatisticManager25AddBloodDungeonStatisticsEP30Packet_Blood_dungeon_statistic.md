...
|---|---|---|---|---|---|
| statics | NEAR | `0x8072780` | `0x109` | `0x80728d4` | `0x109` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1190 行）：
