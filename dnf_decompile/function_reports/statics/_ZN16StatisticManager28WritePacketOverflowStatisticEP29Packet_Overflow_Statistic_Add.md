...
|---|---|---|---|---|---|
| statics | DIFF | `0x806ed58` | `0x18c` | `0x806ef8c` | `0x189` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 326 行）：
