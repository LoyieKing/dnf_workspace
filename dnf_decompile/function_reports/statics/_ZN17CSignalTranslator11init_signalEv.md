...
|---|---|---|---|---|---|
| statics | DIFF | `0x804b012` | `0xe4b` | `0x805bdcc` | `0xe67` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFSignalTranslator.cpp](source/DNFServer/GameServer/Statics/DNFSignalTranslator.cpp)（约第 72 行）：
