...
|---|---|---|---|---|---|
| statics | NEAR | `0x80567fc` | `0x23f` | `0x804d916` | `0x23f` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFApplication.cpp](source/DNFServer/GameServer/Statics/DNFApplication.cpp)（约第 124 行）：
