...
|---|---|---|---|---|---|
| statics | DIFF | `0x8065cde` | `0x19d` | `0x805b484` | `0x1a3` |
...
+je     <T> <_ZN14CServerHandler7ProcessEv+0x199>
 mov    0x8(%ebp),%eax
 add    $0x13ec,%eax
 mov    %eax,(%esp)
 ...
 test   %al,%al
-je     <T> <_ZN14CServerHandler7ProcessEv+0x197>
+je     <T> <_ZN14CServerHandler7ProcessEv+0x19c>
 mov    0x8(%ebp),%eax
 add    $0x13ec,%eax
 mov    %eax,(%esp)
...
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0x19d>
+nop
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0x19d>
+nop
+jmp    <T> <_ZN14CServerHandler7ProcessEv+0x19d>
...
定义于 [source/DNFServer/GameServer/Statics/DNFServerHandler.cpp](source/DNFServer/GameServer/Statics/DNFServerHandler.cpp)（约第 54 行）：
