...
|---|---|---|---|---|---|
| statics | DIFF | `0x8059e1a` | `0x11d` | `0x8054924` | `0xfb` |
...
+jg     <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xf9>
 cmpl   $0x3e7,0xc(%ebp)
-jle    <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0x113>
+jle    <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xf9>
 mov    0x8(%ebp),%eax
...
+ja     <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xf9>
 mov    0x8(%ebp),%eax
 mov    (%eax),%eax
-mov    %eax,-0xc(%ebp)
...
+je     <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xf9>
+mov    0x8(%ebp),%eax
+add    $0x1d640,%eax
+movzbl (%eax),%eax
 test   %al,%al
...
+jne    <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xbe>
 mov    0x8(%ebp),%eax
-movzbl 0x1d640(%eax),%eax
-test   %al,%al
...
+add    %edx,%eax
+movb   $0x0,(%eax)
+jmp    <T> <_ZN14CPacketCounterILi1000ELi10240EE12AfterProcessEi+0xcb>
+mov    0x8(%ebp),%eax
+add    $0x9068,%eax
+mov    (%eax),%eax
+mov    %eax,-0x4(%ebp)
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp)（约第 194 行）：
