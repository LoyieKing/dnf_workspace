...
|---|---|---|---|---|---|
| statics | DIFF | `0x8059e1a` | `0x11d` | `0x80548c6` | `0xfb` |
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp)（约第 193 行）：
