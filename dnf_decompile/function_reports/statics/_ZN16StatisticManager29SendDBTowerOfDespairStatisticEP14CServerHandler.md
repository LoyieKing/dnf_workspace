...
|---|---|---|---|---|---|
| statics | DIFF | `0x8074b4a` | `0xae` | `0x8074c06` | `0xb0` |
...
+lea    -0x352(%ebp),%eax
 ...
 movl   $0x837,0x8(%esp)
 movl   $&_ZZN16StatisticManager29SendDBTowerOfDespairStatisticEP14CServerHandlerE12__FUNCTION__,0x4(%esp)
-lea    -0x10(%ebp),%eax
+lea    -0x18(%ebp),%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1664 行）：
