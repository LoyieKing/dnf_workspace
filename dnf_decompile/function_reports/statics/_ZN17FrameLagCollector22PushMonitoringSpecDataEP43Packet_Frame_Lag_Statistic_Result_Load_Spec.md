...
|---|---|---|---|---|---|
| statics | DIFF | `0x8066ef0` | `0x274` | `0x8060112` | `0x276` |
...
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP43Packet_Frame_Lag_Statistic_Result_Load_Spec+0x26b>
 mov    0x8(%ebp),%eax
 movzbl 0x18(%eax),%edx
 mov    0xc(%ebp),%eax
 movzbl 0xa(%eax),%eax
...
+jne    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP43Packet_Frame_Lag_Statistic_Result_Load_Spec+0x266>
 mov    0x8(%ebp),%eax
 lea    0x1c(%eax),%edx
 lea    -0x24(%ebp),%eax
 mov    %edx,0x4(%esp)
...
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP43Packet_Frame_Lag_Statistic_Result_Load_Spec+0x266>
 mov    0xc(%ebp),%eax
 lea    0xb(%eax),%edx
 mov    0x8(%ebp),%eax
 add    $0x1c,%eax
...
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP43Packet_Frame_Lag_Statistic_Result_Load_Spec+0x221>
+mov    0xc(%ebp),%eax
 mov    -0x1c(%ebp),%edx
-mov    0xc(%ebp),%eax
 add    $0x4,%edx
...
+je     <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP43Packet_Frame_Lag_Statistic_Result_Load_Spec+0x232>
 mov    0x8(%ebp),%eax
 mov    0x4c(%eax),%edx
+mov    0xc(%ebp),%eax
 mov    -0x1c(%ebp),%ecx
...
+jmp    <T> <_ZN17FrameLagCollector22PushMonitoringSpecDataEP43Packet_Frame_Lag_Statistic_Result_Load_Spec+0x233>
 nop
 mov    0x8(%ebp),%eax
 add    $0x1c,%eax
 mov    %eax,(%esp)
...
定义于 [source/DNFServer/GameServer/Statics/FrameLagCollector.cpp](source/DNFServer/GameServer/Statics/FrameLagCollector.cpp)（约第 359 行）：
