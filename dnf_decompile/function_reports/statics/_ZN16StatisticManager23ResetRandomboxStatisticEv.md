...
|---|---|---|---|---|---|
| statics | DIFF | `0x8072de2` | `0x48` | `0x8072e9a` | `0x4e` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1327 行）：
