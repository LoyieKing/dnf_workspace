...
|---|---|---|---|---|---|
| statics | DIFF | `0x806fb8e` | `0x20d` | `0x806fd04` | `0x215` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 517 行）：
