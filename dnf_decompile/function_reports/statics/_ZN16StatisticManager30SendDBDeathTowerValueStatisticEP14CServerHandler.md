...
|---|---|---|---|---|---|
| statics | DIFF | `0x806fb8e` | `0x20d` | `0x806fd12` | `0x20b` |
...
+cmpl   $0x196,-0xc(%ebp)
+jbe    <T> <_ZN16StatisticManager30SendDBDeathTowerValueStatisticEP14CServerHandler+0x165>
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 518 行）：
