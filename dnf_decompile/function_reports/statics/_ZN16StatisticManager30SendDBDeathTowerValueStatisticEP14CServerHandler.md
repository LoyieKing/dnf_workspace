...
|---|---|---|---|---|---|
| statics | DIFF | `0x806fb8e` | `0x20d` | `0x806fdaa` | `0x1f6` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 478 行）：
