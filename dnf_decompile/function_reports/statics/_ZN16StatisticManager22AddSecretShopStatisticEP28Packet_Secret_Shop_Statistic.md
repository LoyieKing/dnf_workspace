...
|---|---|---|---|---|---|
| statics | DIFF | `0x80745d8` | `0x22a` | `0x80747f0` | `0x229` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1628 行）：
