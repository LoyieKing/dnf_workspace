...
|---|---|---|---|---|---|
| statics | DIFF | `0x80745d8` | `0x22a` | `0x8074784` | `0x228` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1630 行）：
