...
|---|---|---|---|---|---|
| statics | DIFF | `0x80745d8` | `0x22a` | `0x8074722` | `0x228` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 1688 行）：
