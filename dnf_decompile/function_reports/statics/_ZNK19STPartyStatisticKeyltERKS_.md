...
|---|---|---|---|---|---|
| statics | DIFF | `0x8075b18` | `0x181` | `0x80662f6` | `0x169` |
...
定义于 [source/DNFServer/GameServer/Statics/GMAccounts.cpp](source/DNFServer/GameServer/Statics/GMAccounts.cpp)（约第 606 行）：
