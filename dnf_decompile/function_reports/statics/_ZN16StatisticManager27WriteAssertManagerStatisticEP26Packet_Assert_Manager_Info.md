...
|---|---|---|---|---|---|
| statics | DIFF | `0x8070540` | `0x333` | `0x80703c4` | `0x32f` |
...
定义于 [source/DNFServer/GameServer/Statics/Statistics.cpp](source/DNFServer/GameServer/Statics/Statistics.cpp)（约第 601 行）：
