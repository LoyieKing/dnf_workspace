...
|---|---|---|---|---|---|
| statics | DIFF | `0x805973e` | `0x1f2` | `0x8054264` | `0x1f1` |
...
@@ -1,126 +1,125 @@
 ...
 mov    $0x0,%eax
-jmp    <T> <_ZN14CPacketDecoder9MsgDecodeEP12PacketHeader+0x1ea>
+jmp    <T> <_ZN14CPacketDecoder9MsgDecodeEP12PacketHeader+0x1e9>
 mov    0xc(%ebp),%eax
 movzwl (%eax),%eax
 cmp    $0x27ff,%ax
-ja     <T> <_ZN14CPacketDecoder9MsgDecodeEP12PacketHeader+0x189>
+ja     <T> <_ZN14CPacketDecoder9MsgDecodeEP12PacketHeader+0x188>
 mov    0xc(%ebp),%eax
 movzwl (%eax),%eax
 cmp    $0x3e7,%ax
-jbe    <T> <_ZN14CPacketDecoder9MsgDecodeEP12PacketHeader+0x189>
+jbe    <T> <_ZN14CPacketDecoder9MsgDecodeEP12PacketHeader+0x188>
 ...
 test   %eax,%eax
 jne    <T> <_ZN14CPacketDecoder9MsgDecodeEP12PacketHeader+0x144>
 mov    0xc(%ebp),%eax
 movzwl (%eax),%eax
 movzwl %ax,%ebx
 movl   $0xca,0x8(%esp)
...

{
  ...
  if (param_1 == (PacketHeader *)0x0) {
    ...
    if (MsgDecode(PacketHeader*)::packet_counter == '\0') {
      ...
      if (iVar3 != 0) {
                    /* try { // try from 080597b8 to 080597bc has its CatchHandler @ 080597e8 */
    ...
    CPacketCounter<1000,10240>::_ZN14CPacketCounterILi1000ELi10240EE20IncrementPacketCountEi
              ((CPacketCounter<1000,10240> *)MsgDecode(PacketHeader*)::packet_counter,
               (uint)*(ushort *)param_1);
    if (*(int *)(this + (uint)*(ushort *)param_1 * 4 + 0xc) == 0) {
      uVar1 = *(ushort *)param_1;
      CMyFileLog::CMyFileLog(local_2c,"MsgDecode",0xca);
      ...
      CPacketCounter<1000,10240>::_ZN14CPacketCounterILi1000ELi10240EE13BeforeProcessEv
                ((CPacketCounter<1000,10240> *)MsgDecode(PacketHeader*)::packet_counter);
      (**(code **)(this + (uint)*(ushort *)param_1 * 4 + 0xc))(param_1);
    ...
    uVar1 = *(ushort *)param_1;
    CMyFileLog::CMyFileLog(local_24,"MsgDecode",0xea);
    CMyFileLog::_ZN10CMyFileLogclEPKcS1_z
...
定义于 [source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp](source/DNFServer/GameServer/Statics/DNFPacketDecoder.cpp)（约第 78 行）：
