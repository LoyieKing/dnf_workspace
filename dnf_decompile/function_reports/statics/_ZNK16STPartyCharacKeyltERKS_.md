...
|---|---|---|---|---|---|
| statics | DIFF | `0x80760f4` | `0x173` | `0x8066860` | `0x165` |
...
定义于 [source/DNFServer/GameServer/Statics/GMAccounts.cpp](source/DNFServer/GameServer/Statics/GMAccounts.cpp)（约第 698 行）：
