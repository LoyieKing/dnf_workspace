...
| 项 | 值 |
|---|---|
| 原始 ELF | `/mnt/d/Docs/my_sources/dnf_workspace/dnf_installer/build/dnf_data/home/template/neople/relay/df_relay_r` |
| 重建 ELF | `/mnt/d/Docs/my_sources/dnf_workspace/dnf_decompile/build/relay/df_relay_r` |
...
```
_ZN5MutexC2Ev	_ZN5MutexC2Ev
_ZN5MutexD2Ev	_ZN5MutexD2Ev
