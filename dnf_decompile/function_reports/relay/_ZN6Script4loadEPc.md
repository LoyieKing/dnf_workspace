...
|---|---|---|---|---|---|
| relay | NEAR | `0x804a852` | `0x120` | `0x805691a` | `0x120` |
...
@@ -1,78 +1,78 @@
 ...
 movl   $0x1,0xc(%esp)
-movl   $"title",0x8(%esp)
+movl   $&data#42b02a09(.rodata),0x8(%esp)
...
定义于 [source/DNFServer/GameServer/Relay/Script.cpp](source/DNFServer/GameServer/Relay/Script.cpp)（约第 27 行）：
