...
|---|---|---|---|---|---|
| relay | DIFF | `0x804a4e2` | `0x148` | `0x804ec82` | `0x15e` |
...
+mov    %edx,0xc(%esp)
+mov    %ecx,0x8(%esp)
 movl   $"[%02d/%02d/%02d %02d:%02d:%02d] Error: %s\n",0x4(%esp)
-mov    -0x1c(%ebp),%eax
+mov    -0x14(%ebp),%eax
 mov    %eax,(%esp)
 call   <T> <fprintf>
...

{
  ...
  if (local_20 != (FILE *)0x0) {
    fprintf(local_20,"[%02d/%02d/%02d %02d:%02d:%02d] Error: %s\n",local_24->tm_year + 0x76c,
            local_24->tm_mon + 1,local_24->tm_mday,local_24->tm_hour,local_24->tm_min,
            local_24->tm_sec,param_1);
    fclose(local_20);
  }
  return;
}
...
定义于 [source/DNFServer/GameServer/Relay/Helper.cpp](source/DNFServer/GameServer/Relay/Helper.cpp)（约第 104 行）：
