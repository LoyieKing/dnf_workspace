...
|---|---|---|---|---|---|
| relay | NEAR | `0x8051c10` | `0x46` | `0x8051fa2` | `0x46` |
...
定义于 [source/DNFServer/GameServer/Relay/RelayService.cpp](source/DNFServer/GameServer/Relay/RelayService.cpp)（约第 270 行）：
