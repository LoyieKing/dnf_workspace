...
public:
    ...
    int32 find(const char* src) const;
    int32 find(const char* src, int32 length) const;
    int32 find(int32 start, const char* src) const;
    int32 find(int32 start, const char* src, int32 length) const;
    int32 find(const CharString& src) const;
    int32 find(int32 start, const CharString& src) const;
    int32 find(char ch) const;
    int32 find(int32 start, char ch) const;
    int32 rfind(const char* src) const;
    int32 rfind(const char* src, int32 length) const;
    int32 rfind(int32 start, const char* src) const;
    int32 rfind(int32 start, const char* src, int32 length) const;
    int32 rfind(const CharString& src) const;
    int32 rfind(int32 start, const CharString& src) const;
    int32 rfind(char ch) const;
    int32 rfind(int32 start, char ch) const;
    ...
    static CharString format(const char* format, ...);
    static CharString vformat(const char* format, char* argList);
    static int32 tokenize(const CharString& delimiters, std::vector<CharString>* tokenVector);
    static int32 tokenize(const CharString& delimiters, std::vector<CharString>* tokenVector,
                          const char* delimiters2, const char* delimiters3, bool bKeepEmpty);
    static int32 tokenizeNewLine(const CharString& delimiters,
                                 std::vector<CharString>* tokenVector);
    static CharString join(const std::vector<CharString>& stringVector,
...
public:
    ...
    int32 find(const wchar* src) const;
    int32 find(const wchar* src, int32 length) const;
    int32 find(int32 start, const wchar* src) const;
    int32 find(int32 start, const wchar* src, int32 length) const;
    int32 find(const WideString& src) const;
    int32 find(int32 start, const WideString& src) const;
    int32 find(wchar ch) const;
    int32 find(int32 start, wchar ch) const;
    int32 rfind(const wchar* src) const;
    int32 rfind(const wchar* src, int32 length) const;
    int32 rfind(int32 start, const wchar* src) const;
    int32 rfind(int32 start, const wchar* src, int32 length) const;
    int32 rfind(const WideString& src) const;
    int32 rfind(int32 start, const WideString& src) const;
    int32 rfind(wchar ch) const;
    int32 rfind(int32 start, wchar ch) const;
    static WideString concat(const wchar* src1, const wchar* src2);
    static WideString concat(const wchar* src1, int32 src1Len, const wchar* src2, int32 src2Len);
    static WideString concat(const WideString& src1, const wchar* src2);
    static WideString concat(const WideString& src1, const wchar* src2, int32 src2Len);
    static WideString concat(const wchar* src1, const WideString& src2);
    static WideString concat(const wchar* src1, int32 src1Len, const WideString& src2);
    static WideString concat(const WideString& src1, const WideString& src2);
    static WideString concat(const WideString& src1, wchar ch);
    static WideString concat(wchar ch, const WideString& src1);
    static WideString pattern(const wchar* pattern, int32 length);
    static WideString format(const wchar* format, ...);
    static WideString vformat(const wchar* format, char* argList);
    static int32 tokenize(const WideString& delimiters, std::vector<WideString>* tokenVector);
    static int32 tokenize(const WideString& delimiters, std::vector<WideString>* tokenVector,
                          const wchar* delimiters2, const wchar* delimiters3, bool bKeepEmpty);
    static int32 tokenizeNewLine(const WideString& delimiters,
                                 std::vector<WideString>* tokenVector);
    static WideString join(const std::vector<WideString>& stringVector,
                           const WideString& separator);
    static int32 compare(const WideString& src1, const wchar* src2);
    static int32 compare(const WideString& src1, const WideString& src2);
    static int32 compare(const wchar* src1, const WideString& src2);
    static int32 compareNoCase(const WideString& src1, const wchar* src2);
    static int32 compareNoCase(const WideString& src1, const WideString& src2);
    static int32 compareNoCase(const wchar* src1, const WideString& src2);
    static bool isuspace(wchar ch);
    static bool isupunct(wchar ch);
