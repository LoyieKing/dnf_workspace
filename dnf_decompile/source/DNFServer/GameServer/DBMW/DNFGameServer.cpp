// df_dbmw_r - CGameServer (ORIG DNFGameServer.cpp)
...
// ---- CGameServer（dbmw 同构宏展开）----

CGameServer::CGameServer() : m_type(0xff) { m_port = 0; m_padA = 0; m_flag = 0; m_udpHandler = 0; } 
CGameServer::~CGameServer() {} 
void CGameServer::OnDisconnect() { m_padA = 0; } 
void CGameServer::Init(unsigned char type, std::string& name, unsigned short port, 
               unsigned char flag) 
{ 
    m_type = type; 
    m_name = name; 
