...
public:
    ...
    int RegistDBServer(CDBServer* db);
    int UnregistDBServer();
    int RegistManagerServer(CManagerServer* mgr);
    int UnregistManagerServer();
    ...
    bool IsConnectedGameServer(unsigned char channel);
