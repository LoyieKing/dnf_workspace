...
void CSHA::FinalDigest(char* pcDigest)
{
    if (m_bAddData != true)
    {
        throw CCryptorException("FinalDigest", 0x53, "FileCrypt ERROR: in CSHA::FinalDigest(), No data Added before call!");
    }
...
void CSHA::Transform()
{
    ...
    m_auiBuf[0] = m_auiBuf[0] + n0;
    m_auiBuf[1] = m_auiBuf[1] + n1;
    m_auiBuf[2] = m_auiBuf[2] + n2;
    m_auiBuf[3] = m_auiBuf[3] + n3;
    m_auiBuf[4] = m_auiBuf[4] + n4;
    m_auiBuf[5] = m_auiBuf[5] + n5;
    m_auiBuf[6] = m_auiBuf[6] + n6;
    m_auiBuf[7] = m_auiBuf[7] + n7;
}
