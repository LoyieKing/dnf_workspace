#!/usr/bin/env python3
"""manager scratch 二进制逐函数分类（子 Agent 闭环复检用）。

用法:
  python3 scratch_check_manager.py <scratch-binary> <mangled-name> [name2 ...]
  python3 scratch_check_manager.py <scratch-binary> --file <list.txt>
...
ORIG = '/home/loyieking/dnf_workspace/dnf_installer/build/dnf_data/home/template/neople/manager/df_manager_r'
