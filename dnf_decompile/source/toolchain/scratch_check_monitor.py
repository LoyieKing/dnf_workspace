#!/usr/bin/env python3
"""monitor scratch 二进制逐函数分类（子 Agent 闭环复检用）。

用法:
  python3 scratch_check_monitor.py <scratch-binary> <mangled-name> [name2 ...]
  python3 scratch_check_monitor.py <scratch-binary> --file <list.txt>
