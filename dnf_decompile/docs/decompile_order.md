...
生成时间：2026-08-06（2026-08-07 更新：`stun`、`channel`、`bridge` 已完成还原，移出队列；`auction/point` 升为下一目标）
...
| 6 | `guild` | 2.3 MB | 7,024 | 12.3k | 无 | 占位 | 公会操作 |
| 7 | `monitor` | 2.5 MB | 7,899 | 13.3k | 无 | 占位 | 无 DWARF 中函数最多 |
| 8 | `manager` | 3.2 MB | 5,948 | 25.8k | 无 | 占位 | 字符串量最大，消息/管理面广 |
| 9 | `dbmw` | 4.0 MB | 7,816 | 32.1k | 几乎无效（2 CU） | 占位 | 无 DWARF 中体量最大，DB 中间件 |
