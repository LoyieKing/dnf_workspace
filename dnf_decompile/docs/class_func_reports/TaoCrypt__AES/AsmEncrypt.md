...
```asm
# 087a17d0  _ZNK8TaoCrypt3AES10AsmEncryptEPKhPhPv
#           TaoCrypt::AES::AsmEncrypt(unsigned char const*, unsigned char*, void*) const
# range [0x087a17d0, 0x087a1813]
087a17d0 +0x00:  push   %ebp
087a17d1 +0x01:  mov    %esp,%ebp
087a17d3 +0x03:  movd   %edi,%mm3
087a17d6 +0x06:  movd   %ebx,%mm4
087a17d9 +0x09:  sub    $0x4,%esp
087a17dc +0x0c:  movd   %ebp,%mm7
087a17df +0x0f:  mov    %esi,-0x4(%ebp)
087a17e2 +0x12:  mov    0x8(%ebp),%ecx
087a17e5 +0x15:  mov    0xc(%ebp),%esi
087a17e8 +0x18:  mov    0x14(%ebp),%ebp
087a17eb +0x1b:  mov    0x38(%ecx),%edx
087a17ee +0x1e:  lea    0x3c(%ecx),%edi
087a17f1 +0x21:  dec    %edx
087a17f2 +0x22:  movd   %edi,%mm6
087a17f5 +0x25:  movd   %edx,%mm5
087a17f8 +0x28:  mov    (%esi),%eax
087a17fa +0x2a:  mov    0x4(%esi),%ebx
087a17fd +0x2d:  mov    0x8(%esi),%ecx
087a1800 +0x30:  mov    0xc(%esi),%edx
087a1803 +0x33:  bswap  %eax
087a1805 +0x35:  bswap  %ebx
087a1807 +0x37:  bswap  %ecx
087a1809 +0x39:  bswap  %edx
087a180b +0x3b:  xor    (%edi),%eax
087a180d +0x3d:  xor    0x4(%edi),%ebx
087a1810 +0x40:  xor    0x8(%edi),%ecx
087a1813 +0x43:  xor    0xc(%edi),%edx
```
