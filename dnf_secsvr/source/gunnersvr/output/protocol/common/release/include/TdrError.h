...
// Original path: output/protocol/common/release/include/TdrError.h
// 内容为类型信息与声明（函数体暂未还原）。
#ifndef SECSVR_OUTPUT_PROTOCOL_COMMON_RELEASE_INCLUDE_TDRERROR_H_H_
#define SECSVR_OUTPUT_PROTOCOL_COMMON_RELEASE_INCLUDE_TDRERROR_H_H_
...
#endif // SECSVR_OUTPUT_PROTOCOL_COMMON_RELEASE_INCLUDE_TDRERROR_H_H_
