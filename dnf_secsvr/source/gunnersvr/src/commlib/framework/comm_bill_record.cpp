...
void CommBillRecord::init_log_file(ZEN_LOGFILE_DEVIDE div_log_file) {
...
int CommBillRecord::init(const char *bill_name, ZEN_LOGFILE_DEVIDE div_log_file, int log_way, bool if_thread_sync, bool arg4) {
    if (!bill_name) {
        return 0x13a2;
    }
