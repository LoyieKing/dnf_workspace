...
int ZEN_Bus_MMAPPipe::push_back_bus(size_t index, const ZEN_LIB::dequechunk_node *node) {
    return bus_pipe_pointer_[index]->push_end(node);
}

int ZEN_Bus_MMAPPipe::pop_front_bus(size_t index, ZEN_LIB::dequechunk_node *node) {
    return bus_pipe_pointer_[index]->pop_front(node);
}

int ZEN_Bus_MMAPPipe::read_front_bus(size_t index, ZEN_LIB::dequechunk_node *&node) {
    return bus_pipe_pointer_[index]->read_front_new(node);
}

int ZEN_Bus_MMAPPipe::pop_front_bus(size_t index) {
    return bus_pipe_pointer_[index]->discard_frond();
}

int ZEN_Bus_MMAPPipe::get_front_nodesize(size_t index, size_t &nodesize) {
...
bool ZEN_Bus_MMAPPipe::is_full_bus(size_t index) {
    return bus_pipe_pointer_[index]->full();
}

bool ZEN_Bus_MMAPPipe::is_empty_bus(size_t index) {
    return bus_pipe_pointer_[index]->empty();
}

void ZEN_Bus_MMAPPipe::get_bus_freesize(size_t index, size_t &freesize, size_t &size) {
