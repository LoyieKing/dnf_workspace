...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32/src/commsvr/gunnersvr/gunner_statinfo_fetcher.cpp
...
// line 55
int GunnerStatinfoFetcher::fetch_svrinfo_from_filename(const char *file_name, GunnerStatInfo &stat_info) {
}
...
int GunnerStatinfoFetcher::get_info(const char *file_name, GunnerStatInfo &stat_info) {
    // local: ZEN_Server_Status server_status;
    // local: int ret;
}
