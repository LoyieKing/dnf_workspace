...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32/src/commsvr/gunnersvr/gunner_file_scanner.cpp
...
// mangled: _Z19check_for_stat_filePK6dirent
// line 31
int check_for_stat_file(const dirent *file) {
    // local: char *begin_pos;
    // local: const char *end_pos;
    // local: int cnt;
}
...
// line 64
int GunnerFileScanner::scan_stat_file(const char *dir, /*anon struct*/ int &all_files) {
    // local: int file_num;
    // local: dirent **name_list;
    // local: string tmp;
}
