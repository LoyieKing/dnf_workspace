...
// Original path: src/formmog/secagent/secagent_restrict.h
// 内容为类型信息与声明（函数体暂未还原）。
#ifndef SECSVR_SRC_FORMMOG_SECAGENT_SECAGENT_RESTRICT_H_H_
#define SECSVR_SRC_FORMMOG_SECAGENT_SECAGENT_RESTRICT_H_H_
