...
// line 103
int SecAgentGamesvrChannel::send(unsigned int channel_id, const void *send_buf, size_t send_buf_size) {
}

// line 82
int SecAgentGamesvrChannel::recv(unsigned int channel_id, void **recv_buf, size_t *recv_buf_size) {
    // local: int ret;
    // local: /*anon struct*/ int *chunk_node;
}

// line 36
int SecAgentGamesvrChannel::open(unsigned int channel_id) {
    // local: char file_name[];
    // local: char dir_path[];
