...
// line 43
bool is_valid_func_id(const unsigned int func_id) {
}
...
// line 137
int AntibotCrypter::decrypt(unsigned int func_id, const unsigned char *key, /*anon struct*/ int *msg) {
    // local: unsigned int crc32_value;
}

// line 106
int AntibotCrypter::encrypt(unsigned int func_id, const unsigned char *key, unsigned char *data, unsigned int data_len, /*anon struct*/ int *msg) {
    // local: int ret;
}
