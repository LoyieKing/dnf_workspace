...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/framework/comm_bill_record.cpp
...
void CommBillRecord::init_log_file(unsigned int bill_num, ZEN_LOGFILE_DEVIDE div_log_file) {
    // local: string bill_prefix;
}

int CommBillRecord::init(const char *bill_name, unsigned int bill_num, ZEN_LOGFILE_DEVIDE div_log_file, int log_way, bool if_thread_sync, bool arg5) {
}
