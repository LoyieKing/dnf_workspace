...
// 继承 ZEN_BusPipe_TwoWay(10292)，自身成员复用基类尾部填充：
//   if_check_pthrad_(0x2831) zerg_svr_info_(0x2832) monitor_(0x2838) config_(0x283c) = 10304
...
public: // monitor_/config_ 原为 protected；secagent TU 内联读取，按反汇编放宽访问
    bool if_check_pthrad_;            // 0x2831
    SERVICES_ID zerg_svr_info_;       // 0x2832
    Comm_Stat_Monitor *monitor_;      // 0x2838
    Comm_Svrd_Config *config_;        // 0x283c
...
public:
    ...
    int getpara_from_zergcfg(const Zen_INI_PropertyTree &zerglingcfg); // line 57
