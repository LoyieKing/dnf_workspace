...
public:
    ...
    int init(const char *bill_name, unsigned int reserve_file_num,
             ZEN_LOGFILE_DEVIDE div_log_file, int log_way,
             bool if_thread_sync, bool arg4); // line 75
...
protected:
    ...
    void init_log_file(unsigned int reserve_file_num,
                       ZEN_LOGFILE_DEVIDE div_log_file); // line 379
