...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/framework/comm_svrd_app_non_ctrl.cpp
...
int Comm_SvrdApp_NonCtrl::proc(size_t &proc_data_num) {
}
...
int Comm_SvrdApp_NonCtrl::run_instance() {
    // local: size_t size_io_event;
    // local: size_t size_timer_expire;
    // local: size_t prc_frame;
    // local: size_t idle;
    // local: size_t proc_data_num;
    // local: ZEN_Time_Value select_interval;
    // local: ZEN_Timer_Queue *time_queue;
    // local: ZEN_Reactor *reactor;
}
