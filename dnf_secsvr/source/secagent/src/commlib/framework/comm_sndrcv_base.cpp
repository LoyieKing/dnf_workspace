...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32/src/commlib/framework/comm_sndrcv_base.cpp
...
Tibetan_SendRecv_Package::Tibetan_SendRecv_Package()
    : tibetan_recv_service_(0, 0),
      ...
      test_frame_len_(0),
      trans_id_builder_(0),
      tibetan_send_appframe_(0),
      tibetan_recv_appframe_(0),
      recv_trans_id_(0) {
}
...
Tibetan_SendRecv_Package::~Tibetan_SendRecv_Package() {
    ...
    tibetan_proxy_service_.~SERVICES_ID();
    tibetan_send_service_.~SERVICES_ID();
    tibetan_recv_service_.~SERVICES_ID();
}
...
Comm_App_Frame * Tibetan_SendRecv_Package::get_send_appframe() {
    return tibetan_send_appframe_;
}

Comm_App_Frame * Tibetan_SendRecv_Package::get_recv_appframe() {
    return tibetan_recv_appframe_;
}

void Tibetan_SendRecv_Package::set_services_id(const SERVICES_ID &recv_service, const SERVICES_ID &send_service, const SERVICES_ID &proxy_service, size_t frame_len) {
    ...
    tibetan_send_appframe_ = new (frame_len) Comm_App_Frame(0, 0x32, 0x1000000);
    tibetan_send_appframe_->init_framehead(frame_len, 0, 0);

    tibetan_recv_appframe_ = new (frame_len) Comm_App_Frame(0, 0x32, 0x1000000);
    tibetan_recv_appframe_->init_framehead(frame_len, 0, 0);
}
