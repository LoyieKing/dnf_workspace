...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_os_adapt_sysinfo.cpp
...
int ZEN_OS::get_system_perf(ZEN_SYSTEM_PERFORMANCE *zen_system_perf) {
}
