...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_socket_stream.cpp
...
// line 105
ssize_t ZEN_Socket_Stream::recvn_timeout(void *buf, size_t len, ZEN_Time_Value &timeout_tv, int flags) {
}

// line 92
ssize_t ZEN_Socket_Stream::send_n(const void *buf, size_t len, ZEN_Time_Value *timeout_tv, int flags) {
}

// line 79
ssize_t ZEN_Socket_Stream::recv_n(void *buf, size_t len, ZEN_Time_Value *timeout_tv, int flags) {
}

// line 68
int ZEN_Socket_Stream::shutdown(int how) {
}
