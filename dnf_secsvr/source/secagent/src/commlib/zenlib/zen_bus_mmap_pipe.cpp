...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_bus_mmap_pipe.cpp
...
int ZEN_Bus_MMAPPipe::init_all_pipe(size_t max_frame_len, bool if_restore, bool if_check_pthread) {
    // local: size_t file_offset;
    // local: size_t i;
    // local: char *pt_pipe;
    // local: size_t sz_room;
}
...
// line 98
int ZEN_Bus_MMAPPipe::initialize(const char *bus_mmap_name, size_t number_of_pipe, size_t *size_of_pipe, size_t max_frame_len, bool if_restore, bool if_check_pthread, uint8_t mem_type) {
    // local: int ret;
    // local: size_t sz_malloc;
    // local: size_t i;
    // local: zen_os_stat mmapfile_stat;
    // local: size_t i;
    // local: size_t sz_room;
    // local: ZEN_Bus_MMAPPipe::ZEN_BUS_PIPE_HEAD *pipe_head;
    // local: size_t i;
}
