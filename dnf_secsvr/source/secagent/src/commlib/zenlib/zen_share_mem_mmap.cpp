...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_share_mem_mmap.cpp
...
// line 52
int ZEN_ShareMem_Mmap::open(const char *file_name, size_t shm_size, int file_open_mode, int file_perms_mode, const void *want_address, int mmap_prot, int mmap_flags, size_t offset) {
    // local: int ret;
...
// line 145
int ZEN_ShareMem_Mmap::open(const char *file_name, size_t shm_size, bool if_restore, bool read_only, bool share_file, const void *want_address, size_t offset) {
