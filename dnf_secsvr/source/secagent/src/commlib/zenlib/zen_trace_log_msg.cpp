...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_trace_log_msg.cpp
...
void ZEN_Trace_LogMsg::vwrite_logmsg(ZEN_LOG_PRIORITY outlevel, const char *str_format, va_list args) {
    // local: timeval now_time_val;
    // local: char log_tmp_buffer[];
    // local: size_t sz_buf_len;
    // local: size_t sz_use_len;
    // local: int len_of_out;
}
...
void ZEN_Trace_LogMsg::debug_output(ZEN_LOG_PRIORITY dbglevel, const char *str_format) {
    // local: va_list args;
}

void ZEN_Trace_LogMsg::debug_assert_ex(const char *file_name, int file_line, const char *function_name, const char *expression_name, const char *out_string) {
}

void ZEN_Trace_LogMsg::debug_assert(const char *file_name, int file_line, const char *function_name, const char *expression_name) {
}

void ZEN_Trace_LogMsg::write_logmsg(ZEN_LOG_PRIORITY outlevel, const char *str_format) {
    // local: va_list args;
}
