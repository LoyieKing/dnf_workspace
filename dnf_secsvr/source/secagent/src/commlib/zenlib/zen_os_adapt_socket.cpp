...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_os_adapt_socket.cpp
...
int ZEN_OS::handle_ready(ZEN_SOCKET handle, ZEN_Time_Value *timeout_tv, ZEN_OS::HANDLE_READY_TODO ready_todo) {
...
ssize_t ZEN_OS::sendn_timeout(ZEN_SOCKET handle, const void *buf, size_t len, ZEN_Time_Value &timeout_tv, int flags) {
    // local: bool error_occur;
    // local: ssize_t result;
...
ssize_t ZEN_OS::recvfrom_timeout2(ZEN_SOCKET handle, void *buf, size_t len, sockaddr *addr, socklen_t *addrlen, ZEN_Time_Value &timeout_tv, int flags) {
    // local: int ret;
    // local: timeval sockopt_tv;
    // local: ssize_t recv_result;
}

ssize_t ZEN_OS::recvn_timeout2(ZEN_SOCKET handle, void *buf, size_t len, ZEN_Time_Value &timeout_tv, int flags) {
    // local: int ret;
    // local: timeval sockopt_tv;
    // local: ssize_t result;
    // local: ssize_t bytes_recv;
...
ssize_t ZEN_OS::recvn_timeout(ZEN_SOCKET handle, void *buf, size_t len, ZEN_Time_Value &timeout_tv, int flags) {
    // local: ssize_t result;
    // local: bool error_occur;
    // local: int ret;
    // local: ssize_t onetime_recv;
...
ssize_t ZEN_OS::sendn_timeout2(ZEN_SOCKET handle, void *buf, size_t len, ZEN_Time_Value &timeout_tv, int flags) {
    // local: int ret;
    // local: timeval sockopt_tv;
    // local: ssize_t result;
    // local: ssize_t bytes_send;
...
int ZEN_OS::handle_multi_ready(ZEN_SOCKET handle, ZEN_Time_Value *timeout_tv, int multi_ready_todo, int *multiready_occur) {
