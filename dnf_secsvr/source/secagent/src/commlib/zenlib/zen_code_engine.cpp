...
int AB_NS_CODEENGINE::EncodeChar(char **pstrEncode, unsigned char ucSrc) {
}

int AB_NS_CODEENGINE::DecodeChar(char **pstrDecode, unsigned char *pucDest) {
}

int AB_NS_CODEENGINE::DecodeMemInt(char **pstrDecode, char *pcDest, int sMemSize) {
}

int AB_NS_CODEENGINE::EncodeMemInt(char **pstrEncode, char *pcSrc, int sMemSize) {
}

int AB_NS_CODEENGINE::DecodeMem(char **pstrDecode, char *pcDest, short int sMemSize) {
}

int AB_NS_CODEENGINE::EncodeMem(char **pstrEncode, char *pcSrc, short int sMemSize) {
}

int AB_NS_CODEENGINE::DecodeString(char **pstrDecode, char *strDest, short int sMaxStrLength) {
    // local: short unsigned int usTemp;
    // local: short unsigned int usTempLength;
    // local: short unsigned int usRealLength;
    // local: short unsigned int __v;
    // local: short unsigned int __x;
}

int AB_NS_CODEENGINE::DecodeInt(char **pstrDecode, unsigned int *puiDest) {
    // local: unsigned int uiTemp;
    // local: unsigned int __v;
    // local: unsigned int __x;
}

int AB_NS_CODEENGINE::EncodeInt(char **pstrEncode, unsigned int uiSrc) {
    // local: unsigned int uiTemp;
    // local: unsigned int __v;
    // local: unsigned int __x;
}

int AB_NS_CODEENGINE::DecodeShort(char **pstrDecode, short unsigned int *pusDest) {
    // local: short unsigned int usTemp;
    // local: short unsigned int __v;
    // local: short unsigned int __x;
}

int AB_NS_CODEENGINE::EncodeShort(char **pstrEncode, short unsigned int usSrc) {
    // local: short unsigned int usTemp;
    // local: short unsigned int __v;
    // local: short unsigned int __x;
}

int AB_NS_CODEENGINE::EncodeString(char **pstrEncode, char *strSrc, short int sMaxStrLength) {
    // local: short unsigned int usTemp;
    // local: short unsigned int usTempLength;
    // local: short unsigned int __v;
    // local: short unsigned int __x;
