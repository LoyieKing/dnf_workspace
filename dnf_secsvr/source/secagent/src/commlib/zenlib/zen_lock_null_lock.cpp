...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_lock_null_lock.cpp
...
bool ZEN_Null_Mutex::try_lock() {
}

void ZEN_Null_Mutex::unlock() {
}

bool ZEN_Null_Mutex::systime_lock(const ZEN_Time_Value &arg0) {
}

bool ZEN_Null_Mutex::duration_lock(const ZEN_Time_Value &arg0) {
}

void ZEN_Null_Mutex::lock_read() {
}

bool ZEN_Null_Mutex::try_lock_read() {
}

bool ZEN_Null_Mutex::timed_lock_read(const ZEN_Time_Value &arg0) {
}

bool ZEN_Null_Mutex::duration_lock_read(const ZEN_Time_Value &arg0) {
}

void ZEN_Null_Mutex::lock_write() {
}

bool ZEN_Null_Mutex::try_lock_write() {
}

bool ZEN_Null_Mutex::timed_lock_write(const ZEN_Time_Value &arg0) {
}

bool ZEN_Null_Mutex::duration_lock_write(const ZEN_Time_Value &arg0) {
}

void ZEN_Null_Condition::wait(ZEN_Null_Mutex *arg0) {
}

bool ZEN_Null_Condition::systime_wait(ZEN_Null_Mutex *arg0, const ZEN_Time_Value &arg1) {
}

bool ZEN_Null_Condition::duration_wait(ZEN_Null_Mutex *arg0, const ZEN_Time_Value &arg1) {
}
