...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_socket_addr_base.cpp
...
bool ZEN_Sockaddr::operator==(const ZEN_Sockaddr &others_sockaddr) {
}

bool ZEN_Sockaddr::operator!=(const ZEN_Sockaddr &others_sockaddr) {
}

const char * ZEN_Sockaddr::tostr(char *buffer, size_t buf_len) {
}
