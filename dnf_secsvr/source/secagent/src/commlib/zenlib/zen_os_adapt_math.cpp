...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_os_adapt_math.cpp
...
uint32_t ZEN_OS::gcd(uint32_t x, uint32_t y) {
    // local: u_long r;
}

bool ZEN_OS::is_prime(size_t n) {
    // local: size_t test_max;
    // local: size_t i;
}
