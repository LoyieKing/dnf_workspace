...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_config_ini_implement.cpp
...
// line 140
int Zen_INI_PropertyTree::get_bool_value(const string &sectionname, const string &keyname, bool &value) {
}

// line 131
int Zen_INI_PropertyTree::get_uint32_value(const string &sectionname, const string &keyname, uint32_t &value) {
}

// line 123
int Zen_INI_PropertyTree::get_int32_value(const string &sectionname, const string &keyname, int32_t &value) {
}

// line 115
int Zen_INI_PropertyTree::get_string_value(const string &sectionname, const string &keyname, char *buf, size_t size_buf) {
}

// line 106
int Zen_INI_PropertyTree::get_string_value(const string &sectionname, const string &keyname, string &value) {
}
