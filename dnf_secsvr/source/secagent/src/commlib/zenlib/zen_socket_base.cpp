...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_socket_base.cpp
...
ZEN_SOCKET ZEN_Socket_Base::get_handle() {
}

// line 211
ssize_t ZEN_Socket_Base::send(const void *buf, size_t len, int flags) {
}

// line 200
ssize_t ZEN_Socket_Base::recv(void *buf, size_t len, int flags) {
}

// line 189
int ZEN_Socket_Base::connect(const ZEN_Sockaddr *addr) {
}

// line 181
int ZEN_Socket_Base::getsockname(ZEN_Sockaddr *addr) {
}

// line 172
int ZEN_Socket_Base::getpeername(ZEN_Sockaddr *addr) {
}

// line 161
int ZEN_Socket_Base::setsockopt(int level, int optname, const void *optval, int optlen) {
}

// line 152
int ZEN_Socket_Base::getsockopt(int level, int optname, void *optval, socklen_t *optlen) {
}

// line 143
int ZEN_Socket_Base::sock_disable(int value) {
}

// line 137
int ZEN_Socket_Base::sock_enable(int value) {
}

// line 130
int ZEN_Socket_Base::bind(const ZEN_Sockaddr *add_name) {
}

// line 39
int ZEN_Socket_Base::open(int type, int family, int protocol, bool reuse_addr) {
    // local: int ret;
    // local: int one;
}
...
// line 78
int ZEN_Socket_Base::open(int type, const ZEN_Sockaddr *local_addr, int family, int protocol, bool reuse_addr) {
    // local: int ret;
}
