...
// Original path: src/commlib/zenlib/zen_os_adapt_sysinfo.h
// 内容为类型信息与声明（函数体暂未还原）。
#ifndef SECSVR_SRC_COMMLIB_ZENLIB_ZEN_OS_ADAPT_SYSINFO_H_H_
...
// sizeof = 160
struct ZEN_SYSTEM_PERFORMANCE { // line 70
public:
...
#endif // SECSVR_SRC_COMMLIB_ZENLIB_ZEN_OS_ADAPT_SYSINFO_H_H_
