...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_os_adapt_time.cpp
...
uint64_t ZEN_OS::total_milliseconds(const timespec &ts) {
}

int ZEN_OS::usleep(long unsigned int usec) {
}
