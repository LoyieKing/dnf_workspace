...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag435/src/commlib/zenlib/zen_socket_connector.cpp
...
// line 156
int ZEN_Socket_Connector::connect(ZEN_Socket_Stream &new_stream, const ZEN_Sockaddr *remote_addr, bool non_blocing, bool reuse_addr, int protocol, const ZEN_Sockaddr *local_addr) {
    // local: int ret;
    // local: int last_error;
}

// line 49
int ZEN_Socket_Connector::connect(ZEN_Socket_Stream &new_stream, const ZEN_Sockaddr *remote_addr, ZEN_Time_Value &timeout, bool reuse_addr, int protocol, const ZEN_Sockaddr *local_addr) {
    // local: int ret;
