...
struct Comm_App_Frame {
    ...
    static const size_t MAX_LEN_OF_APPFRAME = 0x13D1;        // 待最终核对
    static const size_t LEN_OF_TEA_REMAIN_ROOM = 0x13;       // 待最终核对
    static const size_t MAX_LEN_OF_APPFRAME_DATA = 0xFFBD;   // fill_appdata 上限
    static const size_t MAX_LEN_OF_TEA_APPDATA = 0x139F;     // 待最终核对
