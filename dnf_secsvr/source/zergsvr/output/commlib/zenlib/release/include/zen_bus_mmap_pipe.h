...
public:
    ...
    int initialize(const char *bus_mmap_name, size_t number_of_pipe, size_t *size_of_pipe, size_t max_frame_len, bool if_restore, bool if_check_pthread); // zergsvr 6 参版
    int initialize(const char *bus_mmap_name, size_t max_frame_len); // zergsvr 2 参版
