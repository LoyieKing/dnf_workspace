...
// Original path: output/commlib/zenlib/release/include/zen_socket_acceptor.h
// 内容为类型信息与声明（函数体暂未还原）。
#ifndef SECSVR_OUTPUT_COMMLIB_ZENLIB_RELEASE_INCLUDE_ZEN_SOCKET_ACCEPTOR_H_H_
#define SECSVR_OUTPUT_COMMLIB_ZENLIB_RELEASE_INCLUDE_ZEN_SOCKET_ACCEPTOR_H_H_
...
private:
static const int ZEN_DEFAULT_BACKLOG;
public:
...
extern const int ZEN_DEFAULT_BACKLOG; // line 25

#endif // SECSVR_OUTPUT_COMMLIB_ZENLIB_RELEASE_INCLUDE_ZEN_SOCKET_ACCEPTOR_H_H_
