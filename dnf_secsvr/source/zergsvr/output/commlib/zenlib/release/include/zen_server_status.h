...
// Original path: output/commlib/zenlib/release/include/zen_server_status.h
// 内容为类型信息与声明（函数体暂未还原）。
#ifndef SECSVR_OUTPUT_COMMLIB_ZENLIB_RELEASE_INCLUDE_ZEN_SERVER_STATUS_H_H_
#define SECSVR_OUTPUT_COMMLIB_ZENLIB_RELEASE_INCLUDE_ZEN_SERVER_STATUS_H_H_
...
/*anon struct*/ int *status_stat_sandy_;
/*anon struct*/ int *status_copy_mandy_;
...
#endif // SECSVR_OUTPUT_COMMLIB_ZENLIB_RELEASE_INCLUDE_ZEN_SERVER_STATUS_H_H_
