...
const char * std::search<const char*, const char*, std::equal_to<char> >(const char *__first1, const char *__last1, const char *__first2, const char *__last2, /*anon struct*/ int __predicate) {
    // local: const char *__tmp;
    // local: const char *__p1;
    // local: const char *__p;
    // local: const char *__current;
}

void std::fill<__gnu_cxx::__normal_iterator<__gnu_cxx::_Hashtable_node<unsigned int>**, std::vector<__gnu_cxx::_Hashtable_node<unsigned int>*, std::allocator<__gnu_cxx::_Hashtable_node<unsigned int>*> > >, __gnu_cxx::_Hashtable_node<unsigned int>*>(/*anon struct*/ int __first, /*anon struct*/ int __last, _Hashtable_node<unsigned int> *const &__value) {
    // local: const bool __scalar;
}

_Hashtable_node<unsigned int> ** std::fill_n<__gnu_cxx::_Hashtable_node<unsigned int>**, unsigned int, __gnu_cxx::_Hashtable_node<unsigned int>*>(_Hashtable_node<unsigned int> **__first, unsigned int __n, _Hashtable_node<unsigned int> *const &__value) {
    // local: const bool __scalar;
}

void std::__uninitialized_fill_n_a<__gnu_cxx::_Hashtable_node<unsigned int>**, unsigned int, __gnu_cxx::_Hashtable_node<unsigned int>*, __gnu_cxx::_Hashtable_node<unsigned int>*>(_Hashtable_node<unsigned int> **__first, unsigned int __n, _Hashtable_node<unsigned int> *const &__x, /*anon struct*/ int arg3) {
}

/*anon struct*/ int std::fill_n<__gnu_cxx::__normal_iterator<__gnu_cxx::_Hashtable_node<unsigned int>**, std::vector<__gnu_cxx::_Hashtable_node<unsigned int>*, std::allocator<__gnu_cxx::_Hashtable_node<unsigned int>*> > >, unsigned int, __gnu_cxx::_Hashtable_node<unsigned int>*>(/*anon struct*/ int __first, unsigned int __n, _Hashtable_node<unsigned int> *const &__value) {
    // local: const bool __scalar;
}

void std::__uninitialized_fill_n_a<__gnu_cxx::__normal_iterator<__gnu_cxx::_Hashtable_node<unsigned int>**, std::vector<__gnu_cxx::_Hashtable_node<unsigned int>*, std::allocator<__gnu_cxx::_Hashtable_node<unsigned int>*> > >, unsigned int, __gnu_cxx::_Hashtable_node<unsigned int>*, __gnu_cxx::_Hashtable_node<unsigned int>*>(/*anon struct*/ int __first, unsigned int __n, _Hashtable_node<unsigned int> *const &__x, /*anon struct*/ int arg3) {
}

char * _S_construct<const char*>(const char *__beg, const char *__end, const /*anon struct*/ int &__a, /*anon struct*/ int arg3) {
    // local: const size_t __dnew;
    // local: _Rep *__r;
}

pair<__gnu_cxx::_Hashtable_iterator<unsigned int, unsigned int, __gnu_cxx::hash<unsigned int>, std::_Identity<unsigned int>, std::equal_to<unsigned int>, std::allocator<unsigned int> >,bool> insert_unique_noresize(const unsigned int &__obj) {
    // local: const size_t __n;
    // local: _Hashtable_node<unsigned int> *__first;
    // local: _Hashtable_node<unsigned int> *__tmp;
    // local: _Hashtable_node<unsigned int> *__cur;
}
...
void clear() {
    // local: size_t __i;
    // local: _Hashtable_node<unsigned int> *__cur;
    // local: _Hashtable_node<unsigned int> *__next;
}

void _M_fill_insert(__normal_iterator<__gnu_cxx::_Hashtable_node<unsigned int>**,std::vector<__gnu_cxx::_Hashtable_node<unsigned int>*, std::allocator<__gnu_cxx::_Hashtable_node<unsigned int>*> > > __position, unsigned int __n, _Hashtable_node<unsigned int> *const &__x) {
    // local: const size_t __old_size;
    // local: size_t __len;
    // local: /*anon struct*/ int __new_start;
    // local: /*anon struct*/ int __new_finish;
    // local: _Hashtable_node<unsigned int> *__x_copy;
...
int Zerg_IPRestrict_Mgr::get_iprestrict_conf(const Zerg_MMAP_BusPipe::ZERG_CONFIG &config) {
    // local: int ret;
    // local: const size_t TMP_BUFFER_LEN;
    // local: char err_outbuf[];
    // local: /*anon struct*/ int v;
