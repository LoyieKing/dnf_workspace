...
int Zerg_Console_Handler::cmd_modify_logpriority(char *ret_string, size_t &str_len) {
    // local: int ret;
    // local: string tmpstr;
    // local: ZEN_LOG_PRIORITY new_log_priority;
    // local: ZEN_LOG_PRIORITY old_log_priority;
    // local: size_t tmp_size;
}
...
int Zerg_Console_Handler::cmd_get_zergstats(char *ret_string, size_t &str_len) {
    // local: size_t tmp_size;
    // local: char day_and_time[];
    // local: ostringstream tmp_ostrstm;
}

int Zerg_Console_Handler::cmd_get_peer_stats(char *ret_string, size_t &str_len) {
    // local: int ret;
    // local: size_t tmp_size;
    // local: size_t startno;
    // local: size_t numquery;
    // local: string tmpstr;
    // local: const size_t MAX_QUERY_NUMBER;
    // local: ostringstream ostr_stream;
}

int Zerg_Console_Handler::process_mml_command(char *ret_string, size_t &str_len) {
    // local: int ret;
    // local: string mml_cmd;
}
