...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/framework/comm_service_config.cpp
...
void std::fill<__gnu_cxx::__normal_iterator<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>**, std::vector<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*, std::allocator<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*> > >, __gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*>(/*anon struct*/ int __first, /*anon struct*/ int __last, _Hashtable_node<SERVICES_IP_INFO> *const &__value) {
    // local: const bool __scalar;
}

_Hashtable_node<SERVICES_IP_INFO> ** std::fill_n<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>**, unsigned int, __gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*>(_Hashtable_node<SERVICES_IP_INFO> **__first, unsigned int __n, _Hashtable_node<SERVICES_IP_INFO> *const &__value) {
    // local: const bool __scalar;
}

void std::__uninitialized_fill_n_a<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>**, unsigned int, __gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*, __gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*>(_Hashtable_node<SERVICES_IP_INFO> **__first, unsigned int __n, _Hashtable_node<SERVICES_IP_INFO> *const &__x, /*anon struct*/ int arg3) {
}

/*anon struct*/ int std::fill_n<__gnu_cxx::__normal_iterator<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>**, std::vector<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*, std::allocator<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*> > >, unsigned int, __gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*>(/*anon struct*/ int __first, unsigned int __n, _Hashtable_node<SERVICES_IP_INFO> *const &__value) {
    // local: const bool __scalar;
}

void std::__uninitialized_fill_n_a<__gnu_cxx::__normal_iterator<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>**, std::vector<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*, std::allocator<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*> > >, unsigned int, __gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*, __gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*>(/*anon struct*/ int __first, unsigned int __n, _Hashtable_node<SERVICES_IP_INFO> *const &__x, /*anon struct*/ int arg3) {
}

int ServicesConfig::FindServicesIPConf(const SERVICES_ID &svrinfo, unsigned int &ipaddress, short unsigned int &port, unsigned int &idc_no, unsigned int &server_guid_no, char *cfg_info) {
    // local: SERVICES_IP_INFO svc_ip_info;
    // local: /*anon struct*/ int iter;
}

// line 75
int ServicesConfig::FindServicesIPConf(const SERVICES_ID &svrinfo, ZEN_Sockaddr_In &inetadd, unsigned int &idc_no, unsigned int &server_guid_no, char *cfg_info) {
    // local: unsigned int ip;
    // local: short unsigned int port;
    // local: int ret;
}

void reserve(unsigned int __n) {
    // local: const size_t __old_size;
    // local: _Hashtable_node<SERVICES_IP_INFO> **__tmp;
}
...
void clear() {
    // local: size_t __i;
    // local: _Hashtable_node<SERVICES_IP_INFO> *__cur;
    // local: _Hashtable_node<SERVICES_IP_INFO> *__next;
}
...
pair<__gnu_cxx::_Hashtable_iterator<SERVICES_IP_INFO, SERVICES_IP_INFO, HashofSvrIPInfo, std::_Identity<SERVICES_IP_INFO>, EqualSvrIPInfo, std::allocator<SERVICES_IP_INFO> >,bool> insert_unique_noresize(const SERVICES_IP_INFO &__obj) {
    // local: const size_t __n;
    // local: _Hashtable_node<SERVICES_IP_INFO> *__first;
    // local: _Hashtable_node<SERVICES_IP_INFO> *__tmp;
    // local: _Hashtable_node<SERVICES_IP_INFO> *__cur;
}

void _M_fill_insert(__normal_iterator<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>**,std::vector<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*, std::allocator<__gnu_cxx::_Hashtable_node<SERVICES_IP_INFO>*> > > __position, unsigned int __n, _Hashtable_node<SERVICES_IP_INFO> *const &__x) {
    // local: const size_t __old_size;
    // local: size_t __len;
    // local: /*anon struct*/ int __new_start;
    // local: /*anon struct*/ int __new_finish;
    // local: _Hashtable_node<SERVICES_IP_INFO> *__x_copy;
...
int ServicesConfig::FindSelfSERVICES_INFO(const char *cfgfile, SERVICES_ID &svrinfo) {
    // local: int ret;
    // local: const int BUFFER_LEN;
    // local: char outbuf[];
    // local: uint32_t int_value;
    // local: ZEN_INI_Implemention read_cfg;
    // local: ZenINIPropertyTree self_svr_cfg;
}
...
// line 236
int ServicesConfig::LoadSvrConfig(const ServicesConfig::SVCID_CONFIG *svcid_config) {
    // local: int ret;
    // local: const int BUFFER_LEN;
    // local: char tmpkey[];
    // local: char tmpbuf[];
    // local: char outbuf[];
    // local: SERVICES_IP_INFO svc_ip_info;
    // local: uint32_t num_svr;
    // local: uint32_t int_value;
    // local: uint32_t i;
    // local: ZEN_Sockaddr_In inetadd;
    // local: /*anon struct*/ int insert_result;
}

// line 109
int ServicesConfig::AddServicesConf(const SERVICES_ID &svrinfo, const ZEN_Sockaddr_In &inetadd, unsigned int idc_no) {
    // local: SERVICES_IP_INFO svc_ip_info;
    // local: /*anon struct*/ int insert_result;
}
