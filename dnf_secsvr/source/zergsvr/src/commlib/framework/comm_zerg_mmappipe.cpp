...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/framework/comm_zerg_mmappipe.cpp
...
// line 109
int Zerg_MMAP_BusPipe::getpara_from_zergcfg(const ZenINIPropertyTree &zerglingcfg) {
    // local: int ret;
