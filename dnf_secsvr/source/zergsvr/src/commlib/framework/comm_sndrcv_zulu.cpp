...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/framework/comm_sndrcv_zulu.cpp
...
int Zulu_SendRecv_Package::send_svc_package(ZEN_Time_Value *time_wait) {
    // local: int len;
    // local: unsigned int cmd;
    // local: ssize_t socket_ret;
}

int Zulu_SendRecv_Package::connect_zulu_server(ZEN_Time_Value *time_wait) {
    // local: int ret;
    // local: ZEN_Socket_Connector tmp_connector;
    // local: ZEN_Time_Value real_time_wait;
}
