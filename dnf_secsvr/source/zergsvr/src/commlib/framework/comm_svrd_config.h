...
// sizeof(Comm_Svrd_Config) = 166264 (0x28978)
...
public:
    ...
    conf_zerg::zerg_config zerg_config_;          // +0x14
    conf_framework::framework_config framework_config_; // +0xa921 (zergsvr 52 字节)
    conf_svcid::svcid_config svcid_config_;       // +0xa955
    std::string log_file_prefix_;                 // +0x2895c
    std::string zerg_cfg_file_;                   // +0x28960
    std::string app_cfg_file_;                    // +0x28964
    std::string framework_cfg_file_;              // +0x28968
    std::string svcid_cfg_file_;                  // +0x2896c
    std::string master_cfgsvr_ip_;                // +0x28970
    uint16_t instance_id_;                        // +0x28974
    bool is_use_cfgsvr_;                          // +0x28976
private:
