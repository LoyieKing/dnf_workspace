...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/framework/comm_mml_command.cpp
...
// line 45
const char * MML_Console_Command::GetMMLCommand() {
}
...
_Rb_tree_const_iterator<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > find(const /*anon struct*/ int &__k) {
    // local: const _Rb_tree_node<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > *__x;
    // local: const _Rb_tree_node<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > *__y;
    // local: /*anon struct*/ int __j;
}

// line 51
int MML_Console_Command::IsHaveCmdOption(const string &mml_option) {
    // local: /*anon struct*/ int option_iter;
}

_Rb_tree_iterator<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > _M_insert(/*anon struct*/ int *__x, /*anon struct*/ int *__p, const /*anon struct*/ int &__v) {
    // local: bool __insert_left;
    // local: _Rb_tree_node<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > *__z;
}

pair<std::_Rb_tree_iterator<std::basic_string<char, std::char_traits<char>, std::allocator<char> > >,bool> insert_unique(const /*anon struct*/ int &__v) {
    // local: _Rb_tree_node<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > *__x;
    // local: _Rb_tree_node<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > *__y;
    // local: bool __comp;
    // local: /*anon struct*/ int __j;
}

// line 34
int MML_Console_Command::GetMMLCommand(string &mml_cmd) {
}

// line 29
const char * MML_Console_Command::GetMMLString() {
}

// line 24
void MML_Console_Command::GetMMLString(string &mml_string) {
}

// line 64
int MML_Console_Command::GetCmdParameter(const string &para_key, string &para_value) {
    // local: /*anon struct*/ int para_iter;
}

void _M_erase(_Rb_tree_node<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > *__x) {
    // local: _Rb_tree_node<std::basic_string<char, std::char_traits<char>, std::allocator<char> > > *__y;
}
...
/*anon struct*/ int & operator[](const /*anon struct*/ int &__k) {
...
int MML_Console_Command::ParseMMLCommandString2(const char *mml_cmd_string) {
    // local: const char *part_tmp;
    // local: const char *part_end;
    // local: const char *part_start;
    // local: string key;
    // local: string value;
}
...
int MML_Console_Command::ParseMMLCommandString(const char *mml_cmd_string) {
    // local: const char CMD_SEPARATOR;
    // local: const char END_SEPARATOR;
    // local: const char OPTION_SEPARATOR;
    // local: const char KEY_SEPARATOR;
    // local: const char STRING_SEPARATOR;
    // local: const char *part_tmp;
    // local: const char *part_end;
    // local: const char *part_start;
    // local: string key;
