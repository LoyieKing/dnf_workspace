...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/zenlib/zen_os_adapt_mutex.cpp
...
int ZEN_OS::pthread_mutex_unlock(._13 *mutex) {
}

int ZEN_OS::pthread_mutex_trylock(._13 *mutex) {
}

int ZEN_OS::pthread_mutex_timedlock(._13 *mutex, const timespec *abs_timeout_spec) {
    // local: int result;
}

int ZEN_OS::pthread_mutex_timedlock(._13 *mutex, const timeval *abs_timeout_val) {
    // local: timespec abs_timeout_spec;
}

int ZEN_OS::pthread_mutex_lock(._13 *mutex) {
}

int ZEN_OS::pthread_mutex_destroy(._13 *mutex) {
}

int ZEN_OS::pthread_mutex_init(._13 *mutex, const ._15 *attr) {
}

int ZEN_OS::pthread_mutexattr_gettype(const ._15 *attr, int *type) {
}

int ZEN_OS::pthread_mutexattr_settype(._15 *attr, int type) {
}

int ZEN_OS::pthread_mutexattr_getpshared(const ._15 *attr, int *pshared) {
}

int ZEN_OS::pthread_mutexattr_setpshared(._15 *attr, int pshared) {
}

int ZEN_OS::pthread_mutexattr_destroy(._15 *attr) {
}

int ZEN_OS::pthread_mutexattr_init(._15 *attr) {
}

int ZEN_OS::pthread_mutexattr_initex(._15 *attr, bool process_share, bool recursive, bool need_timeout, const char *mutex_name) {
    // local: int result;
    // local: int lock_shared;
    // local: int lock_type;
}
