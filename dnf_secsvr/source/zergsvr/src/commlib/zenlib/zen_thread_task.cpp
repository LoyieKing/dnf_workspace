...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/zenlib/zen_thread_task.cpp
...
int Zen_Thread_Task::group_id() {
}

ZEN_THREAD_ID Zen_Thread_Task::thread_id() {
}
...
int Zen_Thread_Task::activate(int group_id, ZEN_THREAD_ID *threadid, int detachstate, size_t stacksize, int threadpriority) {
    // local: int ret;
}

void Zen_Thread_Task::svc_run(void *args) {
    // local: Zen_Thread_Task *t;
    // local: const int svc_status;
}
