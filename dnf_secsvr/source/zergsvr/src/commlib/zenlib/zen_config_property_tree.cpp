...
_Rb_tree_const_iterator<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > find(const /*anon struct*/ int &__k) {
    // local: const _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__x;
    // local: const _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__y;
...
_Rb_tree_iterator<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > find(const /*anon struct*/ int &__k) {
    // local: _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__x;
    // local: _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__y;
    // local: /*anon struct*/ int __j;
}

// line 60
int ZenConfPropertyTree::get_child(const string &path_str, PROPERTY_TREE_NODE *&child_data) {
...
// line 16
int ZenConfPropertyTree::get_child(const string &path_str, const PROPERTY_TREE_NODE *&const_child_data) {
    // local: size_t str_pos;
    // local: string start_str;
    // local: /*anon struct*/ int iter_tmp;
...
// line 137
int ZenConfPropertyTree::get_leaf_str(const string &path_str, const string &key_data, string &value_data) {
...
// line 221
int ZenConfPropertyTree::get_leaf_bool(const string &path_str, const string &key_data, bool &value_bool) {
    // local: string value_data;
    // local: int ret;
}

// line 203
int ZenConfPropertyTree::get_leaf_uint(const string &path_str, const string &key_data, uint32_t &value_uint) {
    // local: string value_data;
    // local: int ret;
}

// line 186
int ZenConfPropertyTree::get_leaf_int(const string &path_str, const string &key_data, int32_t &value_int) {
    // local: string value_data;
    // local: int ret;
}

// line 167
int ZenConfPropertyTree::get_leaf_str(const string &path_str, const string &key_data, char *&str_data, size_t max_str_len) {
    // local: string value_data;
    // local: int ret;
}
...
void _M_erase(_Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__x) {
    // local: _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__y;
}

_Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > * _M_copy(const _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__x, _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__p) {
    // local: _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__top;
    // local: _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__y;
}

_Rb_tree_iterator<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > _M_insert(/*anon struct*/ int *__x, /*anon struct*/ int *__p, const pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >,ZenConfPropertyTree> &__v) {
    // local: bool __insert_left;
    // local: _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__z;
}

_Rb_tree_iterator<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > insert_equal(const pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >,ZenConfPropertyTree> &__v) {
    // local: _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__x;
    // local: _Rb_tree_node<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, ZenConfPropertyTree> > *__y;
}

// line 103
int ZenConfPropertyTree::put_child(const string &path_str, const string &new_child_name, const PROPERTY_TREE_NODE &new_child_note) {
...
// line 127
int ZenConfPropertyTree::new_child(const string &path_str, const string &new_child_name) {
    // local: PROPERTY_TREE_NODE null_node;
}

// line 249
int ZenConfPropertyTree::put_leaf_str(const string &path_str, const string &key_data, const string &value_data) {
    // local: PROPERTY_TREE_NODE *child_note;
    // local: int ret;
    // local: /*anon struct*/ int iter;
}
...
// line 286
int ZenConfPropertyTree::put_leaf_bool(const string &path_str, const string &key_data, bool value_bool) {
}

// line 274
int ZenConfPropertyTree::put_leaf_int(const string &path_str, const string &key_data, int value_int) {
