...
// line 140
int ZenINIPropertyTree::get_bool_value(const string &sectionname, const string &keyname, bool &value) {
}

// line 131
int ZenINIPropertyTree::get_uint32_value(const string &sectionname, const string &keyname, uint32_t &value) {
}

// line 123
int ZenINIPropertyTree::get_int32_value(const string &sectionname, const string &keyname, int32_t &value) {
}

// line 115
int ZenINIPropertyTree::get_string_value(const string &sectionname, const string &keyname, char *buf, size_t size_buf) {
}

// line 106
int ZenINIPropertyTree::get_string_value(const string &sectionname, const string &keyname, string &value) {
}

// line 20
int ZEN_INI_Implemention::read(const char *file_name, ZenConfPropertyTree &propertytree) {
    // local: const size_t LINE_BUFFER_LEN;
    // local: char one_line[];
    // local: char str_key[];
    // local: char str_value[];
    // local: string cur_section;
    // local: ifstream cfgfile;
    // local: char *str;
    // local: char *snext;
}
