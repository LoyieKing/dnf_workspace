...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/zenlib/zen_event_reactor_base.cpp
...
void std::fill<__gnu_cxx::__normal_iterator<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >**, std::vector<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*, std::allocator<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*> > >, __gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*>(/*anon struct*/ int __first, /*anon struct*/ int __last, _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *const &__value) {
    // local: const bool __scalar;
}

_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > ** std::fill_n<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >**, unsigned int, __gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*>(_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > **__first, unsigned int __n, _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *const &__value) {
    // local: const bool __scalar;
}
...
/*anon struct*/ int std::fill_n<__gnu_cxx::__normal_iterator<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >**, std::vector<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*, std::allocator<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*> > >, unsigned int, __gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*>(/*anon struct*/ int __first, unsigned int __n, _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *const &__value) {
    // local: const bool __scalar;
}
...
void reserve(unsigned int __n) {
    ...
    // local: _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > **__tmp;
}

pair<__gnu_cxx::_Hashtable_iterator<std::pair<const int, ZEN_Event_Handler*>, int, __gnu_cxx::hash<int>, std::_Select1st<std::pair<const int, ZEN_Event_Handler*> >, std::equal_to<int>, std::allocator<ZEN_Event_Handler*> >,bool> insert_unique_noresize(const /*anon struct*/ int &__obj) {
    // local: const size_t __n;
    // local: _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *__first;
    // local: _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *__tmp;
    // local: _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *__cur;
}

void clear() {
    // local: size_t __i;
    // local: _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *__cur;
    // local: _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *__next;
}

int ZEN_Reactor::close() {
    // local: /*anon struct*/ int iter_temp;
    // local: ZEN_Event_Handler *event_handler;
}
...
void _M_fill_insert(__normal_iterator<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >**,std::vector<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*, std::allocator<__gnu_cxx::_Hashtable_node<std::pair<const int, ZEN_Event_Handler*> >*> > > __position, unsigned int __n, _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *const &__x) {
    ...
    // local: _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *__x_copy;
    // local: const size_t __elems_after;
    // local: /*anon struct*/ int __old_finish;
}

size_t erase(const int &__key) {
    // local: const size_t __n;
    // local: _Hashtable_node<std::pair<const int, ZEN_Event_Handler*> > *__first;
...
int ZEN_Reactor::remove_handler(ZEN_Event_Handler *event_handler, bool call_handle_close) {
    // local: int ret;
    // local: ZEN_SOCKET socket_hd;
    // local: ZEN_Event_Handler *tmp_handler;
    // local: int event_mask;
}
