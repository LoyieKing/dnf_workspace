...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/zenlib/zen_thread_wait_mgr.cpp
...
void _M_clear() {
    // local: _List_node<Zen_Thread_Wait_Manager::MANAGE_WAIT_INFO> *__cur;
    // local: _List_node<Zen_Thread_Wait_Manager::MANAGE_WAIT_INFO> *__tmp;
}

// line 23
void Zen_Thread_Wait_Manager::record_wait_thread(ZEN_THREAD_ID wait_thr_id, int wait_group_id) {
    // local: Zen_Thread_Wait_Manager::MANAGE_WAIT_INFO wait_thread;
}
...
_List_iterator<Zen_Thread_Wait_Manager::MANAGE_WAIT_INFO> erase(_List_iterator<Zen_Thread_Wait_Manager::MANAGE_WAIT_INFO> __position) {
    // local: /*anon struct*/ int __ret;
    // local: /*anon struct*/ int __ret;
}
...
void Zen_Thread_Wait_Manager::wait_group(int group_id) {
    ...
    // local: Zen_Thread_Wait_Manager::MANAGE_WAIT_INFO wait_thread;
    // local: /*anon struct*/ int del_iter;
}
