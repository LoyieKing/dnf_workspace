...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32_bugfix_tag296/src/commlib/zenlib/zen_os_adapt_string.cpp
...
void ZEN_OS::tm_from_str1(const char *strtm, tm *ptmptm) {
}

void ZEN_OS::tm_from_str2(const char *strtm, tm *ptmptm) {
}

void ZEN_OS::tm_from_str3(const char *strtm, tm *ptmptm) {
}

void ZEN_OS::tm_from_str4(const char *strtm, tm *ptmptm) {
}

const char * ZEN_OS::skip_line(const char *str) {
}

const char * ZEN_OS::skip_token(const char *str, char separator_char) {
}

const char * ZEN_OS::skip_separator(const char *str, char separator_char) {
}

const char * ZEN_OS::skip_token(const char *str) {
}

const char * ZEN_OS::skip_whitespace(const char *str) {
}

char * ZEN_OS::strtrimright(char *str) {
    // local: char *lstr;
}

char * ZEN_OS::strtrimleft(char *str) {
    // local: char *lstr;
}

char * ZEN_OS::strtrim(char *str) {
}

int ZEN_OS::strncasecmp(const char *string1, const char *string2, size_t maxlen) {
}

int ZEN_OS::strcasecmp(const char *string1, const char *string2) {
}

char * ZEN_OS::strlwr(char *str) {
    // local: char *lstr;
}

char * ZEN_OS::strupr(char *str) {
    // local: char *lstr;
}

char * ZEN_OS::prefix_unique_name(const char *prefix_name, char *name, size_t length) {
    // local: unsigned int uniqueid_builder;
}

char * ZEN_OS::object_unique_name(const void *object_ptr, char *name, size_t length) {
}

time_t ZEN_OS::time_from_str4(const char *strtm) {
    // local: int year;
    // local: int mon;
    // local: int day;
    // local: int hour;
...
time_t ZEN_OS::time_from_str3(const char *strtm) {
    // local: int year;
    // local: int mon;
    // local: int day;
    // local: tm tmtmp;
...
time_t ZEN_OS::time_from_str2(const char *strtm) {
    // local: int year;
    // local: int mon;
    // local: int day;
    // local: int hour;
...
time_t ZEN_OS::time_from_str1(const char *strtm) {
    // local: int year;
    // local: int mon;
    // local: int day;
    // local: tm tmtmp;
