...
// Original source: /data/secci/ci/jenkins/workspace/g3_release_suse32/src/commlib/zenlib/zen_os_adapt_thread.cpp
// Original quirks preserved: adapt_svc_run returns NULL; pthread_createex does
// not destroy the attr on the success path.
...
int pthread_join(ZEN_THREAD_ID threadid) {
    ...
    return ::pthread_join(threadid, &return_data);
}
