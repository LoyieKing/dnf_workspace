...
// line 96
int ZEN_Socket_Acceptor::accept(ZEN_Socket_Stream &new_stream, ZEN_Time_Value &timeout, ZEN_Sockaddr *remote_addr) {
    // local: int ret;
    // local: const int HANDLE_READY_ONE;
    // local: ZEN_SOCKET sock_handle;
}

// line 78
int ZEN_Socket_Acceptor::accept(ZEN_Socket_Stream &new_stream, ZEN_Sockaddr *remote_addr) {
    // local: ZEN_SOCKET sock_handle;
}
