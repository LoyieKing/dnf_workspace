/* haval160.h -- HAVAL V.1（3 轮，160 位）的 tencrypt_new 变体
   由 DWARF 重建：CHaval160 + 上下文（sizeof 208 = 2+2+32+128+4+8+32）。 */

#ifndef TENCRYPT_INC_HAVAL160_H_
#define TENCRYPT_INC_HAVAL160_H_
...
#endif /* TENCRYPT_INC_HAVAL160_H_ */
